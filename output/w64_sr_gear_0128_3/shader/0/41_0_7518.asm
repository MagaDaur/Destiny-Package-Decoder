...
if_nz r0.z
  ...
  add r2.w, cb0[4].x, cb0[4].x
  mad r2.w, r0.z, -r2.w, r2.w
  mad r3.x, cb0[4].x, l(2.000000), l(-2.000000)
  mad r0.z, r0.z, r3.x, l(1.000000)
  movc r0.z, r1.w, r2.w, r0.z
else
  mov r0.z, cb0[4].x
endif
add r0.z, -r0.z, cb0[3].x
...
dp3 r1.w, cb0[8].xyzx, r4.xyzx
add r2.w, -cb0[6].x, cb0[7].x
mad_sat r1.w, r1.w, r2.w, cb0[6].x
add r2.w, v4.z, -cb0[9].z
mul r2.w, r2.w, cb0[10].x
max r2.w, r2.w, l(0.000000)
log r2.w, r2.w
mul r2.w, r2.w, cb0[11].x
exp r2.w, r2.w
mul_sat r2.w, r2.w, cb0[12].x
mul r1.w, r1.w, r2.w
