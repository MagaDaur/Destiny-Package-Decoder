  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r6.xy = r6.xy * cb0[51].xx + cb0[51].yy;
  ...
  r8.x = saturate(cb7[r0.y+13].y * r2.x + cb7[r0.y+13].x);
  ...
  if (r0.z != 0) {
    ...
    r0.z = r0.z ? r2.w : r4.w;
    r0.z = r3.w ? r0.z : r3.x;
    r1.w = cmp(0.5 >= cb0[38].x);
    r2.w = cb0[38].x + cb0[38].x;
    r2.w = r0.z * -r2.w + r2.w;
    r3.x = cb0[38].x * 2 + -2;
    r0.z = r0.z * r3.x + 1;
    r0.z = r1.w ? r2.w : r0.z;
  ...
  r0.z = cmp(r0.z < 0);
  if (r0.z != 0) discard;
  r0.z = saturate(cb0[48].x);
  r1.w = dot(r4.xyz, r4.xyz);
  r1.w = rsqrt(r1.w);
  r4.xyz = r4.xyz * r1.www;
  r1.w = dot(cb0[41].xyz, r4.xyz);
  r2.w = -cb0[40].x + cb0[17].x;
  r1.w = saturate(r1.w * r2.w + cb0[40].x);
  r2.w = -cb0[42].z + v4.z;
  r2.w = cb0[43].x * r2.w;
  r2.w = max(0, r2.w);
  r2.w = log2(r2.w);
  r2.w = cb0[44].x * r2.w;
  r2.w = exp2(r2.w);
  r2.w = saturate(cb0[45].x * r2.w);
  r1.w = r2.w * r1.w;
  r0.x = saturate(r0.x * cb0[46].x + cb0[46].y);
  r0.x = r1.w * r0.x;
