...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r0.xyz = r2.xyz * r1.zxy;
  r0.xyz = r1.yzx * r2.yzx + -r0.xyz;
  o2.xyz = v2.www * r0.xyz;
  r0.xy = v3.xy * cb1[6].xy + cb1[6].zw;
  r0.z = saturate(cb1[7].z * r1.z);
  o0.w = saturate(cb1[7].w + r0.z);
  r0.z = 32767.0996 * v1.w;
  r0.z = (int)r0.z;
  r0.w = (uint)r0.z >> 3;
  r0.zw = (int2)r0.zw & int2(7,4095);
  r0.z = (int)r0.z;
  o2.w = 0.100000001 + r0.z;
  r3.xyzw = t1.Load(r0.w).xyzw;
  r0.zw = (uint2)r3.yw << int2(8,8);
  r0.zw = (int2)r0.zw | (int2)r3.xz;
  r0.zw = f16tof32(r0.zw);
  o3.zw = r0.xy * r0.zw;
  o0.xyz = r1.xyz;
  o1.xyzw = r2.zxyy;
  o3.xy = r0.xy;
