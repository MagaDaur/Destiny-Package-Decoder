...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r2.z = (uint)r0.w;
    r3.xz = float2(2.32830644e-010,2.32830644e-010) * r2.yz;
    r2.y = r2.y * -6.98491931e-010 + -2;
    r2.z = r2.z * -1.3387762e-009 + -4.25;
    r2.w = saturate(cb0[3].z);
    r4.xy = r2.ww * float2(0.181817994,-1.81818199) + float2(0.636363983,1);
    r2.w = r2.w * r2.w;
    r2.w = saturate(r4.x * r2.w + r4.y);
    r2.z = r2.z + -r2.y;
    r2.y = r2.w * r2.z + r2.y;
    r1.w = 2.32830644e-010 * r2.x;
    r2.x = r2.x * 4.65661287e-010 + -3;
    r2.z = r1.w * r1.w;
    r2.x = r2.x * r2.z + 1;
    r2.x = max(0, r2.x);
    r1.z = r2.x * 0.125000015 + 0.174999997;
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r2.x = (uint)r0.w;
  ...
  // No code for instruction (needs manual fix):
    ...
    r3.w = 0;
  // No code for instruction (needs manual fix):
    store_uav_typed u0.xyzw, r0.wwww, r3.xzww
  }
  return;
}