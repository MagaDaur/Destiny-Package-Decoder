...
// unknown dcl_: dcl_input_sgv v3.x, vertex_id
  ...
  r0.xzw = r0.xzw * float3(0.0799999982,0.0799999982,0.0799999982) + r1.xyz;
  r1.xyz = cb12[7].xyz + -r1.xyz;
  r2.xyz = cb12[4].yzx * r1.zxy;
  r2.xyz = r1.yzx * cb12[4].zxy + -r2.xyz;
  r1.w = dot(r2.xyz, r2.xyz);
  r1.w = rsqrt(r1.w);
  r2.xyz = r2.xyz * r1.www;
  r2.xyz = r2.xyz * r0.yyy;
  r0.xyz = r2.xyz * float3(0.0799999982,0.0799999982,0.0799999982) + r0.xzw;
  r0.w = dot(r1.xyz, r1.xyz);
  r0.w = rsqrt(r0.w);
  r1.xyz = r1.xyz * r0.www;
  r0.xyz = r1.xyz * float3(0.180000007,0.180000007,0.180000007) + r0.xyz;
  o1.xyz = r1.xyz;
  ...
  o0.w = r0.w;
  r1.x = cb0[106].x * cb0[8].y;
  r1.y = cmp(0.999000013 < v0.w);
  r1.x = r1.y ? 0 : r1.x;
  o0.z = r1.x;
  r1.x = cmp(r1.x < 9.99999997e-007);
  r1.y = cmp(cb0[109].x < 9.99999997e-007);
