  ...
  out float4 o3 : SV_POSITION0)
{
  ...
  r1.xyz = r1.xyz * float3(0.5,0.5,0.5) + float3(0,-0.0500000007,-0.180000007);
  r1.w = 1.57050002 + v1.w;
  r1.xyzw = float4(0.0399999991,1,8,0.5) * r1.xyzw;
