...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.z = saturate(r4.y);
    r7.x = r0.z * 0.0174999982 + 0.0225000009;
    r0.z = r0.y * -2 + r0.w;
    r7.y = saturate(1 + r0.z);
    r0.z = saturate(cb0[4].y);
    r5.x = r5.y * r0.w + 1;
    r0.z = r0.z * 0.25 + 0.25;
    r0.z = r5.x * r0.z + 0.5;
    r7.z = 7 * r0.z;
    ...
    r8.xyzw = float4(-0.452618003,-0.000830999983,-0.179995999,-0.101346001) * r5.xyzw;
    r5.z = -0.130805001 * r5.w;
    r5.x = dot(float2(1,1), r8.xy);
    r5.y = dot(float2(1,1), r8.zw);
    r5.xyz = float3(0.505478978,0.461268008,1) + r5.xyz;
