...
// unknown dcl_: dcl_input_sgv v5.x, vertex_id
  ...
  r4.xyz = cb0[11].xxx * r3.zxy;
  r0.xyz = r4.xyz * r0.yyy + r0.xzw;
  ...
  r1.y = cb0[106].x * 0.0174532942;
  r1.y = cos(r1.y);
  r1.x = abs(r1.x) + -r1.y;
  r1.z = cb0[107].x + cb0[106].x;
  r1.z = 0.0174532942 * r1.z;
  r1.z = cos(r1.z);
  r1.y = r1.z + -r1.y;
  r1.x = saturate(r1.x / r1.y);
  r1.y = r1.w * 0.333332986 + -0.5;
  r1.z = 10000 + -r1.w;
