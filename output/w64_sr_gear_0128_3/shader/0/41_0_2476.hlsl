  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r6.xy = r6.xy * cb0[48].xx + cb0[48].yy;
  ...
  if (r0.z != 0) {
    ...
    r0.z = r0.z ? r2.w : r4.x;
    r0.z = r3.w ? r0.z : r3.x;
    r1.w = cmp(0.5 >= cb0[35].x);
    r2.w = cb0[35].x + cb0[35].x;
    r2.w = r0.z * -r2.w + r2.w;
    r3.x = cb0[35].x * 2 + -2;
    r0.z = r0.z * r3.x + 1;
    r0.z = r1.w ? r2.w : r0.z;
  ...
  r0.z = cmp(r0.z < 0);
  if (r0.z != 0) discard;
  r0.z = saturate(cb0[45].x);
  r1.w = dot(v0.xyz, v0.xyz);
  r1.w = rsqrt(r1.w);
  r4.xyz = v0.xyz * r1.www;
  r1.w = dot(cb0[38].xyz, r4.xyz);
  r2.w = -cb0[37].x + cb0[14].x;
  r1.w = saturate(r1.w * r2.w + cb0[37].x);
  r2.w = -cb0[39].z + v4.z;
  r2.w = cb0[40].x * r2.w;
  r2.w = max(0, r2.w);
  r2.w = log2(r2.w);
  r2.w = cb0[41].x * r2.w;
  r2.w = exp2(r2.w);
  r2.w = saturate(cb0[42].x * r2.w);
  r1.w = r2.w * r1.w;
  r0.x = saturate(r0.x * cb0[43].x + cb0[43].y);
  r0.x = r1.w * r0.x;
