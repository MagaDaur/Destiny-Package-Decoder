  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.z = rsqrt(r0.z);
  r1.xyz = r1.xyz * r0.zzz;
  r0.z = saturate(cb0[28].x);
  r1.w = dot(v0.xyz, v0.xyz);
  r1.w = rsqrt(r1.w);
  r4.xyz = v0.xyz * r1.www;
  r1.w = dot(cb0[21].xyz, r4.xyz);
  r2.w = -cb0[20].x + cb0[3].x;
  r1.w = saturate(r1.w * r2.w + cb0[20].x);
  r2.w = -cb0[22].z + v4.z;
  r2.w = cb0[23].x * r2.w;
  r2.w = max(0, r2.w);
  r2.w = log2(r2.w);
  r2.w = cb0[24].x * r2.w;
  r2.w = exp2(r2.w);
  r2.w = saturate(cb0[25].x * r2.w);
  r1.w = r2.w * r1.w;
  r0.x = saturate(r0.x * cb0[26].x + cb0[26].y);
  r0.x = r1.w * r0.x;
