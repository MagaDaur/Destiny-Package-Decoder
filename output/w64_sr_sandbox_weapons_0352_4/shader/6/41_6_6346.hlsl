...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r5.x = cb0[22].x / r4.y;
    r5.y = saturate(r1.z);
    r5.y = r5.y * 0.0574999973 + 0.0724999979;
    r6.w = r5.x + r2.w;
    r7.w = r6.w * r4.y;
    r5.xyz = cb0[171].xyz * r5.yyy;
    r0.yzw = r5.xyz * cb0[170].xxx + r0.yzw;
    r5.xy = saturate(cb0[172].xx * float2(6,4));
    r5.xy = float2(1,1) + -r5.xy;
    r7.xyz = r5.xxx * r0.yzw;
    r6.xyz = r7.xyz * cb0[165].xxx + r2.xyz;
    r3.z = r5.y * r3.z;
    r0.y = cb0[172].x * r3.z;
