...
mad r0.yzw, v0.xxyz, cb1[5].wwww, cb1[5].xxyz
lt r0.x, l(0.000000), r0.x
and r0.x, r0.x, l(0x3f800000)
add r1.x, cb0[1].x, -cb0[2].x
mad r0.x, r0.x, r1.x, cb0[2].x
...
rsq r1.y, r1.y
mul r1.yzw, r1.yyyy, cb0[0].xxyz
mul r1.yzw, r0.xxxx, r1.yyzw
add r0.xyz, r0.yzwy, -cb0[6].xyzx
mul r2.xyz, -r1.zwyz, r0.zxyz
...
mul r2.xyz, r0.yzxy, r1.wyzw
mad r2.xyz, r1.zwyz, r0.zxyz, -r2.xyzx
