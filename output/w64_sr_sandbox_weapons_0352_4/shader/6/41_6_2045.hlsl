...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r3.y = (uint)r0.w;
    r4.xy = float2(2.32830644e-010,2.32830644e-010) * r3.xy;
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r3.y = (uint)r0.w;
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r3.z = (uint)r0.w;
    ...
    r3.z = r3.z * 5 + 5;
    r3.w = r3.x * 4.65661287e-010 + 1;
    r2.x = r3.y * 4.65661287e-010 + 1;
    r5.xyz = r3.xxx * float3(7.50445747e-011,7.2853451e-010,1.33330472e-010) + float3(0,-1.132043,0.427350014);
    ...
    r3.xyw = r5.xyz * r3.www;
    r0.w = dot(r3.xyw, r3.xyw);
    r0.w = rsqrt(r0.w);
    r5.xyz = r3.xyw * r0.www;
