...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r5.xyz = r4.xxx * float3(5.72374544e-011,9.35203137e-010,5.82076609e-011) + float3(0,-3.01666689,0.25);
    r4.xzw = cmp(r4.xxx >= float3(0,3.43597389e+009,4.2949673e+009));
    ...
    r4.yzw = float3(0.100000001,0.300000012,0.200000003) * r4.yzw;
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r5.x = (uint)r0.w;
