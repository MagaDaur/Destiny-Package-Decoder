  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.zw = r0.zw * cb0[111].xx + r1.xy;
  r0.xy = r0.xy * cb0[111].xx + r0.zw;
  ...
  r1.xyz = r1.xxx * float3(0.0207250006,0.0207250006,0.0207250006) + cb0[117].xyz;
  r1.xyz = cb0[98].xyz * r1.xyz;
  r2.xyz = cmp(float3(1,2,3) < v0.xxx);
  r3.xyz = r2.zzz ? cb0[14].xyz : cb0[98].xyz;
  ...
  r1.x = sqrt(r1.x);
  r1.y = 0.015625 * r1.x;
  r1.x = saturate(r1.x * cb0[105].x + cb0[105].y);
  r1.y = min(1, r1.y);
  r3.z = sqrt(r1.y);
