  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.w = cb0[5].z + v3.y;
  r1.w = saturate(cb0[5].y * abs(r1.w) + cb0[5].x);
  r1.w = saturate(cb0[6].y * r1.w + cb0[6].x);
  r3.xyz = cb0[15].xxx * cb0[4].xyz;
  ...
  r6.xyzw = t16.SampleLevel(s4_s, r4.xyz, 0).xyzw;
  r7.xyzw = t17.SampleLevel(s4_s, r4.xyz, 0).xyzw;
  r8.xyzw = t18.SampleLevel(s4_s, r4.xyz, 0).xyzw;
  r0.w = cb3[15].x * r0.w;
  ...
  r2.w = t19.SampleLevel(s3_s, r4.xyz, 0).x;
  r2.w = -1 + r2.w;
  r0.w = r0.w * r2.w + 1;
  r2.x = saturate(dot(cb0[9].xyz, r2.xyz));
  r2.yzw = cb0[8].xyz * r3.www;
