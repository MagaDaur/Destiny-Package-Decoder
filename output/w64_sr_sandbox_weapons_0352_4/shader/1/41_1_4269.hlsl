...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r4.xyz = cb1[1].zxy * v0.yyy;
  r4.xyz = cb1[0].zxy * v0.xxx + r4.xyz;
  r4.xyz = cb1[2].zxy * v0.zzz + r4.xyz;
  ...
  r0.z = exp2(r0.z);
  r0.z = 0.75 * r0.z;
  r0.w = -0.425000012 + v3.y;
  r3.y = r0.z * r0.w + 0.425000012;
  r3.x = v3.y;
  r0.zw = v2.yx * r3.xy;
  r0.xy = r0.xy * r0.zw;
  sincos(v2.w, r3.x, r5.x);
  r0.zw = r3.xx * r0.xy;
  r0.x = r0.x * r5.x + r0.w;
  r0.y = r0.y * r5.x + -r0.z;
  ...
  o3.xyzw = r1.wwww ? float4(10000,10000,-10000,1) : r0.xyzw;
