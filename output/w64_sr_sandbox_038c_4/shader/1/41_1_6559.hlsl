  ...
  out float4 o3 : SV_POSITION0)
{
  ...
  r2.w = 0;
  r3.w = 0;
  r0.y = cb0[105].x * 3.14100003;
  sincos(r0.y, r4.x, r5.x);
  r0.yzw = v3.xyz * cb1[4].xyz + cb1[5].xyz;
  r3.xyz = r5.xxx * r0.yzw;
  r4.y = dot(cb0[106].xyz, cb0[106].xyz);
  r4.y = rsqrt(r4.y);
  r4.yzw = cb0[106].xyz * r4.yyy;
  ...
  r0.y = cmp(cb0[113].x < 9.99999997e-007);
