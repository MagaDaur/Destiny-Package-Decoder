...
mul r0.x, r0.x, r0.x
mad_sat r0.x, r0.x, l(2.331002), l(-1.331002)
mov_sat r0.y, v3.x
mad r0.yzw, r0.yyyy, l(0.000000, 0.116221, 0.214713, 0.880462), cb0[98].xxyz
...
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.xyxx, t13.xyzw, s2
...
sample_indexable(texture2d)(float,float,float,float) r0.w, v0.xyxx, t0.yzwx, s1
mul_sat r0.w, r0.w, v3.z
