  ...
  out float4 o3 : SV_POSITION0)
{
  ...
  r0.yzw = float3(-0.300000012,0.0700000003,-0.100000001) + r0.yzw;
  r0.yzw = r0.yzw * float3(1,1.10000002,1) + cb0[8].xyz;
  r2.x = 0.5 * v1.w;
  ...
  r0.y = cmp(cb0[119].x < 9.99999997e-007);
