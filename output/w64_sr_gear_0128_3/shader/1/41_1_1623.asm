...
dp3 r2.x, r5.xyzx, r0.xyzx
dp3 r2.y, r6.xyzx, r0.xyzx
mul r0.xyz, r1.zxyz, r2.xyzx
mad r0.xyz, r1.yzxy, r2.yzxy, -r0.xyzx
mul o2.xyz, r0.xyzx, v2.wwww
mad r0.xy, v3.xyxx, cb1[6].xyxx, cb1[6].zwzz
mul_sat r0.z, r1.z, cb1[7].z
add_sat o0.w, r0.z, cb1[7].w
mul r0.z, v1.w, l(32767.099609)
ftoi r0.z, r0.z
ishr r0.w, r0.z, l(3)
and r0.zw, r0.zzzw, l(0, 0, 7, 4095)
itof r0.z, r0.z
add o2.w, r0.z, l(0.100000)
ld_indexable(buffer)(uint,uint,uint,uint) r3.xyzw, r0.wwww, t1.xyzw
ishl r0.zw, r3.yyyw, l(0, 0, 8, 8)
or r0.zw, r0.zzzw, r3.xxxz
