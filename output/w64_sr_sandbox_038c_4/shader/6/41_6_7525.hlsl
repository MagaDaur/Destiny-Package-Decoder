...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r3.yz = r0.ww * float2(-4.63045213e-010,4.65661287e-010) + float2(2.98876405,-1);
    r0.w = r1.w * r1.w;
    r0.w = r3.y * r0.w;
    r0.w = min(1, r0.w);
    r1.z = r0.w * 0.400000036 + 0.800000012;
    r0.w = cb10[0].x + 0.25;
    r0.w = (int)r0.w;
    r2.w = 2.32830644e-010 * r3.x;
    r3.x = r3.x * 4.65661287e-010 + -1;
    r3.x = cb0[2].x * r3.x;
    r5.xy = float2(1.25,0.699999988) * r3.xx;
    r5.z = 1;
    r3.x = dot(r5.xz, r5.xz);
    r3.x = rsqrt(r3.x);
    r3.xy = r5.xz * r3.xx;
    r3.z = 0.200000003 * r3.z;
    r3.xy = r3.xy * r3.zz;
    r5.w = cb0[2].x * cb0[2].x;
    r6.x = r5.w * r2.z;
    r5.x = -0.200000003 * r6.x;
    r5.w = r5.w * r4.x;
    r5.z = r5.w * -0.324999988 + r3.y;
    r3.zw = float2(0.5,2.04999995);
    r3.xyz = r5.xyz + r3.zxw;
    r5.xyz = -cb9[r0.w+32].yzx * r3.zxy;
    r5.xyz = r3.yzx * -cb9[r0.w+32].zxy + -r5.xyz;
    r3.w = dot(r3.xyz, -cb9[r0.w+32].xyz);
    r5.w = -r3.w;
    r3.xyz = cb9[r0.w+32].www * r3.xyz;
    r3.w = 0;
    r3.xyzw = r5.xyzw + r3.xyzw;
    r5.xyz = cb9[r0.w+32].zxy * r3.yzx;
    r5.xyz = cb9[r0.w+32].yzx * r3.zxy + -r5.xyz;
    r3.xyz = cb9[r0.w+32].www * r3.xyz + r5.xyz;
    r3.xyz = r3.www * cb9[r0.w+32].xyz + r3.xyz;
    r3.xyz = cb9[r0.w+0].xyz + r3.xyz;
    r0.z = mad((int)r0.z, 0x0019660d, 0x3c6ef35f);
    r3.w = (uint)r0.z;
    ...
    r8.xyz = cb9[r0.y+32].yzx * r3.zxy;
    r8.xyz = r3.yzx * cb9[r0.y+32].zxy + -r8.xyz;
