  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyz = cb0[10].xyz + float3(-0.0103086559,-0.0103086559,-0.0103086559);
  r0.xyz = float3(1.01041603,1.01041603,1.01041603) * r0.xyz;
  ...
  r0.xyz = r0.xyz * float3(7.55739975,7.55739975,7.55739975) + r2.xyz;
  ...
  r1.x = exp2(r1.x);
  r1.x = v7.y * r1.x;
  r1.y = -0.800000012 + v6.x;
  r1.y = saturate(1.11111116 * r1.y);
