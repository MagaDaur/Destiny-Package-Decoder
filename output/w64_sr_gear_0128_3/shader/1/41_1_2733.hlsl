...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r2.xyz = r0.yyy * r2.xyz + cb0[22].xyz;
  r0.z = cb0[3].x * cb0[2].x;
  r0.w = dot(cb0[4].xyz, cb0[4].xyz);
  r0.w = sqrt(r0.w);
  r1.w = cb0[7].x * cb0[6].x;
  r1.w = cb0[5].x * r1.w;
  r2.w = max(cb0[9].x, cb0[8].x);
  r2.w = min(cb0[10].x, r2.w);
  r2.w = r2.w * r0.w;
  r2.w = r2.w * cb0[11].x + -r1.w;
  r1.w = cb0[12].x * r2.w + r1.w;
  r0.z = r0.z * r0.w + r1.w;
  r0.z = cb0[13].x * cb0[14].x + r0.z;
  r0.z = max(cb0[15].x, r0.z);
  r0.z = min(cb0[16].x, r0.z);
  r1.w = cb0[18].x + -1;
  r1.w = cmp(abs(r1.w) < 9.99999975e-006);
  r1.w = r1.w ? 1.000000 : 0;
  r0.x = -cb0[17].x + r0.x;
  r0.x = r1.w * r0.x + cb0[17].x;
  r0.z = r0.z * r0.x;
  r0.z = cb0[19].x * r0.z;
  r0.z = cb0[20].x * r0.z;
  r3.xyz = -cb0[1].xyz + cb0[0].xyz;
  r3.xyz = r0.yyy * r3.xyz + cb0[1].xyz;
  ...
  r5.yzw = r4.zxy * -r3.yzx;
  r6.xyz = r4.yzx * -r3.zxy + -r5.yzw;
  ...
  r0.z = cb0[23].x * r0.z;
  r1.w = max(cb0[27].x, cb0[26].x);
  r1.w = min(cb0[28].x, r1.w);
  r0.w = r1.w * r0.w;
  r0.w = r0.w * cb0[29].x + -r0.z;
  r0.z = cb0[30].x * r0.w + r0.z;
  r0.z = max(cb0[31].x, r0.z);
  r0.z = min(cb0[32].x, r0.z);
  r0.x = r0.z * r0.x;
  r0.x = cb0[33].x * r0.x;
  r0.x = cb0[34].x * r0.x;
  r6.xyz = cb0[1].xyz + -cb0[0].xyz;
  r0.yzw = r0.yyy * r6.xyz + cb0[0].xyz;
  ...
  r6.yzw = r3.zxy * -r0.yzx;
  r7.xyz = r3.yzx * -r0.zxy + -r6.yzw;
  r0.w = dot(r3.xyz, -r0.xyz);
  r7.w = -r0.w;
  r3.xyz = r6.xxx * r3.xyz;
  r3.w = 0;
  r3.xyzw = r7.xyzw + r3.xyzw;
  r6.yzw = r3.yzx * r0.zxy;
  r6.yzw = r0.yzx * r3.zxy + -r6.yzw;
