...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r0.z = r0.z * r0.w;
  r0.z = cb0[2].x * r0.z + cb0[2].y;
  r0.z = cb0[0].x * r0.z;
  r2.z = r0.z * r0.x;
  r0.xy = float2(1,1) + -r0.xy;
  r0.z = cb13[0].x + r1.x;
  r0.w = cb0[7].x * r0.z + cb0[6].x;
  r1.x = 0.159154937 * r0.w;
  r1.x = round(r1.x);
  r0.w = r0.w * 0.159154937 + -r1.x;
  r1.x = abs(r0.w) * -16 + 8;
  r0.w = r1.x * r0.w;
  r1.x = abs(r0.w) * 0.224999994 + 0.774999976;
  r0.w = r1.x * r0.w;
  r3.y = cb0[4].x * r0.w + cb0[5].x;
  r3.xz = float2(0,0);
  r3.xyz = r0.xxx * -r3.zyz + r3.xyz;
  r0.x = cb0[11].x * r0.z + cb0[10].x;
  r0.z = 0.159154937 * r0.x;
  r0.z = round(r0.z);
  r0.x = r0.x * 0.159154937 + -r0.z;
  r0.z = abs(r0.x) * -16 + 8;
  r0.x = r0.x * r0.z;
  r0.z = abs(r0.x) * 0.224999994 + 0.774999976;
  r0.x = r0.x * r0.z;
  r4.y = cb0[8].x * r0.x + cb0[9].x;
  r4.xz = float2(0,0);
  r0.xyz = r0.yyy * -r4.zyz + r4.xyz;
  r0.xyz = r3.xyz + r0.xyz;
  r2.xy = float2(0,0);
  r0.xyz = r2.xyz + r0.xyz;
  r0.xyz = cb0[12].xxx * -r0.xyz + r0.xyz;
