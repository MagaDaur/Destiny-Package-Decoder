  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r7.xy = r7.xy * cb0[24].xx + cb0[24].yy;
  ...
  r10.z = r8.y;
  r1.yz = r5.xy + -r10.zx;
  r1.yz = r1.ww * r1.yz + r10.zx;
  r0.z = r1.w * r2.w;
  o0.w = r0.y ? r0.x : r7.z;
  r0.xy = cb0[14].xx * r2.xy;
  r0.xy = r0.xy / r1.xx;
  r0.xy = v3.xy + -r0.xy;
  r1.x = r1.x * r1.x;
  r1.w = saturate(r1.x * cb0[15].x + cb0[15].y);
  r1.w = cb0[17].x * r1.w + cb0[16].x;
  r2.xy = r0.xy * cb0[18].xy + cb0[18].zw;
  r0.xy = r0.xy * cb0[19].xy + cb0[19].zw;
  r0.xy = t10.Sample(s2_s, r0.xy).xy;
  r0.xy = -cb0[21].xy + r0.xy;
  r0.xy = r0.xy * cb0[20].xx + r2.xy;
  r0.x = t11.Sample(s2_s, r0.xy).x;
  r0.x = saturate(cb0[22].y * r0.x + cb0[22].x);
  r0.x = r1.w * r0.x;
  r0.y = saturate(r1.x * cb0[23].x + cb0[23].y);
  r0.x = r0.x * r0.y;
  r0.x = r7.w * r0.x;
  r0.y = cb0[4].x * r0.x;
  r2.xyz = r0.xxx * cb0[4].xxx + r3.xyz;
  r0.x = max(r2.x, r2.y);
  r0.x = max(r0.x, r2.z);
  r0.x = saturate(-1 + r0.x);
  r0.x = 1 + -r0.x;
  r2.xyz = r3.xyz * r0.xxx + r0.yyy;
  r0.x = max(r2.x, r2.y);
  r0.x = max(r0.x, r2.z);
  r0.x = max(1, r0.x);
