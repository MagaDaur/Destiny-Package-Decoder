...
// unknown dcl_: dcl_input_sgv v3.x, vertex_id
  ...
  o0.xy = x1[r0.x+0].xy;
  r0.xy = x0[r0.x+0].xy;
  r0.xy = float2(0,-0.200000003) + r0.yx;
  r0.xy = cb0[10].yx * r0.xy;
  r0.z = 3.14100003 + v2.x;
  ...
  r1.y = cb0[97].x * 0.0174532942;
  r1.y = cos(r1.y);
  r1.x = abs(r1.x) + -r1.y;
  r1.z = cb0[98].x + cb0[97].x;
  ...
  p1.x = v2.z;
  r1.y = cmp(cb0[103].x < 9.99999997e-007);
