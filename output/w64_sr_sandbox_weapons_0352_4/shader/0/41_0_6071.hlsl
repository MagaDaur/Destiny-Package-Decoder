  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.x = t0.Sample(s5_s, v0.xy).x;
  r3.zw = v0.xy * v3.xy + v3.zw;
  r4.xy = float2(0.25,0.200000003) * r3.wz;
  r4.xy = round(r4.xy);
  r4.xy = r3.wz * float2(0.25,0.200000003) + -r4.xy;
  ...
  r5.y = v5.z;
  r5.x = 0.100000001;
  r3.zw = r5.xy * r4.xy + r3.zw;
  r2.w = t2.Sample(s7_s, r3.zw).x;
  r3.z = 0.5 * v6.w;
