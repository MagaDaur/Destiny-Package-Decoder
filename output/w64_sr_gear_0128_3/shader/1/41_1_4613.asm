...
add r5.yzw, r4.xxyz, -cb0[8].xxyz
mul r6.xyz, -r1.yzxy, r5.wyzw
mad r6.xyz, r5.zwyz, -r1.zxyz, -r6.xyzx
dp3 r0.w, r5.yzwy, -r1.xyzx
mov r6.w, -r0.w
mul r7.xyz, r5.yzwy, r5.xxxx
mov r7.w, l(0)
add r6.xyzw, r6.xyzw, r7.xyzw
mul r5.yzw, r1.zzxy, r6.yyzx
mad r5.yzw, r1.yyzx, r6.zzxy, -r5.yyzw
mad r5.xyz, r5.xxxx, r6.xyzx, r5.yzwy
mad r1.xyz, r6.wwww, r1.xyzx, r5.xyzx
...
rsq r0.w, r0.w
mul r5.yzw, r0.wwww, cb0[9].xxyz
mul r5.xyz, r5.yzwy, r5.xxxx
add r6.yzw, r1.xxyz, -cb0[11].xxyz
...
mad r1.xyz, cb0[12].xxxx, r1.xyzx, cb0[0].xyzx
