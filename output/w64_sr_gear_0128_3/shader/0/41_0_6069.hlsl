  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r4.x = dot(r2.xyz, v0.xyz);
  r4.x = r4.x * r4.x;
  r4.x = r4.x * cb0[11].x + cb0[11].y;
  r4.x = r4.x * cb0[12].x + cb0[12].y;
  r4.y = cmp(r4.x < cb0[19].x);
  r4.z = cmp(r4.x < cb0[20].x);
  r4.w = cmp(r4.x >= cb0[19].x);
  r4.z = r4.w ? r4.z : 0;
  r4.w = cmp(r4.x < cb0[21].x);
  r5.x = cmp(r4.x >= cb0[20].x);
  r4.w = r4.w ? r5.x : 0;
  r5.x = cmp(r4.x >= cb0[21].x);
  r5.y = -cb0[23].x + r4.x;
  r5.y = saturate(cb0[23].y * r5.y);
  r6.xyz = cb0[14].xyz + -cb0[13].xyz;
  r5.yzw = r5.yyy * r6.xyz + cb0[13].xyz;
  r6.x = -cb0[24].x + r4.x;
  ...
  r4.x = -cb0[26].x + r4.x;
  r4.x = saturate(cb0[26].y * r4.x);
  r8.xyz = cb0[17].xyz + -cb0[16].xyz;
  r8.xyz = r4.xxx * r8.xyz + cb0[16].xyz;
  r5.yzw = r4.yyy ? r5.yzw : 0;
  r4.xyz = r4.zzz ? r6.xyz : r5.yzw;
  r4.xyz = r4.www ? r7.xyz : r4.xyz;
  r4.xyz = r5.xxx ? r8.xyz : r4.xyz;
  r4.xyz = cb0[27].xyz * r4.xyz;
  r5.xy = -cb0[28].xy + v3.xy;
  r4.w = dot(r5.xy, r5.xy);
  r4.w = sqrt(r4.w);
  r4.w = saturate(r4.w * cb0[30].x + cb0[30].y);
  r5.xyz = cb0[32].xyz * r4.www + cb0[31].xyz;
  r4.xyz = r4.xyz * cb0[33].xxx + r5.xyz;
  r5.xy = -cb0[34].xy + v3.xy;
  r4.w = dot(r5.xy, r5.xy);
  r4.w = sqrt(r4.w);
  r4.w = saturate(r4.w * cb0[36].x + cb0[36].y);
  r4.w = cb0[37].x + r4.w;
  r5.xy = -cb0[38].xy + v3.xy;
  r5.x = dot(r5.xy, r5.xy);
  r5.x = sqrt(r5.x);
  r5.x = saturate(r5.x * cb0[40].x + cb0[40].y);
  r5.x = saturate(r5.x * cb0[41].x + cb0[41].y);
  r4.w = r5.x * r4.w;
  r4.w = saturate(cb0[42].x * r4.w);
  r5.x = saturate(cb0[10].x);
  r5.y = cb0[7].x + 128.5;
  r5.y = 0.00390625 * r5.y;
  r5.z = cmp(cb0[8].x >= cb0[9].x);
  r5.y = r5.z ? r5.y : -1;
  r4.xyz = cb0[69].xxx * r4.xyz;
  r5.z = dot(r3.xyz, r2.xyz);
  r5.w = r5.y * 255 + -127.5;
  r6.y = saturate(0.0078125 * r5.w);
  r5.w = r5.z * r5.z;
  r6.x = min(1, r5.w);
  r6.xyzw = t6.SampleLevel(s8_s, r6.xy, 0).xyzw;
  r6.xyzw = r6.xyzw * r6.xyzw;
  r5.w = -cb0[9].x + 1;
  r7.x = 0.0399999991 * r5.w;
  r5.y = cmp(0.5 < r5.y);
  r7.yzw = r6.www * r4.xyz;
  r4.xyz = r5.yyy ? r7.yzw : r4.xyz;
  r6.xyz = r5.yyy ? r6.xyz : r7.xxx;
  r7.xyz = r4.xyz * r5.www;
  r4.xyz = r4.xyz * cb0[9].xxx + r6.xyz;
  ...
  r6.x = max(r6.x, r6.y);
  r6.x = max(r6.x, r6.z);
  r6.x = max(0.50999999, r6.x);
  r6.x = log2(r6.x);
  r6.x = floor(r6.x);
  r6.z = 1 + r6.x;
  r6.w = cmp(r6.z < cb3[8].x);
  r7.w = exp2(r6.z);
  r8.xyz = cb3[6].xyz * r7.www;
  ...
  r6.xyz = r8.xyz * float3(0.5,0.5,0.5) + r6.xyz;
  r6.z = 0.5 + r6.z;
  r8.xy = cb3[2].xy * r6.xy;
  r8.w = r6.z * cb3[2].z + cb3[9].x;
  r6.xyz = float3(0.5,0.5,0.5) + r8.xyw;
  r6.xyz = r6.xyz / cb3[4].xyz;
  r8.xy = cb8[4].zw;
  r8.z = 0;
  r6.xyz = r6.www ? r6.xyz : r8.xyz;
  r9.xyzw = t16.SampleLevel(s5_s, r6.xyz, 0).xyzw;
  r10.xyzw = t17.SampleLevel(s5_s, r6.xyz, 0).xyzw;
  r11.xyzw = t18.SampleLevel(s5_s, r6.xyz, 0).xyzw;
  r1.w = cb3[15].x * r1.w;
  r1.w = saturate(r1.w * 1.5 + cb3[15].y);
  r6.w = cmp(r1.w < 1);
  if (r6.w != 0) {
    r12.xyzw = t16.SampleLevel(s5_s, r8.xyz, 0).xyzw;
    r13.xyzw = t17.SampleLevel(s5_s, r8.xyz, 0).xyzw;
    r8.xyzw = t18.SampleLevel(s5_s, r8.xyz, 0).xyzw;
  ...
  r3.w = t19.SampleLevel(s4_s, r6.xyz, 0).x;
  r3.w = -1 + r3.w;
  r1.w = r1.w * r3.w + 1;
  r3.w = saturate(dot(cb0[45].xyz, r3.xyz));
  r6.xyz = cb0[44].xyz * r5.yyy;
  r6.xyz = r6.xyz * r1.www;
  r6.xyz = r6.xyz * r3.www;
  r6.xyz = r6.xyz * float3(0.318309873,0.318309873,0.318309873) + r8.xyz;
  r1.w = r5.z + r5.z;
  ...
  r2.x = rsqrt(r2.x);
  r2.xyw = r9.xyz * r2.xxx;
  r3.w = dot(r10.xyz, r10.xyz);
  r3.w = rsqrt(r3.w);
  r12.xyz = r10.xyz * r3.www;
  r3.w = dot(r11.xyz, r11.xyz);
  r3.w = rsqrt(r3.w);
  r13.xyz = r11.xyz * r3.www;
  r12.xyz = float3(0.589999974,0.589999974,0.589999974) * r12.xyz;
  r2.xyw = r2.xyw * float3(0.300000012,0.300000012,0.300000012) + r12.xyz;
  r2.xyw = r13.xyz * float3(0.109999999,0.109999999,0.109999999) + r2.xyw;
  r3.w = dot(r2.xyw, r2.xyw);
  r3.w = rsqrt(r3.w);
  r2.xyw = r3.www * r2.xyw;
  r12.xyz = float3(0.666666746,0.666666746,0.666666746) * r2.xyw;
  r12.w = 0.333333373;
  r9.x = dot(r9.xyzw, r12.xyzw);
  r9.y = dot(r10.xyzw, r12.xyzw);
  r9.z = dot(r11.xyzw, r12.xyzw);
  r3.w = dot(r12.xyzw, r12.xyzw);
  ...
  r3.x = saturate(dot(r3.xyz, r2.xyw));
  r1.x = saturate(dot(r2.xyw, r1.xyz));
  r1.y = -r5.x * 0.899999976 + 1;
  r1.y = r1.y * r1.y;
  r1.y = r1.y * r1.y;
  r1.x = 1 + -r1.x;
  r1.z = cb0[9].x * 0.839999974 + 0.0399999991;
  r2.x = r1.x * r1.x;
  r2.x = r2.x * r2.x;
  r2.y = r2.x * r1.x;
  r1.x = -r1.x * r2.x + 1;
  ...
  r3.y = saturate(cb0[57].x * r3.y + cb0[57].y);
  r3.y = r3.y + -r3.x;
  r3.x = r5.x * r3.y + r3.x;
  r3.y = cmp(-0.5 < cb0[63].x);
  r9.xyz = cb12[7].xyz + -v4.xyz;
  r3.z = dot(r9.xyz, r9.xyz);
  r3.z = sqrt(r3.z);
  r3.z = saturate(r3.z * cb0[60].x + cb0[60].y);
  r3.w = cb0[63].x + -cb0[62].x;
  r3.z = r3.z * r3.w + cb0[62].x;
  r3.y = r3.y ? r3.z : cb0[62].x;
  r8.w = r2.z * r1.w + 1;
  r1.w = dot(r8.xyw, r8.xyw);
  r1.w = rsqrt(r1.w);
  r3.zw = r8.xy * r1.ww;
  r3.zw = r3.zw * float2(0.5,0.5) + float2(0.5,0.5);
  r9.xyz = t5.SampleLevel(s6_s, r3.zw, r2.y).xyz;
  r3.xzw = r9.xyz * r3.xxx;
  r9.xyz = r3.xzw * r3.yyy;
  r1.w = cb8[25].w * r2.x;
  ...
  r2.y = saturate(cb0[54].x * r2.y + cb0[54].y);
  r2.y = r2.y + -r1.w;
  r1.w = r5.x * r2.y + r1.w;
  r2.y = cb8[24].w * r1.w;
  ...
  r5.y = r10.w * r5.y;
  r5.w = cmp(0 < cb8[29].y);
  r10.xyz = cb0[64].xxx * r2.yzw;
  r2.yzw = cb0[61].xxx * r2.yzw;
  r2.yzw = r5.www ? r10.xyz : r2.yzw;
  r5.y = cb8[28].w * r5.y;
  r2.yzw = -r3.xzw * r3.yyy + r2.yzw;
  r2.yzw = r5.yyy * r2.yzw + r9.xyz;
  r2.x = cb8[11].w * r2.x;
  r3.xyzw = t24.SampleLevel(s7_s, r8.xyz, r2.x).xyzw;
  r2.x = cmp(cb8[15].w < 0.5);
  r8.xyz = r3.xyz * r3.xyz;
  r3.xyz = r2.xxx ? r8.xyz : r3.xyz;
  ...
  r1.w = r3.w * r1.w;
  r2.x = cmp(0 < cb8[15].y);
  r8.xyz = cb0[64].xxx * r3.xyz;
  r3.xyz = cb0[61].xxx * r3.xyz;
  r3.xyz = r2.xxx ? r8.xyz : r3.xyz;
  r1.w = cb8[14].w * r1.w;
  r3.xyz = r3.xyz + -r2.yzw;
  r2.xyz = r1.www * r3.xyz + r2.yzw;
  r1.w = saturate(1 + -r5.z);
  r2.w = r1.w * r1.w;
  r2.w = r2.w * r2.w;
  r1.w = r2.w * r1.w;
  r0.w = r0.w + r0.w;
