...
add r0.xy, r0.yxyy, l(0.900000, 0.000000, 0.000000, 0.000000)
sincos r1.x, r2.x, v1.w
mul r0.zw, r0.xxxy, r1.xxxx
mad r0.y, r0.y, r2.x, -r0.z
mad r0.x, r0.x, r2.x, r0.w
mul r0.xzw, r0.xxxx, cb12[5].xxyz
mul r1.xyz, r0.yyyy, cb12[4].xyzx
...
mad r1.xyz, r1.xyzx, l(0.050000, 0.050000, 0.050000, 0.000000), r2.xyzx
mad r0.xyz, r0.xzwx, l(0.050000, 0.050000, 0.050000, 0.000000), r1.xyzx
