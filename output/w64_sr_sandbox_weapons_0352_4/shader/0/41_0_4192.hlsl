  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyzw = v0.xyxy * cb0[8].xyzw + v0.yxyx;
  r0.xyzw = frac(r0.xyzw);
  r0.xyzw = r0.xyzw * r0.xyzw;
  r0.x = dot(r0.xyzw, float4(251,251,251,251));
  r0.x = frac(r0.x);
  r0.x = r0.x * 0.100000001 + cb0[100].x;
  r0.y = t0.Sample(s1_s, v0.xy).x;
  r0.y = log2(r0.y);
  r0.y = 2.20000005 * r0.y;
  r0.y = exp2(r0.y);
  r0.x = r0.y * cb0[102].x + r0.x;
  r0.x = saturate(cb0[111].x * r0.x);
