...
// unknown dcl_: dcl_input_sgv v5.x, vertex_id
  ...
  r0.xyz = r0.xzw * float3(0.0225000009,0.0225000009,0.0225000009) + r3.xyz;
  r3.xyz = cb12[7].zxy + -r3.zxy;
  r0.xyz = r2.xyz * float3(0.0225000009,0.0225000009,0.0225000009) + r0.xyz;
  ...
  r1.w = dot(r3.yzx, r1.xyz);
  r3.xyz = r2.xyz * r1.yzx;
  r2.xyz = r2.zxy * r1.zxy + -r3.xyz;
  r2.x = dot(r2.xyz, r2.xyz);
  r2.x = sqrt(r2.x);
  r2.y = cb0[96].x * 0.0174532942;
  r2.y = cos(r2.y);
  r2.x = r2.x + -r2.y;
  r2.z = cb0[97].x + cb0[96].x;
  ...
  o5.xyzw = r2.xxxx ? float4(10000,10000,-10000,1) : r0.xyzw;
  r0.x = cmp(0 < r1.w);
  r0.y = cmp(r1.w < 0);
