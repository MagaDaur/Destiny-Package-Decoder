  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  if (r0.z != 0) {
    ...
    r0.z = r0.z ? r2.w : r4.w;
    r0.z = r3.w ? r0.z : r3.x;
    r1.w = cmp(0.5 >= cb0[9].x);
    r2.w = cb0[9].x + cb0[9].x;
    r2.w = r0.z * -r2.w + r2.w;
    r3.x = cb0[9].x * 2 + -2;
    r0.z = r0.z * r3.x + 1;
    r0.z = r1.w ? r2.w : r0.z;
  ...
  r2.w = cb0[12].x + -cb0[11].x;
  r1.w = saturate(r1.w * r2.w + cb0[11].x);
  r2.w = -cb0[14].z + v4.z;
  r2.w = cb0[15].x * r2.w;
  r2.w = max(0, r2.w);
  r2.w = log2(r2.w);
