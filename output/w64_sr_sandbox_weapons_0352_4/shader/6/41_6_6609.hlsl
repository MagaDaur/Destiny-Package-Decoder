...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r5.yz = r0.ww * float2(0.225000024,0.75) + float2(0.524999976,0.25);
    r0.y = r1.w + r0.y;
    r6.xyz = cb0[158].xyz * r5.yyy;
    r6.xyz = r6.xyz * cb0[157].xxx + r1.xyz;
    r0.w = saturate(cb0[159].x * 4.5);
    r0.w = 1 + -r0.w;
    r6.xyz = r6.xyz * r0.www;
    r7.xyz = cb0[144].xxx * r6.xyz;
    r8.xyz = r6.xyz * cb0[144].xxx + r3.xyz;
    r0.w = cb0[159].x * r3.w;
