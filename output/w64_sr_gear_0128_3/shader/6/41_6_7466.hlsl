...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.y = 1 + r0.y;
    r0.y = r0.z * r0.y;
    r0.z = saturate(cb0[3].x * 0.0714289993);
    r0.w = r0.z * 986895.063 + -977025.125;
    r5.xyz = cmp(r0.zzz >= float3(0.989998996,0.99000001,1));
    ...
    r5.yz = frac(r5.xy);
    r5.x = r5.y * r0.w;
    r0.zw = float2(2,2) * r5.xz;
    r0.z = r0.z + r0.w;
    r0.z = saturate(r5.w * 1 + r0.z);
    r7.z = r0.y * r0.z;
