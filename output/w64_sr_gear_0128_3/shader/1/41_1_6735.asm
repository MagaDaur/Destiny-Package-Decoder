...
ld_indexable(buffer)(float,float,float,float) r1.yzw, r1.zzzz, t2.xyzw
mov x0[0].y, l(0)
...
mul r5.xyz, r0.xywx, l(0.100000, 0.100000, 0.100000, 0.000000)
itof r3.w, r0.z
lt r3.w, r3.w, l(0.500000)
mul r0.xyw, r0.xyxw, l(-0.100000, -0.100000, 0.000000, -0.100000)
movc r0.xyw, r3.wwww, r0.xyxw, r5.xyxz
add r0.xyw, r0.xyxw, r3.xyxz
dp3 r3.x, r2.xyzx, r4.xyzx
mad r3.xyz, -r3.xxxx, r2.xyzx, r4.xyzx
...
dp3 r2.x, r3.yzwy, r2.xyzx
mul r2.y, l(0.0174532942), cb0[108].x
add r2.z, cb0[108].x, cb0[109].x
