  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyz = float3(1,0.337164015,0.0497069992) * v4.www;
  r0.x = dot(r0.xyz, float3(0.300000012,0.589999974,0.109999999));
  r0.yzw = v4.www * float3(1,0.337164015,0.0497069992) + -r0.xxx;
  r0.xyz = r0.yzw * float3(0.800000012,0.800000012,0.800000012) + r0.xxx;
