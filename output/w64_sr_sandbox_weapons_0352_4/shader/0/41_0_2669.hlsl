  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.y = sqrt(r0.y);
  r0.w = 0.015625 * r0.y;
  r0.y = saturate(r0.y * cb0[108].x + cb0[108].y);
  r0.w = min(1, r0.w);
  r2.z = sqrt(r0.w);
  ...
  r1.xy = r3.ww * r0.xz;
  r4.xy = float2(0.116971001,0.533276021);
  r4.z = r3.w;
  ...
  r1.xy = r1.xy * float2(0.25,0.25) + v0.xy;
  r1.xy = float2(-0.125,-0.125) + r1.xy;
  r1.z = cb0[114].x * v5.y;
  r1.z = floor(r1.z);
  r1.zw = cb0[111].xy * r1.zz;
  r1.xy = r1.xy * cb0[110].xy + r1.zw;
  r1.x = t0.Sample(s3_s, r1.xy).x;
  r1.x = log2(r1.x);
  r1.x = 2.20000005 * r1.x;
  r1.x = exp2(r1.x);
  r1.y = r1.x * 0.971000016 + v0.w;
  r1.x = saturate(r1.x * v6.x + v5.w);
  r1.x = saturate(v0.z * r1.x);
  r1.y = 0.0109999999 + r1.y;
  r0.w = -r1.y + r0.w;
  r0.w = saturate(1.#INF * r0.w);
  r0.w = 1 + -r0.w;
  r0.w = 1 + -r0.w;
  r0.w = r1.x * r0.w;
