...
mul r1.w, cb0[4].x, cb0[5].x
add r2.w, l(1.000000), -cb0[6].x
add r4.xy, -r0.yxyy, l(1.000000, 1.000000, 0.000000, 0.000000)
mad r3.w, -r4.x, cb0[7].x, l(1.000000)
add r4.x, -r2.w, l(1.000000)
mad r4.y, -r4.y, cb0[9].x, l(1.000000)
mul r4.x, r4.y, r4.x
...
mul r5.yzw, -r2.yyzx, r4.zzxy
mad r6.xyz, r4.yzxy, -r2.zxyz, -r5.yzwy
dp3 r1.w, r4.xyzx, -r2.xyzx
mov r6.w, -r1.w
mul r4.xyz, r4.xyzx, r5.xxxx
mov r4.w, l(0)
add r4.xyzw, r4.xyzw, r6.xyzw
mul r5.yzw, r2.zzxy, r4.yyzx
mad r5.yzw, r2.yyzx, r4.zzxy, -r5.yyzw
...
mul r5.yzw, -r2.yyzx, v2.zzxy
mad r6.xyz, v2.yzxy, -r2.zxyz, -r5.yzwy
dp3 r1.w, v2.xyzx, -r2.xyzx
mov r6.w, -r1.w
mov r7.xyz, v2.xyzx
mov r7.w, l(0)
mad r6.xyzw, r5.xxxx, r7.xyzw, r6.xyzw
mul r5.yzw, r2.zzxy, r6.yyzx
mad r5.yzw, r2.yyzx, r6.zzxy, -r5.yyzw
...
mad r1.xyz, cb0[13].xxxx, r3.xyzx, r1.xyzx
...
mad r1.xyw, cb0[13].xxxx, r4.xyxz, v1.xyxz
...
mad r1.xyw, cb0[13].xxxx, r2.xyxz, v2.xyxz
