  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.x = 1 + -r3.x;
  r3.yzw = cb0[97].xyz + -cb0[96].xyz;
  r3.yzw = cb0[15].xxx * r3.yzw + cb0[96].xyz;
  r3.yzw = float3(-2.51188652e-007,-2.51188652e-007,-2.51188652e-007) + r3.yzw;
  r3.yzw = float3(1.00000024,1.00000024,1.00000024) * r3.yzw;
  r3.yzw = max(float3(0,0,0), r3.yzw);
  r3.yzw = v3.xyz * r3.yzw;
  r3.yzw = v6.zzz * r3.yzw;
  r2.w = r2.w * v6.y + v6.x;
  r4.x = -0.800000012 + v3.w;
  r4.x = saturate(0.416666657 * r4.x);
  ...
  r2.x = -1 + r2.x;
  r0.w = r0.w * r2.x + 1;
  r1.x = saturate(dot(cb0[124].xyz, r1.xyz));
  r1.yzw = cb0[123].xyz * r1.www;
  ...
  r0.z = saturate(r1.w * cb0[130].x + cb0[130].y);
