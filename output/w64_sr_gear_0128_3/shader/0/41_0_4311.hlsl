  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.yz = v3.xy * cb0[52].xy + cb0[52].zw;
  ...
  r0.y = r0.y ? r0.z : r2.y;
  r0.z = (int)r0.y * 9;
  r4.xyzw = saturate(cb7[r0.z+11].xyzw);
  r1.xy = saturate(cb7[r0.z+12].yz);
  r5.xyzw = saturate(cb7[r0.z+17].xyzw);
  r2.yzw = t0.Sample(s3_s, v3.xy).xyz;
  r6.xy = t1.Sample(s4_s, v3.xy).xy;
  r6.xy = r6.xy * cb0[53].xx + cb0[53].yy;
  ...
  r7.z = v7.x ? 1 : -1;
  r7.w = saturate(cb7[r0.z+15].y * r8.y + cb7[r0.z+15].x);
  r7.w = saturate(cb7[r0.z+15].w * r7.w + cb7[r0.z+15].z);
  r8.y = cb0[2].x + 128.5;
  r8.y = 0.00390625 * r8.y;
  r8.w = cmp(0.0500000007 >= r9.y);
  r8.y = r8.w ? r8.y : -1;
  ...
  r11.xyz = r4.xxx * r11.xyz + cb7[r0.z+9].xyz;
  r4.x = saturate(cb7[r0.z+13].y * r7.y + cb7[r0.z+13].x);
  r4.x = saturate(cb7[r0.z+13].w * r4.x + cb7[r0.z+13].z);
  r8.x = saturate(r8.x);
  ...
  r8.x = r8.x + -r4.x;
  r4.x = r4.z * r8.x + r4.x;
  r12.xyz = saturate(float3(4,4,4) * r2.yzw);
  r13.xyz = saturate(float3(-0.25,-0.25,-0.25) + r2.yzw);
  r11.xyz = saturate(r11.xyz * r12.xyz + r13.xyz);
  r8.xw = r1.zw * r4.yy + r6.xy;
  r2.x = -1 + r2.x;
  r4.y = r4.y * r2.x + 1;
  r3.yzw = saturate(cb7[r0.z+14].xyz * r10.xyz + r3.yzw);
  r3.yzw = -cb7[r0.z+14].xyz + r3.yzw;
  r3.yzw = r5.xxx * r3.yzw + cb7[r0.z+14].xyz;
  r3.yzw = saturate(r3.yzw * r12.xyz + r13.xyz);
  r4.z = saturate(cb7[r0.z+16].y * r7.y + cb7[r0.z+16].x);
  r4.z = saturate(cb7[r0.z+16].w * r4.z + cb7[r0.z+16].z);
  ...
  r3.yzw = r7.www * r5.xyz + r3.yzw;
  r5.xy = r8.xw + -r1.zw;
  r1.zw = r7.ww * r5.xy + r1.zw;
  r4.x = r4.x + -r3.x;
  r3.x = r7.w * r4.x + r3.x;
  r4.x = -r5.w + r4.w;
  r5.y = r7.w * r4.x + r5.w;
  ...
  r0.x = r0.x * r0.y + r8.z;
  r0.y = saturate(r0.x);
  r10.xyzw = cb0[51].xxxx + -cb0[50].xyzw;
  r10.xyzw = r0.yyyy * r10.xyzw + cb0[50].xyzw;
  r0.y = r10.w * r3.x;
  r0.z = cb7[r0.z+12].x + 128.5;
  r0.z = 0.00390625 * r0.z;
  r3.x = cmp(0.0500000007 >= r4.w);
  r0.z = r3.x ? r0.z : -1;
  r0.y = min(r0.y, r2.x);
  ...
  r1.x = r1.x * r0.y;
  r1.x = r1.x * -5.00250101 + r3.x;
  r1.x = min(r1.x, r0.y);
  r5.x = r2.x ? r1.x : r0.y;
  r3.xyz = r3.yzw * r10.xyz + -r2.yzw;
  r3.xyz = r6.www * r3.xyz + r2.yzw;
  r1.xz = r1.zw + -r6.xy;
  r4.xy = r6.ww * r1.xz + r6.xy;
  r9.w = r7.y;
  r1.xz = r5.xy + -r9.wy;
  r1.xz = r6.ww * r1.xz + r9.wy;
  r0.y = r6.w * r1.y;
  o0.w = r6.z ? r0.z : r8.y;
  r0.x = cb0[16].x * r0.x;
  r1.yw = v3.xy * cb0[21].xy + cb0[21].zw;
  r1.yw = t10.Sample(s2_s, r1.yw).xy;
  r1.yw = -cb0[23].xy + r1.yw;
  r1.yw = r1.yw * cb0[22].xx + v3.xy;
  r1.yw = r1.yw * cb0[24].xy + cb0[24].zw;
  r5.xyz = t11.Sample(s2_s, r1.yw).xyz;
  r1.yw = v3.xy * cb0[25].xy + cb0[25].zw;
  r6.xyz = t12.Sample(s2_s, r1.yw).xyz;
  r1.yw = v3.yx * cb0[27].yx + cb0[27].wz;
  r7.yw = round(r1.yw);
  r1.yw = -r7.yw + r1.yw;
  r7.yw = abs(r1.yw) * float2(-16,-16) + float2(8,8);
  r1.yw = r7.yw * r1.yw;
  r7.yw = abs(r1.yw) * float2(0.224999994,0.224999994) + float2(0.774999976,0.774999976);
  r1.yw = r7.yw * r1.yw;
  r1.yw = cb0[28].yx * r1.yw + v3.xy;
  r7.yw = r1.wy * cb0[29].yx + cb0[29].wz;
  r8.xy = round(r7.yw);
  r7.yw = -r8.xy + r7.yw;
  r8.xy = abs(r7.yw) * float2(-16,-16) + float2(8,8);
  r7.yw = r8.xy * r7.yw;
  r8.xy = abs(r7.yw) * float2(0.224999994,0.224999994) + float2(0.774999976,0.774999976);
  r7.yw = r8.xy * r7.yw;
  r1.yw = cb0[30].yx * r7.yw + r1.yw;
  r0.z = r1.w * cb0[31].y + cb0[31].w;
  r7.yw = r1.yw * cb0[32].xy + cb0[32].zw;
  r2.x = t13.Sample(s2_s, r7.yw).y;
  r2.x = -cb0[34].y + r2.x;
  r0.z = r2.x * cb0[33].x + r0.z;
  r0.z = frac(r0.z);
  r2.x = cb0[35].z + r0.z;
  r2.x = saturate(cb0[35].y * abs(r2.x) + cb0[35].x);
  r0.z = cb0[36].z + r0.z;
  r0.z = saturate(cb0[36].y * abs(r0.z) + cb0[36].x);
  r0.z = r2.x + r0.z;
  r0.z = min(1, r0.z);
  r7.yw = r1.yw * cb0[37].xy + cb0[37].zw;
  r2.x = cb0[38].x * cb0[6].x;
  r1.yw = t13.Sample(s2_s, r1.yw).xy;
  r1.yw = -cb0[39].xy + r1.yw;
  r1.yw = r1.yw * r2.xx + r7.yw;
  r1.y = t14.Sample(s2_s, r1.yw).x;
  r1.w = 1 + -r1.y;
  r1.w = max(0, r1.w);
  r1.w = log2(r1.w);
  r1.w = cb0[40].x * r1.w;
  r1.w = exp2(r1.w);
  r1.w = r1.w * cb0[41].x + cb0[6].x;
  r0.z = log2(r0.z);
  r0.z = r1.w * r0.z;
  r0.z = exp2(r0.z);
  r0.z = saturate(cb0[42].x + r0.z);
  r1.y = cb0[43].x + r1.y;
  r0.z = r0.z * r1.y + cb0[42].x;
  r8.xyz = cb0[44].xyz * r0.zzz;
  r6.xyz = r6.xyz * cb0[26].xyz + r8.xyz;
  r5.xyz = r6.xyz + r5.xyz;
  r5.xyz = saturate(r5.xyz * cb0[45].xxx + cb0[45].yyy);
  r5.xyz = cb0[20].xyz * r5.xyz;
  r0.z = saturate(v5.y);
  r6.xyz = cb0[47].xyz * r0.zzz + cb0[46].xyz;
  r5.xyz = r6.xyz * r5.xyz;
  r2.xyz = r5.xyz * r2.yzw;
  r0.z = 1 + -v5.y;
  r0.z = r0.z * r0.z;
  r1.y = cb0[49].x + cb0[48].x;
  r0.z = r1.y * r0.z;
