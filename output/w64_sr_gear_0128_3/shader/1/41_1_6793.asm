...
mul r0.xy, r0.yxyy, l(0.600000, 0.600000, 0.000000, 0.000000)
...
mul r2.xyz, cb0[11].yyyy, cb12[4].xyzx
...
mul r2.xyz, r2.xyzx, cb0[11].yyyy
...
frc r1.x, r1.x
mul r1.y, r1.x, cb0[105].x
add r1.x, -r1.x, cb0[111].x
add r1.x, r1.x, l(1.000000)
mul_sat r1.x, r1.x, l(3.333333)
mad r1.y, -r1.y, cb0[115].x, cb0[115].y
mad_sat r1.y, r2.x, cb0[115].x, r1.y
mul r1.x, r1.x, r1.y
