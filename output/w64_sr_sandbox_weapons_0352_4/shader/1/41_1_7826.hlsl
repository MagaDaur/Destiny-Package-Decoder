...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r0.w = rsqrt(r0.w);
  r3.xyzw = v2.xyzz * r0.wwww;
  r5.xyzw = r4.yzxx * r3.xyww;
  r5.xyzw = r4.xyzz * r3.ywxx + -r5.xyzw;
  r4.xyzw = r4.wwww * r3.wxyy + r5.xyzw;
  r3.xyzw = -r2.zxyy * r4.wxyy + r3.xyzw;
  r2.xyzw = r2.yzxx * r4.xyzw + r3.xyzw;
  r3.xyz = r2.ywx * r1.zxy;
  r3.xyz = r1.yzx * r2.wxy + -r3.xyz;
