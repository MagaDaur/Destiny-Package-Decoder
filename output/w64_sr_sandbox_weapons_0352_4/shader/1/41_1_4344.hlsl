...
// unknown dcl_: dcl_input_sgv v8.x, vertex_id
  ...
  r1.yzw = t2.Load(r1.w).yzw;
  r3.xy = float2(1,7) + r0.ww;
  r3.xy = (uint2)r3.xy;
  o4.xyzw = t2.Load(r3.x).xyzw;
  r3.xy = t2.Load(r3.y).xy;
  x0[0].y = 0;
  x0[1].y = 1;
  x0[2].y = 0;
  x0[3].y = 1;
