...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  if (r0.x != 0) {
    ...
    r6.xyz = r5.xyz * r2.yzx;
    r2.xyz = r2.xyz * r5.yzx + -r6.xyz;
    r2.xyz = r2.www * r5.zxy + r2.xyz;
    r5.xyz = -r1.zxy * r2.zxy + r5.xyz;
    r1.xyz = r1.yzx * r2.xyz + r5.xyz;
    r2.xyz = r4.zxy * r1.yzx;
    r2.xyz = r4.yzx * r1.zxy + -r2.xyz;
    ...
    r5.xyz = cb0[1].xxx * r2.xyz;
    o4.xyz = r2.xyz * cb0[1].xxx + r0.xyz;
