...
mad r6.xy, r6.xyxx, cb0[20].xxxx, cb0[20].yyyy
...
mad r13.xy, r1.xyxx, r3.yyyy, r6.xyxx
...
mad_sat r8.xyzw, cb0[16].xyzw, r9.zzzz, cb0[15].xyzw
lt r3.x, r8.y, r8.z
mov r10.xy, r8.zyzz
mov r10.zw, l(0,0,-1.000000,0.666666687)
mov r11.xy, r10.yxyy
mov r11.zw, l(0,0,0,-0.333333343)
movc r10.xyzw, r3.xxxx, r10.xyzw, r11.xyzw
lt r3.x, r8.x, r10.x
mov r11.xyz, r10.xywx
mov r11.w, r8.x
mov r10.xyw, r11.wywx
movc r10.xyzw, r3.xxxx, r11.xyzw, r10.xyzw
min r3.x, r10.y, r10.w
add r3.x, -r3.x, r10.x
add r3.y, -r10.y, r10.w
mad r3.z, r3.x, l(6.000000), l(1.000000012E-007)
div r3.y, r3.y, r3.z
add r3.y, r3.y, r10.z
add r3.z, r10.x, l(1.000000012E-007)
div r3.x, r3.x, r3.z
add_sat r3.y, |r3.y|, cb0[17].x
add_sat r3.x, r3.x, cb0[18].x
add_sat r3.z, r10.x, cb0[19].x
add r10.xyz, r3.yyyy, l(1.000000, 0.666666687, 0.333333343, 0.000000)
frc r10.xyz, r10.xyzx
mad r10.xyz, r10.xyzx, l(6.000000, 6.000000, 6.000000, 0.000000), l(-3.000000, -3.000000, -3.000000, 0.000000)
add_sat r10.xyz, |r10.xyzx|, l(-1.000000, -1.000000, -1.000000, 0.000000)
add r10.xyz, r10.xyzx, l(-1.000000, -1.000000, -1.000000, 0.000000)
mad r10.xyz, r3.xxxx, r10.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
mul r8.xyz, r3.zzzz, r10.xyzx
add r3.x, -r9.z, l(1.000000)
mad r8.xyzw, r8.xyzw, r9.zzzz, r3.xxxx
mul r2.x, r2.x, r8.w
...
mad r2.xyz, r2.yzwy, r8.xyzx, -r5.xyzx
