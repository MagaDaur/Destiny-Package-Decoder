...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r3.xyz = r3.xxx * float3(-4.65661287e-010,2.01212241e-011,4.65661287e-010) + float3(3,-1.08642006,-3);
    r3.w = r2.z * r2.z;
    r3.x = r3.x * r3.w;
    r3.x = min(1, r3.x);
    r3.x = r3.x * 52.5 + 7.5;
    ...
    r1.xz = r3.yz * float2(85,0.450000048) + float2(5,0.75);
    r3.y = 0.0174529999 * r1.x;
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r3.z = (uint)r0.w;
