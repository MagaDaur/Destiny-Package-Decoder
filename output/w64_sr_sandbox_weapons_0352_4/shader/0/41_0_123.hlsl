  ...
  out float4 o3 : SV_TARGET3)
{
  ...
  r3.xy = round(v4.zy);
  r3.zw = v0.xy * float2(-2,-2) + float2(1,1);
  r3.xy = r3.xy * r3.zw + v0.xy;
  r3.zw = t2.Sample(s6_s, v0.xy).xy;
  r4.xy = r3.zw * v4.xx + v0.xy;
  r4.xy = v4.xx * float2(-0.5,-0.5) + r4.xy;
  r4.xy = r4.xy + -r3.xy;
  r3.xy = r4.xy * float2(0.5,0.5) + r3.xy;
  r4.xyz = t0.Sample(s6_s, r3.xy).xyz;
  r3.x = v5.x * -v4.w;
  r3.zw = r3.zw * v5.xx + v0.xy;
  r3.y = 0;
  r3.xy = r3.zw + r3.xy;
  r2.w = cb0[125].x * v5.z;
  r2.w = floor(r2.w);
  r3.zw = cb0[122].xy * r2.ww;
  r3.xy = r3.xy * cb0[121].xy + r3.zw;
  r2.w = t1.Sample(s6_s, r3.xy).x;
  r2.w = log2(r2.w);
  r2.w = 2.20000005 * r2.w;
  r2.w = exp2(r2.w);
  r3.x = 0.5 * v5.w;
  r3.yzw = t10.Sample(s1_s, r0.xy).xyw;
  r3.yz = -v0.ww + r3.yz;
  ...
  r2.x = -1 + r2.x;
  r0.w = r0.w * r2.x + 1;
  r1.x = saturate(dot(cb0[114].xyz, r1.xyz));
  r1.yzw = cb0[113].xyz * r1.www;
  ...
  r0.z = saturate(r1.w * cb0[120].x + cb0[120].y);
