...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r2.y = (uint)r0.w;
    r3.xz = float2(2.32830644e-010,2.32830644e-010) * r2.xy;
    r2.x = r2.x * 5.82076618e-012 + 0.0250000004;
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r2.y = (uint)r0.w;
    ...
    r7.xyz = -r6.yzx * r2.wyz;
    r7.xyz = r2.zwy * -r6.zxy + -r7.xyz;
    r0.y = dot(r2.yzw, -r6.xyz);
    r7.w = -r0.y;
    r2.xyz = r6.www * r2.yzw;
    r2.w = 0;
    ...
    r4.xyz = cb0[138].xyz * float3(-0.25,-0.25,-0.25) + r4.xyz;
    r5.xyz = -cb9[r0.z+32].yzx * r2.zxy;
    r5.xyz = r2.yzx * -cb9[r0.z+32].zxy + -r5.xyz;
    r0.y = dot(r2.xyz, -cb9[r0.z+32].xyz);
    r5.w = -r0.y;
    r6.xyz = cb9[r0.z+32].www * r2.xyz;
    r6.w = 0;
  ...
  // No code for instruction (needs manual fix):
    ...
    r3.w = 0;
  // No code for instruction (needs manual fix):
    store_uav_typed u0.xyzw, r0.wwww, r3.wxzw
  }
  return;
}