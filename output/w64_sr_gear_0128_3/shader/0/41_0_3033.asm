...
mad r1.xyz, r1.xxxx, l(0.020725, 0.020725, 0.020725, 0.000000), cb0[120].xyzx
mul r1.xyz, r1.xyzx, cb0[98].xyzx
lt r2.xyz, l(1.000000, 2.000000, 3.000000, 0.000000), v0.xxxx
movc r3.xyz, r2.zzzz, cb0[14].xyzx, cb0[99].xyzx
...
mad_sat r1.x, r1.x, cb0[106].x, cb0[106].y
...
movc r1.x, r2.y, cb0[103].x, cb0[102].x
