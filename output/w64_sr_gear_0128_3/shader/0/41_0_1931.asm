...
mad r6.xy, r6.xyxx, cb0[29].xxxx, cb0[29].yyyy
...
mad r0.yz, v3.xxyx, cb0[14].xxyx, cb0[14].zzwz
sample_indexable(texture2d)(float,float,float,float) r0.yz, r0.yzyy, t10.zxyw, s2
add r0.yz, r0.yyzy, -cb0[16].xxyx
mad r0.yz, r0.yyzy, cb0[15].xxxx, v3.xxyx
mad r0.yz, r0.yyzy, cb0[17].xxyx, cb0[17].zzwz
dp2 r1.w, cb0[18].xyxx, r0.yzyy
add r5.x, r1.w, cb0[18].z
dp2 r0.y, cb0[19].xyxx, r0.yzyy
add r5.y, r0.y, cb0[19].z
sample_indexable(texture2d)(float,float,float,float) r0.y, r5.xyxx, t11.yxzw, s2
sample_indexable(texture2d)(float,float,float,float) r3.xw, v3.xyxx, t10.xzwy, s2
add r3.xw, r3.xxxw, -cb0[22].xxxy
mad r3.xw, r3.xxxw, cb0[21].xxxx, v3.xxxy
mad r3.xw, r3.xxxw, cb0[23].xxxy, cb0[23].zzzw
sample_indexable(texture2d)(float,float,float,float) r0.z, r3.xwxx, t12.yzxw, s2
mad r0.z, r0.z, cb0[24].x, cb0[24].y
mul r0.z, r0.z, cb0[25].x
mad r0.y, r0.y, cb0[20].x, r0.z
max r0.y, r0.y, l(0.000000)
log r0.y, r0.y
mul r0.y, r0.y, cb0[26].x
exp r0.y, r0.y
mul r0.y, r6.w, r0.y
mul r0.z, r6.w, cb0[28].x
mad r0.y, r0.y, cb0[27].x, r0.z
