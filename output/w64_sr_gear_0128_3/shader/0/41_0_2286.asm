...
add r2.y, -r8.z, l(1.000000)
mul r2.x, r2.y, r2.x
add r2.z, l(128.500000), cb7[r0.z + 12].x
mul r2.z, r2.z, l(0.00390625000)
ge r2.w, l(0.050000), r2.w
...
mad r2.xyw, r3.xyxz, r2.yyyy, -r5.xyxz
...
mad r0.x, r0.x, cb0[15].x, cb0[15].y
lt r0.z, r8.z, cb0[21].x
lt r1.w, r8.z, cb0[22].x
ge r2.z, r8.z, cb0[21].x
and r1.w, r1.w, r2.z
ge r2.z, r8.z, cb0[22].x
add r3.z, r8.z, -cb0[24].x
mul_sat r3.z, r3.z, cb0[24].y
add r3.w, -cb0[16].x, cb0[17].x
mad r3.z, r3.z, r3.w, cb0[16].x
add r3.w, r8.z, -cb0[25].x
mul_sat r3.w, r3.w, cb0[25].y
add r4.w, -cb0[17].x, cb0[18].x
mad r3.w, r3.w, r4.w, cb0[17].x
add r4.w, r8.z, -cb0[26].x
mul_sat r4.w, r4.w, cb0[26].y
add r5.x, -cb0[18].x, cb0[19].x
mad r4.w, r4.w, r5.x, cb0[18].x
and r0.z, r0.z, r3.z
...
mad r4.xyz, r4.xyzx, r6.wwww, r2.xywx
max r0.x, r4.y, r4.x
max r0.x, r4.z, r0.x
add_sat r0.x, r0.x, l(-1.000000)
add r0.x, -r0.x, l(1.000000)
mad r2.xyz, r2.xywx, r0.xxxx, r5.xyzx
max r0.x, r2.y, r2.x
max r0.x, r2.z, r0.x
