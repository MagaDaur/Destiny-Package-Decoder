  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r4.y = v7.x;
  r4.x = v6.w;
  r4.xy = v0.yx * float2(0.0500000007,0.0500000007) + r4.xy;
  r4.zw = round(r4.xy);
  r4.xy = r4.xy + -r4.zw;
  ...
  r4.xyz = v4.xyz * r3.xyz;
  r0.y = dot(r4.xyz, float3(0.300000012,0.589999974,0.109999999));
  r3.xyz = r3.xyz * v4.xyz + -r0.yyy;
  r3.xyz = r3.xyz * float3(0.349999994,0.349999994,0.349999994) + r0.yyy;
  r0.y = 1 / cb0[115].x;
  r0.y = r0.y * r0.w;
  r0.y = exp2(r0.y);
  r0.y = saturate(v7.w * r0.y);
