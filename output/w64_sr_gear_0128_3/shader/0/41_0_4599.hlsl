  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r1.w = dot(cb0[14].xyz, r4.xyz);
  r2.w = cb0[13].x + -cb0[12].x;
  r1.w = saturate(r1.w * r2.w + cb0[12].x);
  r2.w = -cb0[15].z + v4.z;
  r2.w = cb0[16].x * r2.w;
  r2.w = max(0, r2.w);
  r2.w = log2(r2.w);
  r2.w = cb0[17].x * r2.w;
  r2.w = exp2(r2.w);
  r2.w = saturate(cb0[18].x * r2.w);
  r1.w = r2.w * r1.w;
  r0.x = saturate(r0.x * cb0[19].x + cb0[19].y);
  r0.x = r1.w * r0.x;
