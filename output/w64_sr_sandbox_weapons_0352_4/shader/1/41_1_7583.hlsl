...
// unknown dcl_: dcl_input_sgv v8.x, vertex_id
  ...
  o0.w = r3.w;
  r4.xyz = cb12[7].zxy + -r1.zxy;
  r1.xyz = r0.xyz + -r1.xyz;
  o2.xyz = cb12[7].xyz + -r0.xyz;
  r0.x = dot(r4.xyz, r4.xyz);
  r0.y = rsqrt(r0.x);
  r0.yzw = r4.xyz * r0.yyy;
  r1.w = dot(r4.yzx, r2.xyz);
  r4.xyz = r0.yzw * r2.yzx;
  r0.yzw = r0.wyz * r2.zxy + -r4.xyz;
  r0.y = dot(r0.yzw, r0.yzw);
  r0.xy = sqrt(r0.xy);
  r0.z = cb0[105].x * 0.0174532942;
  r0.z = cos(r0.z);
  r0.y = r0.y + -r0.z;
  r0.w = cb0[106].x + cb0[105].x;
