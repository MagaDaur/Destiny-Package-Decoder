  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r6.xy = r6.xy * cb0[16].xx + cb0[16].yy;
  ...
  r7.z = r7.w ? r7.z : -1;
  r10.xyzw = cb0[15].xyzw * r8.zzzz;
  r5.w = r7.y;
  r11.xyzw = r5.xyzw * r10.xyzw;
  ...
  r14.xyz = saturate(float3(-0.25,-0.25,-0.25) + r5.xyz);
  r13.xyz = saturate(r13.xyz * r8.xyw + r14.xyz);
  ...
  r2.yzw = saturate(r2.yzw * r8.xyw + r14.xyz);
  ...
  r0.w = r6.z * r1.w;
  o0.w = r0.z ? r0.y : r7.z;
  r4.xyz = cb0[14].xyz * r8.zzz;
  r5.xyz = r8.zzz * cb0[14].xyz + r2.xyz;
  r0.y = max(r5.x, r5.y);
  r0.y = max(r0.y, r5.z);
