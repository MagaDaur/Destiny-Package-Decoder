...
mad r6.xy, r6.xyxx, cb0[21].xxxx, cb0[21].yyyy
...
rsq r0.z, r0.z
mul r1.xyz, r0.zzzz, r1.xyzx
mov_sat r0.z, cb0[18].x
dp3 r1.w, v0.xyzx, v0.xyzx
rsq r1.w, r1.w
mul r4.xyz, r1.wwww, v0.xyzx
dp3 r1.w, cb0[11].xyzx, r4.xyzx
add r2.w, -cb0[9].x, cb0[10].x
mad_sat r1.w, r1.w, r2.w, cb0[9].x
add r2.w, v4.z, -cb0[12].z
mul r2.w, r2.w, cb0[13].x
max r2.w, r2.w, l(0.000000)
log r2.w, r2.w
mul r2.w, r2.w, cb0[14].x
exp r2.w, r2.w
mul_sat r2.w, r2.w, cb0[15].x
mul r1.w, r1.w, r2.w
...
log r1.w, r1.w
mul r1.w, r1.w, -cb0[17].x
exp r1.w, r1.w
mul r0.x, r0.x, r1.w
add o2.w, r0.z, v0.w
mad r0.x, r0.x, cb0[19].x, r0.y
