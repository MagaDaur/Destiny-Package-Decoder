...
// unknown dcl_: dcl_input_sgv v3.x, vertex_id
  ...
  r0.xzw = r0.xzw * float3(0.200000003,0.200000003,0.200000003) + r1.xyz;
  ...
  r0.xyz = r2.xyz * float3(0.200000003,0.200000003,0.200000003) + r0.xzw;
  ...
  r1.x = cmp(cb0[109].x < 9.99999997e-007);
