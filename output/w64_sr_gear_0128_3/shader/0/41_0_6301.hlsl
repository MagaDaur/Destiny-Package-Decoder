  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r4.xzw = r4.xzw * cb0[5].xyz + -r3.xyz;
  ...
  r2.yzw = r1.www * r2.yzw + cb0[8].xyz;
  r0.w = r2.x * r2.x;
  r0.w = saturate(r0.w * cb0[9].x + cb0[9].y);
  r0.w = cb0[10].y * r0.w + cb0[10].x;
  r0.w = r0.w * r4.y;
  r2.x = dot(cb0[11].xy, v3.xy);
  r3.x = cb0[11].z + r2.x;
  r2.x = dot(cb0[12].xy, v3.xy);
  r3.y = cb0[12].z + r2.x;
  r3.xy = r3.xy * cb0[13].xy + cb0[13].zw;
  r2.x = t26.Sample(s1_s, r3.xy).x;
  r2.x = saturate(r2.x * cb0[14].x + cb0[14].y);
  r3.xy = v3.xy * cb0[15].xy + cb0[15].zw;
  r3.x = t27.Sample(s1_s, r3.xy).x;
  r2.x = r3.x + r2.x;
  r0.w = r2.x * r0.w;
  r0.w = r0.w * cb0[16].x + -cb0[8].w;
  r0.w = r1.w * r0.w + cb0[8].w;
