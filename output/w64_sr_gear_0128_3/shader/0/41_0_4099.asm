...
mad r3.xy, r3.xyxx, cb0[16].xxxx, cb0[16].yyyy
...
mad r7.xyz, r3.wwww, r7.xyzx, r5.xzwx
mov r6.x, r4.y
add r1.x, r4.w, -r6.x
mad r7.w, r3.w, r1.x, r4.y
add r1.x, -r0.z, r1.y
mad r8.y, r3.w, r1.x, r0.z
mad r0.z, r3.w, r0.w, l(1.000000)
add r9.xyzw, r7.xyzw, cb0[15].xyzw
mad r7.xyzw, -r7.xyzw, cb0[15].xyzw, r9.xyzw
