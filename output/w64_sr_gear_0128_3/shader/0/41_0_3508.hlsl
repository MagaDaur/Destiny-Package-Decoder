  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.x = r0.x * r0.z;
  r0.z = 1 + -r8.z;
  r0.z = v5.x * cb0[4].x + r0.z;
  r1.w = cb0[4].x + 1;
  r2.y = cmp(r1.w >= 0);
  r2.y = r2.y ? 4.99999987e-005 : -4.99999987e-005;
  r1.w = r2.y + r1.w;
  r1.w = 1 / r1.w;
  r2.y = r0.z * r1.w + -cb0[21].x;
  r3.zw = cb0[22].zw * r2.yy + cb0[22].xy;
  r2.y = saturate(min(r3.z, r3.w));
  r0.z = r0.z * r1.w + -cb0[23].x;
  r3.zw = cb0[24].zw * r0.zz + cb0[24].xy;
  ...
  r3.zw = v3.xy * cb0[28].xy + cb0[28].zw;
  r2.y = t12.Sample(s2_s, r3.zw).x;
  r1.w = cb0[26].x * r1.w + r2.y;
  r1.w = r1.w * cb0[29].x + cb0[29].y;
  r0.z = r1.w + r0.z;
  r0.x = r0.x * r0.z;
  r0.x = cb0[30].x * r0.x;
