...
add_sat r0.x, r0.x, cb0[16].y
mad r0.yz, r1.xxyx, cb0[9].xxyx, cb0[9].zzwz
sample_indexable(texture2d)(float,float,float,float) r0.yz, r0.yzyy, t0.zxyw, s3
add r0.yz, r0.yyzy, l(0.000000, -0.500000, -0.500000, 0.000000)
mad r1.zw, r1.xxxy, l(0.000000, 0.000000, -4.000000, 1.000000), l(0.000000, 0.000000, 1.500000, 0.000000)
mad r1.xy, r1.xyxx, cb0[8].xyxx, cb0[8].zwzz
sample_indexable(texture2d)(float,float,float,float) r1.xy, r1.xyxx, t0.xyzw, s3
add r1.xy, r1.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
mad r0.yz, r0.yyzy, cb0[119].xxxx, r1.zzwz
mad r0.yz, r1.xxyx, cb0[119].xxxx, r0.yyzy
sample_indexable(texture2d)(float,float,float,float) r0.y, r0.yzyy, t1.yxzw, s4
add r1.xyz, r0.yyyy, cb0[96].xyzx
mul r0.y, r0.y, cb0[101].x
mul r1.xyz, r1.xyzx, cb0[14].xyzx
mul r0.zw, v0.xxxy, l(0.000000, 0.000000, 20.000000, 20.000000)
sample_indexable(texture2d)(float,float,float,float) r0.z, r0.zwzz, t2.xzyw, s3
mad_sat r0.z, r0.z, l(4.000000), l(-0.600000)
mad r2.xyz, r0.zzzz, l(0.020725, 0.020725, 0.020725, 0.000000), cb0[125].xyzx
mul r2.xyz, r2.xyzx, cb0[98].xyzx
lt r3.xyz, l(1.000000, 2.000000, 3.000000, 0.000000), v0.xxxx
movc r4.xyz, r3.zzzz, cb0[14].xyzx, cb0[98].xyzx
movc r2.xyz, r3.yyyy, r4.xyzx, r2.xyzx
movc r1.xyz, r3.xxxx, r2.xyzx, r1.xyzx
movc r0.y, r3.x, cb0[102].x, r0.y
mul r0.x, r0.y, r0.x
