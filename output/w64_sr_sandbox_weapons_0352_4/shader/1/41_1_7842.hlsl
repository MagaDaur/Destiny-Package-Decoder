...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  if (r0.x != 0) {
    ...
    r4.xyz = r2.xyz * r3.yzx + -r4.xyz;
    r4.xyz = r2.www * r3.zxy + r4.xyz;
    r3.xyz = -r1.zxy * r4.zxy + r3.xyz;
    r3.xyz = r1.yzx * r4.xyz + r3.xyz;
    r0.w = dot(v2.xyz, v2.xyz);
    r0.w = rsqrt(r0.w);
    r4.xyz = v2.xyz * r0.www;
    r5.xyz = r4.xyz * r2.yzx;
    r2.xyz = r2.xyz * r4.yzx + -r5.xyz;
    r2.xyz = r2.www * r4.zxy + r2.xyz;
    r4.xyz = -r1.zxy * r2.zxy + r4.xyz;
    r1.xyz = r1.yzx * r2.xyz + r4.xyz;
