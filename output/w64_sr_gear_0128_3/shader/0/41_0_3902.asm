...
mad r0.yz, v3.xxyx, cb0[35].xxyx, cb0[35].zzwz
...
mad r6.xy, r6.xyxx, cb0[36].xxxx, cb0[36].yyyy
...
mad r9.yw, r1.zzzw, r4.yyyy, r6.xxxy
...
add r3.z, cb0[19].x, -cb0[34].x
lt r3.z, |r3.z|, l(0.000010)
and r3.z, r3.z, l(0x3f800000)
add r3.w, -v5.y, l(1.000000)
mul_sat r4.x, r3.w, r8.z
mad_sat r4.y, r4.x, cb0[32].x, cb0[32].y
add r4.z, -cb0[4].x, cb0[19].x
lt r4.z, |r4.z|, l(0.000010)
and r4.z, r4.z, l(0x3f800000)
add r5.x, cb0[19].x, -cb0[22].x
lt r5.x, |r5.x|, l(0.000010)
add r5.y, cb0[19].x, -cb0[21].x
lt r5.y, |r5.y|, l(0.000010)
add r5.z, cb0[19].x, -cb0[20].x
lt r5.z, |r5.z|, l(0.000010)
and r5.xyz, r5.xyzx, l(0x3f800000, 0x3f800000, 0x3f800000, 0)
add r8.xyw, cb0[17].xyxz, -cb0[18].xyxz
mad r8.xyw, r5.zzzz, r8.xyxw, cb0[18].xyxz
add r11.xyz, -r8.xywx, cb0[16].xyzx
mad r5.yzw, r5.yyyy, r11.xxyz, r8.xxyw
add r8.xyw, -r5.yzyw, cb0[15].xyxz
mad r5.xyz, r5.xxxx, r8.xywx, r5.yzwy
add r8.xyw, -r5.xyxz, cb0[14].xyxz
mad r5.xyz, r4.zzzz, r8.xywx, r5.xyzx
mad r5.w, r4.x, cb0[33].x, cb0[33].y
add r11.xyz, -r5.xyzx, cb0[31].xyzx
add r11.w, r4.y, -r5.w
...
mov r9.z, r7.y
add r1.xz, -r9.zzxz, r3.xxyx
mad r1.xz, r6.zzzz, r1.xxzx, r9.zzxz
mul r1.y, r1.y, r6.z
movc o0.w, r0.z, r0.y, r7.w
mad_sat r0.y, r8.z, cb0[24].x, cb0[24].y
mul r0.y, r3.w, r0.y
mul r0.y, r0.y, cb0[4].x
mad r0.y, r4.x, cb0[23].x, r0.y
mul r3.xyz, r0.yyyy, r5.xyzx
mad r0.yz, v3.xxyx, cb0[25].xxyx, cb0[25].zzwz
sample_indexable(texture2d)(float,float,float,float) r0.yz, r0.yzyy, t10.zxyw, s2
add r0.yz, r0.yyzy, -cb0[27].xxyx
mad r0.yz, r0.yyzy, cb0[26].xxxx, v3.xxyx
mad r0.yz, r0.yyzy, cb0[28].xxyx, cb0[28].zzwz
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r0.yzyy, t11.xyzw, s2
mad r4.xyz, r4.xyzx, cb0[29].xxxx, cb0[29].yyyy
mul r0.x, r0.x, r0.x
mad_sat r0.x, r0.x, cb0[30].x, cb0[30].y
