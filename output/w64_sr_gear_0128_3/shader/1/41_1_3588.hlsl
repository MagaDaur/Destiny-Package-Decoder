...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r1.w = cb0[14].x * cb0[3].x;
  r2.x = cb0[16].x * cb0[13].x;
  r2.y = cb0[16].x * r1.w;
  r2.z = cb0[16].x * cb0[15].x;
  r1.w = cb0[8].x * cb0[7].x;
  r2.w = -cb0[9].x + 1;
  r3.xy = float2(1,1) + -r0.yx;
  r3.x = -r3.x * cb0[10].x + 1;
  r3.z = 1 + -r2.w;
  r3.y = -r3.y * cb0[12].x + 1;
  r3.y = r3.z * r3.y;
  r2.w = r2.w * r3.x + r3.y;
  r1.w = r1.w * r0.z + r2.w;
  r2.w = -cb0[1].x + 1;
  ...
  r3.z = cb0[6].x * cb0[3].x;
  r4.x = cb0[0].x * r0.z + r3.y;
  r4.y = r2.w * r0.z + cb0[5].x;
  r4.z = r3.x * r0.z + r3.z;
