...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.yzw = saturate(r2.wxz);
    r7.xyz = r0.yyy * float3(1.62637401,0.0731709972,1.66279101) + float3(0,0.471138,-0.662791014);
    r8.xyzw = cmp(r0.yyyy >= float4(0,0.303333014,0.713333011,1));
    ...
    r7.xyz = r7.xxx * float3(-0.899999976,0.899999976,0) + float3(1,0.100000001,1);
    r8.xyzw = r0.zzyy * float4(0.210317001,5.14583302,79.6540833,-0.345488012) + float4(0,-4.14583302,-34.9112434,1.32864797);
    r9.xyz = cmp(r0.zzz >= float3(0,0.839999974,1));
    ...
    r0.z = r0.z * 0.00499999989 + 0.00499999989;
    r8.x = saturate(r4.x);
    r9.xyz = r8.xxx * float3(0,4.34474277,4.05263376) + float3(0,-2.50326395,-7.17653799);
    r10.xyz = r8.xxx * float3(42.8571434,0.366865009,2.33591294) + float3(0,0.992747009,0.787989974);
    r8.y = r8.x * r8.x;
    r9.xyz = r9.xyz * r8.yyy + r10.xyz;
    r10.xyzw = cmp(r8.xxxx >= float4(0,0.023333,0.206667006,1));
    ...
    r9.xy = r9.xy + r9.xy;
    r9.x = r9.x + r9.y;
    r9.x = saturate(r9.z * 2 + r9.x);
    r9.x = r9.x * 0.5 + 0.5;
    r0.z = r9.x * r0.z;
    r9.x = saturate(r3.w * 0.25 + -0.25);
    r9.x = r9.x * 0.899999976 + 0.100000001;
    r9.w = r9.x * r0.z;
    r10.xyz = r8.xxx * float3(0,1.06670296,9.03785515) + float3(0,-1.16432905,-18.681551);
    r11.xyz = r8.xxx * float3(42.8571434,0.309736013,10.3902712) + float3(0,0.993393004,-0.746577978);
    r10.xyz = r10.xyz * r8.yyy + r11.xyz;
    r11.xyzw = cmp(r8.xxxx >= float4(0,0.023333,0.393332988,1));
    ...
    r8.xy = r10.xy + r10.xy;
    r0.z = r8.x + r8.y;
    r10.x = saturate(r10.z * 2 + r0.z);
    r8.xy = r0.yy * float2(1,-1.62083197) + float2(1,0.637672007);
    r0.z = r0.y * r0.y;
    r8.xy = r8.zw * r0.zz + r8.xy;
    r11.xyz = cmp(r0.yyy >= float3(0,0.25999999,1));
  ...
  // No code for instruction (needs manual fix):
    ...
    r2.w = 0;
  // No code for instruction (needs manual fix):
    store_uav_typed u0.xyzw, r1.zzzz, r2.xyzw
  }
  return;
}