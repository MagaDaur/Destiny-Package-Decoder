...
mul r1.xy, r0.xzxx, l(0.068000, 0.463168, 0.000000, 0.000000)
...
sample_l_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t20.wxyz, s2, l(0.000000)
