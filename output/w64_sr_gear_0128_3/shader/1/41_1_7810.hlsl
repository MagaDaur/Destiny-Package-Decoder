...
// unknown dcl_: dcl_input_sgv v11.x, vertex_id
  ...
  o7.xyzw = t2.Load(r1.z).xyzw;
  o8.xyzw = t2.Load(r1.w).xyzw;
  r3.xyzw = float4(1,9,2,10) + r0.wwww;
  r3.xyzw = (uint4)r3.xyzw;
  o4.xyzw = t2.Load(r3.x).xyzw;
  r4.xyzw = t2.Load(r3.y).xyzw;
  o5.xyzw = t2.Load(r3.z).xyzw;
  r1.yz = t2.Load(r3.w).xy;
  r0.w = 6 + r0.w;
  r0.w = (uint)r0.w;
  r3.xyz = t2.Load(r0.w).xyz;
  x0[0].y = 0;
  x0[1].y = 1;
  x0[2].y = 0;
  x0[3].y = 1;
  ...
  r2.y = cb0[109].x * 0.0174532942;
  r2.z = cb0[110].x + cb0[109].x;
  ...
  r0.z = sqrt(r1.w);
  r1.w = r0.z * 0.666666985 + -0.666666985;
  r0.z = 10000 + -r0.z;
