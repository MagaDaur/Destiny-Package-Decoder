...
// unknown dcl_: dcl_input_sgv v3.x, vertex_id
  ...
  o0.xy = x1[r0.x+0].xy;
  r0.xy = x0[r0.x+0].xy;
  r0.xy = float2(0.600000024,0.600000024) * r0.yx;
  ...
  r1.y = -r1.y * cb0[115].x + cb0[115].y;
  r1.y = saturate(r2.x * cb0[115].x + r1.y);
  r1.x = r1.y * r1.x;
  r1.x = cb0[10].y * r1.x;
  r1.x = cb0[122].x * r1.x;
