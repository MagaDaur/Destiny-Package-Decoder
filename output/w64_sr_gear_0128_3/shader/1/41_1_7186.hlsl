  ...
  out float4 o9 : SV_POSITION0)
{
  ...
  r0.xyz = cb1[1].xyz * v4.yyy;
  r0.xyz = cb1[0].xyz * v4.xxx + r0.xyz;
  r0.xyz = cb1[2].xyz * v4.zzz + r0.xyz;
  ...
  r1.w = 0;
  r2.w = 0;
  r0.y = cb0[129].x * 3.14100003;
  sincos(r0.y, r3.x, r4.x);
  r0.yzw = v11.xyz * cb1[4].xyz + cb1[5].xyz;
  r2.xyz = r4.xxx * r0.yzw;
  r3.y = dot(cb0[130].xyz, cb0[130].xyz);
  r3.y = rsqrt(r3.y);
  r3.yzw = cb0[130].xyz * r3.yyy;
  ...
  r4.yzw = -r2.yzx * r0.wyz;
  r6.xyz = r0.zwy * -r2.zxy + -r4.yzw;
  ...
  r6.xyz = v13.xyz;
  r6.w = 0;
  r0.yzw = v13.zxy * -r3.yzx;
  r7.xyz = v13.yzx * -r3.zxy + -r0.yzw;
  r0.y = dot(v13.xyz, -r3.xyz);
  r7.w = -r0.y;
  ...
  r4.xyz = r0.wyz * -r2.yzx;
  r4.xyz = r0.zwy * -r2.zxy + -r4.xyz;
  r0.y = dot(r0.yzw, -r2.xyz);
  r4.w = -r0.y;
  r3.w = 0;
