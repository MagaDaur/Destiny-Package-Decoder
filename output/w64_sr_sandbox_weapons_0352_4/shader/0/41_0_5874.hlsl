  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = t2.Sample(s3_s, v0.xy).xy;
  r0.xy = r0.xy * v5.ww + v0.xy;
  r0.xy = v5.ww * float2(-0.5,-0.5) + r0.xy;
  ...
  r0.w = 1 + -r0.w;
  r0.w = 1 + -r0.w;
  r1.xy = v0.yx * float2(0.400000006,0.400000006) + v6.xy;
  r1.zw = round(r1.xy);
  r1.xy = r1.xy + -r1.zw;
