...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r2.x = dot(r4.xyz, r1.xyz);
  r2.y = dot(r5.xyz, r1.xyz);
  r2.z = dot(r6.xyz, r1.xyz);
  ...
  r1.xyz = r3.yzx * r2.zxy;
  r1.xyz = r2.yzx * r3.zxy + -r1.xyz;
  o2.xyz = v2.www * r1.xyz;
  r1.xy = v3.xy * cb1[6].xy + cb1[6].zw;
  r1.z = saturate(cb1[7].z * r2.z);
  o0.w = saturate(cb1[7].w + r1.z);
  r1.z = min(asuint(cb1[4].w), (uint)v4.x);
  o5.xyzw = t0.Load(r1.z).xyzw;
  r1.z = 32767.0996 * v1.w;
  r1.z = (int)r1.z;
  r1.w = (uint)r1.z >> 3;
  r1.zw = (int2)r1.zw & int2(7,4095);
  r1.z = (int)r1.z;
  o2.w = 0.100000001 + r1.z;
  r4.xyzw = t1.Load(r1.w).xyzw;
  r1.zw = (uint2)r4.yw << int2(8,8);
  r1.zw = (int2)r1.zw | (int2)r4.xz;
  r1.zw = f16tof32(r1.zw);
  o3.zw = r1.xy * r1.zw;
  r4.xyz = cb12[10].xyz + -cb12[7].xyz;
  o4.xyz = r4.xyz + r0.xyw;
  o0.xyz = r2.xyz;
  o1.w = r0.z;
  o1.xyz = r3.xyz;
  o3.xy = r1.xy;
