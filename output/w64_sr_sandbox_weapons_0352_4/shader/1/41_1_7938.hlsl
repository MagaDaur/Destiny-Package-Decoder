...
// unknown dcl_: dcl_input_sgv v13.x, vertex_id
  ...
  o0.w = r0.w;
  r1.y = 10000 + -r1.x;
  r1.z = 0.280000001 * v5.w;
  r1.z = frac(r1.z);
  r1.w = cb0[97].x * r1.z;
  r1.z = cb0[103].x + -r1.z;
  r1.z = 1 + r1.z;
  r1.z = saturate(3.33333302 * r1.z);
  r1.w = -r1.w * 0.100000001 + -0.0500000007;
  r1.x = r1.x * 0.100000001 + r1.w;
