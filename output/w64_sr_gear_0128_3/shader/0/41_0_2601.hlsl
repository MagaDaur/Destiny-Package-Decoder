  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r6.xy = r6.xy * cb0[50].xx + cb0[50].yy;
  ...
  r0.z = rsqrt(r0.z);
  r1.xyz = r1.xyz * r0.zzz;
  r0.z = saturate(cb0[47].x);
  r1.w = dot(r4.xyz, r4.xyz);
  r1.w = rsqrt(r1.w);
  r4.xyz = r4.xyz * r1.www;
  r1.w = dot(cb0[40].xyz, r4.xyz);
  r2.w = cb0[39].x + -cb0[38].x;
  r1.w = saturate(r1.w * r2.w + cb0[38].x);
  r2.w = -cb0[41].z + v4.z;
  r2.w = cb0[42].x * r2.w;
  r2.w = max(0, r2.w);
  r2.w = log2(r2.w);
  r2.w = cb0[43].x * r2.w;
  r2.w = exp2(r2.w);
  r2.w = saturate(cb0[44].x * r2.w);
  r1.w = r2.w * r1.w;
  r0.x = saturate(r0.x * cb0[45].x + cb0[45].y);
  r0.x = r1.w * r0.x;
