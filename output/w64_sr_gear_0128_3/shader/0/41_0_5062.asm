...
mul r10.xyzw, r8.zzzz, cb0[15].xyzw
mov r5.w, r7.y
mul r11.xyzw, r10.xyzw, r5.xyzw
...
add_sat r14.xyz, r5.xyzx, l(-0.250000, -0.250000, -0.250000, 0.000000)
mad_sat r13.xyz, r13.xyzx, r8.xywx, r14.xyzx
...
mad_sat r2.yzw, r2.yyzw, r8.xxyw, r14.xxyz
...
movc r0.y, r3.x, r0.y, l(-1.000000)
min r0.w, r0.w, r2.x
...
mad r2.xyz, -r5.xyzx, r10.xyzx, r2.yzwy
...
mul r0.w, r1.w, r6.z
movc o0.w, r0.z, r0.y, r7.z
mul r4.xyz, r8.zzzz, cb0[14].xyzx
mad r5.xyz, r8.zzzz, cb0[14].xyzx, r2.xyzx
max r0.y, r5.y, r5.x
max r0.y, r5.z, r0.y
