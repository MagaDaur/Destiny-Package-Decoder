...
mad r6.xy, r6.xyxx, cb0[50].xxxx, cb0[50].yyyy
...
rsq r0.z, r0.z
mul r1.xyz, r0.zzzz, r1.xyzx
mov_sat r0.z, cb0[47].x
dp3 r1.w, r4.xyzx, r4.xyzx
rsq r1.w, r1.w
mul r4.xyz, r1.wwww, r4.xyzx
dp3 r1.w, cb0[40].xyzx, r4.xyzx
add r2.w, -cb0[38].x, cb0[39].x
mad_sat r1.w, r1.w, r2.w, cb0[38].x
add r2.w, v4.z, -cb0[41].z
mul r2.w, r2.w, cb0[42].x
max r2.w, r2.w, l(0.000000)
log r2.w, r2.w
mul r2.w, r2.w, cb0[43].x
exp r2.w, r2.w
mul_sat r2.w, r2.w, cb0[44].x
mul r1.w, r1.w, r2.w
mad_sat r0.x, r0.x, cb0[45].x, cb0[45].y
mul r0.x, r0.x, r1.w
dp3 r1.w, r2.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
max r1.w, r1.w, l(0.000100)
log r1.w, r1.w
mul r1.w, r1.w, -cb0[46].x
exp r1.w, r1.w
mul r0.x, r0.x, r1.w
add o2.w, r0.z, v0.w
mad r0.x, r0.x, cb0[48].x, r0.y
