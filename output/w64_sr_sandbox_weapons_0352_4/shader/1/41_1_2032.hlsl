...
void main(
  ...
  out float4 o16 : TEXCOORD16,
  out float4 o17 : SV_POSITION0)
{
  ...
  o15.xyzw = float4(0,0,0,0);
  o16.x = 0;
  o16.yzw = v12.xyz;
  r1.y = cmp(v12.y < 9.99999997e-007);
  r1.x = (int)r1.y | (int)r1.x;
  o17.xyzw = r1.xxxx ? float4(10000,10000,-10000,1) : r0.xyzw;
  return;
}