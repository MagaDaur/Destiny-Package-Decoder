...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r1.w = dot(cb0[2].xyz, cb0[2].xyz);
  r1.w = rsqrt(r1.w);
  r2.yzw = cb0[2].xyz * r1.www;
  r3.yzw = r2.xxx * r2.yzw;
  r4.xyz = -cb0[5].xyz + r1.xyz;
  r5.xyz = r4.zxy * -r3.zwy;
  r5.xyz = r4.yzx * -r3.wyz + -r5.xyz;
  r1.w = dot(r4.xyz, -r3.yzw);
  r5.w = -r1.w;
  r4.xyz = r4.xyz * r3.xxx;
  r4.w = 0;
  r4.xyzw = r5.xyzw + r4.xyzw;
  r5.xyz = r4.yzx * r3.wyz;
  r5.xyz = r3.zwy * r4.zxy + -r5.xyz;
  r4.xyz = r3.xxx * r4.xyz + r5.xyz;
  r4.xyz = r4.www * r3.yzw + r4.xyz;
  r4.xyz = cb0[5].xyz + r4.xyz;
  r5.xyz = v1.zxy * -r3.zwy;
  r5.xyz = v1.yzx * -r3.wyz + -r5.xyz;
  r1.w = dot(v1.xyz, -r3.yzw);
  r5.w = -r1.w;
  r6.xyz = v1.xyz;
  r6.w = 0;
  r5.xyzw = r3.xxxx * r6.xyzw + r5.xyzw;
  r6.xyz = r5.yzx * r3.wyz;
  r6.xyz = r3.zwy * r5.zxy + -r6.xyz;
  r5.xyz = r3.xxx * r5.xyz + r6.xyz;
  r5.xyz = r5.www * r3.yzw + r5.xyz;
  r6.xyz = -v1.xyz + r5.xyz;
  r7.xyz = v2.zxy * -r3.zwy;
  r7.xyz = v2.yzx * -r3.wyz + -r7.xyz;
  r1.w = dot(v2.xyz, -r3.yzw);
  r7.w = -r1.w;
  r8.xyz = v2.xyz;
  r8.w = 0;
  r7.xyzw = r3.xxxx * r8.xyzw + r7.xyzw;
  r9.xyz = r7.yzx * r3.wyz;
  r9.xyz = r3.zwy * r7.zxy + -r9.xyz;
  r7.xyz = r3.xxx * r7.xyz + r9.xyz;
  r3.xyz = r7.www * r3.yzw + r7.xyz;
  ...
  r1.w = cb0[10].x * r0.z;
  r1.w = 3.14100003 * r1.w;
  sincos(r1.w, r2.x, r10.x);
  r2.xyz = r2.xxx * r2.yzw;
  r10.yzw = -cb0[11].xyz + r4.xyz;
  r11.xyz = r10.wyz * -r2.yzx;
  r11.xyz = r10.zwy * -r2.zxy + -r11.xyz;
  r1.w = dot(r10.yzw, -r2.xyz);
  r11.w = -r1.w;
  r12.xyz = r10.xxx * r10.yzw;
  r12.w = 0;
  r11.xyzw = r12.xyzw + r11.xyzw;
  r10.yzw = r11.yzx * r2.zxy;
  r10.yzw = r2.yzx * r11.zxy + -r10.yzw;
  r10.yzw = r10.xxx * r11.xyz + r10.yzw;
  r10.yzw = r11.www * r2.xyz + r10.yzw;
  r10.yzw = cb0[11].xyz + r10.yzw;
  r11.xyz = r5.zxy * -r2.yzx;
  r11.xyz = r5.yzx * -r2.zxy + -r11.xyz;
  r1.w = dot(r5.xyz, -r2.xyz);
  r11.w = -r1.w;
  r12.xyz = r10.xxx * r5.xyz;
  r12.w = 0;
  r11.xyzw = r12.xyzw + r11.xyzw;
  r12.xyz = r11.yzx * r2.zxy;
  r12.xyz = r2.yzx * r11.zxy + -r12.xyz;
  r11.xyz = r10.xxx * r11.xyz + r12.xyz;
  r11.xyz = r11.www * r2.xyz + r11.xyz;
  r5.xyz = r11.xyz + -r5.xyz;
  r11.xyz = v2.zxy * -r2.yzx;
  r11.xyz = v2.yzx * -r2.zxy + -r11.xyz;
  r1.w = dot(v2.xyz, -r2.xyz);
  r11.w = -r1.w;
  r8.xyzw = r10.xxxx * r8.xyzw + r11.xyzw;
  r11.xyz = r8.yzx * r2.zxy;
  r11.xyz = r2.yzx * r8.zxy + -r11.xyz;
  r8.xyz = r10.xxx * r8.xyz + r11.xyz;
  r2.xyz = r8.www * r2.xyz + r8.xyz;
  r2.xyz = -v2.xyz + r2.xyz;
  r4.xyz = r10.yzw + -r4.xyz;
  r4.xyz = r9.xyz + r4.xyz;
  r5.xyz = r6.xyz + r5.xyz;
  r2.xyz = r3.xyz + r2.xyz;
  r3.xyz = r7.xyz + r4.xyz;
  r3.xyz = -cb0[0].xyz + r3.xyz;
  r3.xyz = cb0[12].xxx * r3.xyz + cb0[0].xyz;
  ...
  r3.xyzw = cb12[1].xyzw * r4.yyyy;
  r3.xyzw = cb12[0].xyzw * r4.xxxx + r3.xyzw;
  r3.xyzw = cb12[2].xyzw * r4.zzzz + r3.xyzw;
  o6.xyzw = cb12[14].xyzw + r3.xyzw;
  o4.xyz = cb12[7].xyz + r4.xyz;
  r1.xyw = cb0[12].xxx * r5.xyz + v1.xyz;
  ...
  r1.xyw = cb0[12].xxx * r2.xyz + v2.xyz;
