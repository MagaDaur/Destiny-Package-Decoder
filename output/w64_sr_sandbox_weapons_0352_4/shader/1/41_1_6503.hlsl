...
// unknown dcl_: dcl_input_sgv v9.x, vertex_id
  ...
  o0.xy = x1[r0.x+0].xy;
  r0.xy = x0[r0.x+0].xy;
  r0.xy = float2(0,0.675000012) + r0.yx;
  r0.xy = v3.yx * r0.xy;
  ...
  o0.w = r4.w;
  r0.w = cb0[117].x * cb0[8].y;
  r1.w = cmp(0.999000013 < v2.w);
  r0.w = r1.w ? 0 : r0.w;
  o0.z = r0.w;
  r5.xyz = r3.xyz * r2.xyz;
  r3.xyz = r2.zxy * r3.yzx + -r5.xyz;
  r1.w = v6.w * v3.x;
  r1.w = 0.675000012 * r1.w;
  ...
  o8.xyzw = r0.xxxx ? float4(10000,10000,-10000,1) : r4.xyzw;
  return;
}