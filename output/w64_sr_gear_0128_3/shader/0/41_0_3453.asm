...
mad r3.zw, v3.xxxy, cb0[21].xxxy, cb0[21].zzzw
dp2 r0.z, cb0[22].xyxx, r3.zwzz
add r5.x, r0.z, cb0[22].z
dp2 r0.z, cb0[23].xyxx, r3.zwzz
add r5.y, r0.z, cb0[23].z
sample_indexable(texture2d)(float,float,float,float) r0.z, r5.xyxx, t10.yzxw, s2
mad r3.zw, v3.xxxy, cb0[24].xxxy, cb0[24].zzzw
sample_indexable(texture2d)(float,float,float,float) r1.w, r3.zwzz, t11.yzwx, s2
mad r1.w, r1.w, cb0[25].x, cb0[25].y
mul r0.z, r0.z, r1.w
mad r0.z, cb0[20].x, r0.z, cb0[19].x
mul r0.z, r0.z, r8.z
mul r0.x, r0.z, r0.x
