  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.xyz = r0.xyz * float3(2,2,2) + cb0[14].xyz;
  r0.xyz = r0.xyz * float3(4,4,4) + cb0[12].xyz;
  ...
  r0.y = cb0[113].x * r0.y;
  r0.y = exp2(r0.y);
  r0.y = saturate(cb0[19].w * r0.y);
  r0.y = saturate(v0.z * r0.y);
  r0.z = log2(r0.w);
  r0.z = cb0[97].x * r0.z;
  r0.z = exp2(r0.z);
  r0.x = saturate(r0.z * cb0[109].x + r0.x);
  r0.xzw = cb0[16].xyz * r0.xxx + cb0[18].xyz;
