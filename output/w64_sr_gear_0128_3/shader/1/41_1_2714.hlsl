...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r0.x = t0.Load(r0.x).x;
  r0.yzw = v0.xyz * cb1[5].www + cb1[5].xyz;
  r0.x = cmp(0 < r0.x);
  r0.x = r0.x ? 1.000000 : 0;
  r1.x = -cb0[2].x + cb0[1].x;
  r0.x = r0.x * r1.x + cb0[2].x;
  r1.x = dot(cb0[3].xyz, cb0[3].xyz);
  r1.x = sqrt(r1.x);
  r0.x = r1.x * r0.x;
  r0.x = cb0[4].x * r0.x;
  r0.x = cb0[5].x * r0.x;
  ...
  r1.y = dot(cb0[0].xyz, cb0[0].xyz);
  r1.y = rsqrt(r1.y);
  r1.yzw = cb0[0].xyz * r1.yyy;
  r1.yzw = r1.yzw * r0.xxx;
  r0.xyz = -cb0[6].xyz + r0.yzw;
  r2.xyz = r0.zxy * -r1.zwy;
  r2.xyz = r0.yzx * -r1.wyz + -r2.xyz;
  r0.w = dot(r0.xyz, -r1.yzw);
  r2.w = -r0.w;
