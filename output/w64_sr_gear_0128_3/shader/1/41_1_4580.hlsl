...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r11.yzw = -cb0[8].xyz + r9.xyz;
  r12.xyz = r11.wyz * -r1.yzx;
  r12.xyz = r11.zwy * -r1.zxy + -r12.xyz;
  r0.w = dot(r11.yzw, -r1.xyz);
  r12.w = -r0.w;
  r13.xyz = r11.xxx * r11.yzw;
  r13.w = 0;
  r12.xyzw = r13.xyzw + r12.xyzw;
  r11.yzw = r12.yzx * r1.zxy;
  r11.yzw = r1.yzx * r12.zxy + -r11.yzw;
  r11.yzw = r11.xxx * r12.xyz + r11.yzw;
  r11.yzw = r12.www * r1.xyz + r11.yzw;
  r11.yzw = cb0[8].xyz + r11.yzw;
  r12.xyz = r10.zxy * -r1.yzx;
  r12.xyz = r10.yzx * -r1.zxy + -r12.xyz;
  r0.w = dot(r10.xyz, -r1.xyz);
  r12.w = -r0.w;
  r13.xyz = r11.xxx * r10.xyz;
  r13.w = 0;
  r12.xyzw = r13.xyzw + r12.xyzw;
  r13.xyz = r12.yzx * r1.zxy;
  r13.xyz = r1.yzx * r12.zxy + -r13.xyz;
  r12.xyz = r11.xxx * r12.xyz + r13.xyz;
  r12.xyz = r12.www * r1.xyz + r12.xyz;
  r10.xyz = r12.xyz + -r10.xyz;
  r13.xyz = v2.zxy * -r1.yzx;
  r13.xyz = v2.yzx * -r1.zxy + -r13.xyz;
  r0.w = dot(v2.xyz, -r1.xyz);
  r13.w = -r0.w;
  r13.xyzw = r11.xxxx * r7.xyzw + r13.xyzw;
  r14.xyz = r13.yzx * r1.zxy;
  r14.xyz = r1.yzx * r13.zxy + -r14.xyz;
  r13.xyz = r11.xxx * r13.xyz + r14.xyz;
  r1.xyz = r13.www * r1.xyz + r13.xyz;
  r1.xyz = -v2.xyz + r1.xyz;
  r9.xyz = r11.yzw + -r9.xyz;
  r0.w = cb0[10].x * 3.14100003;
  sincos(r0.w, r11.x, r13.x);
  r0.w = dot(cb0[9].xyz, cb0[9].xyz);
  r0.w = rsqrt(r0.w);
  r13.yzw = cb0[9].xyz * r0.www;
  r13.yzw = r13.yzw * r11.xxx;
  r14.xyz = -cb0[11].xyz + r11.yzw;
  r15.xyz = r14.zxy * -r13.zwy;
  r15.xyz = r14.yzx * -r13.wyz + -r15.xyz;
  r0.w = dot(r14.xyz, -r13.yzw);
  r15.w = -r0.w;
  r14.xyz = r14.xyz * r13.xxx;
  r14.w = 0;
  r14.xyzw = r15.xyzw + r14.xyzw;
  r15.xyz = r14.yzx * r13.wyz;
  r15.xyz = r13.zwy * r14.zxy + -r15.xyz;
  r14.xyz = r13.xxx * r14.xyz + r15.xyz;
  r14.xyz = r14.www * r13.yzw + r14.xyz;
  r14.xyz = cb0[11].xyz + r14.xyz;
  r15.xyz = -r13.zwy * r12.zxy;
  r15.xyz = r12.yzx * -r13.wyz + -r15.xyz;
  r0.w = dot(r12.xyz, -r13.yzw);
  r15.w = -r0.w;
  r16.xyz = r13.xxx * r12.xyz;
  r16.w = 0;
  r15.xyzw = r16.xyzw + r15.xyzw;
  r16.xyz = r15.yzx * r13.wyz;
  r16.xyz = r13.zwy * r15.zxy + -r16.xyz;
  r15.xyz = r13.xxx * r15.xyz + r16.xyz;
  r15.xyz = r15.www * r13.yzw + r15.xyz;
  r12.xyz = r15.xyz + -r12.xyz;
  r15.xyz = v2.zxy * -r13.zwy;
  r15.xyz = v2.yzx * -r13.wyz + -r15.xyz;
  r0.w = dot(v2.xyz, -r13.yzw);
  r15.w = -r0.w;
  r7.xyzw = r13.xxxx * r7.xyzw + r15.xyzw;
  r15.xyz = r13.wyz * r7.yzx;
  r15.xyz = r13.zwy * r7.zxy + -r15.xyz;
  r7.xyz = r13.xxx * r7.xyz + r15.xyz;
  r7.xyz = r7.www * r13.yzw + r7.xyz;
  ...
  r2.xyz = cb0[12].xxx * r2.xyz + cb0[0].xyz;
  ...
  r0.xyw = cb0[12].xxx * r4.xyz + v1.xyz;
  ...
  r0.xyw = cb0[12].xxx * r1.xyz + v2.xyz;
