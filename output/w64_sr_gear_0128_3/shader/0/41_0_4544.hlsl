  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.xyz = t5.Sample(s1_s, r0.xy).xyz;
  r0.w = cb0[10].x * cb0[9].x;
  r0.xyz = r0.www * r0.xyz;
  r1.xy = v3.xy * cb0[8].xy + cb0[8].zw;
  r1.xyz = t4.Sample(s1_s, r1.xy).xyz;
  r0.w = cb0[7].x * cb0[6].x;
  r0.xyz = r0.www * r1.xyz + r0.xyz;
  r1.xy = v3.xy * cb0[16].xy + cb0[16].zw;
  r1.xyz = t6.Sample(s1_s, r1.xy).xyz;
  r1.xyz = max(cb0[17].xxx, r1.xyz);
  r1.xyz = min(cb0[18].xxx, r1.xyz);
  ...
  r0.w = r0.w * r0.w;
  r1.w = saturate(r0.w * cb0[12].x + cb0[12].y);
  r0.w = saturate(r0.w * cb0[3].x + cb0[3].y);
  r2.xyz = cb0[5].xyz * r0.www + cb0[4].xyz;
  r3.xyz = cb0[14].xyz * r1.www + cb0[13].xyz;
  r0.xyz = r0.xyz * r3.xyz + r1.xyz;
  r0.xyz = r2.xyz + r0.xyz;
  r0.xyz = cb0[19].xyz * r0.xyz;
  r1.xyz = r0.xyz * cb0[20].xxx + cb0[0].xyz;
