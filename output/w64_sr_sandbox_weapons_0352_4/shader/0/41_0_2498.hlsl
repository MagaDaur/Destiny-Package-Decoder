  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.xy = r1.zw * v6.xy + r1.xy;
  r1.xy = v6.zw + r1.xy;
  r0.w = t1.Sample(s1_s, r1.xy).x;
  r0.xyz = r0.xyz * v10.www + r0.www;
  ...
  r0.w = sqrt(r0.w);
  r1.x = 0.015625 * r0.w;
  r0.w = saturate(r0.w * cb0[126].x + cb0[126].y);
  r1.x = min(1, r1.x);
  r1.z = sqrt(r1.x);
  r1.xy = cb12[12].zw * v14.xy;
  ...
  r0.w = 1 / r0.w;
  r0.w = -v0.w + r0.w;
  r0.w = saturate(r0.w / v13.w);
  r0.w = 1 + -r0.w;
  r0.w = 1 + -r0.w;
  r1.x = cb0[132].x * v10.z;
  r1.x = floor(r1.x);
  r1.xy = cb0[129].xy * r1.xx;
  r1.xy = v0.xy * cb0[128].xy + r1.xy;
  r1.x = t4.Sample(s1_s, r1.xy).x;
  r1.x = log2(r1.x);
