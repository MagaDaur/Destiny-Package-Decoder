  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.zw = r4.xy * r3.zw;
  r3.zw = r3.zw * float2(0.0599999987,0.0599999987) + v0.xy;
  r2.w = cb0[130].x * v6.x;
  r2.w = floor(r2.w);
  r4.xy = cb0[127].xy * r2.ww;
  r3.zw = r3.zw * cb0[126].xy + r4.xy;
  ...
  r3.xyw = cb0[10].xyz * r3.xyw;
  r3.xyw = float3(5,5,5) * r3.xyw;
  r4.x = 1 / cb0[137].x;
  r2.w = r4.x * r2.w;
  r2.w = exp2(r2.w);
  r2.w = saturate(r2.w * w1.x + v6.w);
  ...
  r2.x = -1 + r2.x;
  r0.w = r0.w * r2.x + 1;
  r1.x = saturate(dot(cb0[118].xyz, r1.xyz));
  r1.yzw = cb0[117].xyz * r1.www;
  ...
  r0.z = saturate(r1.w * cb0[124].x + cb0[124].y);
