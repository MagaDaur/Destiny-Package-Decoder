...
if_nz r0.x
  ...
  if_nz r0.x
    ...
    if_nz r0.x
      add r0.xyz, -cb0[9].xyzx, v[0][4].xyzx
      mad r0.xyz, r0.xyzx, l(1.66666663, 1.66666663, 1.66666663, 0.000000), l(0.500000, 0.500000, 0.500000, 0.000000)
      ...
      add r0.xyz, cb0[9].xyzx, cb1[3].xyzx
      mad r1.xyz, cb1[0].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r0.xyzx
      mad r2.xyz, -cb1[1].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r1.xyzx
      mad r3.xyz, cb1[2].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r2.xyzx
      mad r2.xyz, -cb1[2].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r2.xyzx
      mad r1.xyz, cb1[1].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r1.xyzx
      mad r4.xyz, cb1[2].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r1.xyzx
      mad r1.xyz, -cb1[2].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r1.xyzx
      ...
      mad r2.xyzw, cb12[2].xyzw, r2.zzzz, r5.xyzw
      add r2.xyzw, r2.xyzw, cb12[3].xyzw
      mul r5.xyzw, r4.yyyy, cb12[1].xyzw
      mad r5.xyzw, cb12[0].xyzw, r4.xxxx, r5.xyzw
      mad r4.xyzw, cb12[2].xyzw, r4.zzzz, r5.xyzw
      ...
      emit_stream m0
      cut_stream m0
      mad r1.xyz, cb1[1].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r0.xyzx
      mad r2.xyz, -cb1[0].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r1.xyzx
      mad r3.xyz, cb1[2].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r2.xyzx
      mad r2.xyz, -cb1[2].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r2.xyzx
      mad r1.xyz, cb1[0].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r1.xyzx
      mad r4.xyz, cb1[2].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r1.xyzx
      mad r1.xyz, -cb1[2].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r1.xyzx
      mul r5.xyzw, r3.yyyy, cb12[1].xyzw
      mad r5.xyzw, cb12[0].xyzw, r3.xxxx, r5.xyzw
      ...
      emit_stream m0
      cut_stream m0
      mad r1.xyz, cb1[2].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r0.xyzx
      mad r2.xyz, -cb1[0].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r1.xyzx
      mad r3.xyz, cb1[1].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r2.xyzx
      mad r2.xyz, -cb1[1].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r2.xyzx
      mad r1.xyz, cb1[0].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r1.xyzx
      mad r4.xyz, cb1[1].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r1.xyzx
      mad r1.xyz, -cb1[1].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r1.xyzx
      mul r5.xyzw, r3.yyyy, cb12[1].xyzw
      mad r5.xyzw, cb12[0].xyzw, r3.xxxx, r5.xyzw
      mad r3.xyzw, cb12[2].xyzw, r3.zzzz, r5.xyzw
      ...
      emit_stream m0
      cut_stream m0
      mad r0.xyz, -cb1[2].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r0.xyzx
      mad r1.xyz, -cb1[0].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r0.xyzx
      mad r2.xyz, cb1[1].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r1.xyzx
      mad r1.xyz, -cb1[1].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r1.xyzx
      mad r0.xyz, cb1[0].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r0.xyzx
      mad r3.xyz, cb1[1].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r0.xyzx
      mad r0.xyz, -cb1[1].xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r0.xyzx
  ...
  add r0.xy, l(-1.000000, -2.000000, 0.000000, 0.000000), cb0[3].xxxx
  lt r0.xy, |r0.xyxx|, l(0.010000, 0.010000, 0.000000, 0.000000)
  if_nz r0.x
    lt r0.x, cb0[4].x, l(0.500000)
    if_nz r0.x
      mad r0.xzw, v[0][4].xxyz, l(0.333333343, 0.000000, 0.333333343, 0.333333343), l(0.500000, 0.000000, 0.500000, 0.500000)
      sample_l_indexable(texture3d)(float,float,float,float) r0.xzw, r0.xzwx, t0.xwyz, s0, l(0.000000)
      ...
      mad r2.xyz, cb1[0].xyzx, r0.xxxx, r2.xyzx
      mad r0.xzw, cb1[2].xxyz, r0.wwww, r2.xxyz
      sqrt r1.w, r1.w
      mul r1.w, r1.w, l(0.333333343)
      mul r2.xyz, r0.wxzw, cb12[6].yzxy
      mad r2.xyz, r0.zwxz, cb12[6].zxyz, -r2.xyzx
      ...
      mad r3.xyz, -r2.xyzx, l(0.025000, 0.025000, 0.025000, 0.000000), r1.xyzx
      mad r1.xyz, r2.xyzx, l(0.025000, 0.025000, 0.025000, 0.000000), r1.xyzx
      mul r2.xyzw, r0.zzzz, cb12[1].xyzw
      mad r2.xyzw, cb12[0].xyzw, r0.xxxx, r2.xyzw
      mad r2.xyzw, cb12[2].xyzw, r0.wwww, r2.xyzw
      add r2.xyzw, r2.xyzw, cb12[3].xyzw
      mul r4.xyzw, r3.yyyy, cb12[1].xyzw
      mad r4.xyzw, cb12[0].xyzw, r3.xxxx, r4.xyzw
      mad r3.xyzw, cb12[2].xyzw, r3.zzzz, r4.xyzw
      ...
      mad r0.xzw, cb1[0].xxyz, l(1.500000, 0.000000, 1.500000, 1.500000), cb1[3].xxyz
      mad r1.xyz, -cb1[1].xyzx, l(1.500000, 1.500000, 1.500000, 0.000000), r0.xzwx
      mad r2.xyz, cb1[2].xyzx, l(1.500000, 1.500000, 1.500000, 0.000000), r1.xyzx
      mad r1.xyz, -cb1[2].xyzx, l(1.500000, 1.500000, 1.500000, 0.000000), r1.xyzx
      mad r0.xzw, cb1[1].xxyz, l(1.500000, 0.000000, 1.500000, 1.500000), r0.xxzw
      mad r3.xyz, cb1[2].xyzx, l(1.500000, 1.500000, 1.500000, 0.000000), r0.xzwx
      mad r0.xzw, -cb1[2].xxyz, l(1.500000, 0.000000, 1.500000, 1.500000), r0.xxzw
      mul r4.xyzw, r2.yyyy, cb12[1].xyzw
      mad r4.xyzw, cb12[0].xyzw, r2.xxxx, r4.xyzw
      mad r2.xyzw, cb12[2].xyzw, r2.zzzz, r4.xyzw
      add r2.xyzw, r2.xyzw, cb12[3].xyzw
      ...
      emit_stream m0
      cut_stream m0
      mad r0.xzw, cb1[1].xxyz, l(1.500000, 0.000000, 1.500000, 1.500000), cb1[3].xxyz
      mad r1.xyz, -cb1[0].xyzx, l(1.500000, 1.500000, 1.500000, 0.000000), r0.xzwx
      mad r2.xyz, cb1[2].xyzx, l(1.500000, 1.500000, 1.500000, 0.000000), r1.xyzx
      mad r1.xyz, -cb1[2].xyzx, l(1.500000, 1.500000, 1.500000, 0.000000), r1.xyzx
      mad r0.xzw, cb1[0].xxyz, l(1.500000, 0.000000, 1.500000, 1.500000), r0.xxzw
      mad r3.xyz, cb1[2].xyzx, l(1.500000, 1.500000, 1.500000, 0.000000), r0.xzwx
      mad r0.xzw, -cb1[2].xxyz, l(1.500000, 0.000000, 1.500000, 1.500000), r0.xxzw
      mul r4.xyzw, r2.yyyy, cb12[1].xyzw
      mad r4.xyzw, cb12[0].xyzw, r2.xxxx, r4.xyzw
      ...
      emit_stream m0
      cut_stream m0
      mad r0.xzw, cb1[2].xxyz, l(1.500000, 0.000000, 1.500000, 1.500000), cb1[3].xxyz
      mad r1.xyz, -cb1[0].xyzx, l(1.500000, 1.500000, 1.500000, 0.000000), r0.xzwx
      mad r2.xyz, cb1[1].xyzx, l(1.500000, 1.500000, 1.500000, 0.000000), r1.xyzx
      mad r1.xyz, -cb1[1].xyzx, l(1.500000, 1.500000, 1.500000, 0.000000), r1.xyzx
      mad r0.xzw, cb1[0].xxyz, l(1.500000, 0.000000, 1.500000, 1.500000), r0.xxzw
      mad r3.xyz, cb1[1].xyzx, l(1.500000, 1.500000, 1.500000, 0.000000), r0.xzwx
      mad r0.xzw, -cb1[1].xxyz, l(1.500000, 0.000000, 1.500000, 1.500000), r0.xxzw
      mul r4.xyzw, r2.yyyy, cb12[1].xyzw
      mad r4.xyzw, cb12[0].xyzw, r2.xxxx, r4.xyzw
      mad r2.xyzw, cb12[2].xyzw, r2.zzzz, r4.xyzw
  ...
  if_nz r0.y
    mul r0.xyz, cb1[1].xyzx, v[0][4].yyyy
    mad r0.xyz, cb1[0].xyzx, v[0][4].xxxx, r0.xyzx
    mad r0.xyz, cb1[2].xyzx, v[0][4].zzzz, r0.xyzx
    add r0.xyz, r0.xyzx, cb1[3].xyzx
    mul r1.xyz, cb12[6].yzxy, cb1[0].zxyz
    mad r1.xyz, cb1[0].yzxy, cb12[6].zxyz, -r1.xyzx
    dp3 r0.w, r1.xyzx, r1.xyzx
    rsq r0.w, r0.w
    mul r1.xyz, r0.wwww, r1.xyzx
    mad r2.xyz, cb1[0].xyzx, l(0.333333343, 0.333333343, 0.333333343, 0.000000), r0.xyzx
    mad r3.xyz, -r1.xyzx, l(0.025000, 0.025000, 0.025000, 0.000000), r0.xyzx
    mad r0.xyz, r1.xyzx, l(0.025000, 0.025000, 0.025000, 0.000000), r0.xyzx
    mul r1.xyzw, r2.yyyy, cb12[1].xyzw
    mad r1.xyzw, cb12[0].xyzw, r2.xxxx, r1.xyzw
    mad r1.xyzw, cb12[2].xyzw, r2.zzzz, r1.xyzw
    add r1.xyzw, r1.xyzw, cb12[3].xyzw
