...
// unknown dcl_: dcl_input_sgv v5.x, vertex_id
  ...
  r6.xyz = float3(0.119999997,0.119999997,0.119999997) * r0.xyw;
  r3.w = (int)r0.z;
  r3.w = cmp(r3.w < 0.5);
  r0.xyw = float3(-0.119999997,-0.119999997,-0.119999997) * r0.xyw;
  r0.xyw = r3.www ? r0.xyw : r6.xyz;
