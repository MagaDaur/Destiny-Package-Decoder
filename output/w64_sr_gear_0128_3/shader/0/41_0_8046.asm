...
movc r0.y, r2.y, r0.y, l(-1.000000)
min r0.w, r0.w, r2.x
...
add r0.y, cb0[21].x, -cb0[23].x
lt r0.y, |r0.y|, l(0.000010)
add r0.z, -cb0[6].x, cb0[21].x
lt r0.z, |r0.z|, l(0.000010)
and r0.yz, r0.yyzy, l(0, 0x3f800000, 0x3f800000, 0)
add r1.y, cb0[21].x, -cb0[22].x
lt r1.y, |r1.y|, l(0.000010)
and r1.y, r1.y, l(0x3f800000)
add r4.xyz, cb0[19].xyzx, -cb0[20].xyzx
mad r4.xyz, r1.yyyy, r4.xyzx, cb0[20].xyzx
...
mul r5.xyz, r4.xyzx, cb0[16].xyzx
mad r4.xyz, cb0[16].xyzx, r4.xyzx, r2.xyzx
max r0.y, r4.y, r4.x
max r0.y, r4.z, r0.y
