  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.yz = -cb0[9].xy + r0.yz;
  r1.xy = v3.xy * cb0[6].xy + cb0[6].zw;
  r0.yz = r0.yz * cb0[8].xx + r1.xy;
  r0.y = t1.Sample(s3_s, r0.yz).x;
  r0.y = saturate(r0.y * cb0[10].x + cb0[10].y);
  r0.x = r0.y * r0.x;
  r0.w = min(1, r0.x);
  r0.xyz = cb0[5].xxx * cb0[4].xyz;
  r1.x = saturate(cb0[13].x * 10000 + cb0[13].y);
  r0.xyzw = r1.xxxx * r0.xyzw;
  r0.xyz = cb0[14].xxx * r0.xyz;
  r1.x = cb0[3].x * 0.75;
  r1.x = max(0, r1.x);
