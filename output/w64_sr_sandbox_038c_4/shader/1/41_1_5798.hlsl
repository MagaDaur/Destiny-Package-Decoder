...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  if (r0.x != 0) {
    ...
    r4.xyzw = cb12[14].xyzw + r4.xyzw;
    r1.w = dot(v1.xyz, v1.xyz);
    r1.w = rsqrt(r1.w);
    r5.xyz = v1.xyz * r1.www;
    r6.xyz = r5.xyz * r3.yzx;
    r6.xyz = r3.xyz * r5.yzx + -r6.xyz;
    r6.xyz = r3.www * r5.zxy + r6.xyz;
    r5.xyz = -r2.zxy * r6.zxy + r5.xyz;
    r5.xyz = r2.yzx * r6.xyz + r5.xyz;
    r1.w = dot(v2.xyz, v2.xyz);
    r1.w = rsqrt(r1.w);
    r6.xyzw = v2.xyzz * r1.wwww;
    r7.xyzw = r6.xyww * r3.yzxx;
    r7.xyzw = r3.xyzz * r6.ywxx + -r7.xyzw;
    r3.xyzw = r3.wwww * r6.wxyy + r7.xyzw;
    r6.xyzw = -r2.zxyy * r3.wxyy + r6.xyzw;
    r2.xyzw = r2.yzxx * r3.xyzw + r6.xyzw;
    r3.xyz = r5.zxy * r2.ywx;
    r3.xyz = r5.yzx * r2.wxy + -r3.xyz;
    o2.xyz = v2.www * r3.xyz;
    r3.xyzw = v3.xyxy * cb1[6].xyxy + cb1[6].zwzw;
    r6.xy = r3.zw * cb0[2].xy + cb0[2].zw;
    r1.w = t3.SampleLevel(s1_s, r6.xy, 0).x;
    r1.w = saturate(r1.w * cb0[3].x + cb0[3].y);
    r1.w = cb0[1].x * r1.w;
    r6.xyz = cb0[0].xyz * r1.www;
