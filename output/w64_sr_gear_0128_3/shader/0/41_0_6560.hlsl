  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r1.w = r2.w * r1.w;
  r1.w = cb0[18].x * r1.w + cb0[18].y;
  r1.w = -cb0[19].x + r1.w;
  r3.xw = cb0[20].zw * r1.ww + cb0[20].xy;
  r1.w = saturate(min(r3.x, r3.w));
  r2.w = saturate(cb0[21].x + v5.x);
  r2.w = log2(r2.w);
  r2.w = cb0[22].x * r2.w;
  r2.w = exp2(r2.w);
  r3.x = max(0, v5.y);
  ...
  r1.w = cb0[24].x * r1.w;
  r0.z = r0.z * r1.w + -r0.y;
  r0.y = cb0[25].x * r0.z + r0.y;
  r0.y = max(cb0[26].x, r0.y);
  r0.y = min(cb0[27].x, r0.y);
