  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r6.xy = r6.xy * cb0[27].xx + cb0[27].yy;
  ...
  r9.xyz = saturate(float3(7.96875,7.96875,4) * r7.wzy);
  r7.z = cb0[10].x + 128.5;
  r7.z = 0.00390625 * r7.z;
  r7.w = cmp(0.0500000007 >= r9.x);
  r7.z = r7.w ? r7.z : -1;
  r8.yz = v3.xy * cb0[25].xy + cb0[25].zw;
  r8.yz = t10.Sample(s2_s, r8.yz).xy;
  r10.xy = cb0[26].xy * r9.yy;
  r8.yz = r8.yz * r10.xx + r10.yy;
  r8.yz = r8.yz + r6.xy;
  ...
  r1.xy = r1.xy + -r8.yz;
  r1.xy = r5.ww * r1.xy + r8.yz;
  r9.w = r7.y;
  r3.yz = r4.xy + -r9.wx;
  r3.yz = r5.ww * r3.yz + r9.wx;
  r0.w = r5.w * r1.w;
  o0.w = r0.z ? r3.x : r7.z;
  ...
  r0.z = 1 + -v5.y;
  r1.w = 1 + -r0.z;
  r0.z = cb0[6].x * r1.w + r0.z;
  r1.w = cmp(0.000000 != cb0[12].x);
  if (r1.w != 0) {
    ...
    r4.xy = v3.xy * r2.ww;
    r4.xy = floor(r4.xy);
    r2.w = dot(r4.xy, float2(17,0.100000001));
    r2.w = sin(r2.w);
    r2.w = 10000 * r2.w;
    r3.w = r4.y * 13 + r4.x;
    r3.w = sin(r3.w);
    r3.w = 0.100000001 + abs(r3.w);
    r2.w = r3.w * r2.w;
    r2.w = frac(r2.w);
    r3.xw = v3.xy * r3.xx;
    r3.xw = floor(r3.xw);
    r4.x = dot(r3.xw, float2(17,0.100000001));
    r4.x = sin(r4.x);
    r4.x = 10000 * r4.x;
    r3.x = r3.w * 13 + r3.x;
    r3.x = sin(r3.x);
    ...
    r1.w = r1.w ? r3.x : r4.y;
    r1.w = r4.x ? r1.w : r3.w;
    r2.w = cmp(0.5 >= cb0[11].x);
    r3.x = cb0[11].x + cb0[11].x;
    r3.x = r1.w * -r3.x + r3.x;
    r3.w = cb0[11].x * 2 + -2;
    r1.w = r1.w * r3.w + 1;
    r1.w = r2.w ? r3.x : r1.w;
  ...
  r0.z = cmp(r0.z < 0);
  if (r0.z != 0) discard;
  r0.z = saturate(cb0[22].x);
  r1.w = dot(v0.xyz, v0.xyz);
  r1.w = rsqrt(r1.w);
  r4.xyz = v0.xyz * r1.www;
  r1.w = dot(cb0[15].xyz, r4.xyz);
  r2.w = cb0[14].x + -cb0[13].x;
  r1.w = saturate(r1.w * r2.w + cb0[13].x);
  r2.w = -cb0[16].z + v4.z;
  r2.w = cb0[17].x * r2.w;
  r2.w = max(0, r2.w);
  r2.w = log2(r2.w);
  r2.w = cb0[18].x * r2.w;
  r2.w = exp2(r2.w);
  r2.w = saturate(cb0[19].x * r2.w);
  r1.w = r2.w * r1.w;
  r0.x = saturate(r0.x * cb0[20].x + cb0[20].y);
  r0.x = r1.w * r0.x;
