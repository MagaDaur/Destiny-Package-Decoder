...
mul r5.xyz, -r1.yzxy, v2.zxyz
mad r5.xyz, v2.yzxy, -r1.zxyz, -r5.xyzx
dp3 r0.w, v2.xyzx, -r1.xyzx
mov r5.w, -r0.w
mov r6.xyz, v2.xyzx
mov r6.w, l(0)
mad r5.xyzw, r2.xxxx, r6.xyzw, r5.xyzw
mul r7.xyz, r1.zxyz, r5.yzxy
mad r7.xyz, r1.yzxy, r5.zxyz, -r7.xyzx
mad r5.xyz, r2.xxxx, r5.xyzx, r7.xyzx
mad r1.xyz, r5.wwww, r1.xyzx, r5.xyzx
add r1.xyz, r1.xyzx, -v2.xyzx
add r5.xyz, -r0.xyzx, r2.yzwy
mul r0.w, l(3.141000), cb0[6].x
sincos r2.x, r7.x, r0.w
dp3 r0.w, cb0[5].xyzx, cb0[5].xyzx
rsq r0.w, r0.w
mul r7.yzw, r0.wwww, cb0[5].xxyz
mul r7.yzw, r2.xxxx, r7.yyzw
add r8.xyz, r2.yzwy, -cb0[7].xyzx
mul r9.xyz, -r7.zwyz, r8.zxyz
mad r9.xyz, r8.yzxy, -r7.wyzw, -r9.xyzx
dp3 r0.w, r8.xyzx, -r7.yzwy
mov r9.w, -r0.w
mul r8.xyz, r7.xxxx, r8.xyzx
mov r8.w, l(0)
add r8.xyzw, r8.xyzw, r9.xyzw
mul r9.xyz, r7.wyzw, r8.yzxy
mad r9.xyz, r7.zwyz, r8.zxyz, -r9.xyzx
mad r8.xyz, r7.xxxx, r8.xyzx, r9.xyzx
mad r8.xyz, r8.wwww, r7.yzwy, r8.xyzx
add r8.xyz, r8.xyzx, cb0[7].xyzx
mul r9.xyz, r3.zxyz, -r7.zwyz
mad r9.xyz, r3.yzxy, -r7.wyzw, -r9.xyzx
dp3 r0.w, r3.xyzx, -r7.yzwy
mov r9.w, -r0.w
...
mad r9.xyz, r7.xxxx, r9.xyzx, r10.xyzx
mad r9.xyz, r9.wwww, r7.yzwy, r9.xyzx
add r3.xyz, -r3.xyzx, r9.xyzx
mul r9.xyz, -r7.zwyz, v2.zxyz
mad r9.xyz, v2.yzxy, -r7.wyzw, -r9.xyzx
dp3 r0.w, v2.xyzx, -r7.yzwy
mov r9.w, -r0.w
mad r6.xyzw, r7.xxxx, r6.xyzw, r9.xyzw
mul r9.xyz, r6.yzxy, r7.wyzw
mad r9.xyz, r7.zwyz, r6.zxyz, -r9.xyzx
mad r6.xyz, r7.xxxx, r6.xyzx, r9.xyzx
mad r6.xyz, r6.wwww, r7.yzwy, r6.xyzx
add r6.xyz, r6.xyzx, -v2.xyzx
add r2.xyz, -r2.yzwy, r8.xyzx
add r3.xyz, r3.xyzx, r4.xyzx
add r1.xyz, r1.xyzx, r6.xyzx
add r2.xyz, r2.xyzx, r5.xyzx
add r2.xyz, r2.xyzx, -cb0[0].xyzx
mad r2.xyz, cb0[8].xxxx, r2.xyzx, cb0[0].xyzx
...
mad r0.xyw, cb0[8].xxxx, r3.xyxz, v1.xyxz
...
mad r0.xyw, cb0[8].xxxx, r1.xyxz, v2.xyxz
