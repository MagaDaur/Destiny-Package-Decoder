...
// unknown dcl_: dcl_input_sgv v5.x, vertex_id
  ...
  r1.z = cmp(1 < cb0[126].x);
  if (r1.z != 0) {
    r1.z = cmp((int)r0.y < 0);
    if (r1.z != 0) {
      r1.z = cb0[36].x + 1;
      r1.z = (uint)r1.z;
      r5.xyz = t2.Load(r1.z).xyz;
    } else {
      r1.z = cb0[126].x + -1;
      r0.x = -r1.z + r0.x;
  ...
  o0.y = x0[r0.z+0].y;
  r6.xyzw = cb12[1].xyzw * r4.yyyy;
  r6.xyzw = cb12[0].xyzw * r4.xxxx + r6.xyzw;
  r6.xyzw = cb12[2].xyzw * r4.zzzz + r6.xyzw;
