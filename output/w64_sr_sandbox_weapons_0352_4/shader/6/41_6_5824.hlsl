...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.w = cb0[22].x / r4.z;
    r5.x = saturate(r2.w);
    r5.y = r5.x * -0.173913002 + 1.173913;
    r5.x = r5.x * r5.x;
    r5.x = r5.y * r5.x;
    r5.x = min(1, r5.x);
    r5.x = r5.x * 0.150000006 + 0.0500000007;
    r6.w = r1.w + r0.w;
    ...
    r5.xyz = cb0[147].xyz * cb0[5].yyy;
    r1.xyz = r5.xyz * cb0[146].xxx + r1.xyz;
    r0.y = saturate(cb0[148].x * 7);
    r0.y = 1 + -r0.y;
    r6.xyz = r1.xyz * r0.yyy;
    r3.xyz = r6.xyz * cb0[139].xxx + r3.xyz;
    r0.y = cb0[148].x * r3.w;
