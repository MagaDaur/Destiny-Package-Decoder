...
// unknown dcl_: dcl_input_sgv v3.x, vertex_id
  ...
  o0.xy = x1[r0.x+0].xy;
  r0.xy = x0[r0.x+0].xy;
  r0.xy = cb0[15].yx + r0.yx;
  r0.xy = cb0[16].yx * r0.xy;
  r0.z = 3.14100003 + v1.w;
  ...
  r2.xyzw = cb12[7].zxyz + -r1.zxyz;
  r0.zw = float2(1,0) * r2.zw;
  r0.zw = r2.xy * float2(0,1) + -r0.zw;
  r1.w = dot(r0.zw, r0.zw);
  r1.w = rsqrt(r1.w);
  r0.zw = r1.ww * r0.zw;
  r0.yz = r0.zw * r0.yy;
  r3.xy = float2(0.550000012,0.550000012) * r0.yz;
  r3.z = 0;
  r0.yzw = r3.xyz + r1.xyz;
  r0.xyz = r0.xxx * float3(0,0,0.550000012) + r0.yzw;
  r0.w = dot(r2.yzw, r2.yzw);
  r1.x = rsqrt(r0.w);
  r0.w = sqrt(r0.w);
  r1.xyz = r2.yzw * r1.xxx;
  r1.xyz = -r1.zzz * float3(0,0,1) + r1.xyz;
  r1.w = dot(r1.xyz, r1.xyz);
  r1.w = rsqrt(r1.w);
  r1.xyz = r1.xyz * r1.www;
  r0.xyz = cb0[106].xxx * r1.xyz + r0.xyz;
  o1.xyz = r1.xyz;
  ...
  o0.w = r1.w;
  r0.x = r0.w * 0.066666998 + -0.0333329998;
  r0.y = 10000 + -r0.w;
