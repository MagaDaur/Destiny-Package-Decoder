  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r6.xy = r6.xy * cb0[21].xx + cb0[21].yy;
  ...
  r0.z = rsqrt(r0.z);
  r1.xyz = r1.xyz * r0.zzz;
  r0.z = saturate(cb0[18].x);
  r1.w = dot(v0.xyz, v0.xyz);
  r1.w = rsqrt(r1.w);
  r4.xyz = v0.xyz * r1.www;
  r1.w = dot(cb0[11].xyz, r4.xyz);
  r2.w = cb0[10].x + -cb0[9].x;
  r1.w = saturate(r1.w * r2.w + cb0[9].x);
  r2.w = -cb0[12].z + v4.z;
  r2.w = cb0[13].x * r2.w;
  r2.w = max(0, r2.w);
  r2.w = log2(r2.w);
