...
// unknown dcl_: dcl_input_sgv v3.x, vertex_id
  ...
  r0.xyz = r0.xzw * float3(9.99999975e-006,9.99999975e-006,9.99999975e-006) + r2.xyz;
  r2.xyz = cb12[7].xyz + -r2.xyz;
  r0.w = dot(r2.xyz, r2.xyz);
  r0.w = sqrt(r0.w);
  r0.xyz = r1.xyz * float3(9.99999975e-006,9.99999975e-006,9.99999975e-006) + r0.xyz;
  ...
  r0.y = saturate(r0.w * cb0[106].x + r0.y);
  r0.x = r0.y * r0.x;
  r0.x = cb0[8].y * r0.x;
  r0.x = cb0[113].x * r0.x;
