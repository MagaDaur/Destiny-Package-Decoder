  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyz = cb0[12].www * cb0[10].xyz;
  r0.x = dot(r0.xyz, float3(0.300000012,0.589999974,0.109999999));
  r0.yzw = cb0[10].xyz * cb0[12].www + -r0.xxx;
  r0.xyz = cb0[12].xxx * r0.yzw + r0.xxx;
  ...
  r1.x = exp2(r1.x);
  r1.y = r1.x * 0.0667999983 + v0.w;
  r1.y = 0.0229000002 + r1.y;
  r0.w = -r1.y + r0.w;
  r1.y = r1.x * 0.314999998 + 0.0560999997;
  r1.x = saturate(cb0[12].z * r1.x);
