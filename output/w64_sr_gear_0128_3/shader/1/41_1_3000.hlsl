...
// unknown dcl_: dcl_input_sgv v3.x, vertex_id
  ...
  o0.xy = x1[r0.x+0].xy;
  r0.xy = x0[r0.x+0].xy;
  r0.xy = float2(0.800000012,0) + r0.yx;
  ...
  r1.x = sqrt(r1.x);
  r1.xy = r1.xx * float2(0.400000006,-0.142857) + float2(-0.400000006,2.71428609);
  r1.x = saturate(min(r1.x, r1.y));
  r1.x = cb0[11].y * r1.x;
  r1.x = cb0[115].x * r1.x;
  r1.yzw = cb12[5].xyz * v2.zzz;
  ...
  o1.xyz = cb12[6].xyz;
  p1.x = v2.z;
  r1.y = cmp(cb0[12].w < 9.99999997e-007);
