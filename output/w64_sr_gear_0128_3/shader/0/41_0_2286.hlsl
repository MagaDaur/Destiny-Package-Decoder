  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r2.y = 1 + -r8.z;
  r2.x = r2.x * r2.y;
  r2.z = cb7[r0.z+12].x + 128.5;
  r2.z = 0.00390625 * r2.z;
  r2.w = cmp(0.0500000007 >= r2.w);
  r2.z = r2.w ? r2.z : -1;
  r0.y = min(r2.x, r0.y);
  ...
  r1.y = min(r1.y, r0.y);
  r4.x = r2.x ? r1.y : r0.y;
  r2.xyw = r3.xyz * r2.yyy + -r5.xyz;
  r2.xyw = r6.zzz * r2.xyw + r5.xyz;
  r1.xy = r1.xz + -r6.xy;
  ...
  r0.z = cmp(r8.z < cb0[21].x);
  r1.w = cmp(r8.z < cb0[22].x);
  r2.z = cmp(r8.z >= cb0[21].x);
  r1.w = r1.w ? r2.z : 0;
  r2.z = cmp(r8.z >= cb0[22].x);
  r3.z = -cb0[24].x + r8.z;
  r3.z = saturate(cb0[24].y * r3.z);
  r3.w = cb0[17].x + -cb0[16].x;
  r3.z = r3.z * r3.w + cb0[16].x;
  r3.w = -cb0[25].x + r8.z;
  r3.w = saturate(cb0[25].y * r3.w);
  r4.w = cb0[18].x + -cb0[17].x;
  r3.w = r3.w * r4.w + cb0[17].x;
  r4.w = -cb0[26].x + r8.z;
  r4.w = saturate(cb0[26].y * r4.w);
  r5.x = cb0[19].x + -cb0[18].x;
  r4.w = r4.w * r5.x + cb0[18].x;
  r0.z = r0.z ? r3.z : 0;
  r0.z = r1.w ? r3.w : r0.z;
  r0.z = r2.z ? r4.w : r0.z;
  r0.z = r8.z * r0.z;
  ...
  r4.xyz = r4.xyz * r6.www + r2.xyw;
  r0.x = max(r4.x, r4.y);
  r0.x = max(r0.x, r4.z);
  r0.x = saturate(-1 + r0.x);
  r0.x = 1 + -r0.x;
  r2.xyz = r2.xyw * r0.xxx + r5.xyz;
  r0.x = max(r2.x, r2.y);
  r0.x = max(r0.x, r2.z);
  r0.x = max(1, r0.x);
