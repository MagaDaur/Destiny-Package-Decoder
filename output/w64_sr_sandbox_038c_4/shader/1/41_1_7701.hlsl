  ...
  out float4 o6 : SV_POSITION0)
{
  ...
  r0.x = sqrt(r0.x);
  r0.y = 0.280000001 * v4.x;
  r0.y = frac(r0.y);
  r0.z = cb0[123].x * r0.y;
  r0.y = cb0[129].x + -r0.y;
  r0.y = 1 + r0.y;
  r0.y = saturate(3.33333302 * r0.y);
  r0.z = -r0.z * cb0[133].x + cb0[133].y;
  r0.x = saturate(r0.x * cb0[133].x + r0.z);
  r0.x = r0.x * r0.y;
  r0.x = cb0[8].y * r0.x;
  r0.x = cb0[139].x * r0.x;
  ...
  r1.w = 0;
  r2.w = 0;
  r0.y = cb0[134].x * 3.14100003;
  sincos(r0.y, r3.x, r4.x);
  r0.yzw = v5.xyz * cb1[4].xyz + cb1[5].xyz;
  r2.xyz = r4.xxx * r0.yzw;
  r3.y = dot(cb0[135].xyz, cb0[135].xyz);
  r3.y = rsqrt(r3.y);
  r3.yzw = cb0[135].xyz * r3.yyy;
  ...
  r0.yzw = float3(0.209999993,0.209999993,0.209999993) * r0.yzw;
  r2.x = 0.5 * v3.w;
  ...
  r6.xyz = v7.xyz;
  r6.w = 0;
  r0.yzw = v7.zxy * -r3.yzx;
  r7.xyz = v7.yzx * -r3.zxy + -r0.yzw;
  r0.y = dot(v7.xyz, -r3.xyz);
  r7.w = -r0.y;
  ...
  o4.xyzw = v1.xyzw;
  o5.xy = float2(0,0);
  r0.y = cmp(cb0[142].x < 9.99999997e-007);
