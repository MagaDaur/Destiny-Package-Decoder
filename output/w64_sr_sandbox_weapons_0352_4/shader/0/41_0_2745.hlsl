  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = t0.Sample(s3_s, v0.xy).xy;
  r0.xy = float2(-0.5,-0.5) + r0.xy;
  r0.xy = r0.xy * v6.ww + v0.xy;
  r0.xy = r0.xy * v3.xy + v3.zw;
  r0.x = t1.Sample(s4_s, r0.xy).x;
  r0.x = saturate(r0.x);
  r0.y = cb0[96].x * r0.x;
  r0.y = r0.y * v6.x + v6.y;
  r0.yzw = r0.yyy * cb0[98].xyz + float3(-2.51188652e-007,-2.51188652e-007,-2.51188652e-007);
  ...
  r1.x = sqrt(r1.x);
  r1.y = 0.015625 * r1.x;
  r1.x = saturate(r1.x * cb0[116].x + cb0[116].y);
  r1.y = min(1, r1.y);
  r2.z = sqrt(r1.y);
  ...
  r1.x = sqrt(r1.x);
  r1.x = saturate(r1.x * -2.5 + 1.25);
  r0.x = r1.x * r0.x;
  r0.x = saturate(cb0[103].x * r0.x);
  r0.x = saturate(v7.z * r0.x);
