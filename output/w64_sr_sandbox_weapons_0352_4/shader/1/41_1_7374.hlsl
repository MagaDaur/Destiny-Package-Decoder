  ...
  out float4 o5 : SV_POSITION0)
{
  ...
  r0.yzw = float3(0.075000003,0.300000012,0.300000012) * r0.yzw;
  r2.x = 0.5 * v2.w;
  sincos(r2.x, r2.x, r3.x);
  r1.xyz = r3.xxx * r0.yzw;
  r2.xyz = float3(0,1,0) * r2.xxx;
  r4.xyzw = -r2.zzyy * r0.zwyz;
  ...
  r4.xyz = v7.xyz;
  r4.w = 0;
  r5.xyzw = v7.yzxy * -r2.zzyy;
  r6.xyz = -v7.zxy * -r2.yzz + r5.xyz;
  r6.w = -r5.w;
  r4.xyzw = r3.xxxx * r4.xyzw + r6.xyzw;
  r0.yzw = r4.yzx * r2.zzy;
  r0.yzw = r2.yzz * r4.zxy + -r0.yzw;
  ...
  o4.xyz = v3.xyw;
  o4.w = v4.x;
  r0.y = cmp(cb0[129].x < 9.99999997e-007);
