...
mad_sat r12.xyz, cb7[r0.y + 9].xyzx, r11.xyzx, r2.yzwy
add r12.xyz, r12.xyzx, -cb7[r0.y + 9].xyzx
mad r12.xyz, r3.xxxx, r12.xyzx, cb7[r0.y + 9].xyzx
...
mad_sat r12.xyz, r12.xyzx, r8.xywx, r13.xyzx
mad r14.xy, r1.xyxx, r3.yyyy, r6.xyxx
add r0.w, r0.w, l(-1.000000)
mad r3.y, r3.y, r0.w, l(1.000000)
mad_sat r2.yzw, cb7[r0.y + 14].xxyz, r11.xxyz, r2.yyzw
add r2.yzw, r2.yyzw, -cb7[r0.y + 14].xxyz
mad r2.yzw, r4.xxxx, r2.yyzw, cb7[r0.y + 14].xxyz
mad_sat r2.yzw, r2.yyzw, r8.xxyw, r13.xxyz
...
add r4.xyz, -r2.yzwy, r12.xyzx
mad r2.yzw, r6.wwww, r4.xxyz, r2.yyzw
add r4.xy, -r1.xyxx, r14.xyxx
...
mad r2.xyz, -r5.xyzx, cb0[17].xyzx, r2.yzwy
mad r2.xyz, r6.zzzz, r2.xyzx, r10.xyzx
add r1.xy, -r6.xyxx, r1.xyxx
mad r1.xy, r6.zzzz, r1.xyxx, r6.xyxx
mov r9.w, r10.w
add r3.yz, -r9.wwxw, r4.xxyx
mad r3.yz, r6.zzzz, r3.yyzy, r9.wwxw
mul r0.w, r1.w, r6.z
