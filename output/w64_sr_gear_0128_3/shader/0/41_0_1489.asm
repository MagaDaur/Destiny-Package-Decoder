...
mad r0.yz, v3.xxyx, cb0[30].xxyx, cb0[30].zzwz
...
add r4.x, l(128.500000), cb7[r0.y + 12].x
...
mad r2.xyz, r6.zzzz, r3.xyzx, r2.yzwy
...
mad r0.x, cb0[17].y, r0.x, cb0[17].x
mad_sat r0.y, r8.z, cb0[18].x, cb0[18].y
mul r0.x, r0.y, r0.x
dp2 r0.y, cb0[19].xyxx, v3.xyxx
add r5.x, r0.y, cb0[19].z
dp2 r0.y, cb0[20].xyxx, v3.xyxx
add r5.y, r0.y, cb0[20].z
mad r0.yz, r5.xxyx, cb0[21].xxyx, cb0[21].zzwz
sample_indexable(texture2d)(float,float,float,float) r0.y, r0.yzyy, t10.yxzw, s2
mad r0.y, r0.y, cb0[22].x, cb0[22].y
mul r0.x, r0.y, r0.x
add r0.y, -r8.z, l(1.000000)
mad r0.y, v5.x, cb0[23].x, r0.y
add r0.z, l(1.000000), cb0[23].x
ge r1.w, r0.z, l(0.000000)
movc r1.w, r1.w, l(0.000050), l(-0.000050)
add r0.z, r0.z, r1.w
div r0.z, l(1.000000, 1.000000, 1.000000, 1.000000), r0.z
mad r1.w, r0.y, r0.z, -cb0[24].x
mad r5.xy, cb0[25].zwzz, r1.wwww, cb0[25].xyxx
min_sat r1.w, r5.y, r5.x
mad r0.y, r0.y, r0.z, -cb0[26].x
mad r0.yz, cb0[27].zzwz, r0.yyyy, cb0[27].xxyx
...
mul r4.xyz, r7.zzzz, r0.xyzx
mad r0.xyz, r0.xyzx, r7.zzzz, r2.xyzx
max r0.x, r0.y, r0.x
max r0.x, r0.z, r0.x
