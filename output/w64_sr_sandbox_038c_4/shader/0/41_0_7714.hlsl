  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.yw = r0.yy * float2(0.249500006,0.25) + float2(-2.51188652e-007,-2.51188652e-007);
  r0.yw = float2(1.00000024,1.00000024) * r0.yw;
  r0.yw = max(float2(0,0), r0.yw);
  r0.yw = cb13[1].ww * r0.yw;
  r0.yw = cb13[1].xx * r0.yw;
  r0.yw = cb8[7].xy * r0.yw;
  r1.xy = float2(10,10) * r0.yw;
