...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r2.x = r2.x * 3.79881598e-010 + -0.631578982;
    r2.y = r1.w * r1.w;
    r2.x = r2.x * r2.y;
    r2.x = max(0, r2.x);
    r1.z = r2.x * 0.800000012 + 0.200000003;
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r2.x = (uint)r0.w;
    r2.x = 1.46291812e-009 * r2.x;
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r0.w = (uint)r0.w;
    r0.w = 8.1273259e-011 * r0.w;
    ...
    r0.yzw = r4.yzx * r2.xyz;
    r5.xyz = r2.zxy * r4.zxy + -r0.yzw;
    r0.y = dot(-r2.yzx, -r4.xyz);
    r5.w = -r0.y;
    r2.xyz = r4.www * -r2.yzx;
    r2.w = 0;
