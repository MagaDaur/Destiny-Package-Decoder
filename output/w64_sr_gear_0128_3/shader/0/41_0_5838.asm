...
mad r7.w, r9.x, cb0[16].x, cb0[16].y
mul_sat r8.yzw, r7.wwww, cb0[15].xxyz
max r8.yzw, r5.xxyz, r8.yyzw
...
mad_sat r11.xyz, r11.xyzx, r12.xyzx, r5.xyzx
...
mad_sat r2.yzw, r2.yyzw, r12.xxyz, r5.xxyz
...
add r2.xyz, -r8.yzwy, r2.yzwy
mad r2.xyz, r5.wwww, r2.xyzx, r8.yzwy
