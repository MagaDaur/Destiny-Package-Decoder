...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r1.xyz = r4.yzx * r0.xyz;
  r1.xyz = r4.xyz * r0.yzx + -r1.xyz;
  r1.xyz = r4.www * r0.zxy + r1.xyz;
  r0.xyz = -r2.zxy * r1.zxy + r0.xyz;
  r0.xyz = r2.yzx * r1.xyz + r0.xyz;
  r1.x = dot(v2.xyz, v2.xyz);
  r1.x = rsqrt(r1.x);
  r1.xyz = v2.xyz * r1.xxx;
  r3.xyz = r4.yzx * r1.xyz;
  r3.xyz = r4.xyz * r1.yzx + -r3.xyz;
  r3.xyz = r4.www * r1.zxy + r3.xyz;
  r1.xyz = -r2.zxy * r3.zxy + r1.xyz;
  r1.xyz = r2.yzx * r3.xyz + r1.xyz;
  r2.xyz = r1.yzx * r0.zxy;
  r2.xyz = r0.yzx * r1.zxy + -r2.xyz;
  o2.xyz = v2.www * r2.xyz;
  r2.xy = v3.xy * cb1[6].xy + cb1[6].zw;
  r1.w = saturate(cb1[7].z * r0.z);
  o0.w = saturate(cb1[7].w + r1.w);
  r1.w = min(asuint(cb1[4].w), (uint)v4.x);
  o5.xyzw = t0.Load(r1.w).xyzw;
  ...
  r3.xyzw = t1.Load(r2.z).xyzw;
  r2.zw = (uint2)r3.yw << int2(8,8);
  r2.zw = (int2)r2.zw | (int2)r3.xz;
