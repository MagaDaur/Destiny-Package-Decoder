...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.yzw = saturate(r5.wzw);
    r8.xw = r0.yz * float2(0.450000018,-0.400000006) + float2(0.100000001,0.5);
    r9.xyzw = saturate(r2.yxwz);
    r9.xyzw = r9.zxyw * float4(0.649999976,0.649999976,0.25,0.899999976) + float4(0.100000001,0.100000001,0.75,0.100000001);
    r0.y = saturate(r4.x);
    r0.z = r0.y * 2 + -1;
    r0.z = r0.w * 0.400000006 + r0.z;
    r10.w = -0.200000003 + r0.z;
