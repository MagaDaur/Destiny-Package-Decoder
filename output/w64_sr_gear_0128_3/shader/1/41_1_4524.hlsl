...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r0.w = rsqrt(r0.w);
  r2.yzw = cb0[0].xyz * r0.www;
  r3.xyz = r2.yzw * r0.xxx;
  ...
  r0.x = 3.14100003 * r0.x;
  sincos(r0.x, r0.x, r2.x);
  r0.xyw = r0.xxx * r2.yzw;
  r2.yzw = -cb0[6].xyz + r3.xyz;
  r5.xyz = r2.wyz * -r0.ywx;
  r5.xyz = r2.zwy * -r0.wxy + -r5.xyz;
  r1.w = dot(r2.yzw, -r0.xyw);
  r5.w = -r1.w;
  r6.xyz = r2.xxx * r2.yzw;
  r6.w = 0;
  r5.xyzw = r6.xyzw + r5.xyzw;
  r2.yzw = r5.yzx * r0.wxy;
  r2.yzw = r0.ywx * r5.zxy + -r2.yzw;
  r2.xyz = r2.xxx * r5.xyz + r2.yzw;
  r0.xyw = r5.www * r0.xyw + r2.xyz;
  r0.xyw = cb0[6].xyz + r0.xyw;
  ...
  r0.z = rsqrt(r0.z);
  r3.yzw = cb0[7].xyz * r0.zzz;
  r3.xyz = r3.xxx * r3.yzw;
  r4.yzw = -cb0[10].xyz + r2.xyz;
  r5.xyz = r4.wyz * -r3.yzx;
  r5.xyz = r4.zwy * -r3.zxy + -r5.xyz;
  r0.z = dot(r4.yzw, -r3.xyz);
  r5.w = -r0.z;
