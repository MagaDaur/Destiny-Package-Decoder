  ...
  out float4 o7 : SV_POSITION0)
{
  ...
  r3.xyz = r3.xyz * v6.www + float3(-0.0199999996,0,0);
  r3.xyz = v3.xyz * r3.xyz;
  r4.xyz = r3.yyy * r0.xyz;
  r0.xyz = v11.yyy * r0.xyz;
  r0.xyz = v11.xxx * r1.xyz + r0.xyz;
  r1.xyz = r3.xxx * r1.xyz + r4.xyz;
  r1.xyz = r3.zzz * r2.xyz + r1.xyz;
  r0.xyz = v11.zzz * r2.xyz + r0.xyz;
  r0.w = v7.y * 6.28200006 + v2.w;
  r0.w = 0.5 * r0.w;
  ...
  o5.xyzw = v5.xyzw;
  o6.xyzw = v6.xyzw;
  r0.x = cmp(cb0[118].x < 9.99999997e-007);
