  ...
  out float4 o4 : SV_POSITION0)
{
  ...
  r1.w = 0;
  r2.w = 0;
  r0.y = cb0[102].x * 3.14100003;
  sincos(r0.y, r3.x, r4.x);
  r0.yzw = v4.xyz * cb1[4].xyz + cb1[5].xyz;
  r2.xyz = r4.xxx * r0.yzw;
  r3.y = dot(cb0[103].xyz, cb0[103].xyz);
  r3.y = rsqrt(r3.y);
  r3.yzw = cb0[103].xyz * r3.yyy;
  ...
  r0.xyz = v6.xyz;
  r0.w = 0;
  r1.xyz = v6.zxy * -r3.yzx;
  r1.xyz = v6.yzx * -r3.zxy + -r1.xyz;
  r2.w = dot(v6.xyz, -r3.xyz);
  r1.w = -r2.w;
