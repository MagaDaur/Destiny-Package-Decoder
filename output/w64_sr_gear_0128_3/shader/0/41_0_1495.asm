...
mad r3.xy, r5.wwww, r3.xyxx, r9.zxzz
mul r0.w, r1.w, r5.w
movc o0.w, r0.z, r0.y, r7.z
add r0.y, cb0[19].x, -cb0[21].x
lt r0.y, |r0.y|, l(0.000010)
add r0.z, -cb0[4].x, cb0[19].x
lt r0.z, |r0.z|, l(0.000010)
and r0.yz, r0.yyzy, l(0, 0x3f800000, 0x3f800000, 0)
add r1.w, cb0[19].x, -cb0[20].x
lt r1.w, |r1.w|, l(0.000010)
and r1.w, r1.w, l(0x3f800000)
add r4.xyz, cb0[17].xyzx, -cb0[18].xyzx
mad r4.xyz, r1.wwww, r4.xyzx, cb0[18].xyzx
add r5.xyz, -r4.xyzx, cb0[16].xyzx
...
mad r4.xyz, cb0[14].xyzx, r4.xyzx, r2.xyzx
max r0.y, r4.y, r4.x
max r0.y, r4.z, r0.y
