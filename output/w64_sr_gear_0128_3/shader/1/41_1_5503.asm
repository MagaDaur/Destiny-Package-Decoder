...
mad r2.xyz, cb0[9].xyzx, r1.wwww, r2.xyzx
add r2.w, r0.z, cb0[2].x
add r3.x, -r2.w, l(1.000000)
mad r3.x, cb0[3].w, r3.x, cb0[3].z
add r3.x, r3.x, l(0.250000)
round_ne r3.y, r3.x
add r3.x, -r3.y, r3.x
mad r3.y, |r3.x|, l(-16.000000), l(8.000000)
mul r3.x, r3.y, r3.x
mad r3.y, |r3.x|, l(0.225000), l(0.775000)
mul r3.x, r3.y, r3.x
mad r3.x, cb0[3].x, r3.x, cb0[3].y
max r3.x, r3.x, cb0[4].x
min r3.x, r3.x, cb0[5].x
mad r2.w, cb0[6].w, r2.w, cb0[6].z
add r2.w, r2.w, l(0.250000)
round_ne r3.y, r2.w
add r2.w, r2.w, -r3.y
mad r3.y, |r2.w|, l(-16.000000), l(8.000000)
mul r2.w, r2.w, r3.y
mad r3.y, |r2.w|, l(0.225000), l(0.775000)
mul r2.w, r2.w, r3.y
mad r2.w, cb0[6].x, r2.w, cb0[6].y
max r2.w, r2.w, cb0[7].x
min r2.w, r2.w, cb0[8].x
mul r2.w, r0.y, r2.w
mad r2.w, r3.x, r1.w, r2.w
mul r2.w, r0.x, r2.w
mul r3.xyz, r0.yyyy, cb0[1].xyzx
mad r3.xyz, cb0[0].xyzx, r1.wwww, r3.xyzx
