...
// unknown dcl_: dcl_input_sgv v14.x, vertex_id
  ...
  r2.xyz = cb1[1].zxy * v3.yyy;
  r2.xyz = cb1[0].zxy * v3.xxx + r2.xyz;
  r2.xyz = cb1[2].zxy * v3.zzz + r2.xyz;
  r0.z = dot(r2.xyz, r2.xyz);
  r0.z = rsqrt(r0.z);
  r2.xyz = r2.xyz * r0.zzz;
  r3.xyz = v10.zzz * r2.yzx;
  ...
  o13.xyzw = r1.xxxx ? float4(10000,10000,-10000,1) : r0.xyzw;
  return;
}