...
mad r6.xy, r6.xyxx, cb0[48].xxxx, cb0[48].yyyy
...
add r7.z, l(128.500000), cb0[34].x
...
if_nz r0.z
  ...
  ge r1.w, l(0.500000), cb0[35].x
  add r2.w, cb0[35].x, cb0[35].x
  mad r2.w, r0.z, -r2.w, r2.w
  mad r3.x, cb0[35].x, l(2.000000), l(-2.000000)
...
discard_nz r0.z
mov_sat r0.z, cb0[45].x
dp3 r1.w, v0.xyzx, v0.xyzx
rsq r1.w, r1.w
mul r4.xyz, r1.wwww, v0.xyzx
dp3 r1.w, cb0[38].xyzx, r4.xyzx
add r2.w, cb0[14].x, -cb0[37].x
mad_sat r1.w, r1.w, r2.w, cb0[37].x
add r2.w, v4.z, -cb0[39].z
mul r2.w, r2.w, cb0[40].x
max r2.w, r2.w, l(0.000000)
log r2.w, r2.w
mul r2.w, r2.w, cb0[41].x
exp r2.w, r2.w
mul_sat r2.w, r2.w, cb0[42].x
mul r1.w, r1.w, r2.w
mad_sat r0.x, r0.x, cb0[43].x, cb0[43].y
mul r0.x, r0.x, r1.w
