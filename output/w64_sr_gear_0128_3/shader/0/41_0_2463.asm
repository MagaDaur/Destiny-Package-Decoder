...
mad_sat r6.w, cb7[r0.y + 15].y, r8.y, cb7[r0.y + 15].x
mad_sat r6.w, cb7[r0.y + 15].w, r6.w, cb7[r0.y + 15].z
mad_sat r7.z, r7.y, cb0[2].x, cb0[2].y
mul_sat r7.z, r7.z, cb0[3].x
add r7.w, -r7.z, l(1.000000)
mad r8.y, r9.y, cb0[4].x, cb0[4].y
mul r10.y, r7.w, r8.y
add r7.w, l(128.500000), cb0[5].x
mul r7.w, r7.w, l(0.00390625000)
ge r8.y, l(0.050000), r10.y
movc r7.w, r8.y, r7.w, l(-1.000000)
mad_sat r7.z, r7.z, cb0[22].x, cb0[22].y
add r11.xyzw, -cb0[20].xyzw, cb0[21].xyzw
mad_sat r11.xyzw, r7.zzzz, r11.xyzw, cb0[20].xyzw
...
add r4.xyz, -r2.yzwy, r9.yzwy
mad r2.yzw, r6.wwww, r4.xxyz, r2.yyzw
add r4.xy, -r1.xyxx, r10.zwzz
mad r1.xy, r6.wwww, r4.xyxx, r1.xyxx
add r3.x, -r2.x, r3.x
mad r2.x, r6.w, r3.x, r2.x
add r3.x, r3.w, -r4.w
mad r4.y, r6.w, r3.x, r4.w
add r3.x, -r0.w, r3.y
...
add r2.xyz, -r11.xyzx, r2.yzwy
mad r2.xyz, r6.zzzz, r2.xyzx, r11.xyzx
add r1.xy, -r6.xyxx, r1.xyxx
mad r1.xy, r6.zzzz, r1.xyxx, r6.xyxx
mov r10.x, r11.w
add r3.yz, -r10.xxyx, r4.xxyx
mad r3.yz, r6.zzzz, r3.yyzy, r10.xxyx
mul r0.w, r1.w, r6.z
...
mad r4.xyz, r4.xyzx, r6.wwww, r2.xyzx
max r0.y, r4.y, r4.x
max r0.y, r4.z, r0.y
...
if_nz r0.z
  deriv_rtx_coarse r3.xw, v3.xxxy
  dp2 r0.z, r3.xwxx, r3.xwxx
  sqrt r0.z, r0.z
  deriv_rty_coarse r3.xw, v3.xxxy
  dp2 r1.w, r3.xwxx, r3.xwxx
  sqrt r1.w, r1.w
  max r0.z, r0.z, r1.w
  ...
  round_pi r2.w, r0.z
  exp r2.w, r2.w
  mul r3.xw, r1.wwww, v3.xxxy
  round_ni r3.xw, r3.xxxw
  dp2 r1.w, r3.xwxx, l(17.000000, 0.100000, 0.000000, 0.000000)
  sincos r1.w, null, r1.w
  mul r1.w, r1.w, l(10000.000000)
  mad r3.x, r3.w, l(13.000000), r3.x
  sincos r3.x, null, r3.x
  add r3.x, |r3.x|, l(0.100000)
  mul r1.w, r1.w, r3.x
  frc r1.w, r1.w
  mul r3.xw, r2.wwww, v3.xxxy
  round_ni r3.xw, r3.xxxw
  dp2 r2.w, r3.xwxx, l(17.000000, 0.100000, 0.000000, 0.000000)
  ...
  lt r3.w, r1.w, r3.w
  lt r0.z, r1.w, r0.z
  movc r0.z, r0.z, r2.w, r4.x
  movc r0.z, r3.w, r0.z, r3.x
  ge r1.w, l(0.500000), cb0[6].x
  add r2.w, cb0[6].x, cb0[6].x
  mad r2.w, r0.z, -r2.w, r2.w
  mad r3.x, cb0[6].x, l(2.000000), l(-2.000000)
  mad r0.z, r0.z, r3.x, l(1.000000)
...
dp3 r1.w, cb0[10].xyzx, r4.xyzx
add r2.w, -cb0[8].x, cb0[9].x
mad_sat r1.w, r1.w, r2.w, cb0[8].x
add r2.w, v4.z, -cb0[11].z
mul r2.w, r2.w, cb0[12].x
max r2.w, r2.w, l(0.000000)
log r2.w, r2.w
mul r2.w, r2.w, cb0[13].x
exp r2.w, r2.w
mul_sat r2.w, r2.w, cb0[14].x
mul r1.w, r1.w, r2.w
