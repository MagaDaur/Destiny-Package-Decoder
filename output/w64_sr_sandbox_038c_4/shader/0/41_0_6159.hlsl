  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.y = max(0, r0.y);
  r0.z = cb0[8].z + v0.y;
  r0.z = saturate(cb0[8].y * abs(r0.z) + cb0[8].x);
  r0.z = r0.y * r0.z;
  r1.xyz = r0.yyy * float3(0.875227988,0.0858929977,0.0858929977) + cb0[97].xyz;
