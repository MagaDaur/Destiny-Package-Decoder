  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.xyzw = cb0[14].xyzw * cb0[12].xxxx;
  r0.yz = cmp(float2(1,0) < v3.yx);
  r1.xyzw = r0.zzzz ? r1.xyzw : r3.xyzw;
  r3.xyzw = cb0[15].xyzw * cb0[12].xxxx;
  r3.xyzw = r0.zzzz ? r3.xyzw : 0;
  r1.xyzw = r0.yyyy ? r3.xyzw : r1.xyzw;
  r3.xyzw = cb0[11].xyzw * cb0[9].xyzw;
  r3.xyzw = cb0[9].xyzw * cb0[10].xyzw + r3.xyzw;
  r1.xyzw = r3.xyzw + r1.xyzw;
  r0.x = r1.w * r0.x;
  r0.yzw = cb0[16].xxx * r1.xyz;
