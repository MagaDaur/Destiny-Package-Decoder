...
// unknown dcl_: dcl_input_sgv v7.x, vertex_id
  ...
  r0.yzw = r0.yzw * float3(0.600000024,0.600000024,0.600000024) + r1.xyz;
  ...
  r0.xyz = r2.xyz * float3(0.600000024,0.600000024,0.600000024) + r0.yzw;
