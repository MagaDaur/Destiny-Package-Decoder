  ...
  out float4 o7 : SV_POSITION0)
{
  ...
  r3.w = 0;
  r1.w = cb0[117].x * 3.14100003;
  sincos(r1.w, r4.x, r5.x);
  r4.yzw = v7.xyz * cb1[4].xyz + cb1[5].xyz;
  r3.xyz = r5.xxx * r4.yzw;
  r1.w = dot(cb0[118].xyz, cb0[118].xyz);
  r1.w = rsqrt(r1.w);
  r5.yzw = cb0[118].xyz * r1.www;
  ...
  r7.xyz = v9.xyz;
  r7.w = 0;
  r6.yzw = v9.zxy * -r5.zwy;
  r8.xyz = v9.yzx * -r5.wyz + -r6.yzw;
  r1.w = dot(v9.xyz, -r5.yzw);
  r8.w = -r1.w;
