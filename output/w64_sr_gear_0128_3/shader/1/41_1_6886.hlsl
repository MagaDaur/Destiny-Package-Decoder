...
// unknown dcl_: dcl_input_sgv v10.x, vertex_id
  ...
  o0.xy = x1[r0.x+0].xy;
  r0.xy = x0[r0.x+0].xy;
  r0.xy = float2(0.25,0.25) * r0.yx;
  r0.z = v9.x * 6.28200006 + v5.z;
  ...
  o0.w = r1.w;
  r0.x = 0.280000001 * v5.w;
  r0.x = frac(r0.x);
  r0.y = cb0[100].x * r0.x;
  r0.x = cb0[106].x + -r0.x;
  r0.x = 1 + r0.x;
  r0.x = saturate(3.33333302 * r0.x);
  r0.y = -r0.y * cb0[110].x + cb0[110].y;
  r0.y = saturate(r0.w * cb0[110].x + r0.y);
  r0.x = r0.y * r0.x;
  r0.x = cb0[9].y * r0.x;
  r0.x = cb0[133].x * r0.x;
