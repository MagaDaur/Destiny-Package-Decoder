  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = r1.w * cb0[6].x + -r1.w;
  r0.z = saturate(r0.y * cb0[3].x + cb0[3].y);
  r0.y = 0.015625 * r0.y;
  r0.y = min(1, r0.y);
  r2.z = sqrt(r0.y);
  ...
  r0.x = r3.w * r0.x + r3.w;
  r0.y = cb13[1].x * cb0[5].x;
  r0.x = r0.y * r0.x;
  r0.y = -r0.y * r1.w + r0.y;
  r0.yzw = r3.xyz * r0.yyy;
  r0.xyz = cb0[4].xyz * r0.xxx + r0.yzw;
