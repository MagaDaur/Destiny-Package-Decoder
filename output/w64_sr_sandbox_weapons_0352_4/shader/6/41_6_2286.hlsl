...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.z = r0.z * -0.5 + 1;
    r0.w = saturate(r6.x);
    r0.w = r0.w * 0.900000036 + 0.300000012;
    r7.x = saturate(r4.x);
    r7.y = 1 + -r7.x;
    ...
    r7.y = saturate(r5.z);
    r7.z = r7.y * 5.26315784 + -2.35087705;
    r8.xyz = cmp(r7.yyy >= float3(0.446666986,0.636667013,1));
    r8.xyw = r8.xyz ? float3(1,1,1) : 0;
    r7.yw = r8.xy + r8.yw;
    r7.yw = float2(9.99999997e-007,9.99999997e-007) + r7.yw;
    r7.yw = float2(0.5,0.5) * r7.yw;
    r8.yz = frac(r7.yw);
    r8.x = r8.y * r7.z;
    r7.yz = float2(2,2) * r8.xz;
    r7.y = r7.y + r7.z;
    r7.y = saturate(r8.w * 1 + r7.y);
    r7.y = r7.y * 0.25 + 0.75;
    r4.x = r4.x + r0.y;
    r8.xyz = cb0[162].xyz * cb0[161].xxx;
    r8.xyz = r8.xyz * float3(0.75,0.75,0.75) + r1.xyz;
    r0.y = saturate(cb0[163].x * r7.y);
    r0.y = 1 + -r0.y;
    r7.yzw = r8.xyz * r0.yyy;
    r8.xyz = r7.yzw * cb0[149].xxx + r3.xyz;
    r0.y = cb0[163].x * r4.y;
