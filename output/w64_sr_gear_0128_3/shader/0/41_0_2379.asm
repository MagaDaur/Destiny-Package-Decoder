...
mad_sat r8.z, r7.y, cb0[2].x, cb0[2].y
mul_sat r8.z, r8.z, cb0[3].x
add r8.w, -r8.z, l(1.000000)
mul_sat r7.w, r7.w, l(7.968750)
mad r9.x, r7.w, cb0[4].x, cb0[4].y
mul r9.y, r8.w, r9.x
mad_sat r8.w, cb0[5].y, r7.y, cb0[5].x
...
mad_sat r7.w, r8.z, cb0[21].x, cb0[21].y
add r0.y, r0.y, r7.w
min r0.y, r0.y, l(1.000000)
add r10.xyzw, -cb0[19].xyzw, cb0[20].xyzw
mad_sat r10.xyzw, r0.yyyy, r10.xyzw, cb0[19].xyzw
...
rsq r2.w, r2.w
mul r1.xyz, r1.xyzx, r2.wwww
mov_sat r2.w, cb0[16].x
dp3 r3.w, r3.xyzx, r3.xyzx
rsq r3.w, r3.w
mul r3.xyz, r3.wwww, r3.xyzx
dp3 r3.x, cb0[9].xyzx, r3.xyzx
add r3.y, -cb0[7].x, cb0[8].x
mad_sat r3.x, r3.x, r3.y, cb0[7].x
add r3.y, v4.z, -cb0[10].z
mul r3.y, r3.y, cb0[11].x
max r3.y, r3.y, l(0.000000)
log r3.y, r3.y
mul r3.y, r3.y, cb0[12].x
exp r3.y, r3.y
mul_sat r3.y, r3.y, cb0[13].x
mul r3.x, r3.y, r3.x
...
log r3.x, r3.x
mul r3.x, r3.x, -cb0[15].x
exp r3.x, r3.x
mul r0.x, r0.x, r3.x
add o2.w, r2.w, v0.w
mad r0.x, r0.x, cb0[17].x, r0.z
