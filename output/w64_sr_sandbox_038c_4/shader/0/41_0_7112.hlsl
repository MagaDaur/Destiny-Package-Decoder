  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = -r0.x * r0.x + 1;
  r0.x = max(0, r0.x);
  r0.y = saturate(cb0[119].x * r0.x);
  r0.xzw = r0.xxx * float3(0.849502981,0.162028998,0.372967005) + cb0[97].xyz;
  ...
  r0.xzw = float3(0.349999994,0.349999994,0.349999994) * r0.xzw;
