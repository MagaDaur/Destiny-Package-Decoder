...
// unknown dcl_: dcl_input_sgv v6.x, vertex_id
  ...
  r0.yzw = r0.yyy * float3(0,-0.25,0) + r1.xyz;
  r0.xyz = r0.xxx * float3(0.25,0,0) + r0.yzw;
  ...
  o0.w = r2.w;
  r0.w = 0.280000001 * v3.x;
  r0.w = frac(r0.w);
  r1.w = cb0[97].x * r0.w;
  r0.w = cb0[103].x + -r0.w;
  r0.w = 1 + r0.w;
  r0.w = saturate(3.33333302 * r0.w);
  r1.w = -r1.w * 999.999939 + -1499.99988;
  r3.xyzw = cb12[7].zxyz + -r1.zxyz;
  r1.xyz = r0.xyz + -r1.xyz;
  o2.xyz = cb12[7].xyz + -r0.xyz;
  r0.x = dot(r3.yzw, r3.yzw);
  r0.x = sqrt(r0.x);
  r0.y = r0.x * 999.999939 + r1.w;
  r0.x = 10000 + -r0.x;
  ...
  r0.y = (int)r0.y;
  r0.yzw = float3(0,0,1) * r0.yyy;
  r1.w = dot(r1.xyz, r1.xyz);
  r1.w = rsqrt(r1.w);
  r1.xyz = r1.xyz * r1.www + -r0.zzw;
  o1.xyz = r1.xyz * float3(0.850000024,0.850000024,0.850000024) + r0.yzw;
  o3.x = v0.w;
  o3.yw = v3.yz;
  o3.z = 0;
  o4.x = v3.w;
