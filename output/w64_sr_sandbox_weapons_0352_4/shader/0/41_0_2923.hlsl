  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.xy = t1.Sample(s5_s, v0.xy).xy;
  r3.xy = r3.xy * v7.yy + v0.xy;
  r3.xy = v7.yy * float2(-0.5,-0.5) + r3.xy;
  ...
  r3.x = cb0[126].x * v6.y;
  r3.x = floor(r3.x);
  r3.xy = cb0[123].xy * r3.xx;
  r3.xy = v0.xy * cb0[122].xy + r3.xy;
  r3.x = t2.Sample(s5_s, r3.xy).x;
  r2.w = r3.x * r2.w;
  r3.x = 0.300000012 * v8.x;
  ...
  r4.xyz = v8.zzz * r3.yzw;
  r4.x = dot(r4.xyz, float3(0.300000012,0.589999974,0.109999999));
  r3.yzw = r3.yzw * v8.zzz + -r4.xxx;
  r3.yzw = v7.www * r3.yzw + r4.xxx;
  r2.w = saturate(v8.y * r2.w);
