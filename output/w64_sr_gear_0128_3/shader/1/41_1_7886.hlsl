...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r5.xyz = v2.zxy * -r2.yzx;
  r5.xyz = v2.yzx * -r2.zxy + -r5.xyz;
  ...
  r3.xyz = r3.yzw + -r1.xyz;
  r5.x = cb0[5].x + r3.x;
  r5.y = cb0[6].x + r3.y;
  r5.z = cb0[7].x + r3.z;
  r3.xyz = -cb0[0].xyz + r5.xyz;
  r3.xyz = cb0[9].xxx * r3.xyz + cb0[0].xyz;
  ...
  r1.xyw = cb0[9].xxx * r4.xyz + v1.xyz;
  ...
  r1.xyw = cb0[9].xxx * r2.xyz + v2.xyz;
