...
// unknown dcl_: dcl_input_sgv v12.x, vertex_id
  ...
  r2.xyz = cb1[1].zxy * v4.yyy;
  r2.xyz = cb1[0].zxy * v4.xxx + r2.xyz;
  r2.xyz = cb1[2].zxy * v4.zzz + r2.xyz;
  r0.z = dot(r2.xyz, r2.xyz);
  r0.z = rsqrt(r0.z);
  r2.xyz = r2.xyz * r0.zzz;
  r3.xyz = v10.yyy * r2.yzx;
  ...
  r1.y = cb0[114].x * 0.0174532942;
  r1.y = cos(r1.y);
  r1.x = abs(r1.x) + -r1.y;
  r1.z = cb0[115].x + cb0[114].x;
  ...
  o10.xy = v9.zw;
  o10.zw = v10.xy;
  r1.y = cmp(cb0[128].x < 9.99999997e-007);
