...
mul r2.x, r2.y, r2.x
mad r2.x, cb0[2].x, r2.x, cb0[2].y
mul r2.x, r2.x, cb0[0].x
mul r2.z, r0.x, r2.x
add r3.xy, -r0.xyxx, l(1.000000, 1.000000, 0.000000, 0.000000)
add r1.x, r1.x, cb13[0].x
mad r2.w, cb0[7].x, r1.x, cb0[6].x
mul r3.z, r2.w, l(0.159154937)
round_ne r3.z, r3.z
mad r2.w, r2.w, l(0.159154937), -r3.z
mad r3.z, |r2.w|, l(-16.000000), l(8.000000)
mul r2.w, r2.w, r3.z
mad r3.z, |r2.w|, l(0.225000), l(0.775000)
mul r2.w, r2.w, r3.z
mad r4.y, cb0[4].x, r2.w, cb0[5].x
mov r4.xz, l(0,0,0,0)
mad r3.xzw, r3.xxxx, -r4.zzyz, r4.xxyz
mad r1.x, cb0[11].x, r1.x, cb0[10].x
mul r2.w, r1.x, l(0.159154937)
round_ne r2.w, r2.w
mad r1.x, r1.x, l(0.159154937), -r2.w
mad r2.w, |r1.x|, l(-16.000000), l(8.000000)
mul r1.x, r1.x, r2.w
mad r2.w, |r1.x|, l(0.225000), l(0.775000)
mul r1.x, r1.x, r2.w
mad r4.y, cb0[8].x, r1.x, cb0[9].x
mov r4.xz, l(0,0,0,0)
mad r4.xyz, r3.yyyy, -r4.zyzz, r4.xyzx
add r3.xyz, r3.xzwx, r4.xyzx
mov r2.xy, l(0,0,0,0)
add r2.xyz, r2.xyzx, r3.xyzx
mad r2.xyz, cb0[12].xxxx, -r2.xyzx, r2.xyzx
