...
dp3 r1.x, r4.xyzx, r0.xywx
dp3 r1.y, r5.xyzx, r0.xywx
dp3 r1.z, r6.xyzx, r0.xywx
dp3 r0.x, v2.xyzx, v2.xyzx
rsq r0.x, r0.x
mul r0.xyw, r0.xxxx, v2.xyxz
dp3 r2.x, r4.xyzx, r0.xywx
dp3 r2.y, r5.xyzx, r0.xywx
dp3 r2.z, r6.xyzx, r0.xywx
mul r0.xyw, r1.zxzy, r2.yzyx
mad r0.xyw, r1.yzyx, r2.zxzy, -r0.xyxw
mul o2.xyz, r0.xywx, v2.wwww
mad r0.xy, v3.xyxx, cb1[6].xyxx, cb1[6].zwzz
mul_sat r0.w, r1.z, cb1[7].z
add_sat o0.w, r0.w, cb1[7].w
umin r0.w, v4.x, cb1[4].w
ld_indexable(buffer)(float,float,float,float) o5.xyzw, r0.wwww, t0.xyzw
