  ...
  out float4 o6 : SV_POSITION0)
{
  ...
  r1.w = 0;
  r0.yzw = v8.xyz * cb1[4].xyz + cb1[5].xyz;
  r0.yzw = v5.xxx * r0.yzw;
  r0.yzw = float3(1,1,0.600000024) * r0.yzw;
  r2.x = v5.w * 6.28200006 + v2.w;
  r2.x = 0.5 * r2.x;
  ...
  r0.yzw = v10.zxy * -r2.yzx;
  r4.xyz = v10.yzx * -r2.zxy + -r0.yzw;
  r5.xyz = v10.xyz;
  r5.w = 0;
