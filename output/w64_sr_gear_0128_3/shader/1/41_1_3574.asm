...
add r1.w, l(1.000000), -cb0[7].x
add r0.xy, -r0.yxyy, l(1.000000, 1.000000, 0.000000, 0.000000)
mad r0.x, -r0.x, cb0[8].x, l(1.000000)
add r2.w, -r1.w, l(1.000000)
mad r0.y, -r0.y, cb0[10].x, l(1.000000)
mul r0.y, r0.y, r2.w
...
mad r4.xyz, r1.yzxy, -r0.zxyz, -r2.yzwy
