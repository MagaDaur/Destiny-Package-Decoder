...
mul r2.x, cb0[0].x, cb0[3].x
mul r3.x, cb0[11].x, cb0[13].x
mul r3.y, r2.x, cb0[13].x
mul r3.z, cb0[12].x, cb0[13].x
mul r1.w, cb0[5].x, cb0[6].x
add r2.w, l(1.000000), -cb0[7].x
add r4.xy, -r0.yxyy, l(1.000000, 1.000000, 0.000000, 0.000000)
mad r3.w, -r4.x, cb0[8].x, l(1.000000)
add r4.x, -r2.w, l(1.000000)
mad r4.y, -r4.y, cb0[10].x, l(1.000000)
mul r4.x, r4.y, r4.x
mad r2.w, r2.w, r3.w, r4.x
mad r1.w, r1.w, r0.z, r2.w
add r2.w, l(1.000000), -cb0[1].x
add r3.w, l(1.000000), -cb0[2].x
mul r4.x, r0.z, cb0[0].x
mul r4.y, r0.z, r2.w
mul r4.z, r0.z, r3.w
mul r2.z, cb0[3].x, cb0[4].x
mov r2.y, cb0[3].x
