  ...
  out float4 o3 : SV_TARGET3)
{
  ...
  r3.xy = r3.xy * v7.ww + v0.xy;
  r3.xy = v7.ww * float2(-0.5,-0.5) + r3.xy;
  r2.w = cb0[128].x * v8.y;
  r2.w = floor(r2.w);
  r3.zw = cb0[125].xy * r2.ww;
  r3.xy = r3.xy * cb0[124].xy + r3.zw;
  ...
  r3.x = r3.x + -r3.y;
  r3.x = r3.z * r3.x + r3.y;
  r3.zw = v0.xy * v5.xy + v5.zw;
  r3.zw = t0.Sample(s1_s, r3.zw).xy;
  r3.zw = float2(-0.5,-0.5) + r3.zw;
  r3.zw = r3.zw * v9.xx + v0.xy;
  r3.zw = r3.zw * v4.xy + v4.zw;
  r4.xyz = t1.Sample(s1_s, r3.zw).xyz;
  r4.xyz = saturate(r4.xyz * v6.zzz + v6.www);
  ...
  r4.xyz = float3(0.133634999,0.224710003,0.172031) * r4.xyz;
  r3.z = 1 / cb0[141].x;
  r2.w = r3.z * r2.w;
  r2.w = exp2(r2.w);
  r2.w = saturate(r2.w * v10.z + v10.y);
