  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r2.x = cb0[5].z + v3.y;
  r2.x = saturate(cb0[5].y * abs(r2.x) + cb0[5].x);
  r2.x = saturate(cb0[6].y * r2.x + cb0[6].x);
  r2.yzw = cb0[15].xxx * cb0[4].xyz;
  ...
  r4.xyzw = t16.SampleLevel(s4_s, r3.yzw, 0).xyzw;
  r6.xyzw = t17.SampleLevel(s4_s, r3.yzw, 0).xyzw;
  r7.xyzw = t18.SampleLevel(s4_s, r3.yzw, 0).xyzw;
  r0.w = cb3[15].x * r0.w;
  r0.w = saturate(r0.w * 1.5 + cb3[15].y);
  r5.w = cmp(r0.w < 1);
  if (r5.w != 0) {
    r8.xyzw = t16.SampleLevel(s4_s, r5.xyz, 0).xyzw;
    r9.xyzw = t17.SampleLevel(s4_s, r5.xyz, 0).xyzw;
  ...
  r1.w = t19.SampleLevel(s3_s, r3.yzw, 0).x;
  r1.w = -1 + r1.w;
  r0.w = r0.w * r1.w + 1;
  r1.x = saturate(dot(cb0[9].xyz, r1.xyz));
  r1.yzw = cb0[8].xyz * r3.xxx;
