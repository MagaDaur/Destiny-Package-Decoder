  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = r0.xy * float2(0.0500000007,0.0500000007) + v0.xy;
  r1.y = -0.00625000009;
  r1.z = -0.0500000007 * v4.y;
  r0.xy = r1.yz + r0.xy;
  ...
  r0.x = exp2(r0.x);
  r0.y = saturate(r0.x * v6.z + v6.y);
  r0.x = r0.x * -0.269199997 + 0.269199997;
  r0.x = r0.x * v6.x + v0.w;
