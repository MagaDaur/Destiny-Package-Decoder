  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r3.xy = r3.xy * cb0[49].xx + cb0[49].yy;
  ...
  r0.w = rsqrt(r0.w);
  r2.xyz = r2.xyz * r0.www;
  r0.w = saturate(cb0[46].x);
  r1.w = dot(v0.xyz, v0.xyz);
  r1.w = rsqrt(r1.w);
  r4.yzw = v0.xyz * r1.www;
  r1.w = dot(cb0[39].xyz, r4.yzw);
  r2.w = -cb0[38].x + cb0[17].x;
  ...
  r2.w = cb0[42].x * r2.w;
  r2.w = exp2(r2.w);
  r2.w = saturate(cb0[43].x * r2.w);
  r1.w = r2.w * r1.w;
  r0.x = saturate(r0.x * cb0[44].x + cb0[44].y);
  r0.x = r1.w * r0.x;
