  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.yz = v3.xy * cb0[30].xy + cb0[30].zw;
  ...
  r6.xy = r6.xy * cb0[31].xx + cb0[31].yy;
  ...
  r0.x = cb0[17].y * r0.x + cb0[17].x;
  r0.y = saturate(r8.z * cb0[18].x + cb0[18].y);
  r0.x = r0.x * r0.y;
  r0.y = dot(cb0[19].xy, v3.xy);
  r5.x = cb0[19].z + r0.y;
  r0.y = dot(cb0[20].xy, v3.xy);
  r5.y = cb0[20].z + r0.y;
  r0.yz = r5.xy * cb0[21].xy + cb0[21].zw;
  r0.y = t10.Sample(s2_s, r0.yz).x;
  r0.y = r0.y * cb0[22].x + cb0[22].y;
  r0.x = r0.x * r0.y;
  r0.y = 1 + -r8.z;
  r0.y = v5.x * cb0[23].x + r0.y;
  r0.z = cb0[23].x + 1;
  r1.w = cmp(r0.z >= 0);
  r1.w = r1.w ? 4.99999987e-005 : -4.99999987e-005;
  r0.z = r1.w + r0.z;
  r0.z = 1 / r0.z;
  r1.w = r0.y * r0.z + -cb0[24].x;
  r5.xy = cb0[25].zw * r1.ww + cb0[25].xy;
  r1.w = saturate(min(r5.x, r5.y));
  r0.y = r0.y * r0.z + -cb0[26].x;
  r0.yz = cb0[27].zw * r0.yy + cb0[27].xy;
