...
// unknown dcl_: dcl_input_sgv v9.x, vertex_id
  ...
  r8.xyz = r7.zxy * -r0.ywx;
  r8.xyz = r7.yzx * -r0.wxy + -r8.xyz;
  r2.x = dot(r7.xyz, -r0.xyw);
  r8.w = -r2.x;
  r7.xyz = r3.xxx * r7.xyz;
  r7.w = 0;
  r7.xyzw = r8.xyzw + r7.xyzw;
  r8.xyz = r7.yzx * r0.wxy;
  r8.xyz = r0.ywx * r7.zxy + -r8.xyz;
  r3.xyz = r3.xxx * r7.xyz + r8.xyz;
  r0.xyw = r7.www * r0.xyw + r3.xyz;
  r3.xyz = float3(0.0125000002,0.0125000002,0.0125000002) * r0.xyw;
  r0.xyw = r0.xyw * float3(0.0125000002,0.0125000002,0.0125000002) + r6.xyz;
  r2.x = dot(r3.xyz, r3.xyz);
  r2.x = rsqrt(r2.x);
  o1.xyz = r3.xyz * r2.xxx;
  o0.y = r0.z ? cb0[113].x : cb0[114].x;
