  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = 1 / r0.w;
  r0.w = -v0.w + r0.w;
  r1.x = 0.300000012 * v8.y;
  r0.w = saturate(r0.w / r1.x);
  r0.w = 1 + -r0.w;
  r0.w = 1 + -r0.w;
  r1.xy = v0.xy * v3.xy + v3.zw;
  r1.xy = t2.Sample(s3_s, r1.xy).xy;
  r1.xy = r1.xy * v7.yy + v0.xy;
  r1.xy = v7.yy * float2(-0.5,-0.5) + r1.xy;
  r1.z = cb0[115].x * v7.w;
  r1.z = floor(r1.z);
  r1.zw = cb0[112].xy * r1.zz;
  r1.xy = r1.xy * cb0[111].xy + r1.zw;
