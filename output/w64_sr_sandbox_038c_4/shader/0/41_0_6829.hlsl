  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = 1.977777 * r0.x;
  r0.x = min(1, r0.x);
  r0.xyz = r0.xxx * float3(0.800000012,0.800000012,0.800000012) + cb0[97].xyz;
  r0.w = dot(float2(-14.270401,4.62240124), v0.xy);
  r0.w = 5.32399988 + r0.w;
  r0.w = frac(r0.w);
  r0.w = -0.5 + r0.w;
  r0.w = abs(r0.w) * -1.5 + 1.25;
  r0.w = min(1, r0.w);
  r1.xyz = r0.www * float3(-0.975000024,-0.975000024,-0.975000024) + cb0[105].xyz;
  r2.xyz = cb0[100].xyz + -cb0[99].xyz;
  r2.xyz = v4.www * r2.xyz + cb0[99].xyz;
  ...
  r0.w = sqrt(r0.w);
  r1.x = 0.015625 * r0.w;
  r0.w = saturate(r0.w * cb0[138].x + cb0[138].y);
  r1.x = min(1, r1.x);
  r1.z = sqrt(r1.x);
  ...
  r0.xyz = r0.xyz * float3(6,6,6) + r2.xyz;
