...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r2.xzw = r2.xxx * float3(5.29161194e-011,-4.12745171e-010,2.01212241e-011) + float3(0.545454979,1,-1.08642006);
    r3.z = r1.w * r1.w;
    r2.x = saturate(r2.x * r3.z + r2.z);
    r2.x = r2.x * 13.1999998 + 6.80000019;
    r2.z = r2.w * r3.z + 1;
    r2.z = max(0, r2.z);
    r3.y = 2.32830644e-010 * r2.y;
    r2.y = r2.y * 4.65661287e-010 + -3;
    r2.w = r3.y * r3.y;
    r2.y = r2.y * r2.w + 1;
    r2.y = max(0, r2.y);
    r1.z = r2.y * 0.0899999961 + 0.119999997;
    r0.w = mad((int)r0.w, 0x17385ca9, 0x47502932);
    r2.y = (uint)r0.w;
    r2.yz = float2(1.46291812e-009,0.122171) * r2.yz;
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r0.w = (uint)r0.w;
    r0.w = r0.w * r2.z;
  ...
  // No code for instruction (needs manual fix):
    ...
    r3.w = 0;
  // No code for instruction (needs manual fix):
    store_uav_typed u0.xyzw, r0.wwww, r3.xyww
  }
  return;
}