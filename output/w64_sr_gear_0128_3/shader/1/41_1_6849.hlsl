...
// unknown dcl_: dcl_input_sgv v8.x, vertex_id
  ...
  r0.xyz = r0.yzw * float3(-0.300000012,-0.300000012,-0.300000012) + r2.xyz;
  r2.xyz = cb12[7].xyz + -r2.xyz;
  r0.w = dot(r2.xyz, cb1[2].xyz);
  ...
  o0.w = r1.w;
  r0.x = cb0[106].x * cb0[9].y;
  r0.y = cmp(0.999000013 < v2.w);
  r0.x = r0.y ? 0 : r0.x;
  o0.z = r0.x;
  r0.y = cmp(0 < r0.w);
  r0.xz = cmp(r0.xw < float2(9.99999997e-007,0));
  r0.y = (int)-r0.y + (int)r0.z;
  r0.y = (int)r0.y;
  o1.xyz = cb1[2].xyz * r0.yyy;
  o3.xyzw = v0.xyzw;
  o4.xyzw = v1.xyzw;
  o5.xyz = v5.xyz;
  o5.w = 0;
