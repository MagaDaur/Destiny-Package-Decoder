...
add r4.x, r2.w, cb0[21].z
dp2 r2.w, cb0[22].xyxx, v3.xyxx
add r4.y, r2.w, cb0[22].z
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r4.xyxx, t5.xyzw, s4
mad r4.xy, r4.xyxx, cb0[23].xxxx, cb0[23].yyyy
dp2 r2.w, r4.xyxx, r4.xyxx
add r2.w, -r2.w, l(1.000000)
max r2.w, r2.w, l(0.000000)
sqrt r2.w, r2.w
add_sat r3.w, r4.z, cb0[23].z
mul r4.yzw, r4.yyyy, v2.xxyz
mad r4.xyz, v1.xyzx, r4.xxxx, r4.yzwy
mad r4.xyz, v0.xyzx, r2.wwww, r4.xyzx
dp3 r2.w, r4.xyzx, r4.xyzx
rsq r2.w, r2.w
mul r5.xyz, r2.wwww, r4.xyzx
dp3 r4.w, r2.xyzx, v0.xyzx
mad r6.xy, v3.xyxx, cb0[10].xyxx, cb0[10].zwzz
sample_indexable(texture2d)(float,float,float,float) r6.x, r6.xyxx, t4.xyzw, s4
mad r6.yz, v3.xxyx, cb0[11].xxyx, cb0[11].zzwz
sample_indexable(texture2d)(float,float,float,float) r6.y, r6.yzyy, t4.yxzw, s4
mad r6.x, r6.y, cb0[12].x, r6.x
mov_sat r6.y, r6.x
mad r6.yzw, cb0[15].xxyz, r6.yyyy, cb0[14].xxyz
mul r4.w, r4.w, r4.w
mad_sat r4.w, r4.w, cb0[17].x, cb0[17].y
add r7.xy, v3.xyxx, -cb0[18].xyxx
dp2 r7.x, r7.xyxx, r7.xyxx
sqrt r7.x, r7.x
mad_sat r7.x, r7.x, cb0[20].x, cb0[20].y
mul r4.w, r4.w, r7.x
mul r6.yzw, r4.wwww, r6.yyzw
mul r4.w, r4.w, cb0[16].x
mad r6.x, cb0[13].y, r6.x, cb0[13].x
add_sat r6.x, r6.x, cb0[9].x
mul r6.yzw, r6.yyzw, cb0[50].xxxx
min r3.w, r3.w, r6.x
add r6.x, l(1.000000), -cb0[8].x
mul r7.xyz, r6.xxxx, r6.yzwy
mul r6.yzw, r6.yyzw, cb0[8].xxxx
mad r6.xyz, r6.xxxx, l(0.040000, 0.040000, 0.040000, 0.000000), r6.yzwy
max r6.w, l(0.000100), cb8[6].w
log r6.w, r6.w
mul r6.w, r6.w, cb0[48].x
exp r6.w, r6.w
mul r6.w, r6.w, r6.w
mul r7.w, cb8[6].w, cb8[6].w
...
max r8.x, r8.y, r8.x
max r8.x, r8.z, r8.x
max r8.x, r8.x, l(0.510000)
log r8.x, r8.x
round_ni r8.x, r8.x
add r8.z, r8.x, l(1.000000)
lt r8.w, r8.z, cb3[8].x
exp r9.x, r8.z
mul r9.yzw, r9.xxxx, cb3[6].xxyz
div r10.xyz, cb3[0].xyzx, r9.yzwy
round_ni r10.xyz, r10.xyzx
mad r9.yzw, -r10.xxyz, r9.yyzw, v4.xxyz
div r9.yzw, r9.yyzw, cb3[6].xxyz
div r9.yzw, r9.yyzw, cb3[3].xxyz
div r9.xyz, r9.yzwy, r9.xxxx
...
mul r9.xy, r8.xyxx, cb3[2].xyxx
mad r9.w, r8.z, cb3[2].z, cb3[9].x
add r8.xyz, r9.xywx, l(0.500000, 0.500000, 0.500000, 0.000000)
div r8.xyz, r8.xyzx, cb3[4].xyzx
mov r9.xy, cb8[4].zwzz
mov r9.z, l(0)
movc r8.xyz, r8.wwww, r8.xyzx, r9.xyzx
...
dp3_sat r5.w, cb0[26].xyzx, r5.xyzx
mul r8.xyz, r6.wwww, cb0[25].xyzx
...
add r5.y, -cb0[43].x, cb0[44].x
mad r5.x, r5.x, r5.y, cb0[43].x
movc r4.z, r4.z, r5.x, cb0[43].x
...
mad r2.yzw, r4.yyyy, r2.yyzw, r5.xxyz
mul r2.x, r2.x, cb8[11].w
sample_l_indexable(texturecube)(float,float,float,float) r5.xyzw, r9.xyzx, t24.xyzw, s8, r2.x
lt r2.x, cb8[15].w, l(0.500000)
mul r9.xyz, r5.xyzx, r5.xyzx
movc r5.xyz, r2.xxxx, r9.xyzx, r5.xyzx
mul r9.xyz, v4.yyyy, cb8[19].xyzx
mad r9.xyz, cb8[18].xyzx, v4.xxxx, r9.xyzx
mad r9.xyz, cb8[20].xyzx, v4.zzzz, r9.xyzx
add r9.xyz, r9.xyzx, cb8[21].xyzx
mul r2.x, r4.x, cb8[10].w
add r4.xyz, cb8[16].xyzx, cb8[17].xyzx
mul r4.xyz, r2.xxxx, r4.xyzx
mul r4.xyz, r4.xyzx, r5.xyzx
mov_sat r5.xyz, -r9.xyzx
mad_sat r5.xyz, r5.xyzx, cb8[8].xyzx, -cb8[10].xyzx
...
mul r2.x, r5.y, r2.x
mul r2.x, r5.z, r2.x
lt r5.x, l(0.000000), cb8[13].w
log r9.xyz, |r9.xyzx|
mul r9.xyz, r9.xyzx, cb8[13].wwww
exp r9.xyz, r9.xyzx
dp3 r5.y, r9.xyzx, cb8[13].xyzx
log r5.y, r5.y
...
mul r5.y, r2.x, r5.y
movc r2.x, r5.x, r5.y, r2.x
mul r2.x, r2.x, r5.w
lt r5.x, l(0.000000), cb8[15].y
mul r5.yzw, r4.xxyz, cb0[45].xxxx
...
mul r0.w, r0.w, r3.w
mad r4.xyz, r6.xyzx, r0.wwww, r2.wwww
...
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r0.xyxx, t11.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r6.xyzw, r0.xyxx, t13.xyzw, s2
add r5.xyzw, r5.xyzw, -r6.xyzw
mad r2.xyzw, r2.xxxx, r5.xyzw, r6.xyzw
div r3.x, r3.z, r1.w
add r0.w, -r0.w, r1.w
