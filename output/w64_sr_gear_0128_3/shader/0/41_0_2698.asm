...
mad r3.xy, r3.xyxx, cb0[49].xxxx, cb0[49].yyyy
...
add r4.z, l(128.500000), cb0[37].x
...
rsq r0.w, r0.w
mul r2.xyz, r0.wwww, r2.xyzx
mov_sat r0.w, cb0[46].x
dp3 r1.w, v0.xyzx, v0.xyzx
rsq r1.w, r1.w
mul r4.yzw, r1.wwww, v0.xxyz
dp3 r1.w, cb0[39].xyzx, r4.yzwy
add r2.w, cb0[17].x, -cb0[38].x
mad_sat r1.w, r1.w, r2.w, cb0[38].x
add r2.w, v4.z, -cb0[40].z
mul r2.w, r2.w, cb0[41].x
max r2.w, r2.w, l(0.000000)
log r2.w, r2.w
mul r2.w, r2.w, cb0[42].x
exp r2.w, r2.w
mul_sat r2.w, r2.w, cb0[43].x
mul r1.w, r1.w, r2.w
mad_sat r0.x, r0.x, cb0[44].x, cb0[44].y
mul r0.x, r0.x, r1.w
