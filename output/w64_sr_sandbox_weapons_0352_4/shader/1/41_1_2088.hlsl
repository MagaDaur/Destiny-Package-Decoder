...
// unknown dcl_: dcl_input_sgv v11.x, vertex_id
  ...
  o0.xy = x1[r0.x+0].xy;
  r0.xy = x0[r0.x+0].xy;
  r0.z = v7.w * 6.28200006 + v5.y;
  sincos(r0.z, r1.x, r2.x);
  r0.zw = r1.xx * r0.yx;
  r0.y = r0.y * r2.x + r0.w;
  r0.x = r0.x * r2.x + -r0.z;
  r1.xyz = cb12[4].xyz * v7.xxx;
  ...
  o0.w = r1.w;
  r0.x = 10000 + -r0.w;
  r0.y = 0.280000001 * v5.z;
  r0.y = frac(r0.y);
  r0.z = cb0[99].x * r0.y;
  r0.y = cb0[105].x + -r0.y;
  r0.y = 1 + r0.y;
  r0.y = saturate(3.33333302 * r0.y);
  r0.z = -r0.z * 0.166666999 + -1;
  r0.z = r0.w * 0.166666999 + r0.z;
