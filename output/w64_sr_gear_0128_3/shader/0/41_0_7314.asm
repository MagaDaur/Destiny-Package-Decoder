...
dp4 r0.z, cb0[7].xyzw, cb0[8].xyzw
mov r3.w, -r0.z
mov r2.w, l(1.000000)
mov r3.xyz, cb0[8].xyzx
dp4 r0.z, r2.xyzw, r3.xyzw
max r0.z, r0.z, -cb0[9].x
min r0.z, r0.z, cb0[9].x
mad r3.xyz, cb0[8].xyzx, r0.zzzz, cb0[7].xyzx
...
if_nz r2.w
  ...
  add r6.xyz, -r2.xyzx, cb0[11].xyzx
  dp3 r3.w, r5.xyzx, cb0[10].xyzx
  mad r7.xyz, r3.wwww, r5.xyzx, -cb0[10].xyzx
  dp3 r5.w, r7.xyzx, r6.xyzx
  mad r3.w, -r3.w, r3.w, cb0[13].x
  div_sat r3.w, r5.w, r3.w
  mad r6.xyz, r3.wwww, cb0[10].xyzx, r6.xyzx
  dp3 r3.w, r6.xyzx, r5.xyzx
  mad r5.xyz, r3.wwww, r5.xyzx, -r6.xyzx
  dp3 r3.w, r5.xyzx, r5.xyzx
  sqrt r3.w, r3.w
  div_sat r3.w, cb0[14].x, r3.w
  ...
  mad r3.xyz, r1.wwww, cb0[25].xyzx, cb0[19].xyzx
  ...
  mul r1.xyz, r0.yyyy, cb0[25].xyzx
  mad r1.xyz, r1.xyzx, r3.wwww, cb0[19].xyzx
  mul r2.xyz, r0.xxxx, r3.xyzx
  mul r0.xyz, r0.xxxx, r1.xyzx
  mul r1.xyz, r0.wwww, r2.xyzx
  mul r0.xyz, r0.wwww, r0.xyzx
  mul r1.xyz, r1.xyzx, cb0[28].xxxx
  mul r0.xyz, r0.xyzx, cb0[28].yyyy
else
