...
// unknown dcl_: dcl_thread_group 8, 8, 1
  ...
  if (r1.x != 0) {
    ...
    if (r2.y != 0) {
      ...
      r2.y = sqrt(r2.y);
      r2.z = r2.y + r2.x;
      r2.w = saturate(cb0[17].y / r2.x);
      r3.x = r2.y + -r2.z;
      r2.z = r2.w * r3.x + r2.z;
      r2.y = r0.w ? r2.y : r2.z;
      r2.y = saturate(r2.y * cb0[16].x + cb0[16].y);
      r2.y = r2.y * r2.y;
      r1.w = cmp(r1.w < 0);
      r1.w = r1.w ? 0 : r2.y;
      r2.y = -cb0[12].x * 0.5 + 0.5;
      r3.xyz = r1.xyz;
      r2.z = r1.w;
      r2.w = 0;
      while (true) {
        r3.w = cmp((int)r2.w >= 6);
        if (r3.w != 0) break;
        r4.xyz = icb[r2.w+0].xyz * r2.xxx;
        r4.xyz = r0.www ? r4.xyz : float3(0,0,0);
        r3.xyz = r4.xyz + r3.xyz;
        r3.w = cmp(9.99999975e-005 < r2.z);
        if (r3.w != 0) {
          r4.xyz = cb0[7].xyz + -r3.xyz;
          ...
          r4.w = saturate(dot(icb[r2.w+0].xyz, r4.xyz));
          r6.xyz = -r3.xyz * r3.www + r4.xyz;
          r3.w = dot(r6.xyz, r6.xyz);
          r3.w = rsqrt(r3.w);
          r6.xyz = r6.xyz * r3.www;
          r3.w = dot(icb[r2.w+0].xyz, -r5.xyz);
          ...
          r4.x = dot(icb[r2.w+0].xyz, cb0[13].xyz);
          r4.x = saturate(r4.x * cb0[12].x + r2.y);
          r4.x = r4.x * r4.x;
          r4.xyz = cb0[15].xyz * r4.xxx;
          r4.xyz = r3.www * cb0[11].xyz + r4.xyz;
          r3.w = cb0[19].x * r2.z;
          r4.xyz = r4.xyz * r3.www;
          r4.xyz = cb0[20].xxx * r4.xyz;
          r4.xyz = r4.xyz / cb13[1].xxx;
          r3.w = dot(r4.xyz, r4.xyz);
          r3.w = cmp(9.99999975e-005 < r3.w);
          if (r3.w != 0) {
            r0.x = mad((int)r0.y, 6, (int)r2.w);
