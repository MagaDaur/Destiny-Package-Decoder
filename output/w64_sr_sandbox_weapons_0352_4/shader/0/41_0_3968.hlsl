  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.xzw = float3(1.20000005,1.20000005,1.20000005) * r3.xzw;
  ...
  r2.x = -1 + r2.x;
  r0.w = r0.w * r2.x + 1;
  r1.x = saturate(dot(cb0[101].xyz, r1.xyz));
  r1.yzw = cb0[100].xyz * r1.www;
  ...
  r0.z = saturate(r1.w * cb0[107].x + cb0[107].y);
