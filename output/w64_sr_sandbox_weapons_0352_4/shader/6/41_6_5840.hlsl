...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.z = r0.z * 2 + 3;
    r6.w = r3.w + r0.y;
    r7.xyz = r3.xyz * float3(0.0500000007,0.0500000007,0.0500000007) + float3(0.5,0.5,0.5);
    r7.xyz = t1.SampleLevel(s1_s, r7.xyz, 0).xyz;
    r7.xyz = r7.xyz * float3(2,2,2) + float3(-1,-1,-1);
    r7.xyz = cb0[22].xxx * r7.xyz;
    r7.xyz = r7.xyz * float3(5,5,5) + r1.xyz;
    r0.y = saturate(cb0[152].x * r0.z);
    r0.y = 1 + -r0.y;
    r1.xyz = r7.xyz * r0.yyy;
    r6.xyz = r1.xyz * cb0[141].xxx + r3.xyz;
    r0.y = cb0[152].x * r4.x;
