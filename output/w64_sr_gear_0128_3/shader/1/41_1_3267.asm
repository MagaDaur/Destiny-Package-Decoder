...
mul r6.xyz, r0.xywx, l(0.175000, 0.175000, 0.175000, 0.000000)
itof r3.w, r0.z
lt r3.w, r3.w, l(0.500000)
mul r0.xyw, r0.xyxw, l(-0.175000, -0.175000, 0.000000, -0.175000)
...
mul r2.y, l(0.0174532942), cb0[105].x
add r2.z, cb0[105].x, cb0[106].x
