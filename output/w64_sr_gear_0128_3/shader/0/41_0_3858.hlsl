  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.xy = v3.xy * cb0[14].xy + cb0[14].zw;
  ...
  r5.xyz = t2.Sample(s4_s, v3.xy).xyw;
  r6.xy = float2(-0.25,-0.188235298) + r5.yz;
  r1.w = saturate(1.231884 * r6.y);
  r6.x = saturate(r6.x);
  r1.w = saturate(cb7[33].y * r1.w + cb7[33].x);
  r1.w = saturate(cb7[33].w * r1.w + cb7[33].z);
  r0.xyz = r1.www * r2.xyz + r0.xyz;
  r0.xyz = r0.xyz + -r4.xyz;
  r2.x = cmp(r5.z >= 0.156862751);
  ...
  r4.xy = saturate(float2(7.96875,4) * r5.zy);
  r2.z = cmp(0.0500000007 >= r4.x);
  r0.z = r2.z ? r0.z : -1;
  o0.w = r2.x ? r0.y : r0.z;
  r0.y = saturate(r0.w * r4.y + r6.x);
  ...
  r5.x = saturate(r5.x);
  r0.yz = r6.xy + -r4.zx;
  r0.yz = r2.yy * r0.yz + r4.zx;
  r0.y = r0.y * 0.125 + 0.375;
  o2.x = r0.z;
  r0.zw = t1.Sample(s3_s, v3.xy).xy;
  r0.zw = r0.zw * cb0[15].xx + cb0[15].yy;
  ...
  r0.y = dot(cb0[5].xyz, r0.yzw);
  r0.z = cb0[4].x + -cb0[3].x;
  r0.y = saturate(r0.y * r0.z + cb0[3].x);
  r0.z = -cb0[6].z + v4.z;
  r0.z = cb0[7].x * r0.z;
  r0.z = max(0, r0.z);
  r0.z = log2(r0.z);
  ...
  r0.z = dot(r1.xyz, r1.xyz);
  r0.z = sqrt(r0.z);
  r0.z = saturate(r0.z * cb0[10].x + cb0[10].y);
  r0.y = r0.y * r0.z;
  r0.x = r0.x * r0.y;
  r0.x = r0.x * cb0[13].x + 0.0078125;
  r0.x = log2(r0.x);
