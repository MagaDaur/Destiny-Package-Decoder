...
if_nz r0.x
  ...
  if_nz r0.x
    ...
    emit_stream m0
    cut_stream m0
    mad r0.yzw, cb12[4].xxyz, l(0.000000, 0.005000, 0.005000, 0.005000), cb9[r0.x + 0].xxyz
    ...
    emit_stream m0
    cut_stream m0
    mad r0.xyz, -cb12[4].xyzx, l(0.005000, 0.005000, 0.005000, 0.000000), cb9[r0.x + 0].xyzx
