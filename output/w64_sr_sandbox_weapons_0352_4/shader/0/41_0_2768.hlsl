  ...
  out float4 o3 : SV_TARGET3)
{
  ...
  r3.xy = r3.xy * v6.zz + v0.xy;
  r3.xy = v6.zz * float2(-0.5,-0.5) + r3.xy;
  r4.x = 0;
  r4.y = round(v5.w);
  ...
  r2.w = cb0[133].x * v7.x;
  r2.w = floor(r2.w);
  r3.zw = cb0[130].xy * r2.ww;
  r3.xy = r3.xy * cb0[129].xy + r3.zw;
  r2.w = t1.Sample(s1_s, r3.xy).x;
  r3.xyz = t10.Sample(s2_s, r0.xy).xyw;
  r3.xy = -v0.ww + r3.xy;
  r3.xy = saturate(float2(0.5,0.5) * r3.xy);
  r3.xy = float2(1,1) + -r3.xy;
  r3.z = -1 + r3.z;
  r3.z = cb2[5].x * r3.z + 1;
  r3.x = r3.x + -r3.y;
  r3.x = r3.z * r3.x + r3.y;
  r4.xyz = cb0[97].xyz + -cb0[96].xyz;
  r4.xyz = cb0[9].yyy * r4.xyz + cb0[96].xyz;
  r3.zw = v0.xy * v4.xy + v4.zw;
  r3.z = t0.Sample(s1_s, r3.zw).x;
  r4.xyz = r4.xyz * r3.zzz + float3(-2.51188652e-007,-2.51188652e-007,-2.51188652e-007);
  r4.xyz = float3(1.00000024,1.00000024,1.00000024) * r4.xyz;
  r4.xyz = max(float3(0,0,0), r4.xyz);
  r4.xyz = v8.zzz * r4.xyz;
  r2.w = saturate(r2.w * v8.y + v8.x);
  ...
  r2.x = -1 + r2.x;
  r0.w = r0.w * r2.x + 1;
  r1.x = saturate(dot(cb0[121].xyz, r1.xyz));
  r1.yzw = cb0[120].xyz * r1.www;
  ...
  r0.z = saturate(r1.w * cb0[127].x + cb0[127].y);
