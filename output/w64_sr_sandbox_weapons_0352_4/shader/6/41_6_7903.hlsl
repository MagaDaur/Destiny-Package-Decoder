...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r3.y = 0.119999997 * r3.x;
    r3.z = 0.119999997 * r4.x;
    r2.yzw = float3(1,0,0) * r2.yyy;
    ...
    r3.xw = float2(0,0);
    r4.xyz = -r5.yzx * r3.zwy;
    r4.xyz = r3.yzw * -r5.zxy + -r4.xyz;
    r6.x = dot(r3.yz, -r5.yz);
    r4.w = -r6.x;
    r3.xyzw = r5.wwww * r3.xyzw + r4.xyzw;
    ...
    r4.xyzw = -r5.zxyx * r2.wwyy;
    r6.xyz = -r2.wyw * -r5.yzx + r4.xyz;
    r6.w = -r4.w;
    r4.xyz = r5.www * r2.yzw;
    r4.w = 0;
    r4.xyzw = r6.xyzw + r4.xyzw;
    r0.yzw = r5.zxy * r4.yzx;
    r0.yzw = r5.yzx * r4.zxy + -r0.yzw;
    r0.yzw = r5.www * r4.xyz + r0.yzw;
    r4.xyz = r4.www * r5.xyz + r0.yzw;
  ...
  // No code for instruction (needs manual fix):
    ...
    r1.x = 0;
    r1.zw = r2.xx * float2(1.62981448e-010,2.32830644e-010) + float2(0.800000012,0);
  // No code for instruction (needs manual fix):
