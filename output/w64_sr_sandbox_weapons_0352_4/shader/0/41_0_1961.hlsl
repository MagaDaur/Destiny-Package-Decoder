  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.z = 1 / r0.z;
  r0.z = -v0.w + r0.z;
  r0.z = saturate(6.66666651 * r0.z);
  r0.z = 1 + -r0.z;
  r0.z = 1 + -r0.z;
  r0.x = r0.x * r0.z;
  r0.zw = float2(0.366252989,1) * r0.yy;
  r0.z = dot(r0.zw, float2(0.589999974,0.109999999));
  r1.xyz = r0.yyy * float3(0,0.366252989,1) + -r0.zzz;
  r0.yzw = r1.xyz * float3(0.899999976,0.899999976,0.899999976) + r0.zzz;
