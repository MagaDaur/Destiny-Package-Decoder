...
mad r6.xy, r6.xyxx, cb0[22].xxxx, cb0[22].yyyy
...
add r5.x, r0.y, cb0[16].z
dp2 r0.y, cb0[17].xyxx, v3.xyxx
add r5.y, r0.y, cb0[17].z
mad r0.yz, r5.xxyx, cb0[18].xxyx, cb0[18].zzwz
sample_indexable(texture2d)(float,float,float,float) r0.y, r0.yzyy, t10.yxzw, s2
