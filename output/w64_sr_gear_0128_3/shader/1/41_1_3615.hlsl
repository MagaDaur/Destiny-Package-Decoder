...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r2.xz = cb0[3].xx * cb0[0].xx;
  r3.x = cb0[12].x * cb0[10].x;
  r3.y = cb0[12].x * r2.z;
  r3.z = cb0[12].x * cb0[11].x;
  r1.w = cb0[5].x * cb0[4].x;
  r2.w = -cb0[6].x + 1;
  r4.xy = float2(1,1) + -r0.yx;
  r3.w = -r4.x * cb0[7].x + 1;
  r4.x = 1 + -r2.w;
  r4.y = -r4.y * cb0[9].x + 1;
  r4.x = r4.x * r4.y;
  ...
  r5.yzw = r4.zxy * -r2.yzx;
  r6.xyz = r4.yzx * -r2.zxy + -r5.yzw;
  r1.w = dot(r4.xyz, -r2.xyz);
  r6.w = -r1.w;
  r4.xyz = r5.xxx * r4.xyz;
  r4.w = 0;
  r4.xyzw = r6.xyzw + r4.xyzw;
  r5.yzw = r4.yzx * r2.zxy;
  r5.yzw = r2.yzx * r4.zxy + -r5.yzw;
  ...
  r5.yzw = v2.zxy * -r2.yzx;
  r6.xyz = v2.yzx * -r2.zxy + -r5.yzw;
  r1.w = dot(v2.xyz, -r2.xyz);
  r6.w = -r1.w;
  r7.xyz = v2.xyz;
  r7.w = 0;
  r6.xyzw = r5.xxxx * r7.xyzw + r6.xyzw;
  r5.yzw = r6.yzx * r2.zxy;
  r5.yzw = r2.yzx * r6.zxy + -r5.yzw;
  ...
  r1.xyz = cb0[13].xxx * r3.xyz + r1.xyz;
  ...
  r1.xyw = cb0[13].xxx * r4.xyz + v1.xyz;
  ...
  r1.xyw = cb0[13].xxx * r2.xyz + v2.xyz;
