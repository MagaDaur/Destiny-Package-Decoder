...
mul r2.x, cb0[0].x, cb0[1].x
mul r2.xz, r0.xxxx, r2.xxxx
mad r2.w, r0.z, cb0[3].x, cb0[4].x
add r1.x, r1.x, r2.w
mad r1.x, cb0[5].w, r1.x, cb0[5].z
...
mad_sat o0.w, cb1[7].z, l(0.500000), cb1[7].w
