...
mad r6.xy, r6.xyxx, cb0[30].xxxx, cb0[30].yyyy
...
mad r0.z, cb0[15].y, r8.z, cb0[15].x
...
mad r1.w, cb0[18].y, r1.w, cb0[18].x
mul r0.x, r0.x, r0.x
mad_sat r0.x, r0.x, cb0[19].x, cb0[19].y
log r0.x, r0.x
mul r0.x, r0.x, cb0[20].x
exp r0.x, r0.x
min r0.x, r0.x, l(1.000000)
mad r0.x, cb0[22].x, r0.x, cb0[21].x
mad_sat r2.w, r7.y, cb0[23].x, cb0[23].y
mad r2.w, cb0[25].x, r2.w, cb0[24].x
add r0.x, r0.x, r2.w
mul r0.x, r0.x, r1.w
mul r0.x, r0.x, r0.z
...
exp r0.x, r0.x
min r0.x, r0.x, l(1.000000)
mad r4.xyz, cb0[28].xyzx, r0.xxxx, cb0[27].xyzx
mul r4.xyz, r4.xyzx, cb0[29].xyzx
mul r4.xyz, r4.xyzx, r8.zzzz
mul r5.xyz, r4.xyzx, cb0[14].xxxx
mad r4.xyz, cb0[14].xxxx, r4.xyzx, r2.xyzx
max r0.x, r4.y, r4.x
max r0.x, r4.z, r0.x
