...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  if (r0.x != 0) {
    ...
    r1.x = r1.w ? r2.y : r1.x;
    r2.y = (int)r1.x * 3;
    r2.zw = mad(int2(3,3), (int2)r1.xx, int2(1,2));
    if (r1.w != 0) {
      r1.x = (uint)r1.y << 2;
      r1.x = (int)r1.x & 1792;
      ...
      r4.z = cb1[r2.w+8].w;
      r1.w = (int)r1.x * 3;
      r3.zw = mad(int2(3,3), (int2)r1.xx, int2(1,2));
      ...
      if (r2.x != 0) {
        ...
        r7.zw = (int2)r1.yw * int2(3,3);
        r1.xyzw = mad(int4(3,3,3,3), (int4)r1.xyzw, int4(1,2,1,2));
    ...
    r5.z = dot(r5.xyz, r2.xyz);
    r5.x = dot(r6.xyz, r2.xyz);
    r5.y = dot(r3.xyz, r2.xyz);
    r2.xyz = r7.zxy * r5.xyz;
    r2.xyz = r7.yzx * r5.yzx + -r2.xyz;
    o2.xyz = v2.www * r2.xyz;
    r2.xyzw = v3.xyxy * cb1[6].xyxy + cb1[6].zwzw;
    r3.xy = r2.zw * cb0[2].xy + cb0[2].zw;
    r3.x = t3.SampleLevel(s1_s, r3.xy, 0).x;
    r3.x = saturate(r3.x * cb0[3].x + cb0[3].y);
    r3.x = cb0[1].x * r3.x;
    r3.yzw = cb0[0].xyz * r3.xxx;
    r4.xyz = cb0[0].xyz * r3.xxx + r4.xyz;
    o4.xyz = cb12[7].xyz + r4.xyz;
    r4.xyzw = cb12[1].xyzw * r3.zzzz;
    r4.xyzw = cb12[0].xyzw * r3.yyyy + r4.xyzw;
    r3.xyzw = cb12[2].xyzw * r3.wwww + r4.xyzw;
