...
// unknown dcl_: dcl_input_sgv v6.x, vertex_id
  ...
  r8.xyz = float3(9.99999975e-005,9.99999975e-005,9.99999975e-005) * r0.xyw;
  r1.z = (int)r0.z;
  r1.z = cmp(r1.z < 0.5);
  r0.xyw = float3(-9.99999975e-005,-9.99999975e-005,-9.99999975e-005) * r0.xyw;
  ...
  r0.z = r0.z * r5.x;
  r7.xyzw = cb0[107].xxxx + float4(0.125,0.375,0.25,0.5);
  ...
  r7.xzw = cb0[106].xyz * r7.xxx + r8.xyz;
  r7.xzw = cb0[15].xyz + r7.xzw;
  r7.xzw = r7.xzw + -r0.xyw;
  r7.xzw = r7.xzw * r4.zzz;
  r8.xyz = cb0[16].xyz * r1.www;
  r8.xyz = cb0[106].xyz * r7.yyy + r8.xyz;
  r8.xyz = cb0[15].xyz + r8.xyz;
  ...
  r7.xyz = cb12[5].xyz * r1.zzz + r7.xyz;
