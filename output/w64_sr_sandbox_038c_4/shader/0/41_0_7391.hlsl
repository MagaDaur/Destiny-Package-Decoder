  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyz = float3(1.27818012,1.27818012,1.27818012) * r0.xyz;
  ...
  r0.w = sqrt(r0.w);
  r1.x = 0.015625 * r0.w;
  r0.w = saturate(r0.w * cb0[103].x + cb0[103].y);
  r1.x = min(1, r1.x);
  r1.z = sqrt(r1.x);
  ...
  r0.xyz = r0.xyz * float3(20,8.46535969,3.05851984) + r2.xyz;
  ...
  r1.x = exp2(r1.x);
  r1.y = t2.Sample(s3_s, v0.xy).x;
  r1.x = r1.x * r1.y;
  r1.y = r1.x * -0.800000012 + v0.w;
  r1.y = 0.800000012 + r1.y;
  r0.w = -r1.y + r0.w;
  r1.y = r1.x * 0.300000012 + 0.5;
  r1.x = saturate(r1.x * v4.w + -0.00659999996);
