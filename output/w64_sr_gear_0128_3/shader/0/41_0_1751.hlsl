  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = t4.Sample(s3_s, v3.xy).x;
  r0.y = cb0[13].z + v3.y;
  r0.y = saturate(cb0[13].y * abs(r0.y) + cb0[13].x);
  r0.x = r0.x + -r0.y;
  r0.x = cb0[14].x * r0.x + r0.y;
  r0.yz = v3.xy * cb0[15].xy + cb0[15].zw;
  r0.y = t5.Sample(s4_s, r0.yz).x;
  r0.x = r0.x * r0.y;
  r0.x = 4.59479332 * r0.x;
  r0.xyzw = cb0[16].xyzw * r0.xxxx;
  r1.x = saturate(cb0[17].x * 10000 + cb0[17].y);
