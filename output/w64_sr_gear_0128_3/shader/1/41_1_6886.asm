...
mul r0.xy, r0.yxyy, l(0.250000, 0.250000, 0.000000, 0.000000)
mad r0.z, v9.x, l(6.282000), v5.z
...
mov o0.w, r1.w
mul r0.x, v5.w, l(0.280000)
frc r0.x, r0.x
mul r0.y, r0.x, cb0[100].x
add r0.x, -r0.x, cb0[106].x
add r0.x, r0.x, l(1.000000)
mul_sat r0.x, r0.x, l(3.333333)
mad r0.y, -r0.y, cb0[110].x, cb0[110].y
mad_sat r0.y, r0.w, cb0[110].x, r0.y
mul r0.x, r0.x, r0.y
