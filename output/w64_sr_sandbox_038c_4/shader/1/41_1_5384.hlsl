...
// unknown dcl_: dcl_input_sgv v3.x, vertex_id
  ...
  r3.xyz = float3(0,0,1) * r2.zxy;
  r3.xyz = r2.xyz * float3(1,0,0) + -r3.xyz;
  r0.z = dot(r3.xz, r3.xz);
  r0.z = rsqrt(r0.z);
  r3.xyz = r3.xyz * r0.zzz;
  r4.xyz = r3.xyz * r2.zxy;
  r4.xyz = r2.yzx * r3.yzx + -r4.xyz;
  r0.xz = r3.zx * r0.xx;
  r3.xy = float2(0.100000001,0.100000001) * r0.xz;
  ...
  r0.xyz = r0.xyz * float3(0.100000001,0.100000001,0.100000001) + r1.xyz;
