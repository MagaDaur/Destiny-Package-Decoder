...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  o0.xy = x1[r0.x+0].xy;
  r0.xy = x0[r0.x+0].xy;
  r0.xy = float2(8,1) * r0.yx;
  r0.z = -0.0628200024 + v1.w;
  sincos(r0.z, r1.x, r2.x);
  r0.zw = r1.xx * r0.xy;
  r0.x = r0.x * r2.x + r0.w;
  r0.y = r0.y * r2.x + -r0.z;
  r0.xzw = cb1[2].xyz * r0.xxx;
  ...
  r3.xyz = cb1[2].zxy * r2.xyz;
  r3.xyz = cb1[2].yzx * r2.yzx + -r3.xyz;
  r1.w = dot(r3.xyz, r3.xyz);
  r1.w = rsqrt(r1.w);
  r3.xyz = r3.xyz * r1.www;
  r3.xyz = r3.xyz * r0.yyy;
  r1.xyz = r3.xyz * float3(0.180000007,0.180000007,0.180000007) + r1.xyz;
  r0.xyz = r0.xzw * float3(0.180000007,0.180000007,0.180000007) + r1.xyz;
  ...
  r1.y = sqrt(r1.x);
  r1.x = rsqrt(r1.x);
  r1.xzw = r2.zxy * r1.xxx;
  r2.x = r1.y * 4 + -2;
  r1.y = 10000 + -r1.y;
  r1.y = saturate(min(r2.x, r1.y));
  r1.y = cb0[8].y * r1.y;
  r1.y = cb0[107].x * r1.y;
  ...
  r2.x = dot(cb1[2].xyz, r1.xzw);
  r1.xzw = -r2.xxx * cb1[2].xyz + r1.xzw;
  r2.x = dot(r1.xzw, r1.xzw);
  r2.x = rsqrt(r2.x);
  o1.xyz = r2.xxx * r1.xzw;
  o3.xyz = v2.yzw;
  r1.x = cmp(v2.w < 9.99999997e-007);
