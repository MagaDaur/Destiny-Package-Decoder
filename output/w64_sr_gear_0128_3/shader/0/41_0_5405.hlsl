  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.yz = v3.xy * cb0[37].xy + cb0[37].zw;
  ...
  r6.xy = r6.xy * cb0[38].xx + cb0[38].yy;
  ...
  r1.y = r6.z * r1.y;
  o0.w = r0.z ? r0.y : r7.w;
  r0.y = saturate(r8.z * cb0[26].x + cb0[26].y);
  r0.y = r0.y * r3.w;
  r0.y = cb0[6].x * r0.y;
  r0.y = r4.x * cb0[25].x + r0.y;
  r3.xyz = r5.xyz * r0.yyy;
  r0.yz = v3.xy * cb0[27].xy + cb0[27].zw;
  r0.yz = t10.Sample(s2_s, r0.yz).xy;
  r0.yz = -cb0[29].xy + r0.yz;
  r0.yz = r0.yz * cb0[28].xx + v3.xy;
  r0.yz = r0.yz * cb0[30].xy + cb0[30].zw;
  r4.xyz = t11.Sample(s2_s, r0.yz).xyz;
  r4.xyz = r4.xyz * cb0[31].xxx + cb0[31].yyy;
  r0.x = r0.x * r0.x;
