  ...
  out float4 o6 : SV_POSITION0)
{
  ...
  r0.w = 0;
  r1.xyz = v5.xyz * cb1[4].xyz + cb1[5].xyz;
  r1.xyz = float3(4,4,8) * r1.xyz;
  r1.w = 0.5 * v2.w;
  ...
  r4.xyz = v7.xyz;
  r4.w = 0;
  r5.xyzw = v7.yzxx * -r2.zxzx;
  r6.xyz = -v7.zxy * -r2.zzx + r5.xyz;
  r6.w = -r5.w;
