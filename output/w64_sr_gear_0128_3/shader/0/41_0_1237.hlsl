  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r8.xy = r8.xy * cb0[58].xx + cb0[58].yy;
  ...
  r4.w = r8.z ? r4.w : -1;
  r12.xyzw = cb0[56].xyzw + -cb0[55].xyzw;
  r12.xyzw = cb0[57].xxxx * r12.xyzw + cb0[55].xyzw;
  ...
  r5.xyz = cb0[25].xyz * r0.xxx + cb0[24].xyz;
  r0.xy = v3.xy * cb0[26].xy + cb0[26].zw;
  r0.xy = t11.Sample(s2_s, r0.xy).xy;
  r0.xy = -cb0[28].xy + r0.xy;
  r0.xy = r0.xy * cb0[27].xx + v3.xy;
  r0.xy = r0.xy * cb0[29].xy + cb0[29].zw;
  r6.xyz = t12.Sample(s2_s, r0.xy).xyz;
  r0.xy = v3.xy * cb0[30].xy + cb0[30].zw;
  r8.xyz = t13.Sample(s2_s, r0.xy).xyz;
  r0.xy = v3.yx * cb0[32].yx + cb0[32].wz;
  r3.xy = round(r0.xy);
  r0.xy = -r3.xy + r0.xy;
  ...
  r0.xy = r3.xy * r0.xy;
  r0.xy = cb0[33].yx * r0.xy + v3.xy;
  r3.xy = r0.yx * cb0[34].yx + cb0[34].wz;
  r9.yz = round(r3.xy);
  r3.xy = -r9.yz + r3.xy;
  ...
  r3.xy = r9.yz * r3.xy;
  r0.xy = cb0[35].yx * r3.xy + r0.xy;
  r1.w = r0.y * cb0[36].y + cb0[36].w;
  r3.xy = r0.xy * cb0[37].xy + cb0[37].zw;
  ...
  r1.w = r2.w + r1.w;
  r1.w = min(1, r1.w);
  r3.xy = r0.xy * cb0[42].xy + cb0[42].zw;
  r2.w = cb0[43].x * cb0[6].x;
  r0.xy = t14.Sample(s2_s, r0.xy).xy;
  r0.xy = -cb0[44].xy + r0.xy;
  ...
  r0.y = cb0[45].x * r0.y;
  r0.y = exp2(r0.y);
  r0.y = r0.y * cb0[46].x + cb0[6].x;
  r1.w = log2(r1.w);
  r0.y = r1.w * r0.y;
  r0.y = exp2(r0.y);
  r0.y = saturate(cb0[47].x + r0.y);
  r0.x = cb0[48].x + r0.x;
  r0.x = r0.y * r0.x + cb0[47].x;
  ...
  r0.x = saturate(v5.y);
  r6.xyz = cb0[52].xyz * r0.xxx + cb0[51].xyz;
  r5.xyz = r6.xyz * r5.xyz;
  r5.xyz = r7.xyz * r5.xyz;
  r0.x = 1 + -v5.y;
  r0.x = r0.x * r0.x;
  r0.y = cb0[54].x + cb0[53].x;
  r0.x = r0.x * r0.y;
  ...
  if (r0.y != 0) {
    ...
    r3.xy = v3.xy * r1.ww;
    r3.xy = floor(r3.xy);
    r1.w = dot(r3.xy, float2(17,0.100000001));
    r1.w = sin(r1.w);
    r1.w = 10000 * r1.w;
    r3.x = r3.y * 13 + r3.x;
    r3.x = sin(r3.x);
    ...
    r3.xy = v3.xy * r2.ww;
    r3.xy = floor(r3.xy);
    r2.w = dot(r3.xy, float2(17,0.100000001));
    r2.w = sin(r2.w);
    r2.w = 10000 * r2.w;
    r3.x = r3.y * 13 + r3.x;
    r3.x = sin(r3.x);
