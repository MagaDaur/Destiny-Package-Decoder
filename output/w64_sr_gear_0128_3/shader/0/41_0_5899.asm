...
dcl_output o0.xyzw
dcl_temps 4
mul r0.xyzw, cb0[12].xxxx, cb0[13].xyzw
mul r1.xyzw, cb0[12].xxxx, cb0[14].xyzw
lt r2.xy, l(1.000000, 0.000000, 0.000000, 0.000000), v3.yxyy
movc r0.xyzw, r2.yyyy, r0.xyzw, r1.xyzw
mul r1.xyzw, cb0[12].xxxx, cb0[15].xyzw
and r1.xyzw, r1.xyzw, r2.yyyy
movc r0.xyzw, r2.xxxx, r1.xyzw, r0.xyzw
dp2 r1.x, cb0[10].xyxx, v3.xyxx
add r1.x, r1.x, cb0[10].z
dp2 r1.z, cb0[11].xyxx, v3.xyxx
add r1.y, r1.z, cb0[11].z
sample_indexable(texture2d)(float,float,float,float) r1.x, r1.xyxx, t4.xyzw, s3
mul r0.xyzw, r0.xyzw, r1.xxxx
mad r0.xyzw, cb0[8].xxxx, cb0[9].xyzw, r0.xyzw
...
mul r0.w, r0.w, r1.x
mul r0.xyz, r0.xyzx, cb0[16].xxxx
