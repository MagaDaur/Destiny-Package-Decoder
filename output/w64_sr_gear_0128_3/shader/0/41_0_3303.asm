...
mov r1.x, v4.z
mov r1.z, l(1.000000)
mul r0.xyw, r0.xyxw, r1.xxxz
mov r1.x, cb13[1].w
mov r1.z, v4.z
mul r0.xyw, r0.xyxw, r1.xxxz
mul r0.xyw, r0.xyxw, cb13[1].xxxw
mul r0.xy, r0.xyxx, cb8[7].xyxx
mul r0.w, r0.w, cb13[1].x
mul r1.z, r0.w, cb8[7].z
...
mul r1.xy, r0.xyxx, r3.wwww
mov r4.xy, l(0.136349,0.187154,0,0)
mov r4.z, r3.w
