...
// unknown dcl_: dcl_input_sgv v6.x, vertex_id
  ...
  o0.xy = x1[r0.x+0].xy;
  r0.xy = x0[r0.x+0].xy;
  r0.xy = float2(0,-0.100000001) + r0.yx;
  r0.xy = float2(1.20000005,1.5) * r0.xy;
  sincos(v2.w, r1.x, r2.x);
  r0.zw = r1.xx * r0.xy;
  r0.y = r0.y * r2.x + -r0.z;
  r0.x = r0.x * r2.x + r0.w;
  r1.xyz = cb1[1].yzx * v1.yyy;
  r1.xyz = cb1[0].yzx * v1.xxx + r1.xyz;
  r1.xyz = cb1[2].yzx * v1.zzz + r1.xyz;
  r2.xyz = cb1[2].zxy * r1.xyz;
  r1.xyz = cb1[2].yzx * r1.yzx + -r2.xyz;
  r0.z = dot(r1.xyz, r1.xyz);
  r0.z = rsqrt(r0.z);
  r1.xyz = r1.xyz * r0.zzz;
  r2.xyz = cb1[2].yzx * r1.zxy;
  r2.xyz = r1.yzx * cb1[2].zxy + -r2.xyz;
  ...
  r1.xyz = r1.xyz * float3(1.29999995,1.29999995,1.29999995) + r2.xyz;
  r2.xyz = cb12[7].yzx + -r2.yzx;
  r0.xyz = r0.xzw * float3(1.29999995,1.29999995,1.29999995) + r1.xyz;
  ...
  r2.x = dot(r2.zxy, cb1[2].xyz);
  r2.yzw = cb1[2].zxy * r1.yzw;
  r1.yzw = cb1[2].yzx * r1.zwy + -r2.yzw;
  r1.y = dot(r1.yzw, r1.yzw);
  r1.xy = sqrt(r1.xy);
  r1.z = cb0[105].x * 0.0174532942;
  r1.z = cos(r1.z);
  r1.y = r1.y + -r1.z;
  r1.w = cb0[106].x + cb0[105].x;
