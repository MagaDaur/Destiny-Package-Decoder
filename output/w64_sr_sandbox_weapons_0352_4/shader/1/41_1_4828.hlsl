  ...
  out float4 o8 : SV_POSITION0)
{
  ...
  r0.xyz = r0.zxy * float3(0,1,0) + -r1.xyz;
  ...
  r1.xyz = float3(0,1,0) * r0.yzx;
  r1.xyz = r0.zxy * float3(0,0,1) + -r1.xyz;
  r2.xyz = v10.xyz * cb1[4].xyz + cb1[5].xyz;
  r2.xyz = v7.yyy * r2.xyz;
  r2.xyz = v3.xyz * r2.xyz;
  r3.xyz = r2.yyy * r0.xyz;
  r0.xyz = v12.yyy * r0.xyz;
  r0.xyz = v12.xxx * float3(1,0,0) + r0.xyz;
  r0.xyz = v12.zzz * r1.xyz + r0.xyz;
  r2.xyw = r2.xxx * float3(1,0,0) + r3.xyz;
  r1.xyz = r2.zzz * r1.xyz + r2.xyw;
  r0.w = v8.y * 6.28200006 + v4.w;
  r0.w = 0.5 * r0.w;
