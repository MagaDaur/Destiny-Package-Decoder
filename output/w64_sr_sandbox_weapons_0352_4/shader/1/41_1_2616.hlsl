...
// unknown dcl_: dcl_input_sgv v8.x, vertex_id
  ...
  o0.xy = x1[r0.x+0].xy;
  r0.xy = x0[r0.x+0].xy;
  r0.xy = float2(0,0.800000012) + r0.yx;
  r0.xy = v2.yx * r0.xy;
  sincos(v2.w, r1.x, r2.x);
  r0.zw = r1.xx * r0.xy;
  r0.y = r0.y * r2.x + -r0.z;
  r0.x = r0.x * r2.x + r0.w;
  r1.xyz = cb1[1].zxy * v0.yyy;
  r1.xyz = cb1[0].zxy * v0.xxx + r1.xyz;
  r1.xyz = cb1[2].zxy * v0.zzz + r1.xyz;
  ...
  r0.yzw = r0.yzw * float3(0.25,0.25,0.25) + r2.xyz;
  ...
  r0.xyz = r3.xyz * float3(0.25,0.25,0.25) + r0.yzw;
  ...
  o0.w = r0.w;
  r2.w = 10000 + -r1.w;
  r3.x = 0.280000001 * v3.x;
  r3.x = frac(r3.x);
  r3.y = -r3.x * 1.99999785 + -1;
  r3.x = cb0[102].x + -r3.x;
  r3.x = 1 + r3.x;
  r3.x = saturate(3.33333302 * r3.x);
  r1.w = r1.w * 0.333332986 + r3.y;
  ...
  o7.xyzw = r1.xxxx ? float4(10000,10000,-10000,1) : r0.xyzw;
  return;
}