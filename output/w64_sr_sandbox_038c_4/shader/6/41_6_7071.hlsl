...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r2.y = t0.Load(r2.w).x;
    r0.y = saturate(r1.w);
    r0.zw = float2(-0,-0.5) + r0.yy;
    r0.zw = saturate(r0.zw + r0.zw);
    r6.xyzw = float4(-0.269293994,-0.419999987,-0.348185003,0.691697001) * r0.zwzw;
    r0.zw = float2(0.310000002,-0.219420001) * r0.zw;
    r7.x = dot(float2(1,1), r6.xy);
    r7.y = dot(float2(1,1), r6.zw);
    r7.z = dot(float2(1,1), r0.zw);
    r6.xyz = float3(0.689293981,0.368185014,0) + r7.xyz;
    ...
    r7.xyzw = r0.yyyy * float4(-295.639099,0.194573,0,-2.87750602) + float4(84.3003311,1.14689398,0,1.53603899);
    ...
    r7.x = r7.x * 0.699999988 + 0.300000012;
    r7.y = r7.x * r0.z;
    r0.z = saturate(r5.x);
    ...
    r0.z = r0.z * 100 + 100;
    r8.xyz = r0.yyy * float3(-5898.53564,180.109512,-0.319651008) + float3(621.713318,-85.7811432,1.57300103);
    r9.xyz = r0.yyy * float3(-0.331395,9.3617506,-2.18704796) + float3(0,0.703226984,0.933699012);
    r8.xyz = r8.xyz * r0.www + r9.xyz;
    r9.xyzw = cmp(r0.yyyy >= float4(0,0.0700000003,0.230000004,1));
