  ...
  out float4 o9 : SV_POSITION0)
{
  ...
  r0.x = sqrt(r0.x);
  r0.y = r0.x * 0.666666985 + -0.666666985;
  r0.x = 10000 + -r0.x;
  ...
  r3.w = 0;
  r1.w = 3.14100003 * v5.w;
  sincos(r1.w, r4.x, r5.x);
  r4.yzw = v9.xyz * cb1[4].xyz + cb1[5].xyz;
  r3.xyz = r5.xxx * r4.yzw;
  r1.w = dot(cb0[121].xyz, cb0[121].xyz);
  r1.w = rsqrt(r1.w);
  r5.yzw = cb0[121].xyz * r1.www;
  ...
  r6.yzw = -r4.yzx * r3.zxy;
  r8.xyz = r3.yzx * -r4.zxy + -r6.yzw;
  r1.w = dot(r3.xyz, -r4.xyz);
  r8.w = -r1.w;
  r3.xyzw = r8.xyzw + r7.xyzw;
  r6.yzw = r4.zxy * r3.yzx;
  r6.yzw = r4.yzx * r3.zxy + -r6.yzw;
  ...
  r2.xyz = r0.wyz * -r4.yzx;
  r2.xyz = r0.zwy * -r4.zxy + -r2.xyz;
  r0.y = dot(r0.yzw, -r4.xyz);
  r2.w = -r0.y;
  r1.w = 0;
  r1.xyzw = r2.xyzw + r1.xyzw;
  r0.yzw = r4.zxy * r1.yzx;
  r0.yzw = r4.yzx * r1.zxy + -r0.yzw;
  ...
  o9.xyzw = r0.xxxx ? float4(10000,10000,-10000,1) : r3.xyzw;
  return;
}