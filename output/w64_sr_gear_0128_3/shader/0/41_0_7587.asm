...
mul r1.xyzw, cb0[12].xxxx, cb0[13].xyzw
mul r3.xyzw, cb0[12].xxxx, cb0[14].xyzw
lt r0.yz, l(0.000000, 1.000000, 0.000000, 0.000000), v3.yyxy
movc r1.xyzw, r0.zzzz, r1.xyzw, r3.xyzw
mul r3.xyzw, cb0[12].xxxx, cb0[15].xyzw
and r3.xyzw, r0.zzzz, r3.xyzw
movc r1.xyzw, r0.yyyy, r3.xyzw, r1.xyzw
mul r3.xyzw, cb0[9].xyzw, cb0[11].xyzw
mad r3.xyzw, cb0[9].xyzw, cb0[10].xyzw, r3.xyzw
add r1.xyzw, r1.xyzw, r3.xyzw
mul r0.x, r0.x, r1.w
mul r0.yzw, r1.xxyz, cb0[16].xxxx
