...
add r7.z, l(128.500000), cb0[18].x
...
rsq r0.z, r0.z
mul r1.xyz, r0.zzzz, r1.xyzx
mov_sat r0.z, cb0[27].x
dp3 r1.w, v0.xyzx, v0.xyzx
rsq r1.w, r1.w
mul r4.xyz, r1.wwww, v0.xyzx
dp3 r1.w, cb0[20].xyzx, r4.xyzx
add r2.w, cb0[3].x, -cb0[19].x
mad_sat r1.w, r1.w, r2.w, cb0[19].x
add r2.w, v4.z, -cb0[21].z
...
mul r1.w, r1.w, r2.w
mad_sat r0.x, r0.x, cb0[25].x, cb0[25].y
mul r0.x, r0.x, r1.w
