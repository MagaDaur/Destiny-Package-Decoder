...
// unknown dcl_: dcl_input_sgv v5.x, vertex_id
  ...
  r0.xyz = r0.xzw * float3(0.800000012,0.800000012,0.800000012) + r2.xyz;
  r2.xyz = cb12[7].xyz + -r2.xyz;
  r0.xyz = r1.xyz * float3(0.800000012,0.800000012,0.800000012) + r0.xyz;
  r0.w = dot(r2.xyz, r2.xyz);
  r1.x = rsqrt(r0.w);
  r0.w = sqrt(r0.w);
  r1.xyz = r2.xyz * r1.xxx;
  r0.xyz = r1.xyz * float3(0.160000011,0.160000011,0.160000011) + r0.xyz;
