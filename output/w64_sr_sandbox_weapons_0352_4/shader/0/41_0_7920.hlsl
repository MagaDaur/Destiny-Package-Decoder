  ...
  out float4 o1 : SV_TARGET1)
{
  ...
  r5.xyz = cb0[18].xyz * r2.yyy;
  r5.xyz = cb0[17].xyz * r2.xxx + r5.xyz;
  r5.xyz = cb0[19].xyz * r2.zzz + r5.xyz;
  r5.xyz = cb0[20].xyz + r5.xyz;
  r5.xyz = r5.xyz * float3(0.5,0.5,0.5) + float3(0.5,0.5,0.5);
  r5.xyz = r5.xyz * cb0[11].xyz + cb0[12].xyz;
  ...
  if (r3.w != 0) {
    ...
    r5.w = r5.w * r5.w;
    r5.w = min(1, r5.w);
    r6.x = saturate(cb0[21].y * r0.w + cb0[21].x);
    r6.yzw = cb0[22].xyz * cb0[23].xxx + -cb0[24].xyz;
    r6.xyz = r6.xxx * r6.yzw + cb0[24].xyz;
    r6.w = saturate(dot(r1.xyz, r3.xyz));
    r7.x = min(0.200000003, r1.w);
    r7.x = r7.x + r6.w;
    r7.x = min(1, r7.x);
    r7.yzw = -r2.xyz * r0.zzz + r3.xyz;
    r8.x = dot(r7.yzw, r7.yzw);
    r8.x = rsqrt(r8.x);
    r7.yzw = r8.xxx * r7.yzw;
    r3.w = 9.99999975e-006 + abs(r3.w);
    r7.y = saturate(dot(r3.xyz, r7.yzw));
    r8.x = -0.5 * r0.y;
    r0.y = -r0.y * 0.899999976 + 1;
    r7.y = r7.y * r7.y;
    r7.y = dot(r7.yy, r0.yy);
    r6.w = 1 + -r6.w;
    r7.y = -0.5 + r7.y;
    r7.z = r6.w * r6.w;
    r7.z = r7.z * r7.z;
    ...
    r7.y = r7.y * r7.z + 1;
    r6.w = r7.y * r6.w;
    r7.y = cmp(9.99999975e-005 < r1.w);
    r7.z = saturate(dot(r3.xyz, -r1.xyz));
    ...
    r3.x = cb13[4].y * r3.x;
    r3.x = exp2(r3.x);
    r3.x = saturate(r7.z * cb13[4].x + r3.x);
    r1.w = r3.x * r1.w;
    r1.w = r7.y ? r1.w : 0;
    r3.x = r6.w * r7.x;
