  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.w = r1.w * r1.w;
  r2.x = saturate(r1.w * cb0[7].x + cb0[7].y);
  r2.y = saturate(r1.w * cb0[8].x + cb0[8].y);
  r2.x = r2.x + r2.y;
  r1.w = saturate(r1.w * cb0[9].x + cb0[9].y);
  r1.w = r1.w * cb0[10].x + r2.x;
  r1.w = saturate(cb0[11].x + r1.w);
  r2.xyzw = cb0[13].xyzw * r1.wwww + cb0[12].xyzw;
  r4.xyzw = max(cb0[14].xxxx, r4.xyzw);
  r4.xyzw = min(cb0[15].xxxx, r4.xyzw);
  r4.xyzw = r4.xyzw * r4.xyzw;
  r2.xyzw = r4.xyzw * r2.xyzw;
  r2.xyzw = cb0[16].xyzw * r2.xyzw;
  r2.xyzw = float4(4.59479332,4.59479332,4.59479332,4.59479332) * r2.xyzw;
  r1.w = dot(cb0[17].xy, v3.xy);
  r4.x = cb0[17].z + r1.w;
  r1.w = dot(cb0[18].xy, v3.xy);
  r4.y = cb0[18].z + r1.w;
  r4.zw = r4.xy * cb0[19].xy + cb0[19].zw;
  r1.w = t26.Sample(s2_s, r4.zw).x;
  r1.w = saturate(r1.w * cb0[20].x + cb0[20].y);
  r1.w = cb0[23].y * r1.w + cb0[23].x;
  r1.w = max(cb0[21].x, r1.w);
  r1.w = min(cb0[22].x, r1.w);
  r4.xy = r4.xy * cb0[24].xy + cb0[24].zw;
  r3.w = t26.Sample(s2_s, r4.xy).x;
  r3.w = saturate(r3.w * cb0[25].x + cb0[25].y);
  r3.w = cb0[28].y * r3.w + cb0[28].x;
  r3.w = max(cb0[26].x, r3.w);
  r3.w = min(cb0[27].x, r3.w);
  r4.x = dot(cb0[29].xy, v3.xy);
  r4.x = cb0[29].z + r4.x;
  r4.z = dot(cb0[30].xy, v3.xy);
  r4.y = cb0[30].z + r4.z;
  r4.xy = r4.xy * cb0[31].xy + cb0[31].zw;
  r4.x = t27.Sample(s2_s, r4.xy).x;
  r4.x = saturate(r4.x * cb0[32].x + cb0[32].y);
  r4.x = cb0[35].y * r4.x + cb0[35].x;
  r4.x = max(cb0[33].x, r4.x);
  r4.x = min(cb0[34].x, r4.x);
  r3.w = r4.x * r3.w;
  r1.w = r1.w * cb0[36].x + r3.w;
  r3.w = dot(cb0[37].xy, v3.xy);
  r4.x = cb0[37].z + r3.w;
  r3.w = dot(cb0[38].xy, v3.xy);
  r4.y = cb0[38].z + r3.w;
  r4.xy = r4.xy * cb0[39].xy + cb0[39].zw;
  r3.w = t27.Sample(s2_s, r4.xy).x;
  r3.w = saturate(r3.w * cb0[40].x + cb0[40].y);
  r3.w = cb0[43].y * r3.w + cb0[43].x;
  r3.w = max(cb0[41].x, r3.w);
  r3.w = min(cb0[42].x, r3.w);
  r4.xyzw = r1.wwww * r3.wwww + cb0[44].xyzw;
  r1.w = dot(cb0[45].xy, v3.xy);
  r6.x = cb0[45].z + r1.w;
  r1.w = dot(cb0[46].xy, v3.xy);
  r6.y = cb0[46].z + r1.w;
  r5.yz = t28.Sample(s2_s, r6.xy).xy;
  r5.yz = -cb0[48].xy + r5.yz;
  r5.yz = r5.yz * cb0[47].xx + v3.xy;
  r5.yz = r5.yz * cb0[49].xy + cb0[49].zw;
  r6.xyz = t29.Sample(s2_s, r5.yz).xyz;
  r6.w = 1;
  r6.xyzw = r6.xyzw * cb0[50].xxxx + cb0[50].yyyy;
  r4.xyzw = r6.xyzw * r4.xyzw;
  r2.xyzw = r4.xyzw * r2.xyzw;
  r2.xyzw = max(cb0[51].xxxx, r2.xyzw);
  r2.xyzw = min(cb0[52].xxxx, r2.xyzw);
  r2.xyzw = cb0[53].xyzw * r2.xyzw;
  r4.xyzw = cb0[6].xxxx * r2.xyzw;
