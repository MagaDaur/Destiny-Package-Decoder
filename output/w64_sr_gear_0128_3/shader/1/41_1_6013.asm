...
mul r0.xyzw, r5.yyyy, cb12[1].xyzw
mad r0.xyzw, cb12[0].xyzw, r5.xxxx, r0.xyzw
mad r0.xyzw, cb12[2].xyzw, r5.zzzz, r0.xyzw
add o6.xyzw, r0.xyzw, cb12[14].xyzw
dp3 r0.x, r2.yzwy, r2.yzwy
rsq r0.x, r0.x
mul r0.xyz, r0.xxxx, r2.yzwy
dp3 r2.x, r7.xyzx, r0.xyzx
...
dp3 r1.y, r8.xyzx, r0.xyzx
mul r0.xyz, r1.xyzx, r2.zxyz
mad r0.xyz, r2.yzxy, r1.yzxy, -r0.xyzx
mul o2.xyz, r0.xyzx, v2.wwww
mad o3.xyzw, v3.xyxy, cb1[6].xyxy, cb1[6].zwzw
mul_sat r0.x, r2.z, cb1[7].z
add_sat o0.w, r0.x, cb1[7].w
umin r0.x, v4.x, cb1[4].w
ld_indexable(buffer)(float,float,float,float) o5.xyzw, r0.xxxx, t0.xyzw
add r0.xyz, r5.xyzx, cb12[7].xyzx
add r3.xyz, -cb12[7].xyzx, cb12[10].xyzx
add o4.xyz, r0.xyzx, r3.xyzx
mov o0.xyz, r2.xyzx
mov o1.xyzw, r1.zxyy
ret
