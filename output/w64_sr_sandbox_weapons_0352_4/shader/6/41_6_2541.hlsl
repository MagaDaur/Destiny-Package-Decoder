...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.z = mad((int)r0.z, 0x0019660d, 0x3c6ef35f);
    r2.w = (uint)r0.z;
    r4.xyz = float3(2.32830644e-010,2.32830644e-010,2.32830644e-010) * r2.yzw;
    r0.z = mad((int)r0.z, 0x0019660d, 0x3c6ef35f);
    r2.w = (uint)r0.z;
    r4.w = 2.32830644e-010 * r2.w;
    ...
    r10.x = r10.y * r5.y;
    r6.yz = r10.xz + r10.xz;
    r0.w = saturate(r6.y + r6.z);
    r0.w = 1.57079625 * r0.w;
    ...
    r0.w = dot(-cb9[r2.w+32].xyz, cb9[r2.z+32].xyz);
    r12.w = -r0.w;
    ...
    r0.w = dot(cb9[r2.w+32].xyz, r12.xyz);
    r14.w = -r0.w;
    ...
    r0.w = dot(-cb9[r2.z+32].xyz, r12.xyz);
    r13.w = -r0.w;
    ...
    r0.w = dot(cb9[r2.z+32].xyz, r10.xyz);
    r11.w = -r0.w;
    ...
    r0.w = dot(cb9[r2.z+0].xyz, cb9[r2.w+32].xyz);
    r11.w = -r0.w;
    ...
    r0.w = dot(r6.xyz, -cb9[r2.w+32].xyz);
    r7.w = -r0.w;
    ...
    r0.w = dot(r5.xyz, -cb9[r2.w+32].xyz);
    r6.w = -r0.w;
    ...
    r0.yzw = -r7.yzx * r2.zxy;
    r6.xyz = r2.yzx * -r7.zxy + -r0.yzw;
    r0.y = dot(r2.xyz, -r7.xyz);
    r6.w = -r0.y;
    r2.xyz = r7.www * r2.xyz;
    r2.w = 0;
    r2.xyzw = r6.xyzw + r2.xyzw;
    r0.yzw = r7.zxy * r2.yzx;
    r0.yzw = r7.yzx * r2.zxy + -r0.yzw;
    r0.yzw = r7.www * r2.xyz + r0.yzw;
    r2.xyz = r2.www * r7.xyz + r0.yzw;
  ...
  // No code for instruction (needs manual fix):
    store_uav_typed u0.xyzw, r2.wwww, r4.xyzw
  }
  return;
}