...
mad r6.xy, r6.xyxx, cb0[28].xxxx, cb0[28].yyyy
...
mul r0.z, r6.w, cb0[15].x
mul r0.z, r0.z, cb0[16].x
add r1.w, v5.y, cb0[17].x
mad r1.w, cb0[18].w, r1.w, cb0[18].z
...
mul r1.w, r1.w, r2.w
mad r1.w, cb0[18].x, r1.w, cb0[18].y
add r1.w, r1.w, -cb0[19].x
mad r3.xw, cb0[20].zzzw, r1.wwww, cb0[20].xxxy
min_sat r1.w, r3.w, r3.x
add_sat r2.w, v5.x, cb0[21].x
log r2.w, r2.w
mul r2.w, r2.w, cb0[22].x
exp r2.w, r2.w
max r3.x, v5.y, l(0.000000)
log r3.x, r3.x
mul r3.x, r3.x, cb0[23].x
exp r3.x, r3.x
mul r2.w, r2.w, r3.x
mul r1.w, r1.w, r2.w
mul r1.w, r1.w, cb0[24].x
mad r0.z, r0.z, r1.w, -r0.y
mad r0.y, cb0[25].x, r0.z, r0.y
max r0.y, r0.y, cb0[26].x
min r0.y, r0.y, cb0[27].x
