...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r2.x = cb0[3].x * cb0[0].x;
  r3.x = cb0[13].x * cb0[11].x;
  r3.y = cb0[13].x * r2.x;
  r3.z = cb0[13].x * cb0[12].x;
  r1.w = cb0[6].x * cb0[5].x;
  r2.w = -cb0[7].x + 1;
  r4.xy = float2(1,1) + -r0.yx;
  r3.w = -r4.x * cb0[8].x + 1;
  r4.x = 1 + -r2.w;
  r4.y = -r4.y * cb0[10].x + 1;
  r4.x = r4.x * r4.y;
  r2.w = r2.w * r3.w + r4.x;
  r1.w = r1.w * r0.z + r2.w;
  r2.w = -cb0[1].x + 1;
  ...
  r3.xyz = v1.zxy * -r2.yzx;
  r3.xyz = v1.yzx * -r2.zxy + -r3.xyz;
  r2.w = dot(v1.xyz, -r2.xyz);
  r3.w = -r2.w;
  r4.xyz = v1.xyz;
  r4.w = 0;
  r3.xyzw = r5.xxxx * r4.xyzw + r3.xyzw;
