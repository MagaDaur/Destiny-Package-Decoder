...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.w = r0.w * 6 + 4;
    r5.w = saturate(r1.w);
    r6.xyzw = r5.wwww * float4(-21.9478455,0.272157997,6.16666698,1.24129796) + float4(-8.70372009,-1.02153206,0,0.508077025);
    r7.x = r5.w * r5.w;
    r6.xy = r6.xy * r7.xx + r6.zw;
    r7.xyz = cmp(r5.www >= float3(0,0.180000007,1));
    ...
    r5.xyz = cb0[155].xyz * cb0[154].xxx;
    r1.xyz = r5.xyz * float3(-0.100000001,-0.100000001,-0.100000001) + r1.xyz;
    r0.y = saturate(cb0[156].x * r5.w);
    r0.y = 1 + -r0.y;
    r6.xyz = r1.xyz * r0.yyy;
    r3.xyz = r6.xyz * cb0[145].xxx + r3.xyz;
    r0.y = cb0[156].x * r3.w;
