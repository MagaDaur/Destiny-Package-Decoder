...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r4.yzw = -cb0[6].xyz + r2.xyz;
  r5.xyz = r4.wyz * -r1.yzx;
  r5.xyz = r4.zwy * -r1.zxy + -r5.xyz;
  r0.w = dot(r4.yzw, -r1.xyz);
  r5.w = -r0.w;
  r6.xyz = r4.xxx * r4.yzw;
  r6.w = 0;
  r5.xyzw = r6.xyzw + r5.xyzw;
  r4.yzw = r5.yzx * r1.zxy;
  r4.yzw = r1.yzx * r5.zxy + -r4.yzw;
  ...
  r0.w = rsqrt(r0.w);
  r4.yzw = cb0[7].xyz * r0.www;
  r4.xyz = r4.xxx * r4.yzw;
  r5.yzw = -cb0[9].xyz + r1.xyz;
  r6.xyz = r5.wyz * -r4.yzx;
  r6.xyz = r5.zwy * -r4.zxy + -r6.xyz;
  r0.w = dot(r5.yzw, -r4.xyz);
  r6.w = -r0.w;
  ...
  r4.xyz = cb0[9].xyz + r4.xyz;
  r1.xyz = r4.xyz + -r1.xyz;
  r1.xyz = r2.xyz + r1.xyz;
  r1.xyz = r3.xyz + r1.xyz;
  r1.xyz = -cb0[0].xyz + r1.xyz;
  r1.xyz = cb0[10].xxx * r1.xyz + cb0[0].xyz;
