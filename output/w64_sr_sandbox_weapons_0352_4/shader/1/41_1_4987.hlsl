  ...
  out float4 o3 : SV_POSITION0)
{
  ...
  r1.xyz = r1.xyz * cb0[13].www + float3(-0.600000024,0,0);
  r1.w = 3.14100003 + v1.w;
  r1.xyzw = float4(1.66999996,1.20000005,0.100000001,0.5) * r1.xyzw;
  sincos(r1.w, r2.x, r3.x);
  r0.xyz = r3.xxx * r1.xyz;
  r2.xyz = float3(0,1,0) * r2.xxx;
  r4.xyzw = -r2.zzyy * r1.yzxy;
  r1.xyz = -r1.zxy * -r2.yzz + r4.xyz;
  r1.w = -r4.w;
  ...
  r4.xyz = v5.xyz;
  r4.w = 0;
  r5.xyzw = v5.yzxy * -r2.zzyy;
  r6.xyz = -v5.zxy * -r2.yzz + r5.xyz;
  r6.w = -r5.w;
  r4.xyzw = r3.xxxx * r4.xyzw + r6.xyzw;
  r1.yzw = r4.yzx * r2.zzy;
  r1.yzw = r2.yzz * r4.zxy + -r1.yzw;
