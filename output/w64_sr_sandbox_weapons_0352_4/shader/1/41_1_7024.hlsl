...
// unknown dcl_: dcl_input_sgv v7.x, vertex_id
  ...
  r4.w = dot(r2.xyz, r5.xyz);
  r6.xyz = -r4.www * r2.xyz + r5.xyz;
  ...
  r5.w = rsqrt(r5.w);
  r0.xyw = r0.xyw * r5.www + -r6.xyz;
  o1.xyz = r0.xyw * float3(0.5,0.5,0.5) + r6.xyz;
  r0.x = dot(r5.xyz, r2.xyz);
  r0.y = cb0[105].x * 0.0174532942;
  ...
  o0.y = x0[r0.z+0].y;
  r5.xyzw = cb12[1].xyzw * r4.yyyy;
  r5.xyzw = cb12[0].xyzw * r4.xxxx + r5.xyzw;
  r5.xyzw = cb12[2].xyzw * r4.zzzz + r5.xyzw;
