...
mul r2.xyzw, r0.xxxx, cb0[12].xyzw
...
dp2 r1.x, cb0[9].xyxx, v3.xyxx
add r1.x, r1.x, cb0[9].z
dp2 r1.z, cb0[10].xyxx, v3.xyxx
add r1.y, r1.z, cb0[10].z
sample_indexable(texture2d)(float,float,float,float) r1.x, r1.xyxx, t4.xyzw, s3
add r1.x, -r1.x, l(1.000000)
mul r0.xyzw, r0.xyzw, r1.xxxx
mul r1.x, l(0.750000), cb0[8].x
...
mul r0.w, r0.w, r1.x
mul r0.xyz, r0.xyzx, cb0[14].xxxx
