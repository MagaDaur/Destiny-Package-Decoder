...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r0.z = rsqrt(r0.z);
  r3.yzw = cb0[0].xyz * r0.zzz;
  r0.xzw = r3.yzw * r0.xxx;
  r4.xyz = -r2.xyz + r1.xyz;
  r5.xyz = r4.zxy * -r0.zwx;
  r5.xyz = r4.yzx * -r0.wxz + -r5.xyz;
  r1.w = dot(r4.xyz, -r0.xzw);
  r5.w = -r1.w;
  r4.xyz = r4.xyz * r3.xxx;
  r4.w = 0;
  r4.xyzw = r5.xyzw + r4.xyzw;
  r5.xyz = r4.yzx * r0.wxz;
  r5.xyz = r0.zwx * r4.zxy + -r5.xyz;
  r4.xyz = r3.xxx * r4.xyz + r5.xyz;
  r0.xzw = r4.www * r0.xzw + r4.xyz;
  r0.xzw = r0.xzw + r2.xyz;
  r2.xyz = r0.xzw + -r1.xyz;
  r4.x = cb0[10].x * cb0[7].x;
  r4.y = cb0[11].x * cb0[7].y;
  r4.z = cb0[12].x * cb0[7].z;
  r1.w = cb0[8].x * cb0[1].x;
  r0.y = r1.w * r0.y;
  r0.y = cb0[9].x * r0.y;
  r0.y = 3.14100003 * r0.y;
  sincos(r0.y, r3.x, r5.x);
  r3.xyz = r3.xxx * r3.yzw;
  r5.yzw = -r4.xyz + r0.xzw;
  r6.xyz = r5.wyz * -r3.yzx;
  r6.xyz = r5.zwy * -r3.zxy + -r6.xyz;
  r0.y = dot(r5.yzw, -r3.xyz);
  r6.w = -r0.y;
  r7.xyz = r5.xxx * r5.yzw;
  r7.w = 0;
  r6.xyzw = r7.xyzw + r6.xyzw;
  r5.yzw = r6.yzx * r3.zxy;
  r5.yzw = r3.yzx * r6.zxy + -r5.yzw;
