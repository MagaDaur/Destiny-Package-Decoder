...
// unknown dcl_: dcl_thread_group 8, 8, 1
  ...
  if (r1.x != 0) {
    ...
    if (r2.y != 0) {
      ...
      r2.y = sqrt(r2.y);
      r2.z = r2.y + r2.x;
      r2.w = saturate(cb0[13].y / r2.x);
      r3.x = r2.y + -r2.z;
      r2.z = r2.w * r3.x + r2.z;
      r2.y = r0.w ? r2.y : r2.z;
      r2.y = saturate(r2.y * cb0[12].x + cb0[12].y);
      r2.y = r2.y * r2.y;
      r1.w = cmp(r1.w < 0);
      r1.w = r1.w ? 0 : r2.y;
      r2.yzw = cb0[9].xyz * cb0[10].xxx + -cb0[11].xyz;
      r3.xyzw = r1.xyzw;
      r4.x = 0;
      while (true) {
        r4.y = cmp((int)r4.x >= 6);
        ...
        if (r4.y != 0) {
          ...
          r5.x = saturate(cb0[8].y * r3.w + cb0[8].x);
          r5.xyz = r5.xxx * r2.yzw + cb0[11].xyz;
