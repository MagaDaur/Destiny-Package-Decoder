...
sample_indexable(texture2d)(float,float,float,float) r0.y, v3.xyxx, t6.yxzw, s4
mul r1.xyzw, r0.yyyy, cb0[14].xyzw
mad r2.xyzw, r0.xxxx, cb0[15].xyzw, -r1.xyzw
mad r1.xyzw, cb0[16].xxxx, r2.xyzw, r1.xyzw
...
ge r1.x, cb0[9].x, r1.x
movc r1.xyzw, r1.xxxx, cb0[7].xyzw, cb0[8].xyzw
sample_indexable(texture2d)(float,float,float,float) r2.x, v3.xyxx, t5.xyzw, s3
ge r2.x, cb0[10].x, r2.x
movc r2.xyzw, r2.xxxx, cb0[7].xyzw, cb0[8].xyzw
mul r1.xyzw, r1.xyzw, r2.xyzw
mul r0.xyzw, r0.xyzw, r1.xyzw
mul r0.xyzw, r0.xyzw, cb0[17].xyzw
mul r0.xyz, r0.xyzx, cb0[18].xxxx
mul r1.x, l(0.750000), cb0[6].x
