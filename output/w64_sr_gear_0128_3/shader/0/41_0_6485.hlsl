  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.x = sqrt(r0.x);
  r0.yz = v3.xy * cb0[18].xy + cb0[18].zw;
  ...
  r6.xy = r6.xy * cb0[19].xx + cb0[19].yy;
  ...
  r3.yzw = saturate(r3.yzw * r8.xzw + r12.xyz);
  ...
  if (r0.z != 0) {
    ...
    r0.z = r0.z ? r1.w : r4.w;
    r0.z = r3.w ? r0.z : r2.w;
    r1.y = cmp(0.5 >= cb0[4].x);
    r1.w = cb0[4].x + cb0[4].x;
    r1.w = r0.z * -r1.w + r1.w;
    r2.w = cb0[4].x * 2 + -2;
    r0.z = r0.z * r2.w + 1;
    r0.z = r1.y ? r1.w : r0.z;
  ...
  r0.z = cmp(r0.z < 0);
  if (r0.z != 0) discard;
  r0.z = saturate(cb0[15].x);
  r1.y = dot(r4.xyz, r4.xyz);
  r1.y = rsqrt(r1.y);
  r4.xyz = r4.xyz * r1.yyy;
  r1.y = dot(cb0[8].xyz, r4.xyz);
  r1.w = cb0[7].x + -cb0[6].x;
  r1.y = saturate(r1.y * r1.w + cb0[6].x);
  r1.w = -cb0[9].z + v4.z;
  r1.w = cb0[10].x * r1.w;
  r1.w = max(0, r1.w);
  r1.w = log2(r1.w);
