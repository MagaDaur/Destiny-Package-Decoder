...
// unknown dcl_: dcl_input_sgv v7.x, vertex_id
  ...
  r0.y = r0.y * r2.x + -r0.z;
  r0.x = r0.x * r2.x + r0.w;
  r1.xyz = cb1[1].zxy * v1.yyy;
  r1.xyz = cb1[0].zxy * v1.xxx + r1.xyz;
  r1.xyz = cb1[2].zxy * v1.zzz + r1.xyz;
  ...
  r0.yzw = r0.yzw * float3(0.449999988,0.449999988,0.449999988) + r2.xyz;
  ...
  r4.xyz = r3.zxy * r0.xxx;
  r0.xyz = r4.xyz * float3(0.449999988,0.449999988,0.449999988) + r0.yzw;
  ...
  r2.x = dot(r2.zxy, r1.xyz);
  r2.x = -0.965925813 + abs(r2.x);
  r2.x = saturate(-16.7734413 * r2.x);
  r2.y = r1.w * 0.333332986 + -1;
  r1.w = 10000 + -r1.w;
  r1.w = saturate(min(r2.y, r1.w));
  r1.w = r1.w * r2.x;
  r1.w = cb0[10].y * r1.w;
  r1.w = cb0[123].x * r1.w;
  r2.x = cmp(0.999000013 < v1.w);
  r1.w = r2.x ? 0 : r1.w;
  o0.z = r1.w;
  r2.xyz = r3.xyz * r1.xyz;
  o1.xyz = r1.zxy * r3.yzx + -r2.xyz;
  o3.xyzw = v0.xyzw;
  o4.xyzw = v4.xyzw;
  o5.xyz = v5.xyz;
  r1.x = v5.y + v5.x;
  r1.xw = cmp(r1.xw < float2(9.99999997e-007,9.99999997e-007));
