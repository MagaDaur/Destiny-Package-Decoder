  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.yz = cb0[17].xx * r2.xy;
  r1.xy = cb0[20].xx * r2.xy;
  r1.xy = r1.xy / r0.xx;
  r0.xy = r0.yz / r0.xx;
  r0.zw = v3.xy * cb0[16].xy + cb0[16].zw;
  r0.xy = r0.zw + -r0.xy;
  r0.xyzw = t1.Sample(s5_s, r0.xy).xyzw;
  r0.x = dot(r0.xyzw, cb0[18].xyzw);
  r0.yz = v3.xy * cb0[19].xy + cb0[19].zw;
  r0.yz = r0.yz + -r1.xy;
  r1.xyzw = t1.Sample(s3_s, r0.yz).xyzw;
  r0.y = dot(r1.xyzw, cb0[21].xyzw);
  r0.x = r0.x * r0.y;
  r0.yz = v3.xy * cb0[14].xy + cb0[14].zw;
  r1.xyzw = t1.Sample(s4_s, r0.yz).xyzw;
  r0.y = dot(r1.xyzw, cb0[15].xyzw);
  r0.zw = v3.xy * cb0[13].xy + cb0[13].zw;
  r0.z = t0.Sample(s3_s, r0.zw).y;
  r0.x = r0.z * r0.y + r0.x;
  r0.xyzw = cb0[22].xyzw * r0.xxxx;
