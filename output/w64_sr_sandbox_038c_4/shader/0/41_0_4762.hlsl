  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r1.xyzw = r0.yzyz * float4(0.75,-1,0.75,-1) + float4(0.100000001,0,0.300000012,0);
  ...
  r0.z = cb0[138].x + r0.z;
  r0.y = r0.z * r0.y;
  r1.xyzw = v0.xyxy * float4(0.75,-1,0.75,-1) + float4(0.100000001,0,0.300000012,0);
  r0.zw = round(r1.wz);
  r0.zw = r1.wz + -r0.zw;
  r1.zw = abs(r0.zw) * float2(-16,-16) + float2(8,8);
  r0.zw = r1.zw * r0.zw;
  ...
  r1.xyzw = r1.xyzw * float4(0.75,-1,0.75,-1) + float4(0.100000001,0,0.300000012,0);
  r2.xyzw = r2.xyzw * float4(0.75,-1,0.75,-1) + float4(0.100000001,0,0.300000012,0);
  r0.xy = round(r2.wz);
  r0.xy = r2.wz + -r0.xy;
