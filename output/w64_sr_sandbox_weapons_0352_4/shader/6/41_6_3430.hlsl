...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r8.z = r5.w * 0.75 + 0.25;
    r9.xyz = r4.xzw * float3(0.349999994,0.12500003,0.0249999985) + float3(0.150000006,0.474999994,0.115000002);
    ...
    r8.w = r4.x * r4.y + r5.x;
    r7.xyz = r4.zzz * float3(0.549999952,0.25,0.75) + float3(2.45000005,1.75,0.75);
    r11.x = r10.z * r9.z;
    r11.y = r4.z * 2 + 1;
    r4.x = r4.w * r4.w;
    r4.x = r4.x * 175 + 125;
