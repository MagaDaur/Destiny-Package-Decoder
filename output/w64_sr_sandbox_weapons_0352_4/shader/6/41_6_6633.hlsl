...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r2.xyz = r2.xxx * float3(-7.27595761e-011,2.01212241e-011,4.65661287e-010) + float3(1.3125,-1.08642006,-3);
    r2.w = r1.w * r1.w;
    r2.x = r2.x * r2.w;
    r2.x = min(1, r2.x);
    r2.x = r2.x * 18.25 + 5.75;
    r2.yz = r2.yz * r2.ww + float2(1,1);
    r2.yz = max(float2(0,0), r2.yz);
    r1.xz = r2.yz * float2(35,0.275000006) + float2(5,0.125);
    r2.y = 0.0174529999 * r1.x;
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r2.z = (uint)r0.w;
