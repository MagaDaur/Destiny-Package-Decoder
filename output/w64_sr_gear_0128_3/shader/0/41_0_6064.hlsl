  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.yz = cb0[12].xx * r1.xy;
  r0.xy = r0.yz / r0.xx;
  r0.xy = v3.xy + -r0.xy;
  r0.x = t6.Sample(s4_s, r0.xy).x;
  r0.y = t6.Sample(s4_s, v3.xy).x;
  r1.xyzw = cb0[14].xyzw * r0.yyyy;
  r2.xyzw = r0.xxxx * cb0[15].xyzw + -r1.xyzw;
  r1.xyzw = cb0[16].xxxx * r2.xyzw + r1.xyzw;
  r0.xyzw = r0.xxxx * cb0[13].xyzw + r1.xyzw;
  r0.xyzw = cb0[11].xyzw * r0.xyzw;
  r1.x = t4.Sample(s3_s, v3.xy).x;
  r1.x = cmp(cb0[9].x >= r1.x);
  r1.xyzw = r1.xxxx ? cb0[7].xyzw : cb0[8].xyzw;
  r2.x = t5.Sample(s3_s, v3.xy).x;
  r2.x = cmp(cb0[10].x >= r2.x);
  r2.xyzw = r2.xxxx ? cb0[7].xyzw : cb0[8].xyzw;
  r1.xyzw = r2.xyzw * r1.xyzw;
  r0.xyzw = r1.xyzw * r0.xyzw;
  r0.xyzw = cb0[17].xyzw * r0.xyzw;
