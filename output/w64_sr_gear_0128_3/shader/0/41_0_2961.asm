...
mad r0.zw, r0.zzzw, cb0[109].xxxx, r1.xxxy
mad r0.xy, r0.xyxx, cb0[109].xxxx, r0.zwzz
...
mul r0.yzw, r0.yyzw, cb0[12].xxyz
...
mad r1.xyz, r1.xxxx, l(0.020725, 0.020725, 0.020725, 0.000000), cb0[115].xyzx
mul r1.xyz, r1.xyzx, cb0[98].xyzx
lt r2.xyz, l(1.000000, 2.000000, 3.000000, 0.000000), v0.xxxx
movc r3.xyz, r2.zzzz, cb0[12].xyzx, cb0[98].xyzx
movc r1.xyz, r2.yyyy, r3.xyzx, r1.xyzx
movc r0.yzw, r2.xxxx, r1.xxyz, r0.yyzw
movc r0.x, r2.x, cb0[100].x, r0.x
mul_sat r0.x, r0.x, cb0[119].x
...
mad_sat r1.x, r1.x, cb0[103].x, cb0[103].y
