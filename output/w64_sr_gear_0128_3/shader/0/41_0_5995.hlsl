  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = rsqrt(r0.w);
  r3.xyz = r3.xyz * r0.www;
  r5.xy = v3.xy * cb0[7].xy + cb0[7].zw;
  r5.zw = v3.xy * cb0[8].xy + cb0[8].zw;
  r5.zw = t26.Sample(s2_s, r5.zw).xy;
  r5.xy = r5.zw * cb0[9].xy + r5.xy;
  r5.xy = cb0[9].zw + r5.xy;
  r5.xyzw = t27.Sample(s2_s, r5.xy).xyzw;
  r6.xyzw = saturate(float4(4,4,4,4) * r5.xyzw);
  r5.xyzw = saturate(float4(-0.25,-0.25,-0.25,-0.25) + r5.xyzw);
  r5.xyzw = cb0[6].xyzw * r6.xyzw + r5.xyzw;
  ...
  r4.xyzw = cb0[10].xxxx * r4.xyzw;
  r0.w = dot(r2.xyz, r3.xyz);
  r0.w = 1 + -r0.w;
  r0.w = -r0.w * r0.w + 1;
  r0.w = saturate(r0.w * cb0[12].x + cb0[12].y);
  r2.xyzw = cb0[13].xyzw * r0.wwww + cb0[11].xyzw;
