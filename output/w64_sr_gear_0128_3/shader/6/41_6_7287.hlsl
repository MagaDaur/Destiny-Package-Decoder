...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.w = saturate(r1.w);
    r3.xyz = r0.www * float3(0,0.200000018,1) + float3(1,0.400000006,2);
    ...
    r4.y = r4.x * -75 + 1;
    r4.x = cmp(r4.x >= 0.0133330002);
    r4.x = r4.x ? 4.76837158e-007 : 0.500000477;
    r4.x = saturate(dot(r4.xx, r4.yy));
    r4.y = r4.x * r0.w;
