...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r5.yzw = -cb0[8].xyz + r4.xyz;
  r6.xyz = r5.wyz * -r1.yzx;
  r6.xyz = r5.zwy * -r1.zxy + -r6.xyz;
  r0.w = dot(r5.yzw, -r1.xyz);
  r6.w = -r0.w;
  r7.xyz = r5.xxx * r5.yzw;
  r7.w = 0;
  r6.xyzw = r7.xyzw + r6.xyzw;
  r5.yzw = r6.yzx * r1.zxy;
  r5.yzw = r1.yzx * r6.zxy + -r5.yzw;
  r5.xyz = r5.xxx * r6.xyz + r5.yzw;
  r1.xyz = r6.www * r1.xyz + r5.xyz;
  ...
  r5.xyz = cb0[11].xyz + r5.xyz;
  r1.xyz = r5.xyz + -r1.xyz;
  r1.xyz = r4.xyz + r1.xyz;
  r1.xyz = r2.xyz + r1.xyz;
  r1.xyz = r3.xyz + r1.xyz;
  r1.xyz = -cb0[0].xyz + r1.xyz;
  r1.xyz = cb0[12].xxx * r1.xyz + cb0[0].xyz;
