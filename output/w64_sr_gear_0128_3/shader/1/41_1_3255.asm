...
// POSITION                 1   xy          7     NONE   float   xy
// POSITION                 2   xyz         8     NONE   float   xyz
...
mov o0.w, r4.w
mad o0.xy, v7.xyxx, cb1[6].xyxx, cb1[6].zwzz
