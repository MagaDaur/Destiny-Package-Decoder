...
// unknown dcl_: dcl_input_sgv v6.x, vertex_id
  ...
  r0.xyz = r0.yzw * float3(0.519999981,0.519999981,0.519999981) + r2.xyz;
  r2.xyz = cb12[7].xyz + -r2.xyz;
  r0.xyz = r1.xyz * float3(0.519999981,0.519999981,0.519999981) + r0.xyz;
  r0.w = dot(r2.xyz, r2.xyz);
  r1.x = rsqrt(r0.w);
  r0.w = sqrt(r0.w);
  r1.xyz = r2.xyz * r1.xxx;
  r0.xyz = r1.xyz * float3(0.25999999,0.25999999,0.25999999) + r0.xyz;
