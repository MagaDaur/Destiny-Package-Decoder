...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.w = cb0[22].x / r4.z;
    r5.x = saturate(r2.w);
    r5.x = r5.x * 0.174999997 + 0.075000003;
    r5.x = cb0[22].x * r5.x;
    r6.w = r1.w + r0.w;
    ...
    r5.xyz = cb0[139].xyz * cb0[6].yyy;
    r1.xyz = r5.xyz * cb0[138].xxx + r1.xyz;
    r0.y = saturate(cb0[140].x * 7);
    r0.y = 1 + -r0.y;
    r6.xyz = r1.xyz * r0.yyy;
    r3.xyz = r6.xyz * cb0[131].xxx + r3.xyz;
    r0.y = cb0[140].x * r3.w;
