...
ld_indexable(buffer)(float,float,float,float) r1.zw, r2.zzzz, t2.xwyz
mov x0[0].y, l(0)
...
add r0.xyw, -r2.zxzy, r0.xyxw
dp3 r2.w, r0.xywx, r0.xywx
sqrt r2.w, r2.w
lt r2.w, l(0.000010), r2.w
movc r0.xyw, r2.wwww, r0.xyxw, l(0,1.000000,0,0)
dp3 r2.w, r0.xywx, r0.xywx
rsq r2.w, r2.w
mul r3.xyz, r0.ywxy, r2.wwww
add r4.xyz, -r2.xyzx, cb12[7].xyzx
...
lt r0.z, l(0.999000), r3.w
movc o0.z, r0.z, l(0), cb0[115].x
