  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.xyz = float3(0.666000009,0.640204012,0.640204012) * r3.xyz;
  r4.x = 1 / cb0[116].x;
  r2.w = r4.x * r2.w;
  r2.w = exp2(r2.w);
  r2.w = saturate(r2.w * v7.y + v7.x);
