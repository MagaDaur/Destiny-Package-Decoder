...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r3.z = 0.5 * r0.w;
    r5.xy = r0.ww * float2(0.389794499,-25.8221054) + float2(-0.328988999,149.90741);
    r5.zw = r0.ww * float2(0.0421054997,-70.0565491) + float2(0,42.849823);
    r3.z = r3.z * r3.z;
    r3.zw = r5.xy * r3.zz + r5.zw;
    r5.xyz = cmp(r0.www >= float3(0,1.62,2));
    ...
    r0.w = r3.x * r0.w;
    r3.x = min(1, r3.z);
    r1.w = r3.y * 6.98491931e-010 + 1;
    r3.y = cb10[0].x + 0.25;
    r3.y = (int)r3.y;
    r3.zw = cb0[4].xy + r2.yz;
    r3.zw = r3.zw * float2(18.9452477,6.99969196) + float2(3.25,0.133332998);
    r3.zw = floor(r3.zw);
    r3.z = dot(r3.zzzz, float4(0.958312452,1.25869918,8.78912258,66.2207794));
    r3.z = frac(r3.z);
    r3.z = r3.z * r3.z;
    r3.xz = float2(3.14154005,251) * r3.xz;
    r3.z = frac(r3.z);
    r3.z = r3.z * 0.5 + -0.25;
    r3.z = 3.1415925 * r3.z;
    sincos(r3.z, r5.x, r6.x);
    r5.xyz = float3(0,1,0) * r5.xxx;
    r3.z = dot(r3.wwww, float4(0.958312452,1.25869918,8.78912258,66.2207794));
    r3.z = frac(r3.z);
    r3.z = r3.z * r3.z;
    r3.z = 251 * r3.z;
    r3.z = frac(r3.z);
    ...
    r6.yzw = -cb9[r3.y+32].zxy * cb9[r3.y+32].yzx;
    r6.yzw = -cb9[r3.y+32].yzx * cb9[r3.y+32].zxy + -r6.yzw;
    r3.z = dot(-cb9[r3.y+32].xyz, cb9[r3.y+32].xyz);
    r9.w = -r3.z;
    r9.xyz = cb9[r3.y+32].www * cb9[r3.y+32].xyz + r6.yzw;
    r10.xyzw = cb9[r3.y+32].xyzw * float4(-1,-1,-1,1);
    r9.xyzw = cb9[r3.y+32].wwww * r10.xyzw + r9.xyzw;
    r11.xyzw = r9.zxyy * r5.yzzy;
    r6.yzw = -r5.zzy * r9.yzx + r11.xyz;
    r11.w = -r11.w;
    r11.xyz = r6.xxx * r9.xyz + r6.yzw;
    r5.w = r6.x;
    r5.xyzw = r9.wwww * r5.xyzw + r11.xyzw;
    r6.xyz = cb9[r3.y+32].zxy * r5.yzx;
    r6.xyz = cb9[r3.y+32].yzx * r5.zxy + -r6.xyz;
    r3.z = dot(cb9[r3.y+32].xyz, r5.xyz);
    r9.w = -r3.z;
    r9.xyz = cb9[r3.y+32].www * r5.xyz + r6.xyz;
    r5.xyzw = r5.wwww * cb9[r3.y+32].xyzw + r9.xyzw;
    r6.xyz = -cb9[r3.y+32].zxy * r5.yzx;
    r6.xyz = -cb9[r3.y+32].yzx * r5.zxy + -r6.xyz;
    r3.z = dot(-cb9[r3.y+32].xyz, r5.xyz);
    r9.w = -r3.z;
    r9.xyz = cb9[r3.y+32].www * r5.xyz + r6.xyz;
    r5.xyzw = r5.wwww * r10.xyzw + r9.xyzw;
    r6.xyzw = r7.zzxx * r5.zxyx;
    r6.xyz = -r7.zxz * r5.yzx + r6.xyz;
    r9.w = -r6.w;
    r9.xyz = r8.xxx * r5.xyz + r6.xyz;
    r7.w = r8.x;
    r5.xyzw = r5.wwww * r7.xyzw + r9.xyzw;
    r6.xyz = cb9[r3.y+32].zxy * r5.yzx;
    r6.xyz = cb9[r3.y+32].yzx * r5.zxy + -r6.xyz;
    r3.z = dot(cb9[r3.y+32].xyz, r5.xyz);
    r7.w = -r3.z;
    ...
    r6.xyzw = float4(0.150000006,0,0,0) * r5.wwww;
    r6.xyzw = r5.zzyx * float4(-0,0.150000006,-0.150000006,0.150000006) + r6.xyzw;
