...
mad r6.xy, r6.xyxx, cb0[63].xxxx, cb0[63].yyyy
...
mul r0.z, cb0[14].x, cb0[15].x
mul r0.x, r0.x, r0.x
mad_sat r1.w, r0.x, cb0[16].x, cb0[16].y
mad_sat r2.w, r0.x, cb0[17].x, cb0[17].y
add r1.w, r1.w, r2.w
mad_sat r0.x, r0.x, cb0[18].x, cb0[18].y
mad r0.x, r0.x, cb0[19].x, r1.w
add_sat r0.x, r0.x, cb0[20].x
mad r4.xyz, cb0[22].xyzx, r0.xxxx, cb0[21].xyzx
max r5.xyz, r5.xyzx, cb0[23].xxxx
min r5.xyz, r5.xyzx, cb0[24].xxxx
mul r5.xyz, r5.xyzx, r5.xyzx
mul r4.xyz, r4.xyzx, r5.xyzx
mul r4.xyz, r4.xyzx, cb0[25].xyzx
mul r4.xyz, r4.xyzx, l(4.59479332, 4.59479332, 4.59479332, 0.000000)
dp2 r0.x, cb0[26].xyxx, v3.xyxx
add r5.x, r0.x, cb0[26].z
dp2 r0.x, cb0[27].xyxx, v3.xyxx
add r5.y, r0.x, cb0[27].z
mad r3.zw, r5.xxxy, cb0[28].xxxy, cb0[28].zzzw
sample_indexable(texture2d)(float,float,float,float) r0.x, r3.zwzz, t10.xyzw, s2
mad_sat r0.x, r0.x, cb0[29].x, cb0[29].y
mad r0.x, cb0[32].y, r0.x, cb0[32].x
max r0.x, r0.x, cb0[30].x
min r0.x, r0.x, cb0[31].x
mad r3.zw, r5.xxxy, cb0[33].xxxy, cb0[33].zzzw
sample_indexable(texture2d)(float,float,float,float) r1.w, r3.zwzz, t10.yzwx, s2
mad_sat r1.w, r1.w, cb0[34].x, cb0[34].y
mad r1.w, cb0[37].y, r1.w, cb0[37].x
max r1.w, r1.w, cb0[35].x
min r1.w, r1.w, cb0[36].x
dp2 r2.w, cb0[38].xyxx, v3.xyxx
add r5.x, r2.w, cb0[38].z
dp2 r2.w, cb0[39].xyxx, v3.xyxx
add r5.y, r2.w, cb0[39].z
mad r3.zw, r5.xxxy, cb0[40].xxxy, cb0[40].zzzw
sample_indexable(texture2d)(float,float,float,float) r2.w, r3.zwzz, t11.yzwx, s2
mad_sat r2.w, r2.w, cb0[41].x, cb0[41].y
mad r2.w, cb0[44].y, r2.w, cb0[44].x
max r2.w, r2.w, cb0[42].x
min r2.w, r2.w, cb0[43].x
mul r1.w, r1.w, r2.w
mad r0.x, r0.x, cb0[45].x, r1.w
dp2 r1.w, cb0[46].xyxx, v3.xyxx
add r5.x, r1.w, cb0[46].z
dp2 r1.w, cb0[47].xyxx, v3.xyxx
add r5.y, r1.w, cb0[47].z
mad r3.zw, r5.xxxy, cb0[48].xxxy, cb0[48].zzzw
sample_indexable(texture2d)(float,float,float,float) r1.w, r3.zwzz, t11.yzwx, s2
mad_sat r1.w, r1.w, cb0[49].x, cb0[49].y
mad r1.w, cb0[52].y, r1.w, cb0[52].x
max r1.w, r1.w, cb0[50].x
min r1.w, r1.w, cb0[51].x
mad r5.xyz, r0.xxxx, r1.wwww, cb0[53].xyzx
dp2 r0.x, cb0[54].xyxx, v3.xyxx
add r6.x, r0.x, cb0[54].z
dp2 r0.x, cb0[55].xyxx, v3.xyxx
add r6.y, r0.x, cb0[55].z
sample_indexable(texture2d)(float,float,float,float) r3.zw, r6.xyxx, t12.zwxy, s2
add r3.zw, r3.zzzw, -cb0[57].xxxy
mad r3.zw, r3.zzzw, cb0[56].xxxx, v3.xxxy
mad r3.zw, r3.zzzw, cb0[58].xxxy, cb0[58].zzzw
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r3.zwzz, t13.xyzw, s2
mad r6.xyz, r6.xyzx, cb0[59].xxxx, cb0[59].yyyy
mul r5.xyz, r5.xyzx, r6.xyzx
mul r4.xyz, r4.xyzx, r5.xyzx
max r4.xyz, r4.xyzx, cb0[60].xxxx
min r4.xyz, r4.xyzx, cb0[61].xxxx
mul r4.xyz, r4.xyzx, cb0[62].xyzx
mul r4.xyz, r0.zzzz, r4.xyzx
mul r5.xyz, r8.zzzz, r4.xyzx
mad r4.xyz, r4.xyzx, r8.zzzz, r2.xyzx
max r0.x, r4.y, r4.x
max r0.x, r4.z, r0.x
