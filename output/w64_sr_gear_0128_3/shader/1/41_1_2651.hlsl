...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r0.w = cb0[5].x * r0.w + cb0[3].x;
  r1.x = cb0[7].x * cb0[6].x;
  r0.w = r0.w * r1.x + -cb0[2].x;
  r0.w = cb0[8].x * r0.w + cb0[2].x;
  r0.w = cb0[1].x + r0.w;
  r0.w = max(cb0[9].x, r0.w);
  r0.w = min(cb0[10].x, r0.w);
  r0.w = cb0[11].x * r0.w;
  ...
  o5.xyzw = cb12[14].xyzw + r3.xyzw;
  o4.xyz = cb12[7].xyz + r5.xyz;
  r0.x = dot(r2.yzw, r2.yzw);
  r0.x = rsqrt(r0.x);
  r0.xyw = r2.yzw * r0.xxx;
  r2.x = dot(r7.xyz, r0.xyw);
  r2.y = dot(r4.xyz, r0.xyw);
  r2.z = dot(r8.xyz, r0.xyw);
  r0.x = dot(r1.xyz, r1.xyz);
  r0.x = rsqrt(r0.x);
  r0.xyw = r1.xyz * r0.xxx;
  r1.x = dot(r7.xyz, r0.xyw);
  r1.y = dot(r4.xyz, r0.xyw);
  r1.z = dot(r8.xyz, r0.xyw);
