  ...
  out float4 o1 : SV_TARGET1)
{
  ...
  r5.xyz = r4.xyz * cb0[14].xyz + cb0[15].xyz;
  r5.xyz = t4.Sample(s1_s, r5.xyz).xyz;
  r5.xyz = -cb0[16].xyz + r5.xyz;
  r4.xyz = r5.xyz * cb0[13].xxx + r4.xyz;
  r4.xyz = r4.xyz * cb0[17].xyz + cb0[18].xyz;
  r2.w = t3.Sample(s1_s, r4.xyz).x;
  r2.w = 1 + -r2.w;
  r2.w = saturate(r2.w * cb0[19].x + cb0[19].y);
  r4.xyz = saturate(cb0[12].xyz + r2.www);
  ...
  if (r2.w != 0) {
    ...
    r0.z = saturate(cb0[8].y * r0.w + cb0[8].x);
    r5.yzw = cb0[9].xyz * cb0[10].xxx + -cb0[11].xyz;
    r5.yzw = r0.zzz * r5.yzw + cb0[11].xyz;
    ...
    r4.w = dot(r1.xyz, -r6.xyz);
    r4.w = 9.99999975e-006 + abs(r4.w);
    ...
    r1.xyz = r0.yyy * cb0[25].xyz + r5.yzw;
    r2.xyz = r0.zzz * cb0[25].xyz + r5.yzw;
    r1.xyz = r1.xyz * r0.xxx;
