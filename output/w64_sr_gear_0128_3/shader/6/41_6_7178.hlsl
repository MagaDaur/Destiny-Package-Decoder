...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r3.z = (uint)r0.w;
    r5.y = 2.32830644e-010 * r3.z;
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r3.z = (uint)r0.w;
    r5.xz = float2(2.32830644e-010,2.32830644e-010) * r3.yz;
    r1.w = r3.y * -1.16415322e-010 + 1.25;
    r3.yzw = r3.xxx * float3(7.50445747e-011,7.2853451e-010,1.33330472e-010) + float3(0,-1.132043,0.427350014);
    ...
    r0.w = max(cb0[7].y, 0.00100000005);
    r3.xyz = r3.xyz * r0.www;
