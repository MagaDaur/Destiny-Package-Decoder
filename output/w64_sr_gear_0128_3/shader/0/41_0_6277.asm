...
mad_sat r4.w, cb7[r3.w + 0].y, r2.x, cb7[r3.w + 0].x
mad_sat r3.w, cb7[r3.w + 0].w, r4.w, cb7[r3.w + 0].z
add r3.w, -r3.x, r3.w
...
add r4.xzw, -r2.yyzw, r12.xxyz
mad r2.yzw, r3.yyyy, r4.xxzw, r2.yyzw
add r4.xz, -r0.zzwz, r5.xxzx
mad r0.zw, r3.yyyy, r4.xxxz, r0.zzzw
add r3.x, -r2.x, r3.x
mad r2.x, r3.y, r3.x, r2.x
add r3.x, r5.w, -r6.w
mad r5.y, r3.y, r3.x, r6.w
add r3.x, -r1.x, r3.w
mad r1.x, r3.y, r3.x, r1.x
add r3.x, l(128.500000), cb7[r3.z + 0].x
mul r3.x, r3.x, l(0.00390625000)
ge r3.y, l(0.050000), r5.w
movc r3.x, r3.y, r3.x, l(-1.000000)
min r1.x, r1.x, r2.x
lt r2.x, l(0.000100), r1.y
mul r3.y, r1.y, l(-2.000000)
mad r1.y, r1.y, l(-2.000000), l(-0.200000)
mul r1.y, r1.x, r1.y
mad r1.y, r1.y, l(-5.002501), r3.y
min r1.y, r1.y, r1.x
...
mov r11.z, r9.y
add r0.zw, -r11.zzzx, r5.xxxy
mad r0.zw, r1.wwww, r0.zzzw, r11.zzzx
mul r1.x, r1.z, r1.w
movc o0.w, r0.y, r3.x, r4.y
add r1.yzw, cb0[14].xxyz, cb0[15].xxyz
mad r0.y, r8.w, cb0[16].x, cb0[16].y
mul r3.xyz, r0.yyyy, r1.yzwy
mad r1.yzw, r1.yyzw, r0.yyyy, r2.xxyz
max r0.y, r1.z, r1.y
max r0.y, r1.w, r0.y
add_sat r0.y, r0.y, l(-1.000000)
add r0.y, -r0.y, l(1.000000)
mad r1.yzw, r2.xxyz, r0.yyyy, r3.xxyz
max r0.y, r1.z, r1.y
max r0.y, r1.w, r0.y
