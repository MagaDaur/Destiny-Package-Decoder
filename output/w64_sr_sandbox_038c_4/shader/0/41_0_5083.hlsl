  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = exp2(r0.x);
  r0.y = 1 + -r0.x;
  r0.x = cb0[116].x * r0.y + r0.x;
  r0.x = 1 + -r0.x;
  r0.x = saturate(r0.x * -3.33277798 + 0.999832988);
  r0.xyzw = r0.xxxx * float4(0.203415006,0.203415006,0.203415006,0) + cb0[112].xyzw;
  r1.xyz = v4.zzz * v3.xyz;
  r1.x = dot(r1.xyz, float3(0.300000012,0.589999974,0.109999999));
  r1.yzw = v3.xyz * v4.zzz + -r1.xxx;
  r1.xyz = v3.www * r1.yzw + r1.xxx;
  r2.x = saturate(v4.y);
