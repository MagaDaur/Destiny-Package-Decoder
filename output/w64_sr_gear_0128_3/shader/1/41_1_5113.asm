...
mul r1.xyzw, r6.yyyy, cb12[1].xyzw
mad r1.xyzw, cb12[0].xyzw, r6.xxxx, r1.xyzw
mad r1.xyzw, cb12[2].xyzw, r6.zzzz, r1.xyzw
add o6.xyzw, r1.xyzw, cb12[14].xyzw
dp3 r1.x, r3.yzwy, r3.yzwy
rsq r1.x, r1.x
mul r1.xyz, r1.xxxx, r3.yzwy
dp3 r3.x, r8.xyzx, r1.xyzx
