...
// unknown dcl_: dcl_input_sgv v8.x, vertex_id
  ...
  r0.xyz = r0.xzw * float3(0.180000007,0.180000007,0.180000007) + r2.xyz;
  ...
  o0.w = r1.w;
  r0.x = 10000 + -r0.w;
  r0.y = 0.280000001 * v3.x;
  r0.y = frac(r0.y);
  r0.z = cb0[96].x * r0.y;
  r0.y = cb0[102].x + -r0.y;
  r0.y = 1 + r0.y;
  r0.y = saturate(3.33333302 * r0.y);
  r0.z = -r0.z * 0.666666985 + -1;
  r0.z = r0.w * 0.666666985 + r0.z;
