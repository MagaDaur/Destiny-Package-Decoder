  ...
  out float4 o3 : SV_TARGET3)
{
  ...
  r4.xzw = v7.yyy * r3.xyz;
  r4.x = dot(r4.xzw, float3(0.300000012,0.589999974,0.109999999));
  r3.xyz = r3.xyz * v7.yyy + -r4.xxx;
  r3.xyz = v6.zzz * r3.xyz + r4.xxx;
  r2.w = saturate(v7.x * r2.w);
