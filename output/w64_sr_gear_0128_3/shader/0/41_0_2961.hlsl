  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.z = 0.125 * r0.z;
  r0.y = frac(r0.z);
  r0.zw = r0.xy * cb0[9].xy + cb0[9].zw;
  r0.zw = t0.Sample(s3_s, r0.zw).xy;
  r0.zw = float2(-0.5,-0.5) + r0.zw;
  r1.xy = r0.xy * float2(-4,1) + float2(1.5,0);
  r0.xy = r0.xy * cb0[8].xy + cb0[8].zw;
  r0.xy = t0.Sample(s3_s, r0.xy).xy;
  r0.xy = float2(-0.5,-0.5) + r0.xy;
  r0.zw = r0.zw * cb0[109].xx + r1.xy;
  r0.xy = r0.xy * cb0[109].xx + r0.zw;
  r0.x = t1.Sample(s4_s, r0.xy).x;
  r0.yzw = cb0[96].xyz + r0.xxx;
  r0.x = cb0[99].x * r0.x;
  r0.yzw = cb0[12].xyz * r0.yzw;
  r1.xy = float2(20,20) * v0.xy;
  r1.x = t2.Sample(s3_s, r1.xy).y;
  r1.x = saturate(r1.x * 4 + -0.600000024);
  r1.xyz = r1.xxx * float3(0.0207250006,0.0207250006,0.0207250006) + cb0[115].xyz;
  r1.xyz = cb0[98].xyz * r1.xyz;
  r2.xyz = cmp(float3(1,2,3) < v0.xxx);
  r3.xyz = r2.zzz ? cb0[12].xyz : cb0[98].xyz;
  r1.xyz = r2.yyy ? r3.xyz : r1.xyz;
  r0.yzw = r2.xxx ? r1.xyz : r0.yzw;
  r0.x = r2.x ? cb0[100].x : r0.x;
  r0.x = saturate(cb0[119].x * r0.x);
  ...
  r1.x = sqrt(r1.x);
  r1.y = 0.015625 * r1.x;
  r1.x = saturate(r1.x * cb0[103].x + cb0[103].y);
  r1.y = min(1, r1.y);
  r2.z = sqrt(r1.y);
