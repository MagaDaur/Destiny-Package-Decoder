...
mul r3.xyzw, cb0[11].xxxx, cb0[13].xyzw
lt r0.yz, l(0.000000, 1.000000, 0.000000, 0.000000), v3.yyxy
movc r1.xyzw, r0.zzzz, r1.xyzw, r3.xyzw
mul r3.xyzw, cb0[11].xxxx, cb0[14].xyzw
and r3.xyzw, r0.zzzz, r3.xyzw
movc r1.xyzw, r0.yyyy, r3.xyzw, r1.xyzw
mul r3.xyzw, cb0[8].xyzw, cb0[10].xyzw
mad r3.xyzw, cb0[8].xyzw, cb0[9].xyzw, r3.xyzw
