  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.yz = cb0[16].xx * r1.xy;
  r1.xy = cb0[13].xx * r1.xy;
  r1.xy = r1.xy / r0.xx;
  r0.xy = r0.yz / r0.xx;
  r0.xy = v3.xy + -r0.xy;
  ...
  r0.z = t6.Sample(s4_s, v3.xy).x;
  r1.xyzw = cb0[15].xyzw * r0.zzzz;
  r2.xyzw = r0.xxxx * cb0[17].xyzw + -r1.xyzw;
  r1.xyzw = cb0[18].xxxx * r2.xyzw + r1.xyzw;
  r0.xyzw = r0.yyyy * cb0[14].xyzw + r1.xyzw;
