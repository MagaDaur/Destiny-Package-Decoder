  ...
  out float4 o3 : SV_POSITION0)
{
  ...
  r1.xyz = r1.xyz * float3(0.5,0.5,0.5) + float3(0,-0.150000006,-0.180000007);
  r1.w = 1.57050002 + v1.w;
  r1.xyzw = float4(0.100000001,0.349999994,8,0.5) * r1.xyzw;
  sincos(r1.w, r2.x, r3.x);
  r0.xyz = r3.xxx * r1.xyz;
  r2.xyz = float3(0,0,1) * r2.xxx;
  r4.xyzw = -r2.zyyz * r1.yzxz;
  r1.xyz = -r1.zxy * -r2.yzy + r4.xyz;
  r1.w = -r4.w;
  r0.xyzw = r1.xyzw + r0.xyzw;
  r1.xyz = r2.zyy * r0.yzx;
  r1.xyz = r2.yzy * r0.zxy + -r1.xyz;
  r0.xyz = r3.xxx * r0.xyz + r1.xyz;
  r0.xyz = r0.www * r2.yyz + r0.xyz;
  ...
  r4.xyz = v5.xyz;
  r4.w = 0;
  r5.xyzw = v5.yzxz * -r2.zyyz;
  r6.xyz = -v5.zxy * -r2.yzy + r5.xyz;
  r6.w = -r5.w;
  r4.xyzw = r3.xxxx * r4.xyzw + r6.xyzw;
  r1.yzw = r4.yzx * r2.zyy;
  r1.yzw = r2.yzy * r4.zxy + -r1.yzw;
