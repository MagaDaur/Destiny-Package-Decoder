...
mad r0.yz, v3.xxyx, cb0[28].xxyx, cb0[28].zzwz
...
max r0.x, r0.x, cb0[17].x
min r0.x, r0.x, cb0[18].x
mad r0.yz, v3.xxyx, cb0[21].xxyx, cb0[21].zzwz
dp2 r1.w, cb0[22].xyxx, r0.yzyy
add r5.x, r1.w, cb0[22].z
dp2 r0.y, cb0[23].xyxx, r0.yzyy
add r5.y, r0.y, cb0[23].z
sample_indexable(texture2d)(float,float,float,float) r0.y, r5.xyxx, t10.yxzw, s2
mad r5.xy, v3.xyxx, cb0[24].xyxx, cb0[24].zwzz
sample_indexable(texture2d)(float,float,float,float) r0.z, r5.xyxx, t11.yzxw, s2
mad r0.z, r0.z, cb0[25].x, cb0[25].y
mul r0.y, r0.z, r0.y
mad r0.y, cb0[20].x, r0.y, cb0[19].x
mul r0.y, r0.y, r8.z
mul r0.x, r0.y, r0.x
