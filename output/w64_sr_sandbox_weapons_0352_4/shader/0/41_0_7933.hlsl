  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = sqrt(r0.w);
  r1.x = 0.015625 * r0.w;
  r0.w = saturate(r0.w * cb0[118].x + cb0[118].y);
  r1.x = min(1, r1.x);
  r1.z = sqrt(r1.x);
  ...
  r0.xyz = r0.xyz * float3(375,409.913513,500) + r2.xyz;
  ...
  r1.z = sqrt(r1.z);
  r1.z = saturate(r1.z * -15.8730173 + 3.96825409);
  r1.z = cb0[104].x * r1.z;
  r2.xy = r1.xy * cb0[10].xy + cb0[10].zw;
  r1.x = t2.Sample(s1_s, r1.xy).x;
  r1.x = 1 + -r1.x;
  r1.x = saturate(r1.x * 1.53999996 + -0.435779989);
  r1.y = t1.Sample(s1_s, r2.xy).x;
  r1.y = saturate(r1.y * cb0[12].x + cb0[12].y);
  r1.y = r1.y * r1.z;
  r1.x = r1.y * r1.x;
