  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.xy = t3.Sample(s5_s, v0.xy).xy;
  r3.xy = r3.xy * v6.xx + v0.xy;
  r3.xy = v6.xx * float2(-0.5,-0.5) + r3.xy;
  ...
  r4.xyz = w1.xww * r3.xyw;
  r4.x = dot(r4.xyz, float3(0.300000012,0.589999974,0.109999999));
  r3.xyw = r3.xyw * w1.xww + -r4.xxx;
  r3.xyw = v7.yyy * r3.xyw + r4.xxx;
