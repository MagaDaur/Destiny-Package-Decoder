...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r2.x = cb0[7].x * cb0[4].x;
  r2.y = cb0[7].y * cb0[5].x;
  r2.z = cb0[7].z * cb0[6].x;
  ...
  r4.yzw = r3.xxx * r3.yzw;
  r5.xyz = -r2.xyz + r1.xyz;
  r6.xyz = r5.zxy * -r4.zwy;
  r6.xyz = r5.yzx * -r4.wyz + -r6.xyz;
  r1.w = dot(r5.xyz, -r4.yzw);
  r6.w = -r1.w;
  r5.xyz = r5.xyz * r4.xxx;
  r5.w = 0;
  r5.xyzw = r6.xyzw + r5.xyzw;
  r6.xyz = r5.yzx * r4.wyz;
  r6.xyz = r4.zwy * r5.zxy + -r6.xyz;
  r5.xyz = r4.xxx * r5.xyz + r6.xyz;
  r5.xyz = r5.www * r4.yzw + r5.xyz;
  r2.xyz = r5.xyz + r2.xyz;
  r5.xyz = v1.zxy * -r4.zwy;
  r5.xyz = v1.yzx * -r4.wyz + -r5.xyz;
  r1.w = dot(v1.xyz, -r4.yzw);
  r5.w = -r1.w;
  r6.xyz = v1.xyz;
  r6.w = 0;
  ...
  r7.xyz = v2.zxy * -r4.zwy;
  r7.xyz = v2.yzx * -r4.wyz + -r7.xyz;
  r1.w = dot(v2.xyz, -r4.yzw);
  r7.w = -r1.w;
  r8.xyz = v2.xyz;
  r8.w = 0;
  r7.xyzw = r4.xxxx * r8.xyzw + r7.xyzw;
  r9.xyz = r7.yzx * r4.wyz;
  r9.xyz = r4.zwy * r7.zxy + -r9.xyz;
  r7.xyz = r4.xxx * r7.xyz + r9.xyz;
  r4.xyz = r7.www * r4.yzw + r7.xyz;
  r4.xyz = -v2.xyz + r4.xyz;
  r7.xyz = r2.xyz + -r1.xyz;
  r9.x = cb0[10].x * cb0[7].x;
  r9.y = cb0[11].x * cb0[7].y;
  r9.z = cb0[12].x * cb0[7].z;
  r1.w = cb0[8].x * cb0[1].x;
  r1.w = r1.w * r0.z;
  r1.w = cb0[9].x * r1.w;
  r1.w = 3.14100003 * r1.w;
  sincos(r1.w, r3.x, r10.x);
  r3.xyz = r3.xxx * r3.yzw;
  r10.yzw = -r9.xyz + r2.xyz;
  r11.xyz = r10.wyz * -r3.yzx;
  r11.xyz = r10.zwy * -r3.zxy + -r11.xyz;
  r1.w = dot(r10.yzw, -r3.xyz);
  r11.w = -r1.w;
  r12.xyz = r10.xxx * r10.yzw;
  r12.w = 0;
  r11.xyzw = r12.xyzw + r11.xyzw;
  r10.yzw = r11.yzx * r3.zxy;
  r10.yzw = r3.yzx * r11.zxy + -r10.yzw;
  r10.yzw = r10.xxx * r11.xyz + r10.yzw;
  r10.yzw = r11.www * r3.xyz + r10.yzw;
  r9.xyz = r10.yzw + r9.xyz;
  r10.yzw = r5.zxy * -r3.yzx;
  r11.xyz = r5.yzx * -r3.zxy + -r10.yzw;
  ...
  r10.yzw = r10.xxx * r11.xyz + r10.yzw;
  r10.yzw = r11.www * r3.xyz + r10.yzw;
  r5.xyz = r10.yzw + -r5.xyz;
  r10.yzw = v2.zxy * -r3.yzx;
  r11.xyz = v2.yzx * -r3.zxy + -r10.yzw;
  r1.w = dot(v2.xyz, -r3.xyz);
  r11.w = -r1.w;
  r8.xyzw = r10.xxxx * r8.xyzw + r11.xyzw;
  r10.yzw = r8.yzx * r3.zxy;
  r10.yzw = r3.yzx * r8.zxy + -r10.yzw;
  r8.xyz = r10.xxx * r8.xyz + r10.yzw;
  r3.xyz = r8.www * r3.xyz + r8.xyz;
