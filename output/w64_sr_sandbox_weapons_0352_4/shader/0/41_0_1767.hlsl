  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.yz = cb0[19].xx * r2.xy;
  r1.xy = cb0[22].xx * r2.xy;
  r1.xy = r1.xy / r0.xx;
  r0.xy = r0.yz / r0.xx;
  r0.zw = v3.xy * cb0[18].xy + cb0[18].zw;
  r0.xy = r0.zw + -r0.xy;
  r0.xyzw = t0.Sample(s3_s, r0.xy).xyzw;
  r0.x = dot(r0.xyzw, cb0[20].xyzw);
  r0.yz = v3.xy * cb0[21].xy + cb0[21].zw;
  r0.yz = r0.yz + -r1.xy;
  r1.xyzw = t0.Sample(s4_s, r0.yz).xyzw;
  r0.y = dot(r1.xyzw, cb0[23].xyzw);
  r0.x = r0.x * r0.y;
  r0.y = dot(v3.xy, cb0[17].xy);
  r0.y = saturate(cb0[17].z + r0.y);
  r0.y = cb0[15].w * r0.y + cb0[14].w;
  r0.x = r0.y * r0.x;
  r0.xyzw = cb0[24].xyzw * r0.xxxx;
