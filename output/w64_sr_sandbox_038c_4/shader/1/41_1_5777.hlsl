...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  if (r0.x != 0) {
    ...
    r4.z = dot(r4.xyz, r1.xyz);
    r4.x = dot(r5.xyz, r1.xyz);
    r4.y = dot(r2.xyz, r1.xyz);
    r1.xyz = r6.zxy * r4.xyz;
    r1.xyz = r6.yzx * r4.yzx + -r1.xyz;
    o2.xyz = v2.www * r1.xyz;
    r1.xyzw = v3.xyxy * cb1[6].xyxy + cb1[6].zwzw;
    r2.xy = r1.zw * cb0[2].xy + cb0[2].zw;
    r2.x = t3.SampleLevel(s1_s, r2.xy, 0).x;
    r2.x = saturate(r2.x * cb0[3].x + cb0[3].y);
    r2.x = cb0[1].x * r2.x;
    r2.yzw = cb0[0].xyz * r2.xxx;
    r3.xyz = cb0[0].xyz * r2.xxx + r3.xyz;
    o4.xyz = cb12[7].xyz + r3.xyz;
    r3.xyzw = cb12[1].xyzw * r2.zzzz;
    r3.xyzw = cb12[0].xyzw * r2.yyyy + r3.xyzw;
    r2.xyzw = cb12[2].xyzw * r2.wwww + r3.xyzw;
    o5.xyzw = r2.xyzw + r0.xyzw;
    o0.xyz = r6.xyz;
    o0.w = 1;
    o1.xyzw = r4.zxyy;
    o3.xyzw = r1.xyzw;
