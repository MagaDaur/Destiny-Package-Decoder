...
// unknown dcl_: dcl_input_sgv v3.x, vertex_id
  ...
  r0.xzw = r0.xzw * float3(0.150000006,0.150000006,0.150000006) + r1.xyz;
  ...
  r0.xyz = r2.xyz * float3(0.150000006,0.150000006,0.150000006) + r0.xzw;
  ...
  r1.x = 0.280000001 * v2.x;
  r1.x = frac(r1.x);
  r1.y = cb0[106].x * r1.x;
  r1.x = cb0[112].x + -r1.x;
  r1.x = 1 + r1.x;
  r1.x = saturate(3.33333302 * r1.x);
  r1.y = -r1.y * cb0[116].x + cb0[116].y;
  r1.y = saturate(r2.x * cb0[116].x + r1.y);
  r1.x = r1.y * r1.x;
  r1.x = cb0[9].y * r1.x;
  r1.x = cb0[122].x * r1.x;
