...
sample_indexable(texture2d)(float,float,float,float) r2.xyz, v3.xyxx, t3.xyzw, s5
add r0.w, -r2.z, r2.y
...
sample_indexable(texture2d)(float,float,float,float) r4.xy, v3.xyxx, t2.zwxy, s4
...
dp2 r0.w, cb0[8].xyxx, v3.xyxx
add r3.x, r0.w, cb0[8].z
dp2 r0.w, cb0[9].xyxx, v3.xyxx
add r3.y, r0.w, cb0[9].z
mad r3.xy, r3.xyxx, cb0[10].xyxx, cb0[10].zwzz
sample_indexable(texture2d)(float,float,float,float) r0.w, r3.xyxx, t26.yzwx, s2
mad r0.w, r0.w, cb0[11].x, cb0[11].y
mul r1.w, cb0[12].x, cb0[12].x
mul r0.w, r0.w, r1.w
mad r0.w, r0.w, r4.y, -cb0[7].w
