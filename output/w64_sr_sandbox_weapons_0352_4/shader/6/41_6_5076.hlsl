...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r8.z = r5.w * 0.75 + 0.25;
    r9.xyz = r4.xzw * float3(0.349999994,0.12500003,0.0324999988) + float3(0.150000006,0.474999994,0.0675000027);
    r10.xyzw = r5.yyyy * float4(0,-29.0015869,0.449999988,-0.0276319999) + float4(0,7.74040604,0.550000012,1.00263202);
    ...
    r8.w = r4.x * r4.y + r5.x;
    r7.xyz = r4.zzz * float3(0.829999983,0.850000024,-0.799999952) + float3(0.670000017,1.14999998,2);
    r11.x = r10.z * r9.z;
    r11.y = r4.z * 2 + 1;
    r4.x = r4.w * r4.w;
    r4.x = r4.x * 175 + 125;
