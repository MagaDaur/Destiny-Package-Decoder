...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  o0.w = r0.w;
  r1.y = 0.280000001 * v2.x;
  r1.y = frac(r1.y);
  r1.z = cb0[97].x * r1.y;
  r1.y = cb0[103].x + -r1.y;
  r1.y = 1 + r1.y;
  r1.y = saturate(3.33333302 * r1.y);
  r1.z = -r1.z * cb0[107].x + cb0[107].y;
  r1.x = saturate(r1.x * cb0[107].x + r1.z);
  r1.x = r1.x * r1.y;
  r1.x = cb0[9].y * r1.x;
  r1.x = cb0[113].x * r1.x;
