...
if_nz r0.x
  ...
  mad r0.w, r0.z, l(-1.528888), l(2.533903)
  mul r4.x, r0.z, r0.z
  mul r0.w, r0.w, r4.x
  ge r4.xyz, r0.zzzz, l(0.000000, 0.990000, 1.000000, 0.000000)
  and r4.xyw, r4.xyxz, l(0x3f800000, 0x3f800000, 0, 0x3f800000)
  add r4.xyz, r4.ywwy, r4.xywx
  add r4.xyz, r4.xyzx, l(0.000001, 0.000001, 0.000001, 0.000000)
  mul r4.xyz, r4.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000)
  frc r4.xyz, r4.xyzx
  mul r4.x, r0.w, r4.x
  mul r0.zw, r4.xxxy, l(0.000000, 0.000000, 2.000000, 2.000000)
  add r0.z, r0.w, r0.z
  mad r0.z, r4.z, l(2.000000), r0.z
  mad r0.z, r4.w, l(1.000000), r0.z
