  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.xy = float2(0,0.219525993);
  r1.z = v3.y;
  r2.xy = r1.yz * r0.zw;
  r1.w = dot(r2.xy, float2(0.589999974,0.109999999));
  r0.yzw = r0.yzw * r1.xyz + -r1.www;
  r0.yzw = r0.yzw * float3(0.899999976,0.899999976,0.899999976) + r1.www;
