  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r3.z = saturate(cb7[r4.z+0].y * r8.z + cb7[r4.z+0].x);
  r3.z = saturate(cb7[r4.z+0].w * r3.z + cb7[r4.z+0].z);
  r11.xyz = saturate(float3(7.96875,4,7.96875) * r9.wyz);
  r4.z = cb0[2].x + 128.5;
  r4.z = 0.00390625 * r4.z;
  r7.w = cmp(0.0500000007 >= r11.x);
  r4.z = r7.w ? r4.z : -1;
  ...
  r2.yzw = r3.zzz * r6.xyz + r2.yzw;
  r4.yw = r5.xz + -r0.zw;
  r0.zw = r3.zz * r4.yw + r0.zw;
  r3.x = r3.x + -r2.x;
  r2.x = r3.z * r3.x + r2.x;
  r3.x = -r6.w + r5.w;
  r5.y = r3.z * r3.x + r6.w;
  ...
  r3.xyw = r1.yzw * r3.zzz;
  r1.yzw = r1.yzw * r3.zzz + r2.xyz;
  r0.y = max(r1.y, r1.z);
  r0.y = max(r0.y, r1.w);
  ...
  if (r3.x != 0) {
    ...
    r3.x = r3.x ? r3.z : r4.y;
    r3.x = r4.x ? r3.x : r3.w;
    r3.y = cmp(0.5 >= cb0[3].x);
    r3.z = cb0[3].x + cb0[3].x;
    r3.z = r3.x * -r3.z + r3.z;
    r3.w = cb0[3].x * 2 + -2;
    r3.x = r3.x * r3.w + 1;
    r3.x = r3.y ? r3.z : r3.x;
