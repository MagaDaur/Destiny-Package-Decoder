...
mul r5.xyz, -r2.yzxy, v2.zxyz
mad r5.xyz, v2.yzxy, -r2.zxyz, -r5.xyzx
...
add r3.xyz, -r1.xyzx, r3.yzwy
add r5.x, r3.x, cb0[5].x
add r5.y, r3.y, cb0[6].x
add r5.z, r3.z, cb0[7].x
add r3.xyz, r5.xyzx, -cb0[0].xyzx
mad r3.xyz, cb0[9].xxxx, r3.xyzx, cb0[0].xyzx
...
mad r1.xyw, cb0[9].xxxx, r4.xyxz, v1.xyxz
...
mad r1.xyw, cb0[9].xxxx, r2.xyxz, v2.xyxz
