...
mad r0.zw, v3.xxxy, cb0[13].xxxy, cb0[13].zzzw
sample_indexable(texture2d)(float,float,float,float) r0.z, r0.zwzz, t4.yzxw, s3
mad r0.y, r0.z, cb0[14].x, r0.y
mul r1.xyzw, cb0[17].xxxx, cb0[18].xyzw
mul r1.xyzw, r0.yyyy, r1.xyzw
mad r1.xyzw, cb0[11].xyzw, cb0[12].xyzw, r1.xyzw
mul r3.xyzw, cb0[9].xxxx, cb0[10].xyzw
mul r1.xyzw, r1.xyzw, r3.xyzw
mul r0.x, r0.x, r1.w
mul r0.yzw, r1.xxyz, cb0[19].xxxx
