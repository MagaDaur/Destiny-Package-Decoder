  ...
  out float4 o11 : SV_POSITION0)
{
  ...
  o10.y = v7.w;
  o10.w = v8.z;
  r0.y = cmp(v8.z < 9.99999997e-007);
  r0.x = (int)r0.y | (int)r0.x;
  o11.xyzw = r0.xxxx ? float4(10000,10000,-10000,1) : r4.xyzw;
  return;
}