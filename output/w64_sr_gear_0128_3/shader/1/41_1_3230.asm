...
add r1.zw, r0.wwww, l(0.000000, 0.000000, 1.000000, 3.000000)
ftou r1.zw, r1.zzzw
ld_indexable(buffer)(float,float,float,float) r2.xyzw, r1.zzzz, t2.xyzw
ld_indexable(buffer)(float,float,float,float) r1.zw, r1.wwww, t2.xwyz
mov x0[0].y, l(0)
...
sqrt r0.z, r0.z
mad r1.y, r0.z, l(4.000000), l(-2.000000)
add r0.z, -r0.z, l(10000.000000)
min_sat r0.z, r0.z, r1.y
mul r0.z, r0.z, cb0[11].y
mul r0.z, r0.z, cb0[112].x
lt r1.y, l(0.999000), r2.w
movc o0.z, r1.y, l(0), r0.z
