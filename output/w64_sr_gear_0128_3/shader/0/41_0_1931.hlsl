  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.yz = v3.xy * cb0[14].xy + cb0[14].zw;
  r0.yz = t10.Sample(s2_s, r0.yz).xy;
  r0.yz = -cb0[16].xy + r0.yz;
  r0.yz = r0.yz * cb0[15].xx + v3.xy;
  r0.yz = r0.yz * cb0[17].xy + cb0[17].zw;
  r1.w = dot(cb0[18].xy, r0.yz);
  r5.x = cb0[18].z + r1.w;
  r0.y = dot(cb0[19].xy, r0.yz);
  r5.y = cb0[19].z + r0.y;
  r0.y = t11.Sample(s2_s, r5.xy).x;
  r3.xw = t10.Sample(s2_s, v3.xy).xy;
  r3.xw = -cb0[22].xy + r3.xw;
  r3.xw = r3.xw * cb0[21].xx + v3.xy;
  r3.xw = r3.xw * cb0[23].xy + cb0[23].zw;
  r0.z = t12.Sample(s2_s, r3.xw).x;
  r0.z = r0.z * cb0[24].x + cb0[24].y;
  r0.z = cb0[25].x * r0.z;
  r0.y = r0.y * cb0[20].x + r0.z;
  r0.y = max(0, r0.y);
  r0.y = log2(r0.y);
  r0.y = cb0[26].x * r0.y;
  r0.y = exp2(r0.y);
