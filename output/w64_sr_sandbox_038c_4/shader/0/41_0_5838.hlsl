  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.x = 1 + -r3.x;
  r3.yz = float2(0.699999988,0.699999988) * v0.xy;
  r3.y = t0.Sample(s1_s, r3.yz).x;
  r3.y = r3.y * 0.899999976 + -0.5;
  r3.yzw = v3.xyz * r3.yyy;
  r2.w = -r2.w * r2.w + 1;
  r2.w = max(0, r2.w);
  r3.yzw = r3.yzw * r2.www;
  r3.yzw = r3.yzw * v4.www + float3(-2.51188652e-007,-2.51188652e-007,-2.51188652e-007);
  r3.yzw = float3(1.00000024,1.00000024,1.00000024) * r3.yzw;
  r3.yzw = max(float3(0,0,0), r3.yzw);
  r3.yzw = w1.xww * r3.yzw;
  r3.yzw = float3(0.0379710011,0.391573012,0.271025985) * r3.yzw;
  r2.w = saturate(v5.w);
  ...
  r2.x = -1 + r2.x;
  r0.w = r0.w * r2.x + 1;
  r1.x = saturate(dot(cb0[125].xyz, r1.xyz));
  r1.yzw = cb0[124].xyz * r1.www;
  ...
  r0.z = saturate(r1.w * cb0[131].x + cb0[131].y);
