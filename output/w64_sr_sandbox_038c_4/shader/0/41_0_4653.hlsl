  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = t2.Sample(s3_s, r0.xy).xy;
  r0.xy = r0.xy * float2(0.100000001,0.100000001) + v0.xy;
  ...
  r0.w = sqrt(r0.w);
  r1.x = 0.015625 * r0.w;
  r0.w = saturate(r0.w * cb0[106].x + cb0[106].y);
  r1.x = min(1, r1.x);
  r1.z = sqrt(r1.x);
  ...
  r0.xyz = r0.xyz * float3(8,0,8) + r2.xyz;
