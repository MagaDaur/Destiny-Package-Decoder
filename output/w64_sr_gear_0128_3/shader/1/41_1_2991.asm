...
mad r0.xyz, r0.xzwx, l(0.050000, 0.050000, 0.050000, 0.000000), r2.xyzx
add r2.xyz, -r2.xyzx, cb12[7].xyzx
dp3 r0.w, r2.xyzx, r2.xyzx
sqrt r0.w, r0.w
mad r0.xyz, r1.xyzx, l(0.050000, 0.050000, 0.050000, 0.000000), r0.xyzx
mad r0.xyz, cb12[4].xyzx, l(-0.007000, -0.007000, -0.007000, 0.000000), r0.xyzx
...
mov o0.w, r1.w
mul r0.x, v3.x, l(0.280000)
frc r0.x, r0.x
mul r0.y, r0.x, cb0[107].x
add r0.x, -r0.x, cb0[113].x
add r0.x, r0.x, l(1.000000)
mul_sat r0.x, r0.x, l(3.333333)
mad r0.y, -r0.y, cb0[117].x, cb0[117].y
mad_sat r0.y, r0.w, cb0[117].x, r0.y
mul r0.x, r0.x, r0.y
mul r0.x, r0.x, cb0[12].y
mul r0.x, r0.x, cb0[122].x
