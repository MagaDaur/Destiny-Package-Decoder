...
add r0.w, r0.w, -v0.w
mul r1.x, v6.w, l(0.300000)
div_sat r0.w, r0.w, r1.x
add r0.w, -r0.w, l(1.000000)
add r0.w, -r0.w, l(1.000000)
sample_indexable(texture2d)(float,float,float,float) r1.xy, v0.xyxx, t1.xyzw, s3
mad r1.zw, r1.xxxy, v6.zzzz, v0.xxxy
log r1.xy, r1.xyxx
mul r1.xy, r1.xyxx, l(2.200000, 2.200000, 0.000000, 0.000000)
exp r1.xy, r1.xyxx
mad r1.xy, r1.xyxx, v5.yyyy, v0.xyxx
mad r1.xy, v5.yyyy, l(-0.500000, -0.500000, 0.000000, 0.000000), r1.xyxx
sample_indexable(texture2d)(float,float,float,float) r1.x, r1.xyxx, t2.xyzw, s3
mad r1.yz, v6.zzzz, l(0.000000, -0.500000, -0.500000, 0.000000), r1.zzwz
mad r1.yz, r1.yyzy, v3.xxyx, v3.zzwz
sample_indexable(texture2d)(float,float,float,float) r1.y, r1.yzyy, t0.yxzw, s3
log r1.y, r1.y
mul r1.y, r1.y, l(2.200000)
exp r1.y, r1.y
mul r1.x, r1.x, r1.y
log r1.x, r1.x
div r1.y, l(1.000000, 1.000000, 1.000000, 1.000000), v5.x
mul r1.x, r1.x, r1.y
exp r1.x, r1.x
mad_sat r1.x, r1.x, v7.y, v7.x
