...
sqrt r0.x, r0.x
mad r0.yz, v3.xxyx, cb0[18].xxyx, cb0[18].zzwz
...
mad r6.xy, r6.xyxx, cb0[19].xxxx, cb0[19].yyyy
...
mul_sat r8.yzw, r7.zzwy, l(0.000000, 7.968750, 7.968750, 4.000000)
...
mad r9.y, r8.z, cb0[2].x, cb0[2].y
add r7.w, l(128.500000), cb0[3].x
mul r7.w, r7.w, l(0.00390625000)
ge r8.z, l(0.050000), r9.y
movc r7.w, r8.z, r7.w, l(-1.000000)
...
mad_sat r3.yzw, r3.yyzw, r8.xxzw, r12.xxyz
...
if_nz r0.z
  ...
  ge r1.y, l(0.500000), cb0[4].x
  add r1.w, cb0[4].x, cb0[4].x
  mad r1.w, r0.z, -r1.w, r1.w
  mad r2.w, cb0[4].x, l(2.000000), l(-2.000000)
...
dp3 r1.y, cb0[8].xyzx, r4.xyzx
add r1.w, -cb0[6].x, cb0[7].x
mad_sat r1.y, r1.y, r1.w, cb0[6].x
add r1.w, v4.z, -cb0[9].z
mul r1.w, r1.w, cb0[10].x
max r1.w, r1.w, l(0.000000)
log r1.w, r1.w
mul r1.w, r1.w, cb0[11].x
exp r1.w, r1.w
mul_sat r1.w, r1.w, cb0[12].x
mul r1.y, r1.w, r1.y
...
log r1.y, r1.y
mul r1.y, r1.y, -cb0[14].x
exp r1.y, r1.y
mul r0.x, r0.x, r1.y
add o2.w, r0.z, v0.w
mad r0.x, r0.x, cb0[16].x, r0.y
