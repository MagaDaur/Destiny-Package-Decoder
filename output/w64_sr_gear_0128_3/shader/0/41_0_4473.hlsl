  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.x = exp2(r0.x);
  r0.x = min(1, r0.x);
  r0.x = cb0[22].x * r0.x + cb0[21].x;
  r2.w = saturate(r7.y * cb0[23].x + cb0[23].y);
  r2.w = cb0[25].x * r2.w + cb0[24].x;
  r0.x = r2.w + r0.x;
  r0.x = r1.w * r0.x;
  r0.x = r0.z * r0.x;
  r0.x = max(0, r0.x);
  ...
  r0.x = exp2(r0.x);
  r0.x = min(1, r0.x);
  r4.xyz = cb0[28].xyz * r0.xxx + cb0[27].xyz;
  r4.xyz = cb0[29].xyz * r4.xyz;
  r4.xyz = r8.zzz * r4.xyz;
  r5.xyz = cb0[14].xxx * r4.xyz;
  r4.xyz = cb0[14].xxx * r4.xyz + r2.xyz;
  r0.x = max(r4.x, r4.y);
  r0.x = max(r0.x, r4.z);
