...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r3.x = r3.x * r3.y;
  r3.x = cb0[3].x * r3.x + cb0[3].y;
  r3.x = max(cb0[4].x, r3.x);
  r3.x = min(cb0[5].x, r3.x);
  r2.w = cb0[6].w * r2.w + cb0[6].z;
  r2.w = 0.25 + r2.w;
  r3.y = round(r2.w);
  r2.w = -r3.y + r2.w;
  r3.y = abs(r2.w) * -16 + 8;
  r2.w = r3.y * r2.w;
  r3.y = abs(r2.w) * 0.224999994 + 0.774999976;
  r2.w = r3.y * r2.w;
  r2.w = cb0[6].x * r2.w + cb0[6].y;
  r2.w = max(cb0[7].x, r2.w);
  r2.w = min(cb0[8].x, r2.w);
  r2.w = r2.w * r0.y;
  r2.w = r3.x * r1.w + r2.w;
  r2.w = r2.w * r0.x;
  ...
  r2.y = dot(r5.xyz, r1.xyw);
  r2.z = dot(r9.xyz, r1.xyw);
  r1.x = dot(r3.xyz, r3.xyz);
  r1.x = rsqrt(r1.x);
  r1.xyw = r3.xyz * r1.xxx;
  r3.x = dot(r8.xyz, r1.xyw);
  r3.y = dot(r5.xyz, r1.xyw);
  r3.z = dot(r9.xyz, r1.xyw);
