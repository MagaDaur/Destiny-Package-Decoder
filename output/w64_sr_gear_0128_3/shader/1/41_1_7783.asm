...
exp r0.w, r0.w
mad r1.y, r0.w, l(-0.850000), l(1.500000)
dp3 r0.w, r4.xyzx, r4.xyzx
rsq r0.w, r0.w
mul r4.xyz, r0.wwww, r4.xyzx
mul r5.xyz, r3.yzxy, r4.zxyz
mad r5.xyz, r4.yzxy, r3.zxyz, -r5.xyzx
mul r4.xyz, r4.xyzx, v8.yyyy
mov o1.xyz, r3.xyzx
mul r3.xyz, r5.xyzx, v8.yyyy
mov r1.x, l(0.650000)
mul r0.xy, r0.xyxx, r1.xyxx
sincos r1.x, r5.x, v4.w
...
mov o8.zw, v8.xxxy
mov o9.xy, v8.zwzz
add r0.y, v8.z, cb0[20].x
lt r0.xy, r0.xyxx, l(0.000001, 0.000001, 0.000000, 0.000000)
or r0.x, r0.y, r0.x
movc o10.xyzw, r0.xxxx, l(10000.000000,10000.000000,-10000.000000,1.000000), r1.xyzw
ret
