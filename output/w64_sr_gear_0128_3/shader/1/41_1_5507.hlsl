...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r2.xyz = cb0[9].xyz * r0.www + r2.xyz;
  r0.z = cb0[2].x + r0.z;
  r1.w = 1 + -r0.z;
  r1.w = cb0[3].w * r1.w + cb0[3].z;
  r1.w = 0.25 + r1.w;
  r2.w = round(r1.w);
  ...
  r1.w = r2.w * r1.w;
  r1.w = cb0[3].x * r1.w + cb0[3].y;
  r1.w = max(cb0[4].x, r1.w);
  r1.w = min(cb0[5].x, r1.w);
  r0.z = cb0[6].w * r0.z + cb0[6].z;
  r0.z = 0.25 + r0.z;
  r2.w = round(r0.z);
  r0.z = -r2.w + r0.z;
  r2.w = abs(r0.z) * -16 + 8;
  r0.z = r2.w * r0.z;
  r2.w = abs(r0.z) * 0.224999994 + 0.774999976;
  r0.z = r2.w * r0.z;
  r0.z = cb0[6].x * r0.z + cb0[6].y;
  r0.z = max(cb0[7].x, r0.z);
  r0.z = min(cb0[8].x, r0.z);
  r0.z = r0.z * r0.y;
  r0.z = r1.w * r0.w + r0.z;
  r0.x = r0.x * r0.z;
  r3.xyz = cb0[1].xyz * r0.yyy;
  r0.yzw = cb0[0].xyz * r0.www + r3.xyz;
  ...
  r3.yzw = r1.zxy * -r0.yzx;
  r4.xyz = r1.yzx * -r0.zxy + -r3.yzw;
  r0.w = dot(r1.xyz, -r0.xyz);
  r4.w = -r0.w;
  r1.xyz = r3.xxx * r1.xyz;
  r1.w = 0;
  r1.xyzw = r4.xyzw + r1.xyzw;
  r3.yzw = r1.yzx * r0.zxy;
  r3.yzw = r0.yzx * r1.zxy + -r3.yzw;
