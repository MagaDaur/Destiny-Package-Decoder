...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r0.x = r1.w * r0.x + r0.y;
  r0.x = r0.w * r0.z + r0.x;
  r0.y = cb0[4].x * cb0[3].x;
  r0.w = cb0[3].x * cb0[3].x;
  r3.x = cb0[0].x * r0.z + r0.y;
  r3.y = cb0[1].x * r0.z + cb0[5].x;
  r3.z = cb0[2].x * r0.z + r0.w;
  ...
  r4.yzw = r3.zxy * -r0.yzx;
  r5.xyz = r3.yzx * -r0.zxy + -r4.yzw;
  r0.w = dot(r3.xyz, -r0.xyz);
  r5.w = -r0.w;
  r3.xyz = r4.xxx * r3.xyz;
  r3.w = 0;
  r3.xyzw = r5.xyzw + r3.xyzw;
  r4.yzw = r3.yzx * r0.zxy;
  r4.yzw = r0.yzx * r3.zxy + -r4.yzw;
  ...
  r0.xyz = cb0[16].xxx * r0.xyz + r1.xyz;
