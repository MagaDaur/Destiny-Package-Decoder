  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.x = r0.x * -0.5 + 0.5;
  r0.x = max(0, r0.x);
  r0.yz = float2(0.699999988,0.699999988) * v0.xy;
  r0.y = t0.Sample(s1_s, r0.yz).x;
  r0.y = r0.y * 0.680999994 + -0.280999988;
  r0.yzw = v3.xyz * r0.yyy;
  r0.xyz = r0.yzw * r0.xxx;
  r0.xyz = r0.xyz * v4.www + float3(-2.51188652e-007,-2.51188652e-007,-2.51188652e-007);
  ...
  r0.w = sqrt(r0.w);
  r1.x = 0.015625 * r0.w;
  r0.w = saturate(r0.w * cb0[123].x + cb0[123].y);
  r1.x = min(1, r1.x);
  r1.z = sqrt(r1.x);
  ...
  r0.xyz = r0.xyz * float3(0.0379710011,0.391573012,0.271025985) + r2.xyz;
