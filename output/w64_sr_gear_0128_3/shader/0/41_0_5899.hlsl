  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xyzw = cb0[13].xyzw * cb0[12].xxxx;
  r1.xyzw = cb0[14].xyzw * cb0[12].xxxx;
  r2.xy = cmp(float2(1,0) < v3.yx);
  r0.xyzw = r2.yyyy ? r0.xyzw : r1.xyzw;
  r1.xyzw = cb0[15].xyzw * cb0[12].xxxx;
  r1.xyzw = r2.yyyy ? r1.xyzw : 0;
  r0.xyzw = r2.xxxx ? r1.xyzw : r0.xyzw;
  r1.x = dot(cb0[10].xy, v3.xy);
  r1.x = cb0[10].z + r1.x;
  r1.z = dot(cb0[11].xy, v3.xy);
  r1.y = cb0[11].z + r1.z;
  r1.x = t4.Sample(s3_s, r1.xy).x;
  r0.xyzw = r1.xxxx * r0.xyzw;
  r0.xyzw = cb0[8].xxxx * cb0[9].xyzw + r0.xyzw;
  r1.x = cb0[7].x * 0.75;
  r1.x = max(0, r1.x);
