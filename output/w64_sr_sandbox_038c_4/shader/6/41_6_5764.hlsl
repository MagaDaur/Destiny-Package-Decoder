...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.w = min(1, r9.x);
    r9.xyz = r0.www * float3(1,0,0) + float3(1,1,1);
    r0.w = r8.y * 0.0700000077 + 0.0799999982;
    r8.x = 0.899999976 * r0.w;
    r11.xyzw = r0.yyyy * float4(-29.7586937,5.83090401,3.98838401,5.24781418) + float4(6.74410582,-11.3702621,0,0.291545004);
    r0.zw = r11.xy * r0.zz + r11.zw;
    r11.xyz = cmp(r0.yyy >= float3(0,0.300000012,1));
