...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r2.yzw = cb9[r0.z+32].yzx * cb9[r0.z+0].zxy;
    r4.xyz = cb9[r0.z+0].yzx * cb9[r0.z+32].zxy + -r2.yzw;
    r0.w = dot(cb9[r0.z+0].xyz, cb9[r0.z+32].xyz);
    r4.w = -r0.w;
    r5.xyz = cb9[r0.z+0].xyz;
    r5.w = 0;
    r4.xyzw = cb9[r0.z+32].wwww * r5.xyzw + r4.xyzw;
    r2.yzw = -cb9[r0.z+32].zxy * r4.yzx;
    r2.yzw = -cb9[r0.z+32].yzx * r4.zxy + -r2.yzw;
    r2.yzw = cb9[r0.z+32].www * r4.xyz + r2.yzw;
    r2.yzw = r4.www * -cb9[r0.z+32].xyz + r2.yzw;
    ...
    r5.xyz = -r2.yzw + r0.yzw;
    r6.xyzw = float4(0.00999999978,0,0,0) * r4.wwww;
    r6.xyzw = r4.zzyx * float4(-0,0.00999999978,-0.00999999978,0.00999999978) + r6.xyzw;
    r0.yzw = r6.yzx * r4.zxy;
    r0.yzw = r4.yzx * r6.zxy + -r0.yzw;
    r0.yzw = r4.www * r6.xyz + r0.yzw;
    r4.xyz = r6.www * r4.xyz + r0.yzw;
  ...
  // No code for instruction (needs manual fix):
    ...
    r1.x = 0;
    r1.zw = r2.xx * float2(2.32830664e-011,2.32830644e-010) + float2(0.200000003,0);
  // No code for instruction (needs manual fix):
