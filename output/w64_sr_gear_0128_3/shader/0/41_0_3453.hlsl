  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r3.zw = v3.xy * cb0[21].xy + cb0[21].zw;
  r0.z = dot(cb0[22].xy, r3.zw);
  r5.x = cb0[22].z + r0.z;
  r0.z = dot(cb0[23].xy, r3.zw);
  r5.y = cb0[23].z + r0.z;
  r0.z = t10.Sample(s2_s, r5.xy).x;
  r3.zw = v3.xy * cb0[24].xy + cb0[24].zw;
  r1.w = t11.Sample(s2_s, r3.zw).x;
  r1.w = r1.w * cb0[25].x + cb0[25].y;
  r0.z = r1.w * r0.z;
  r0.z = cb0[20].x * r0.z + cb0[19].x;
  r0.z = r8.z * r0.z;
  r0.x = r0.x * r0.z;
  r0.x = max(0, r0.x);
  r0.x = log2(r0.x);
