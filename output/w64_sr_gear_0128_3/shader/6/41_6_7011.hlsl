...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r2.x = 0.5 + r4.y;
    r6.xyzw = cb9[r0.y+32].wwww * float4(0.200000003,0,0,0);
    r6.xyzw = cb9[r0.y+32].zzyx * float4(-0,0.200000003,-0.200000003,0.200000003) + r6.xyzw;
    r4.yzw = cb9[r0.y+32].zxy * r6.yzx;
    r4.yzw = cb9[r0.y+32].yzx * r6.zxy + -r4.yzw;
    r4.yzw = cb9[r0.y+32].www * r6.xyz + r4.yzw;
    r4.yzw = r6.www * cb9[r0.y+32].xyz + r4.yzw;
    r4.yzw = cb9[r0.y+0].xyz + r4.yzw;
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r6.x = (uint)r0.w;
    r6.x = r6.x * 4.65661287e-010 + -1;
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r6.w = (uint)r0.w;
    r6.y = r6.w * 4.65661287e-010 + -1;
    r0.w = mad((int)r0.w, 0x0019660d, 0x3c6ef35f);
    r0.w = (uint)r0.w;
    ...
    r6.xyz = float3(0.5,0.100000001,0.100000001) * r6.xyz;
    r7.xyz = float3(1,0,0) * r4.xxx;
    ...
    r9.xyz = -cb9[r0.z+32].zxy * cb9[r0.y+32].yzx;
    r9.xyz = -cb9[r0.z+32].yzx * cb9[r0.y+32].zxy + -r9.xyz;
    r0.w = dot(-cb9[r0.z+32].xyz, cb9[r0.y+32].xyz);
    r10.w = -r0.w;
    r10.xyz = cb9[r0.z+32].www * cb9[r0.y+32].xyz + r9.xyz;
    r9.xyzw = cb9[r0.z+32].xyzw * float4(-1,-1,-1,1);
    r9.xyzw = cb9[r0.y+32].wwww * r9.xyzw + r10.xyzw;
    r10.xyz = cb9[r0.z+32].yzx * r4.wyz;
    r10.xyz = r4.zwy * cb9[r0.z+32].zxy + -r10.xyz;
    r0.y = dot(r4.yzw, cb9[r0.z+32].xyz);
    r10.w = -r0.y;
    r4.xyz = cb9[r0.z+32].www * r4.yzw;
    r4.w = 0;
    r4.xyzw = r10.xyzw + r4.xyzw;
    r10.xyz = -cb9[r0.z+32].zxy * r4.yzx;
    r10.xyz = -cb9[r0.z+32].yzx * r4.zxy + -r10.xyz;
    r4.xyz = cb9[r0.z+32].www * r4.xyz + r10.xyz;
    r4.xyz = r4.www * -cb9[r0.z+32].xyz + r4.xyz;
    r4.xyz = -r8.xyz + r4.xyz;
    r8.xyz = -r9.yzx * r6.zxy;
    r8.xyz = r6.yzx * -r9.zxy + -r8.xyz;
    r0.y = dot(r6.xyz, -r9.xyz);
    r8.w = -r0.y;
    r6.xyz = r9.www * r6.xyz;
    r6.w = 0;
    r6.xyzw = r8.xyzw + r6.xyzw;
    r8.xyz = r9.zxy * r6.yzx;
    r8.xyz = r9.yzx * r6.zxy + -r8.xyz;
    r6.xyz = r9.www * r6.xyz + r8.xyz;
    r6.xyz = r6.www * r9.xyz + r6.xyz;
    r4.xyz = r6.xyz + r4.xyz;
    r6.xyzw = -r9.zxyx * r7.zzxx;
    r8.xyz = -r7.zxz * -r9.yzx + r6.xyz;
    r8.w = -r6.w;
    r6.xyz = r9.www * r7.xyz;
    r6.w = 0;
    r6.xyzw = r8.xyzw + r6.xyzw;
    r7.xyz = r9.zxy * r6.yzx;
    r7.xyz = r9.yzx * r6.zxy + -r7.xyz;
    r6.xyz = r9.www * r6.xyz + r7.xyz;
    r6.xyz = r6.www * r9.xyz + r6.xyz;
