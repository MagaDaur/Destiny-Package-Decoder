  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.z = cb0[119].x * v3.w;
  r0.z = floor(r0.z);
  r0.zw = cb0[116].xy * r0.zz;
  r0.xy = r0.xy * cb0[115].xy + r0.zw;
  r0.x = t0.Sample(s2_s, r0.xy).x;
  r0.x = saturate(r0.x * v4.z + v4.y);
  ...
  r0.y = 1 / r0.y;
  r0.y = -v0.w + r0.y;
  r0.y = saturate(16 * r0.y);
  r0.y = 1 + -r0.y;
  r0.y = 1 + -r0.y;
  r0.x = r0.x * r0.y;
  r0.y = max(0.00100000005, v4.x);
  r0.y = log2(r0.y);
  r0.y = 2.20000005 * r0.y;
  r0.y = exp2(r0.y);
  r0.yzw = float3(1,0.614151001,1) + -r0.yyy;
