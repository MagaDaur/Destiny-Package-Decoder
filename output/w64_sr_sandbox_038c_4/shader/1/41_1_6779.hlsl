  ...
  out float4 o3 : SV_POSITION0)
{
  ...
  r1.w = 0;
  r2.w = 0;
  r0.y = cb0[115].x * 3.14100003;
  sincos(r0.y, r3.x, r4.x);
  r0.yzw = v3.xyz * cb1[4].xyz + cb1[5].xyz;
  r2.xyz = r4.xxx * r0.yzw;
  r3.y = dot(cb0[116].xyz, cb0[116].xyz);
  r3.y = rsqrt(r3.y);
  r3.yzw = cb0[116].xyz * r3.yyy;
  ...
  r0.yzw = float3(0.0500000007,0.0100000007,0.0500000007) * r0.yzw;
  r2.x = 0.157049999 + v1.w;
  r2.x = 0.5 * r2.x;
  sincos(r2.x, r2.x, r5.x);
  r1.xyz = r5.xxx * r0.yzw;
  r2.xyz = float3(0.707106769,0.707106769,0) * r2.xxx;
  r4.yzw = -r2.yzy * r0.wyz;
  r6.xyz = r0.zwy * -r2.zyy + -r4.yzw;
  r0.y = dot(r0.yz, -r2.yy);
  r6.w = -r0.y;
  ...
  r4.xyz = r0.wyz * -r2.yzy;
  r4.xyz = r0.zwy * -r2.zyy + -r4.xyz;
  r0.y = dot(r0.yz, -r2.yy);
  r4.w = -r0.y;
  r3.w = 0;
  ...
  r0.y = cmp(cb0[15].y < 9.99999997e-007);
