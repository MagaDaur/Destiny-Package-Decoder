  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.xy = r3.xy * v3.ww + v0.xy;
  r3.xy = v3.ww * float2(-0.5,-0.5) + r3.xy;
  r2.w = cb0[129].x * cb0[10].z;
  r2.w = floor(r2.w);
  r3.zw = cb0[126].xy * r2.ww;
  r3.xy = r3.xy * cb0[125].xy + r3.zw;
  r2.w = t0.Sample(s5_s, r3.xy).x;
  r2.w = saturate(r2.w * v3.x + v3.y);
  r3.x = r2.w * -0.187000006 + 0.374000013;
  ...
  r3.x = 1 + -r3.x;
  r3.yzw = cb0[96].xyz + float3(0.151068747,0.381325752,0.592759788);
  r3.yzw = float3(1.00000024,1.00000024,1.00000024) * r3.yzw;
  r3.yzw = max(float3(0,0,0), r3.yzw);
  r3.yzw = float3(50,50,50) * r3.yzw;
  r2.w = saturate(v4.w * r2.w);
  ...
  r2.x = -1 + r2.x;
  r0.w = r0.w * r2.x + 1;
  r1.x = saturate(dot(cb0[117].xyz, r1.xyz));
  r1.yzw = cb0[116].xyz * r1.www;
  ...
  r0.z = saturate(r1.w * cb0[123].x + cb0[123].y);
