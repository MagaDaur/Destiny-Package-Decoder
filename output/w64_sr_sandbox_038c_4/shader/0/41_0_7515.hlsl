  ...
  out float4 o1 : SV_TARGET1)
{
  ...
  r0.z = sqrt(r0.z);
  r0.w = saturate(r0.z * cb0[19].x + cb0[19].y);
  r0.w = r0.w * r0.w;
  r4.xyz = cb12[7].xyz + r2.xyz;
  r5.xyz = cb0[10].xyz + -r4.xyz;
  r2.w = dot(r5.xyz, r5.xyz);
  r2.w = sqrt(r2.w);
  r2.w = cb0[11].x * r2.w;
  r4.zw = r4.yx * cb0[9].yx + r2.ww;
  r4.xy = r4.yx * cb0[8].yx + r4.zw;
  ...
  if (r2.w != 0) {
    ...
    r1.xyz = cb0[18].xyz * r0.yyy;
    r2.xyz = cb0[18].xyz * r0.zzz;
    r1.xyz = r1.xyz * r0.xxx;
