...
// unknown dcl_: dcl_input_sgv v3.x, vertex_id
  ...
  o0.xy = x1[r0.x+0].xy;
  r0.xy = x0[r0.x+0].xy;
  r0.xy = float2(0.400000006,2.79999995) * r0.yx;
  ...
  r1.xyz = cb12[7].yzx + -r1.yzx;
  r2.xyz = cb1[0].xyz * v2.yyy;
  ...
  r1.x = dot(r1.zxy, cb1[2].xyz);
  r3.xyz = cb1[2].zxy * r2.xyz;
  r2.xyz = cb1[2].yzx * r2.yzx + -r3.xyz;
