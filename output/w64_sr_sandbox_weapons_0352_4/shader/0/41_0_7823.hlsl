  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.x = 1 + -r3.x;
  r3.yz = v0.xy * v6.xy + v6.zw;
  r3.yz = t0.Sample(s1_s, r3.yz).xy;
  r3.yz = float2(-0.5,-0.5) + r3.yz;
  r3.yz = r3.yz * v12.yy + v0.xy;
  r3.yz = r3.yz * v5.xy + v5.zw;
  r3.yzw = t1.Sample(s1_s, r3.yz).xyz;
  r3.yzw = saturate(r3.yzw * v9.zzz + v9.www);
