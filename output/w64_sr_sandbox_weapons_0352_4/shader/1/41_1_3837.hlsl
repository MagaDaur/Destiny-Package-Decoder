...
// unknown dcl_: dcl_input_sgv v10.x, vertex_id
  ...
  r2.xyz = cb12[4].xyz * v6.www;
  r0.xzw = r2.xyz * r0.xxx + r1.xyz;
  r2.xyz = cb12[5].xyz * v6.www;
  ...
  r0.x = rsqrt(r0.x);
  r0.xyz = r1.xyz * r0.xxx + -cb12[6].xyz;
  ...
  o9.xyzw = r0.xxxx ? float4(10000,10000,-10000,1) : r2.xyzw;
  return;
}