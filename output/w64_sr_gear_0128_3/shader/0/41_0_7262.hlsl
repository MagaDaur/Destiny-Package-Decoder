  ...
  out float4 o1 : SV_TARGET1)
{
  ...
  r0.z = sqrt(r0.z);
  r0.w = saturate(r0.z * cb0[12].x + cb0[12].y);
  r0.w = r0.w * r0.w;
  ...
  if (r2.w != 0) {
    ...
    r4.yzw = cb0[9].xyz * cb0[10].xxx + -cb0[11].xyz;
    r4.yzw = r0.zzz * r4.yzw + cb0[11].xyz;
    ...
    r1.xyz = r0.yyy * r4.yzw;
    r2.xyz = r0.zzz * r4.yzw;
    r1.xyz = r1.xyz * r0.xxx;
    r0.xyz = r2.xyz * r0.xxx;
    r0.w = cb0[15].x * r0.w;
    r1.xyz = r1.xyz * r0.www;
    r0.xyz = r0.xyz * r0.www;
    r1.xyz = cb0[16].xxx * r1.xyz;
