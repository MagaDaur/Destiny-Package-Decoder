...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r0.z = cb0[1].x * cb0[0].x;
  r2.xz = r0.zz * r0.xx;
  r0.y = r0.y * cb0[3].x + cb0[4].x;
  r0.y = r0.y + r1.x;
  r0.y = cb0[5].w * r0.y + cb0[5].z;
  r0.y = 0.25 + r0.y;
  r0.z = round(r0.y);
  r0.y = r0.y + -r0.z;
  r0.z = abs(r0.y) * -16 + 8;
  ...
  r3.xyzw = t1.Load(r0.y).xyzw;
  r0.x = r0.z ? r3.x : r0.x;
  r1.x = (int)r0.x * 3;
  r4.xy = mad(int2(3,3), (int2)r0.xx, int2(1,2));
  if (r0.z != 0) {
    r0.xz = (uint2)r3.zw;
    ...
    r6.xyz = cb1[r2.w+8].xyz * r0.zzz;
    r7.x = cb1[r2.w+8].w * r0.z;
    r7.y = cb1[r3.x+8].w * r0.z;
    r7.z = cb1[r3.y+8].w * r0.z;
    r3.xzw = cb1[r3.x+8].xyz * r0.zzz;
    r8.xyz = cb1[r3.y+8].xyz * r0.zzz;
    r6.xyz = cb1[r1.x+8].xyz * r0.xxx + r6.xyz;
    r5.xyz = r5.xyz * r0.xxx + r7.xyz;
    r3.xyz = cb1[r4.x+8].xyz * r0.xxx + r3.xzw;
    r7.xyz = cb1[r4.y+8].xyz * r0.xxx + r8.xyz;
    if (r0.w != 0) {
      r0.x = (int)r0.y + 1;
      r0.xyzw = t1.Load(r0.x).xyzw;
      r0.zw = (uint2)r0.zw;
      r0.zw = float2(0.00392156886,0.00392156886) * r0.zw;
      r4.zw = (int2)r0.xy * int2(3,3);
      r8.xyzw = mad(int4(3,3,3,3), (int4)r0.xxyy, int4(1,2,1,2));
      r9.x = cb1[r4.z+8].w * r0.z;
      r9.y = cb1[r8.x+8].w * r0.z;
      r9.z = cb1[r8.y+8].w * r0.z;
      r10.xyz = r0.zzz * cb1[r4.z+8].xyz + r6.xyz;
      r9.xyz = r9.xyz + r5.xyz;
      r11.xyz = r0.zzz * cb1[r8.x+8].xyz + r3.xyz;
      r0.xyz = r0.zzz * cb1[r8.y+8].xyz + r7.xyz;
      r12.x = cb1[r4.w+8].w * r0.w;
      r12.y = cb1[r8.z+8].w * r0.w;
      r12.z = cb1[r8.w+8].w * r0.w;
      r6.xyz = r0.www * cb1[r4.w+8].xyz + r10.xyz;
      r5.xyz = r12.xyz + r9.xyz;
      r3.xyz = r0.www * cb1[r8.z+8].xyz + r11.xyz;
      r7.xyz = r0.www * cb1[r8.w+8].xyz + r0.xyz;
    }
  } else {
    r6.xyz = cb1[r1.x+8].xyz;
    r5.x = cb1[r1.x+8].w;
    r5.y = cb1[r4.x+8].w;
    r5.z = cb1[r4.y+8].w;
  ...
  r0.xyz = r2.xyz + r1.yzw;
  r1.xyz = cb12[15].xyz + r5.xyz;
  r6.w = r1.x;
  r0.w = 1;
  r2.x = dot(r6.xyzw, r0.xyzw);
  r3.w = r1.y;
  r2.y = dot(r3.xyzw, r0.xyzw);
  r7.w = r1.z;
  r2.z = dot(r7.xyzw, r0.xyzw);
