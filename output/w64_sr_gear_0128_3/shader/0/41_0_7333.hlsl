  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = 1 / r0.w;
  r0.w = -v0.w + r0.w;
  r1.x = 0.300000012 * v6.w;
  r0.w = saturate(r0.w / r1.x);
  r0.w = 1 + -r0.w;
  r0.w = 1 + -r0.w;
  r1.xy = t1.Sample(s3_s, v0.xy).xy;
  r1.zw = r1.xy * v6.zz + v0.xy;
  r1.xy = log2(r1.xy);
  r1.xy = float2(2.20000005,2.20000005) * r1.xy;
  r1.xy = exp2(r1.xy);
  r1.xy = r1.xy * v5.yy + v0.xy;
  r1.xy = v5.yy * float2(-0.5,-0.5) + r1.xy;
  r1.x = t2.Sample(s3_s, r1.xy).x;
  r1.yz = v6.zz * float2(-0.5,-0.5) + r1.zw;
