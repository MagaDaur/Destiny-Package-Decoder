...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r0.xyz = r0.xzw * float3(0.0500000007,0.0500000007,0.0500000007) + r2.xyz;
  r2.xyz = cb12[7].xyz + -r2.xyz;
  r0.w = dot(r2.xyz, r2.xyz);
  r0.w = sqrt(r0.w);
  r0.xyz = r1.xyz * float3(0.0500000007,0.0500000007,0.0500000007) + r0.xyz;
  r0.xyz = cb12[4].xyz * float3(-0.00700000022,-0.00700000022,-0.00700000022) + r0.xyz;
  ...
  o0.w = r1.w;
  r0.x = 0.280000001 * v3.x;
  r0.x = frac(r0.x);
  r0.y = cb0[107].x * r0.x;
  r0.x = cb0[113].x + -r0.x;
  r0.x = 1 + r0.x;
  r0.x = saturate(3.33333302 * r0.x);
  r0.y = -r0.y * cb0[117].x + cb0[117].y;
  r0.y = saturate(r0.w * cb0[117].x + r0.y);
  r0.x = r0.y * r0.x;
  r0.x = cb0[12].y * r0.x;
  r0.x = cb0[122].x * r0.x;
  ...
  r0.y = cmp(cb0[14].x < 9.99999997e-007);
