...
// unknown dcl_: dcl_input_sgv v9.x, vertex_id
  ...
  o0.xy = x1[r0.x+0].xy;
  r0.xy = x0[r0.x+0].xy;
  r0.xy = float2(0,0.239999995) + r0.yx;
  r0.xy = v3.yx * r0.xy;
  ...
  r1.y = cb0[107].x * 0.0174532942;
  r1.y = cos(r1.y);
  r1.x = abs(r1.x) + -r1.y;
  r1.z = cb0[108].x + cb0[107].x;
  r1.z = 0.0174532942 * r1.z;
  r1.z = cos(r1.z);
  r1.y = r1.z + -r1.y;
  r1.x = saturate(r1.x / r1.y);
  r1.y = 0.280000001 * v4.w;
  r1.y = frac(r1.y);
  r1.z = cb0[96].x * r1.y;
  r1.y = cb0[102].x + -r1.y;
  r1.y = 1 + r1.y;
  r1.y = saturate(3.33333302 * r1.y);
  r1.z = -r1.z * cb0[106].x + cb0[106].y;
  r1.z = saturate(r1.w * cb0[106].x + r1.z);
  r1.y = r1.z * r1.y;
  r1.x = r1.y * r1.x;
  r1.x = cb0[8].y * r1.x;
  r1.x = cb0[117].x * r1.x;
