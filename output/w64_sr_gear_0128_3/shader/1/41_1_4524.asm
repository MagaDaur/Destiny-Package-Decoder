...
mul r0.x, r0.y, cb0[4].x
mul r0.x, r0.x, cb0[5].x
mul r0.x, r0.x, l(3.141000)
sincos r0.x, r2.x, r0.x
mul r0.xyw, r2.yzyw, r0.xxxx
add r2.yzw, r3.xxyz, -cb0[6].xxyz
mul r5.xyz, -r0.ywxy, r2.wyzw
mad r5.xyz, r2.zwyz, -r0.wxyw, -r5.xyzx
dp3 r1.w, r2.yzwy, -r0.xywx
mov r5.w, -r1.w
mul r6.xyz, r2.yzwy, r2.xxxx
mov r6.w, l(0)
add r5.xyzw, r5.xyzw, r6.xyzw
mul r2.yzw, r0.wwxy, r5.yyzx
mad r2.yzw, r0.yywx, r5.zzxy, -r2.yyzw
mad r2.xyz, r2.xxxx, r5.xyzx, r2.yzwy
mad r0.xyw, r5.wwww, r0.xyxw, r2.xyxz
add r0.xyw, r0.xyxw, cb0[6].xyxz
add r0.xyw, -r3.xyxz, r0.xyxw
add r0.xyw, r0.xyxw, r4.xyxz
add r2.xyz, r0.xywx, r1.xyzx
...
rsq r0.z, r0.z
mul r3.yzw, r0.zzzz, cb0[7].xxyz
mul r3.xyz, r3.yzwy, r3.xxxx
add r4.yzw, r2.xxyz, -cb0[10].xxyz
