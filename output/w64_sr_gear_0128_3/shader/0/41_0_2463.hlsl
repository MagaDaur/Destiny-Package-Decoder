  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r6.xy = r6.xy * cb0[23].xx + cb0[23].yy;
  ...
  r7.z = saturate(r7.y * cb0[2].x + cb0[2].y);
  r7.z = saturate(cb0[3].x * r7.z);
  r7.w = 1 + -r7.z;
  r8.y = r9.y * cb0[4].x + cb0[4].y;
  r10.y = r8.y * r7.w;
  r7.w = cb0[5].x + 128.5;
  r7.w = 0.00390625 * r7.w;
  r8.y = cmp(0.0500000007 >= r10.y);
  r7.w = r8.y ? r7.w : -1;
  r7.z = saturate(r7.z * cb0[22].x + cb0[22].y);
  r11.xyzw = cb0[21].xyzw + -cb0[20].xyzw;
  r11.xyzw = saturate(r7.zzzz * r11.xyzw + cb0[20].xyzw);
  ...
  r9.yzw = saturate(r13.xyz * r8.xyw + r5.xyz);
  r10.zw = r1.xy * r3.yy + r6.xy;
  r0.w = -1 + r0.w;
  r3.y = r3.y * r0.w + 1;
  r2.yzw = saturate(cb7[r0.y+14].xyz * r12.xyz + r2.yzw);
  r2.yzw = -cb7[r0.y+14].xyz + r2.yzw;
  r2.yzw = r4.xxx * r2.yzw + cb7[r0.y+14].xyz;
  r2.yzw = saturate(r2.yzw * r8.xyw + r5.xyz);
  ...
  r1.z = min(r1.z, r0.w);
  r4.x = r2.x ? r1.z : r0.w;
  r2.xyz = r2.yzw + -r11.xyz;
  r2.xyz = r6.zzz * r2.xyz + r11.xyz;
  r1.xy = r1.xy + -r6.xy;
  r1.xy = r6.zz * r1.xy + r6.xy;
  r10.x = r11.w;
  r3.yz = r4.xy + -r10.xy;
  r3.yz = r6.zz * r3.yz + r10.xy;
  r0.w = r6.z * r1.w;
  o0.w = r0.z ? r3.x : r7.w;
  ...
  if (r0.z != 0) {
    ...
    r0.z = r0.z ? r2.w : r4.x;
    r0.z = r3.w ? r0.z : r3.x;
    r1.w = cmp(0.5 >= cb0[6].x);
    r2.w = cb0[6].x + cb0[6].x;
    r2.w = r0.z * -r2.w + r2.w;
    r3.x = cb0[6].x * 2 + -2;
    r0.z = r0.z * r3.x + 1;
    r0.z = r1.w ? r2.w : r0.z;
  ...
  r1.w = dot(cb0[10].xyz, r4.xyz);
  r2.w = cb0[9].x + -cb0[8].x;
  r1.w = saturate(r1.w * r2.w + cb0[8].x);
  r2.w = -cb0[11].z + v4.z;
  r2.w = cb0[12].x * r2.w;
  r2.w = max(0, r2.w);
  r2.w = log2(r2.w);
