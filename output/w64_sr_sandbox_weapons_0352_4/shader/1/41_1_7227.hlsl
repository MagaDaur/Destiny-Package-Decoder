  ...
  out float4 o8 : SV_POSITION0)
{
  ...
  r1.w = 0;
  r0.yzw = v10.xyz * cb1[4].xyz + cb1[5].xyz;
  r0.yzw = v7.yyy * r0.yzw;
  r0.yzw = float3(1,1,0.5) * r0.yzw;
  r2.x = v8.x * 6.28200006 + v3.w;
  r2.x = 0.5 * r2.x;
  ...
  r0.yzw = v12.zxy * -r2.yzx;
  r4.xyz = v12.yzx * -r2.zxy + -r0.yzw;
  r5.xyz = v12.xyz;
  r5.w = 0;
  r0.y = dot(v12.xyz, -r2.xyz);
  r4.w = -r0.y;
