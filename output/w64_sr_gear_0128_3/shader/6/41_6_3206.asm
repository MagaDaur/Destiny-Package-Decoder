...
if_nz r1.x
  ...
  if_nz r2.y
    ...
    sqrt r2.y, r2.y
    add r2.z, r2.x, r2.y
    div_sat r2.w, cb0[11].y, r2.x
    add r3.x, -r2.z, r2.y
    mad r2.z, r2.w, r3.x, r2.z
    movc r2.y, r0.w, r2.y, r2.z
    mad_sat r2.y, r2.y, cb0[10].x, cb0[10].y
    mul r2.y, r2.y, r2.y
    ...
    loop
      ...
      if_nz r3.z
        ...
        mul r4.xyz, r3.zzzz, cb0[9].xyzx
        mul r3.z, r3.x, cb0[13].x
        mul r4.xyz, r3.zzzz, r4.xyzx
        mul r4.xyz, r4.xyzx, cb0[14].xxxx
