  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.x = sqrt(r0.x);
  r0.yz = v3.xy * cb0[23].xy + cb0[23].zw;
  ...
  r6.xy = r6.xy * cb0[24].xx + cb0[24].yy;
  ...
  r7.w = saturate(r7.y * cb0[2].x + cb0[2].y);
  r7.w = saturate(cb0[3].x * r7.w);
  r8.y = 1 + -r7.w;
  r8.w = r9.y * cb0[4].x + cb0[4].y;
  r10.y = r8.y * r8.w;
  r8.y = cb0[5].x + 128.5;
  r8.y = 0.00390625 * r8.y;
  r8.w = cmp(0.0500000007 >= r10.y);
  r8.y = r8.w ? r8.y : -1;
  r7.w = saturate(r7.w * cb0[22].x + cb0[22].y);
  r11.xyzw = cb0[21].xyzw + -cb0[20].xyzw;
  r11.xyzw = saturate(r7.wwww * r11.xyzw + cb0[20].xyzw);
  ...
  r11.xyzw = r5.xyzw * r12.xyzw + r11.xyzw;
  r12.xyz = saturate(float3(4,4,4) * r3.yzw);
  r3.yzw = saturate(float3(-0.25,-0.25,-0.25) + r3.yzw);
  r13.xyz = saturate(cb7[r0.y+9].xyz * r12.xyz + r3.yzw);
  r13.xyz = -cb7[r0.y+9].xyz + r13.xyz;
  r13.xyz = r2.xxx * r13.xyz + cb7[r0.y+9].xyz;
  r2.x = saturate(cb7[r0.y+13].y * r7.y + cb7[r0.y+13].x);
  r2.x = saturate(cb7[r0.y+13].w * r2.x + cb7[r0.y+13].z);
  r8.x = saturate(r8.x);
  r3.x = saturate(r3.x * r9.z + r8.x);
  r5.w = saturate(cb7[r0.y+13].y * r3.x + cb7[r0.y+13].x);
  r5.w = saturate(cb7[r0.y+13].w * r5.w + cb7[r0.y+13].z);
  r5.w = r5.w + -r2.x;
  r2.x = r2.z * r5.w + r2.x;
  r9.yzw = saturate(float3(4,4,4) * r5.xyz);
  r5.xyz = saturate(float3(-0.25,-0.25,-0.25) + r5.xyz);
  r13.xyz = saturate(r13.xyz * r9.yzw + r5.xyz);
  r8.xw = r1.zw * r2.yy + r6.xy;
  r0.w = -1 + r0.w;
  r2.y = r2.y * r0.w + 1;
  r3.yzw = saturate(cb7[r0.y+14].xyz * r12.xyz + r3.yzw);
  r3.yzw = -cb7[r0.y+14].xyz + r3.yzw;
  r3.yzw = r4.xxx * r3.yzw + cb7[r0.y+14].xyz;
  r3.yzw = saturate(r3.yzw * r9.yzw + r5.xyz);
  ...
  r0.w = r4.y * r0.w + 1;
  r4.xyz = r13.xyz + -r3.yzw;
  r3.xyz = r7.zzz * r4.xyz + r3.yzw;
  r4.xy = r8.xw + -r1.zw;
  r1.zw = r7.zz * r4.xy + r1.zw;
  r2.x = r2.x + -r2.z;
  r2.x = r7.z * r2.x + r2.z;
  r2.z = -r4.w + r2.w;
  r4.y = r7.z * r2.z + r4.w;
  ...
  r1.x = min(r1.x, r0.w);
  r4.x = r2.x ? r1.x : r0.w;
  r2.xzw = r3.xyz + -r11.xyz;
  r2.xzw = r6.zzz * r2.xzw + r11.xyz;
  r1.xz = r1.zw + -r6.xy;
  r3.xy = r6.zz * r1.xz + r6.xy;
  r10.x = r11.w;
  r1.xz = r4.xy + -r10.xy;
  r1.xz = r6.zz * r1.xz + r10.xy;
  r0.w = r6.z * r1.y;
  o0.w = r0.z ? r2.y : r8.y;
  ...
  r0.z = cmp(r0.z < 0);
  if (r0.z != 0) discard;
  r0.z = saturate(cb0[17].x);
  r1.y = dot(r4.xyz, r4.xyz);
  r1.y = rsqrt(r1.y);
  r4.xyz = r4.xyz * r1.yyy;
  r1.y = dot(cb0[10].xyz, r4.xyz);
  r1.w = cb0[9].x + -cb0[8].x;
  r1.y = saturate(r1.y * r1.w + cb0[8].x);
  r1.w = -cb0[11].z + v4.z;
  r1.w = cb0[12].x * r1.w;
  r1.w = max(0, r1.w);
  r1.w = log2(r1.w);
