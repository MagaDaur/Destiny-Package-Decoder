  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.xy = r3.xy * float2(0.400000006,0.400000006) + v0.xy;
  r3.xy = float2(-0.200000003,-0.200000003) + r3.xy;
  r2.w = cb0[131].x * v3.z;
  r2.w = floor(r2.w);
  r3.zw = cb0[128].xy * r2.ww;
  r3.xy = r3.xy * cb0[127].xy + r3.zw;
  r2.w = t2.Sample(s1_s, r3.xy).x;
  r2.w = log2(r2.w);
  r2.w = 2.20000005 * r2.w;
  r2.w = exp2(r2.w);
  r3.xy = v0.xy * cb0[10].xy + cb0[10].zw;
  r3.xy = t0.Sample(s1_s, r3.xy).xy;
  r3.xy = float2(-0.5,-0.5) + r3.xy;
  r3.xy = r3.xy * cb0[102].xx + v0.xy;
  r3.xy = r3.xy * cb0[9].xy + cb0[9].zw;
  r3.xyz = t1.Sample(s1_s, r3.xy).xyz;
  r3.xyz = saturate(r3.xyz * float3(0.899999976,0.899999976,0.899999976) + float3(0.100000001,0.100000001,0.100000001));
  r3.xyz = cb0[99].xyz * r3.xyz + float3(-2.51188652e-007,-2.51188652e-007,-2.51188652e-007);
  r3.xyz = float3(1.00000024,1.00000024,1.00000024) * r3.xyz;
  r3.xyz = max(float3(0,0,0), r3.xyz);
  r3.xyz = float3(20,20,20) * r3.xyz;
  ...
  r2.x = -1 + r2.x;
  r0.w = r0.w * r2.x + 1;
  r1.x = saturate(dot(cb0[119].xyz, r1.xyz));
  r1.yzw = cb0[118].xyz * r1.www;
  ...
  r0.z = saturate(r1.w * cb0[125].x + cb0[125].y);
