  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.z = sqrt(r0.z);
  r0.w = 0.015625 * r0.z;
  r0.z = saturate(r0.z * cb0[108].x + cb0[108].y);
  r0.w = min(1, r0.w);
  r3.z = sqrt(r0.w);
  ...
  r2.xy = r4.ww * r0.xy;
  r5.xy = float2(0.272520989,0.0316900015);
  r5.z = r4.w;
  r0.xyw = r2.xyz * r5.xyz + r4.xyz;
  ...
  r0.xyz = r1.yzw * cb13[1].xxx + r0.xyw;
