  ...
  out float4 o1 : SV_TARGET1)
{
  ...
  r0.z = sqrt(r0.z);
  r0.w = saturate(r0.z * cb0[28].x + cb0[28].y);
  r0.w = r0.w * r0.w;
  r4.xyz = cb0[23].xyz * r2.yyy;
  r4.xyz = cb0[22].xyz * r2.xxx + r4.xyz;
  r4.xyz = cb0[24].xyz * r2.zzz + r4.xyz;
  ...
  r4.xyz = r5.xyz * cb0[15].xxx + r4.xyz;
  r4.xyz = r4.xyz * cb0[19].xyz + cb0[20].xyz;
  r2.w = t3.Sample(s1_s, r4.xyz).x;
  r2.w = 1 + -r2.w;
  r2.w = saturate(r2.w * cb0[21].x + cb0[21].y);
  r4.xyz = cb0[14].xyz + r2.www;
  ...
  if (r2.w != 0) {
    ...
    r3.w = r3.w * r3.w;
    r3.w = min(1, r3.w);
    r4.w = saturate(cb0[10].y * r0.w + cb0[10].x);
    r7.xyz = cb0[11].xyz * cb0[12].xxx + -cb0[13].xyz;
    r7.xyz = r4.www * r7.xyz + cb0[13].xyz;
    r8.xyz = cb0[11].xyz * cb0[26].xxx + -cb0[27].xyz;
    r8.xyz = r4.www * r8.xyz + cb0[27].xyz;
    ...
    r9.y = dot(-r5.yzw, -r5.yzw);
    r9.y = rsqrt(r9.y);
    r5.yzw = r9.yyy * -r5.yzw;
    r3.x = saturate(dot(r3.xyz, -r5.yzw));
    r3.x = log2(r3.x);
    r3.x = cb13[4].y * r3.x;
    r3.x = exp2(r3.x);
    r3.x = saturate(r8.w * cb13[4].x + r3.x);
    r1.w = r3.x * r1.w;
    r1.w = r7.w ? r1.w : 0;
    r3.x = r4.w * r6.w;
    r1.w = 0.318309873 * r1.w;
    r1.w = r3.x * 0.318309873 + r1.w;
    r3.xyz = r1.www * r8.xyz + r7.xyz;
    ...
    r1.xyz = r0.yyy * r8.xyz;
    r1.xyz = r1.xyz * r3.www + r7.xyz;
