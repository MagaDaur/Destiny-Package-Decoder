...
if_nz r0.x
  ...
  mul r0.y, r0.y, r0.z
  mul_sat r0.z, l(0.200000), cb0[3].x
  mad r5.xyz, r0.zzzz, l(986895.062500, 0.000000, -986895.062500, 0.000000), l(-592136.062500, 1.000000, 779647.125000, 0.000000)
  ge r8.xyzw, r0.zzzz, l(0.599999, 0.600000, 0.789999, 0.790000)
  and r8.xyz, r8.xyzx, l(0x3f800000, 0x3f800000, 0x3f800000, 0)
  add r0.zw, r8.yyyz, r8.xxxy
  add r0.zw, r0.zzzw, l(0.000000, 0.000000, 0.000001, 0.000001)
  mul r0.zw, r0.zzzw, l(0.000000, 0.000000, 0.500000, 0.500000)
  ...
  mul r0.zw, r5.xxxy, r0.zzzw
  mov r5.x, l(2.000000)
  mul r0.zw, r0.zzzw, r5.xxxx
  add r0.z, r0.w, r0.z
  mad_sat r0.z, r5.z, r8.z, r0.z
  mul r0.y, r0.z, r0.y
  movc r7.z, r8.w, l(0), r0.y
