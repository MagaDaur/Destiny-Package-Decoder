...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r0.xy = float2(0.5,1.35000002) * r0.xy;
  ...
  r1.y = cb0[105].x * 0.0174532942;
  r1.y = cos(r1.y);
  r1.x = abs(r1.x) + -r1.y;
  r1.z = cb0[106].x + cb0[105].x;
  ...
  o3.xyzw = v0.xyzw;
  o4.xy = v3.yz;
  r1.y = cmp(cb0[112].x < 9.99999997e-007);
