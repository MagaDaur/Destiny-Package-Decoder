  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r0.xy = v3.xy * cb0[3].xy + cb0[3].zw;
  r1.xyz = t5.Sample(s1_s, r0.xy).xyz;
  r2.xyz = saturate(float3(4,4,4) * r1.xyz);
  r3.xyz = saturate(float3(-0.25,-0.25,-0.25) + r1.xyz);
  r2.xyz = cb6[3].xyz * r2.xyz + r3.xyz;
  r2.xyz = r2.xyz + -r1.xyz;
  r0.z = t4.Sample(s1_s, r0.xy).x;
  r0.xy = -cb0[4].xy + r0.xy;
  r0.x = dot(r0.xy, r0.xy);
  r0.x = sqrt(r0.x);
  r0.x = saturate(r0.x * cb0[6].x + cb0[6].y);
  r0.x = r0.x * cb0[7].x + 0.0078125;
  r0.x = log2(r0.x);
