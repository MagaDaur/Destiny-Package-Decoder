...
// unknown dcl_: dcl_input_sgv v7.x, vertex_id
  ...
  o0.xy = x1[r0.x+0].xy;
  r0.xy = x0[r0.x+0].xy;
  r0.xy = float2(0,0.850000024) + r0.yx;
  r0.xy = v3.yx * r0.xy;
  ...
  r1.y = cb0[115].x * 0.0174532942;
  r1.y = cos(r1.y);
  r1.x = abs(r1.x) + -r1.y;
  r1.z = cb0[116].x + cb0[115].x;
  r1.z = 0.0174532942 * r1.z;
  r1.z = cos(r1.z);
  r1.y = r1.z + -r1.y;
  r1.x = saturate(r1.x / r1.y);
  r1.y = 10000 + -r1.w;
  r1.z = 0.280000001 * v3.w;
  r1.z = frac(r1.z);
  r2.w = cb0[100].x * r1.z;
  r1.z = cb0[106].x + -r1.z;
  r1.z = 1 + r1.z;
  r1.z = saturate(3.33333302 * r1.z);
  r2.w = -r2.w * 0.333332986 + -1.33333302;
  r1.w = r1.w * 0.333332986 + r2.w;
  r1.y = saturate(min(r1.w, r1.y));
  r1.y = r1.y * r1.z;
  r1.x = r1.y * r1.x;
  r1.x = cb0[9].w * r1.x;
  r1.x = cb0[131].x * r1.x;
