...
mad r0.z, v5.x, cb0[21].x, r0.z
add r1.w, l(1.000000), cb0[21].x
ge r2.y, r1.w, l(0.000000)
movc r2.y, r2.y, l(0.000050), l(-0.000050)
add r1.w, r1.w, r2.y
div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), r1.w
mad r2.y, r0.z, r1.w, -cb0[22].x
mad r3.zw, cb0[23].zzzw, r2.yyyy, cb0[23].xxxy
min_sat r2.y, r3.w, r3.z
mad r0.z, r0.z, r1.w, -cb0[24].x
mad r3.zw, cb0[25].zzzw, r0.zzzz, cb0[25].xxxy
min_sat r0.z, r3.w, r3.z
add r0.z, r0.z, r2.y
log r0.z, r0.z
mul r0.z, r0.z, cb0[26].x
exp r0.z, r0.z
mul r0.x, r0.z, r0.x
