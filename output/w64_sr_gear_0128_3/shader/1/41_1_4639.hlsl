...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r4.xyz = r5.www * r4.yzw + r5.xyz;
  r4.xyz = cb0[6].xyz + r4.xyz;
  r2.xyz = r4.xyz + -r2.xyz;
  r0.w = cb0[7].x * 3.14100003;
  sincos(r0.w, r1.x, r5.x);
  r5.yzw = r1.xxx * r1.yzw;
  r6.xyz = -cb0[8].xyz + r4.xyz;
  r7.xyz = r6.zxy * -r5.zwy;
  r7.xyz = r6.yzx * -r5.wyz + -r7.xyz;
  r0.w = dot(r6.xyz, -r5.yzw);
  r7.w = -r0.w;
  ...
  r5.xyz = r6.www * r5.yzw + r6.xyz;
  r5.xyz = cb0[8].xyz + r5.xyz;
  r4.xyz = r5.xyz + -r4.xyz;
  r0.w = cb0[9].x * 3.14100003;
  sincos(r0.w, r1.x, r6.x);
  r1.xyz = r1.xxx * r1.yzw;
  r6.yzw = -cb0[10].xyz + r5.xyz;
  r7.xyz = r6.wyz * -r1.yzx;
  r7.xyz = r6.zwy * -r1.zxy + -r7.xyz;
  r0.w = dot(r6.yzw, -r1.xyz);
  r7.w = -r0.w;
  r8.xyz = r6.xxx * r6.yzw;
  r8.w = 0;
  r7.xyzw = r8.xyzw + r7.xyzw;
  r6.yzw = r7.yzx * r1.zxy;
  r6.yzw = r1.yzx * r7.zxy + -r6.yzw;
  r6.xyz = r6.xxx * r7.xyz + r6.yzw;
  r1.xyz = r7.www * r1.xyz + r6.xyz;
  ...
  r0.w = rsqrt(r0.w);
  r6.yzw = cb0[11].xyz * r0.www;
  r6.xyz = r6.xxx * r6.yzw;
  r7.yzw = -cb0[13].xyz + r1.xyz;
  r8.xyz = r7.wyz * -r6.yzx;
  r8.xyz = r7.zwy * -r6.zxy + -r8.xyz;
  r0.w = dot(r7.yzw, -r6.xyz);
  r8.w = -r0.w;
  r9.xyz = r7.xxx * r7.yzw;
  r9.w = 0;
  r8.xyzw = r9.xyzw + r8.xyzw;
  r7.yzw = r8.yzx * r6.zxy;
  r7.yzw = r6.yzx * r8.zxy + -r7.yzw;
  r7.xyz = r7.xxx * r8.xyz + r7.yzw;
  ...
  r1.xyz = cb0[14].xxx * r1.xyz + cb0[0].xyz;
