...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r10.xyzw = r0.yyyy * float4(-1.07087505,-5.92559814,-1726.58252,1.19507802) + float4(4.56910706,2.42736411,232.774414,-1.27509701);
    r8.xyzw = r8.xyzw * r0.zzzz + r9.xyzw;
    ...
    r0.w = r0.w * r0.z + 1;
    r0.w = max(0, r0.w);
    r11.xyz = r0.www * float3(1,0.5,0) + float3(1,1,1);
    r0.w = r8.y * 0.0700000077 + 0.0799999982;
    r8.x = 0.899999976 * r0.w;
    r10.xy = r0.yy * float2(3.98838401,-1.03504205) + float2(0,1.11505997);
    r0.zw = r10.zw * r0.zz + r10.xy;
    r10.xyz = cmp(r0.yyy >= float3(0,0.100000001,1));
