...
// unknown dcl_: dcl_thread_group 8, 8, 1
  ...
  if (r1.x != 0) {
    ...
    if (r2.y != 0) {
      ...
      r3.x = sqrt(r3.x);
      r3.y = r3.x + r2.x;
      r3.z = saturate(cb0[27].y / r2.x);
      r3.w = r3.x + -r3.y;
      r3.y = r3.z * r3.w + r3.y;
      r3.x = r0.w ? r3.x : r3.y;
      r3.x = saturate(r3.x * cb0[26].x + cb0[26].y);
      r3.x = r3.x * r3.x;
      r1.w = cmp(r1.w < 0);
      r1.w = r1.w ? 0 : r3.x;
      r3.xyz = cb0[9].xyz * cb0[10].xxx + -cb0[11].xyz;
      r4.xyz = r2.yzw;
      r3.w = r1.w;
      r4.w = 0;
      while (true) {
        ...
        r6.xyz = r5.xyz * cb0[14].xyz + cb0[15].xyz;
        r6.xyz = t1.SampleLevel(s1_s, r6.xyz, 0).xyz;
        r6.xyz = -cb0[16].xyz + r6.xyz;
        r5.xyz = r6.xyz * cb0[13].xxx + r5.xyz;
        r5.xyz = r5.xyz * cb0[17].xyz + cb0[18].xyz;
        r5.x = t0.SampleLevel(s1_s, r5.xyz, 0).x;
        r5.x = 1 + -r5.x;
        r5.x = saturate(r5.x * cb0[19].x + cb0[19].y);
        r5.xyz = saturate(cb0[12].xyz + r5.xxx);
        ...
        if (r5.w != 0) {
          ...
          r5.w = saturate(cb0[8].y * r3.w + cb0[8].x);
          r7.xyz = r5.www * r3.xyz + cb0[11].xyz;
          r5.w = dot(r4.xyz, r4.xyz);
          r5.w = rsqrt(r5.w);
          r8.xyz = r5.www * r4.xyz;
          r6.w = saturate(dot(icb[r4.w+0].xyz, r6.xyz));
          r9.xyz = -r4.xyz * r5.www + r6.xyz;
          r5.w = dot(r9.xyz, r9.xyz);
          r5.w = rsqrt(r5.w);
          r9.xyz = r9.xyz * r5.www;
          r5.w = dot(icb[r4.w+0].xyz, -r8.xyz);
          r5.w = 9.99999975e-006 + abs(r5.w);
          r6.x = saturate(dot(r6.xyz, r9.xyz));
          ...
          r6.xyz = r5.www * cb0[25].xyz + r7.xyz;
          r5.w = cb0[29].x * r3.w;
          r6.xyz = r6.xyz * r5.www;
          r5.xyz = r6.xyz * r5.xyz;
          r5.xyz = cb0[30].xxx * r5.xyz;
