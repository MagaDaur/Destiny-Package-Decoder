...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.w = saturate(r5.z);
    r9.xyz = r0.www * float3(-0.5,0.5,0) + float3(1,0.5,1);
    r10.xzw = saturate(r2.wzy);
    r0.w = 0.166666999 * r10.x;
    r11.x = r10.x * 0.166666999 + 0.666665971;
    r11.y = r10.x * r10.x;
    r0.w = r11.x * r11.y + r0.w;
    r0.w = r0.w * 0.180000007 + 0.0399999991;
    r11.xyz = r0.yyy * float3(0,5.05299902,3.85573411) + float3(0,-2.72532296,-6.74565601);
    r12.xyz = r0.yyy * float3(42.8571434,0.376071006,2.06485295) + float3(0,0.992645025,0.825070024);
    r11.xyz = r11.xyz * r0.zzz + r12.xyz;
    r12.xyzw = cmp(r0.yyyy >= float4(0,0.023333,0.193333,1));
    ...
    r11.x = r11.x * 0.899999976 + 0.100000001;
    r8.z = r11.x * r0.w;
