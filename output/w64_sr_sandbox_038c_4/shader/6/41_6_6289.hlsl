...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.z = mad((int)r0.z, 0x0019660d, 0x3c6ef35f);
    r3.y = (uint)r0.z;
    r3.zw = float2(2.32830644e-010,1.28056857e-010) * r0.ww;
    ...
    r0.w = cb10[0].x + 0.25;
    r0.w = (int)r0.w;
    r4.xyz = r3.xxx * float3(0,0,1.97906053e-010) + float3(-0.25,0,0.150000006);
    r5.xyz = -cb9[r0.w+32].yzx * r4.zxy;
    r5.xyz = r4.yzx * -cb9[r0.w+32].zxy + -r5.xyz;
    r3.x = dot(r4.xz, -cb9[r0.w+32].xz);
    r5.w = -r3.x;
    r4.xyw = float3(-0.25,0,0);
