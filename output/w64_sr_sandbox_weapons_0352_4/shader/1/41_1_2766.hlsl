...
// unknown dcl_: dcl_input_sgv v10.x, vertex_id
  ...
  r2.w = cb0[116].x * 0.0174532942;
  r2.w = cos(r2.w);
  r1.w = -r2.w + abs(r1.w);
  r3.x = cb0[117].x + cb0[116].x;
  r3.x = 0.0174532942 * r3.x;
  r3.x = cos(r3.x);
  r2.w = r3.x + -r2.w;
  r1.w = saturate(r1.w / r2.w);
  r2.w = 10000 + -r0.w;
  r3.x = 0.280000001 * v5.z;
  r3.x = frac(r3.x);
  r3.y = -r3.x * 1.00000203 + -1.33333302;
  r3.x = cb0[107].x + -r3.x;
  r3.x = 1 + r3.x;
  r3.x = saturate(3.33333302 * r3.x);
  r0.w = r0.w * 0.166666999 + r3.y;
  ...
  o1.xyz = r0.xyz * float3(0.850000024,0.850000024,0.850000024) + r3.xyz;
  o3.xyzw = v0.xyzw;
  o4.xyzw = v1.xyzw;
  o5.xyw = v5.xyw;
  o5.z = v2.w;
