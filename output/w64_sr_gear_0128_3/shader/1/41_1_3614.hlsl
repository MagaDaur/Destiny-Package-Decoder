...
// unknown dcl_: dcl_input_sgv v4.x, vertex_id
  ...
  r1.w = cb0[13].x * cb0[3].x;
  r2.x = cb0[15].x * cb0[12].x;
  r2.y = cb0[15].x * r1.w;
  r2.z = cb0[15].x * cb0[14].x;
  r1.w = cb0[7].x * cb0[6].x;
  r2.w = -cb0[8].x + 1;
  r3.xy = float2(1,1) + -r0.yx;
  r3.x = -r3.x * cb0[9].x + 1;
  r3.z = 1 + -r2.w;
  r3.y = -r3.y * cb0[11].x + 1;
  r3.y = r3.z * r3.y;
  r2.w = r2.w * r3.x + r3.y;
  r1.w = r1.w * r0.z + r2.w;
  r2.w = cb0[4].x * cb0[3].x;
  r3.x = cb0[3].x * cb0[3].x;
  r4.x = cb0[0].x * r0.z + r2.w;
  r4.y = cb0[1].x * r0.z + cb0[5].x;
  r4.z = cb0[2].x * r0.z + r3.x;
  ...
  r4.xyz = r4.www * r3.xyz + r4.xyz;
  r2.xyz = r4.xyz + r2.xyz;
  r4.xyz = v1.zxy * -r3.yzx;
  r4.xyz = v1.yzx * -r3.zxy + -r4.xyz;
  r1.w = dot(v1.xyz, -r3.xyz);
  r4.w = -r1.w;
  r6.xyz = v1.xyz;
  r6.w = 0;
  ...
  r5.yzw = v2.zxy * -r3.yzx;
  r6.xyz = v2.yzx * -r3.zxy + -r5.yzw;
  ...
  r1.xyz = cb0[16].xxx * r2.xyz + r1.xyz;
  ...
  r1.xyw = cb0[16].xxx * r4.xyz + v1.xyz;
  ...
  r1.xyw = cb0[16].xxx * r3.xyz + v2.xyz;
