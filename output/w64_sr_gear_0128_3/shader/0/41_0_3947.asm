...
add r6.xyz, r5.ywzy, l(-0.250000, -0.188235298, -0.156862751, 0.000000)
mul_sat r6.yz, r6.yyzy, l(0.000000, 1.231884, 1.18604648, 0.000000)
mov_sat r6.x, r6.x
mad_sat r1.w, cb7[33].y, r6.y, cb7[33].x
mul r2.w, r6.z, cb0[14].x
mad_sat r1.w, cb7[33].w, r1.w, cb7[33].z
mad r0.xyz, r1.wwww, r2.xyzx, r0.xyzx
add r0.xyz, -r4.xyzx, r0.xyzx
ge r2.x, r5.w, l(0.156862751)
and r2.y, r2.x, l(0x3f800000)
mad r0.xyz, r2.yyyy, r0.xyzx, r4.xyzx
ne r2.z, l(0.000000, 0.000000, 0.000000, 0.000000), cb7[28].w
and r4.xyz, r2.zzzz, cb7[28].xyzx
mul r4.xyz, r2.wwww, r4.xyzx
mul r4.xyz, r2.yyyy, r4.xyzx
mad r6.yzw, r4.xxyz, r1.wwww, r0.xxyz
...
mul_sat r8.xy, r5.wyww, l(7.968750, 4.000000, 0.000000, 0.000000)
ge r2.z, l(0.050000), r8.x
movc r0.z, r2.z, r0.z, l(-1.000000)
movc o0.w, r2.x, r0.y, r0.z
mad_sat r0.y, r0.w, r8.y, r6.x
...
mad_sat r0.z, r0.z, r0.w, cb0[3].x
add r0.w, v4.z, -cb0[6].z
mul r0.w, r0.w, cb0[7].x
max r0.w, r0.w, l(0.000000)
log r0.w, r0.w
mul r0.w, r0.w, cb0[8].x
exp r0.w, r0.w
mul_sat r0.w, r0.w, cb0[9].x
mul r0.z, r0.w, r0.z
