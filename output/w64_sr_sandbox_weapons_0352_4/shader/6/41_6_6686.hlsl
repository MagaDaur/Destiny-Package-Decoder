...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r0.y = saturate(r1.w);
    r7.xyzw = r0.yyyy * float4(-8143.06348,1.28217101,9.12500095,0.300125003) + float4(611.829468,-2.57331896,0,0.991023004);
    r0.z = r0.y * r0.y;
    r7.xy = r7.xy * r0.zz + r7.zw;
    r8.xyz = cmp(r0.yyy >= float3(0,0.0566670001,1));
    ...
    r0.y = r0.y * r0.z + 0.5;
    r7.z = 18 * r0.y;
    r6.xyzw = r6.xyzw * float4(0.0150000006,0.188278019,0.147128999,0.289774984) + float4(0.00999999978,0.0661220029,0.0637099966,0.43039301);
