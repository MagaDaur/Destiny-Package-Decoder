...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r2.yz = float2(2.32830644e-010,-2.32830644e-010) * r2.xx;
    r2.xw = r2.xx * float2(-7.27595761e-011,2.01212241e-011) + float2(1.3125,-1.08642006);
    r4.x = r2.y * r2.y;
    r2.x = r4.x * r2.x;
    r2.x = min(1, r2.x);
    r2.x = r2.x * 6.75 + 2.25;
  ...
  // No code for instruction (needs manual fix):
    ...
    r1.x = 0;
    r1.zw = r2.zy * float2(1.54999995,1) + float2(2,0);
  // No code for instruction (needs manual fix):
