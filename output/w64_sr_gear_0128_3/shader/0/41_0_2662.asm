...
add r7.z, l(128.500000), cb0[15].x
...
rsq r0.z, r0.z
mul r1.xyz, r0.zzzz, r1.xyzx
mov_sat r0.z, cb0[25].x
dp3 r1.w, v0.xyzx, v0.xyzx
rsq r1.w, r1.w
mul r4.xyz, r1.wwww, v0.xyzx
dp3 r1.w, cb0[18].xyzx, r4.xyzx
add r2.w, -cb0[16].x, cb0[17].x
mad_sat r1.w, r1.w, r2.w, cb0[16].x
add r2.w, v4.z, -cb0[19].z
mul r2.w, r2.w, cb0[20].x
max r2.w, r2.w, l(0.000000)
log r2.w, r2.w
mul r2.w, r2.w, cb0[21].x
exp r2.w, r2.w
mul_sat r2.w, r2.w, cb0[22].x
mul r1.w, r1.w, r2.w
