...
struct __c59d1c81 // string array_element
{
	uint32_t hash; // 0x0
	uint16_t byte_size; // 0x4
	uint16_t string_size; // 0x6
	uint64_t unk[2]; // 0x8
	uint32_t next_string_offset; // 0x18
	uint32_t next_struct_hash; // 0x1C
};

struct __076f8080 // entity model info
{
