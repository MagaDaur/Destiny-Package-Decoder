...
movc r3.z, v6.x, l(1.000000), l(-1.000000)
mad_sat r7.w, cb7[r4.z + 0].y, r8.z, cb7[r4.z + 0].x
mad_sat r4.z, cb7[r4.z + 0].w, r7.w, cb7[r4.z + 0].z
mul_sat r11.xyz, r9.wyzw, l(7.968750, 4.000000, 7.968750, 0.000000)
...
mad r2.yzw, r4.zzzz, r6.xxyz, r2.yyzw
add r4.yw, -r0.zzzw, r5.xxxz
mad r0.zw, r4.zzzz, r4.yyyw, r0.zzzw
add r3.x, -r2.x, r3.x
mad r2.x, r4.z, r3.x, r2.x
add r3.x, r5.w, -r6.w
mad r5.y, r4.z, r3.x, r6.w
add r3.x, -r1.x, r4.x
mad r1.x, r4.z, r3.x, r1.x
...
mov r11.w, r9.y
add r0.zw, -r11.wwwx, r5.xxxy
mad r0.zw, r1.wwww, r0.zzzw, r11.wwwx
mul r1.x, r1.z, r1.w
movc o0.w, r0.y, r3.x, r7.w
...
mul r3.xyw, r4.zzzz, r1.yzyw
mad r1.yzw, r1.yyzw, r4.zzzz, r2.xxyz
max r0.y, r1.z, r1.y
max r0.y, r1.w, r0.y
...
if_nz r3.w
  ...
  round_pi r4.y, r3.w
  exp r4.y, r4.y
  mul r4.xz, r4.xxxx, v3.xxyx
  round_ni r4.xz, r4.xxzx
  dp2 r4.w, r4.xzxx, l(17.000000, 0.100000, 0.000000, 0.000000)
  sincos r4.w, null, r4.w
  mul r4.w, r4.w, l(10000.000000)
  mad r4.x, r4.z, l(13.000000), r4.x
  sincos r4.x, null, r4.x
  add r4.x, |r4.x|, l(0.100000)
  mul r4.x, r4.x, r4.w
  mul r4.yz, r4.yyyy, v3.xxyx
  round_ni r4.yz, r4.yyzy
  dp2 r4.w, r4.yzyy, l(17.000000, 0.100000, 0.000000, 0.000000)
  sincos r4.w, null, r4.w
  mul r4.w, r4.w, l(10000.000000)
  ...
  mul r4.yz, r4.xxwx, r4.xxzx
  div r4.y, r4.y, r4.z
  mad r5.x, -r3.w, l(0.500000), r4.x
  div r5.x, r5.x, r4.w
  add r5.y, -r4.x, l(1.000000)
  mul r5.y, r5.y, r5.y
  div r4.z, r5.y, r4.z
  add r4.z, -r4.z, l(1.000000)
  lt r4.w, r4.x, r4.w
  lt r3.w, r4.x, r3.w
  movc r3.w, r3.w, r4.y, r5.x
  movc r3.w, r4.w, r3.w, r4.z
  ge r4.x, l(0.500000), cb0[3].x
  add r4.y, cb0[3].x, cb0[3].x
  mad r4.y, r3.w, -r4.y, r4.y
  mad r4.z, cb0[3].x, l(2.000000), l(-2.000000)
