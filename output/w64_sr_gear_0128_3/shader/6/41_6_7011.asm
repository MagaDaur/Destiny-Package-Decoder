...
if_nz r0.x
  ...
  mul r5.z, r4.y, l(2.328306437E-010)
  ...
  mul r6.xyzw, l(0.200000, 0.000000, 0.000000, 0.000000), cb9[r0.y + 32].wwww
  mad r6.xyzw, cb9[r0.y + 32].zzyx, l(-0.000000, 0.200000, -0.200000, 0.200000), r6.xyzw
  mul r4.yzw, r6.yyzx, cb9[r0.y + 32].zzxy
  mad r4.yzw, cb9[r0.y + 32].yyzx, r6.zzxy, -r4.yyzw
  mad r4.yzw, cb9[r0.y + 32].wwww, r6.xxyz, r4.yyzw
  mad r4.yzw, r6.wwww, cb9[r0.y + 32].xxyz, r4.yyzw
  add r4.yzw, r4.yyzw, cb9[r0.y + 0].xxyz
  imad r0.w, r0.w, l(0x0019660d), l(0x3c6ef35f)
  utof r6.x, r0.w
  mad r6.x, r6.x, l(4.656612873E-010), l(-1.000000)
  imad r0.w, r0.w, l(0x0019660d), l(0x3c6ef35f)
  utof r6.w, r0.w
  mad r6.y, r6.w, l(4.656612873E-010), l(-1.000000)
  imad r0.w, r0.w, l(0x0019660d), l(0x3c6ef35f)
  utof r0.w, r0.w
  ...
  mul r6.xyz, r6.xyzx, l(0.500000, 0.100000, 0.100000, 0.000000)
  mul r7.xyz, r4.xxxx, l(1.000000, 0.000000, 0.000000, 0.000000)
  ...
  mul r9.xyz, cb9[r0.y + 32].yzxy, -cb9[r0.z + 32].zxyz
  mad r9.xyz, -cb9[r0.z + 32].yzxy, cb9[r0.y + 32].zxyz, -r9.xyzx
  dp3 r0.w, -cb9[r0.z + 32].xyzx, cb9[r0.y + 32].xyzx
  mov r10.w, -r0.w
  mad r10.xyz, cb9[r0.z + 32].wwww, cb9[r0.y + 32].xyzx, r9.xyzx
  mul r9.xyzw, l(-1.000000, -1.000000, -1.000000, 1.000000), cb9[r0.z + 32].xyzw
  mad r9.xyzw, cb9[r0.y + 32].wwww, r9.xyzw, r10.xyzw
  mul r10.xyz, r4.wyzw, cb9[r0.z + 32].yzxy
  mad r10.xyz, r4.zwyz, cb9[r0.z + 32].zxyz, -r10.xyzx
  dp3 r0.y, r4.yzwy, cb9[r0.z + 32].xyzx
  mov r10.w, -r0.y
  mul r4.xyz, r4.yzwy, cb9[r0.z + 32].wwww
  mov r4.w, l(0)
  add r4.xyzw, r4.xyzw, r10.xyzw
  mul r10.xyz, r4.yzxy, -cb9[r0.z + 32].zxyz
  mad r10.xyz, -cb9[r0.z + 32].yzxy, r4.zxyz, -r10.xyzx
  mad r4.xyz, cb9[r0.z + 32].wwww, r4.xyzx, r10.xyzx
  mad r4.xyz, r4.wwww, -cb9[r0.z + 32].xyzx, r4.xyzx
  add r4.xyz, r4.xyzx, -r8.xyzx
  mul r8.xyz, r6.zxyz, -r9.yzxy
  mad r8.xyz, r6.yzxy, -r9.zxyz, -r8.xyzx
  dp3 r0.y, r6.xyzx, -r9.xyzx
  mov r8.w, -r0.y
  mul r6.xyz, r6.xyzx, r9.wwww
  mov r6.w, l(0)
  add r6.xyzw, r6.xyzw, r8.xyzw
  mul r8.xyz, r6.yzxy, r9.zxyz
  mad r8.xyz, r9.yzxy, r6.zxyz, -r8.xyzx
  mad r6.xyz, r9.wwww, r6.xyzx, r8.xyzx
  mad r6.xyz, r6.wwww, r9.xyzx, r6.xyzx
  add r4.xyz, r4.xyzx, r6.xyzx
  mul r6.xyzw, r7.zzxx, -r9.zxyx
  mad r8.xyz, -r7.zxzz, -r9.yzxy, r6.xyzx
  mov r8.w, -r6.w
  mul r6.xyz, r7.xyzx, r9.wwww
  mov r6.w, l(0)
  add r6.xyzw, r6.xyzw, r8.xyzw
  mul r7.xyz, r6.yzxy, r9.zxyz
  mad r7.xyz, r9.yzxy, r6.zxyz, -r7.xyzx
  mad r6.xyz, r9.wwww, r6.xyzx, r7.xyzx
  mad r6.xyz, r6.wwww, r9.xyzx, r6.xyzx
