  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r3.zw = float2(0.25,0.200000003) * r3.yx;
  r3.zw = round(r3.zw);
  r3.zw = r3.yx * float2(0.25,0.200000003) + -r3.zw;
  r4.xy = abs(r3.zw) * float2(-16,-16) + float2(8,8);
  r3.zw = r4.xy * r3.zw;
  r4.xy = abs(r3.zw) * float2(0.224999994,0.224999994) + float2(0.774999976,0.774999976);
  r3.zw = r4.xy * r3.zw;
  r4.y = v5.z;
  r4.xzw = float3(0.100000001,0,0);
  ...
  r3.x = 1 + -r3.x;
  r3.y = max(0.00100000005, v6.y);
  r3.y = log2(r3.y);
  r3.y = 2.20000005 * r3.y;
  r3.y = exp2(r3.y);
  r3.y = 1 + -r3.y;
  r3.z = max(9.99999975e-006, r3.y);
  r3.y = r3.y / r3.z;
  r3.y = max(0, r3.y);
  r3.yzw = v4.xyz * r3.yyy;
  r4.xyz = v7.zzz * r3.yzw;
  r4.x = dot(r4.xyz, float3(0.300000012,0.589999974,0.109999999));
  r3.yzw = r3.yzw * v7.zzz + -r4.xxx;
  r3.yzw = v6.zzz * r3.yzw + r4.xxx;
  r4.x = 1 / cb0[131].x;
  r2.w = log2(r2.w);
  r2.w = r4.x * r2.w;
  r2.w = exp2(r2.w);
  r2.w = r2.w * v7.y + v7.x;
  r4.x = -0.800000012 + v4.w;
  r4.x = saturate(1.11111116 * r4.x);
  ...
  r2.x = -1 + r2.x;
  r0.w = r0.w * r2.x + 1;
  r1.x = saturate(dot(cb0[108].xyz, r1.xyz));
  r1.yzw = cb0[107].xyz * r1.www;
  ...
  r0.z = saturate(r1.w * cb0[114].x + cb0[114].y);
