...
mad r3.xyz, v4.xyzx, cb1[4].xyzx, cb1[5].xyzx
mad r3.xyz, r3.xyzx, l(0.004000, 0.004000, 0.004000, 0.000000), l(0.000000, 0.000000, -0.003000, 0.000000)
mul r3.xyz, r3.xyzx, v2.xyzx
mul r4.xyz, r0.xyzx, r3.yyyy
mul r0.xyz, r0.xyzx, v6.yyyy
mad r0.xyz, v6.xxxx, r1.xyzx, r0.xyzx
mad r1.xyz, r3.xxxx, r1.xyzx, r4.xyzx
mad r1.xyz, r3.zzzz, r2.xyzx, r1.xyzx
mad r0.xyz, v6.zzzz, r2.xyzx, r0.xyzx
add r0.w, v2.w, l(1.570500)
