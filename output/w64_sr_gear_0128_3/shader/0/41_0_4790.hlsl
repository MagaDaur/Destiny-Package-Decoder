  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.y = cb0[15].x * r0.y;
  r0.zw = v3.xy * cb0[12].xy + cb0[12].zw;
  r0.z = t4.Sample(s3_s, r0.zw).x;
  r0.y = r0.z * cb0[13].x + r0.y;
  r1.xyzw = cb0[17].xyzw * cb0[16].xxxx;
  r1.xyzw = r1.xyzw * r0.yyyy;
  r1.xyzw = cb0[10].xyzw * cb0[11].xyzw + r1.xyzw;
  r3.xyzw = cb0[9].xyzw * cb0[8].xxxx;
  r1.xyzw = r3.xyzw * r1.xyzw;
  r0.x = r1.w * r0.x;
  r0.yzw = cb0[18].xxx * r1.xyz;
