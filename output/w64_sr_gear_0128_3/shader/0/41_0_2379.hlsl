  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r8.z = saturate(r7.y * cb0[2].x + cb0[2].y);
  r8.z = saturate(cb0[3].x * r8.z);
  r8.w = 1 + -r8.z;
  r7.w = saturate(7.96875 * r7.w);
  r9.x = r7.w * cb0[4].x + cb0[4].y;
  r9.y = r9.x * r8.w;
  r8.w = saturate(cb0[5].y * r7.y + cb0[5].x);
  r7.w = r6.z ? 0 : r7.w;
  r8.w = r8.w + -r7.y;
  r5.w = r7.w * r8.w + r7.y;
  r7.y = cb0[6].x + 128.5;
  ...
  r7.w = saturate(r8.z * cb0[21].x + cb0[21].y);
  r0.y = r7.w + r0.y;
  r0.y = min(1, r0.y);
  r10.xyzw = cb0[20].xyzw + -cb0[19].xyzw;
  r10.xyzw = saturate(r0.yyyy * r10.xyzw + cb0[19].xyzw);
  ...
  r2.w = rsqrt(r2.w);
  r1.xyz = r2.www * r1.xyz;
  r2.w = saturate(cb0[16].x);
  r3.w = dot(r3.xyz, r3.xyz);
  r3.w = rsqrt(r3.w);
  r3.xyz = r3.xyz * r3.www;
  r3.x = dot(cb0[9].xyz, r3.xyz);
  r3.y = cb0[8].x + -cb0[7].x;
  r3.x = saturate(r3.x * r3.y + cb0[7].x);
  r3.y = -cb0[10].z + v4.z;
  r3.y = cb0[11].x * r3.y;
  r3.y = max(0, r3.y);
  r3.y = log2(r3.y);
