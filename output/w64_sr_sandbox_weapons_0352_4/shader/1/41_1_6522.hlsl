...
// unknown dcl_: dcl_input_sgv v3.x, vertex_id
  ...
  r0.w = 2.5 * r0.w;
  r0.w = exp2(r0.w);
  r4.y = r0.w * 0.0224999953 + 0.100000001;
  r4.x = 0.129999995;
  r4.xy = cb0[15].yx * r4.xy;
  r0.xy = r4.xy * r0.xy;
  sincos(v1.w, r4.x, r5.x);
  r4.xy = r4.xx * r0.xy;
  r0.y = r0.y * r5.x + -r4.x;
  r0.x = r0.x * r5.x + r4.y;
  ...
  o1.xyz = r3.xyz;
  r0.xyw = r4.xyz * r0.yyy;
  r0.xyw = r0.xyw * float3(0.5,0.5,0.5) + r2.xyz;
  ...
  r0.y = cmp(cb0[16].w < 9.99999997e-007);
