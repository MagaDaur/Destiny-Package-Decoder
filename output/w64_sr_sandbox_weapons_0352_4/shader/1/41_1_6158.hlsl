  ...
  out float4 o8 : SV_POSITION0)
{
  ...
  r3.xyz = v10.xyz * cb1[4].xyz + cb1[5].xyz;
  r3.xyz = r3.xyz * v7.xxx + float3(-0.0799999982,0,0);
  r3.xyz = v3.xyz * r3.xyz;
  r4.xyz = r3.yyy * r1.xyz;
  r1.xyz = v12.yyy * r1.xyz;
  r1.xyz = v12.xxx * r0.yzw + r1.xyz;
  r0.yzw = r3.xxx * r0.yzw + r4.xyz;
  r0.yzw = r3.zzz * r2.xyz + r0.yzw;
  r1.xyz = v12.zzz * r2.xyz + r1.xyz;
  r1.w = v8.x * 6.28200006 + v2.w;
  r1.w = 0.5 * r1.w;
