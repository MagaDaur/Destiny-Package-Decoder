  ...
  out float4 o2 : SV_TARGET2)
{
  ...
  r6.xy = r6.xy * cb0[22].xx + cb0[22].yy;
  ...
  r9.z = r7.y;
  r3.xy = r4.xy + -r9.zx;
  r3.xy = r5.ww * r3.xy + r9.zx;
  r0.w = r5.w * r1.w;
  o0.w = r0.z ? r0.y : r7.z;
  r0.y = -cb0[21].x + cb0[19].x;
  r0.y = cmp(abs(r0.y) < 9.99999975e-006);
  r0.z = cb0[19].x + -cb0[4].x;
  r0.z = cmp(abs(r0.z) < 9.99999975e-006);
  r0.yz = r0.yz ? float2(1,1) : 0;
  r1.w = -cb0[20].x + cb0[19].x;
  r1.w = cmp(abs(r1.w) < 9.99999975e-006);
  r1.w = r1.w ? 1.000000 : 0;
  r4.xyz = -cb0[18].xyz + cb0[17].xyz;
  r4.xyz = r1.www * r4.xyz + cb0[18].xyz;
  r5.xyz = cb0[16].xyz + -r4.xyz;
  ...
  r4.xyz = cb0[14].xyz * r4.xyz + r2.xyz;
  r0.y = max(r4.x, r4.y);
  r0.y = max(r0.y, r4.z);
