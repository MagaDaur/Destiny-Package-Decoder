...
// unknown dcl_: dcl_thread_group 64, 1, 1
  ...
  if (r0.x != 0) {
    ...
    r3.w = round(r2.z);
    r3.w = r3.x * 2.32830644e-010 + -r3.w;
    r5.x = abs(r3.w) * -16 + 8;
    r3.w = r5.x * r3.w;
    r5.x = abs(r3.w) * 0.224999994 + 0.774999976;
    r3.w = r5.x * r3.w;
    r6.y = 0.600000024 * r3.w;
    r3.x = r3.x * 2.32830644e-010 + 0.25;
    r3.w = round(r3.x);
    r3.x = r3.x + -r3.w;
    r3.w = abs(r3.x) * -16 + 8;
    r3.x = r3.x * r3.w;
    r3.w = abs(r3.x) * 0.224999994 + 0.774999976;
    r3.x = r3.x * r3.w;
    r6.z = 1.5 * abs(r3.x);
    r6.xw = float2(0,0);
    r5.xyz = r6.zwy * -r4.yzx;
    r7.xyz = r6.yzw * -r4.zxy + -r5.xyz;
    r3.w = dot(r6.yz, -r4.yz);
    r7.w = -r3.w;
