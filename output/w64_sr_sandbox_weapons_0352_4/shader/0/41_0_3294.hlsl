  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.y = 1 / r0.y;
  r0.y = -v0.w + r0.y;
  r0.y = saturate(0.666666985 * r0.y);
  r0.y = log2(r0.y);
  r0.y = cb0[105].x * r0.y;
  r0.y = exp2(r0.y);
  r0.x = r0.x * r0.y;
  ...
  r0.yzw = r0.yzw * v10.yyy + float3(-2.51188652e-007,-2.51188652e-007,-2.51188652e-007);
  r0.yzw = float3(1.00000024,1.00000024,1.00000024) * r0.yzw;
  r0.yzw = max(float3(0,0,0), r0.yzw);
  r0.yzw = v11.zzz * r0.yzw;
  r0.yzw = cb13[1].www * r0.yzw;
  r0.yzw = cb13[1].xxx * r0.yzw;
  r0.yzw = float3(0.00646599988,0.0216029994,0.0216029994) * r0.yzw;
