...
mad r6.xy, r6.xyxx, cb0[27].xxxx, cb0[27].yyyy
...
if_nz r1.w
  ...
  round_pi r3.x, r1.w
  exp r3.x, r3.x
  mul r4.xy, r2.wwww, v3.xyxx
  round_ni r4.xy, r4.xyxx
  dp2 r2.w, r4.xyxx, l(17.000000, 0.100000, 0.000000, 0.000000)
  sincos r2.w, null, r2.w
  mul r2.w, r2.w, l(10000.000000)
  mad r3.w, r4.y, l(13.000000), r4.x
  sincos r3.w, null, r3.w
  add r3.w, |r3.w|, l(0.100000)
  mul r2.w, r2.w, r3.w
  frc r2.w, r2.w
  mul r3.xw, r3.xxxx, v3.xxxy
  round_ni r3.xw, r3.xxxw
  dp2 r4.x, r3.xwxx, l(17.000000, 0.100000, 0.000000, 0.000000)
  sincos r4.x, null, r4.x
  mul r4.x, r4.x, l(10000.000000)
  ...
  lt r4.x, r2.w, r4.x
  lt r1.w, r2.w, r1.w
  movc r1.w, r1.w, r3.x, r4.y
  movc r1.w, r4.x, r1.w, r3.w
  ge r2.w, l(0.500000), cb0[11].x
  add r3.x, cb0[11].x, cb0[11].x
  mad r3.x, r1.w, -r3.x, r3.x
  mad r3.w, cb0[11].x, l(2.000000), l(-2.000000)
...
discard_nz r0.z
mov_sat r0.z, cb0[22].x
dp3 r1.w, v0.xyzx, v0.xyzx
rsq r1.w, r1.w
mul r4.xyz, r1.wwww, v0.xyzx
dp3 r1.w, cb0[15].xyzx, r4.xyzx
add r2.w, -cb0[13].x, cb0[14].x
mad_sat r1.w, r1.w, r2.w, cb0[13].x
add r2.w, v4.z, -cb0[16].z
...
mul r1.w, r1.w, r2.w
mad_sat r0.x, r0.x, cb0[20].x, cb0[20].y
mul r0.x, r0.x, r1.w
