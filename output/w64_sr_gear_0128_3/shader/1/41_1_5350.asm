...
ishl r2.zw, r6.yyyw, l(0, 0, 8, 8)
or r2.zw, r2.zzzw, r6.xxxz
f16tof32 r2.zw, r2.zzzw
mul o3.zw, r2.zzzw, r2.xxxy
mul r2.z, cb0[0].x, cb0[1].x
mul r2.z, r2.z, r5.x
mul r2.z, r2.z, cb0[2].x
add r6.xy, r2.xyxx, -cb0[4].xyxx
dp2 r2.w, r6.xyxx, r6.xyxx
sqrt r2.w, r2.w
add r2.w, r2.w, cb0[3].x
mad r2.w, cb0[5].w, r2.w, cb0[5].z
round_ne r3.w, r2.w
add r2.w, r2.w, -r3.w
mad r3.w, |r2.w|, l(-16.000000), l(8.000000)
mul r2.w, r2.w, r3.w
mad r3.w, |r2.w|, l(0.225000), l(0.775000)
mul r2.w, r2.w, r3.w
mad r2.w, cb0[5].x, r2.w, cb0[5].y
mad r6.xy, r2.xyxx, cb0[6].xyxx, cb0[6].zwzz
sample_l_indexable(texture2d)(float,float,float,float) r3.w, r6.xyxx, t2.yzwx, s1, l(0.000000)
mad r6.xy, r2.xyxx, cb0[7].xyxx, cb0[7].zwzz
sample_l_indexable(texture2d)(float,float,float,float) r4.w, r6.xyxx, t3.yzwx, s1, l(0.000000)
mad r4.w, r4.w, cb0[8].x, cb0[8].y
mad r6.xy, r2.xyxx, cb0[9].xyxx, cb0[9].zwzz
...
mad_sat r3.w, r3.w, cb0[11].x, cb0[11].y
mad r2.w, r3.w, cb0[12].x, r2.w
mad_sat r3.w, r5.x, cb0[13].x, cb0[13].y
mul r6.z, r2.w, r3.w
mov r6.xy, l(0,0,0,0)
mad r6.xyz, r2.zzzz, r3.xyzx, r6.xyzx
