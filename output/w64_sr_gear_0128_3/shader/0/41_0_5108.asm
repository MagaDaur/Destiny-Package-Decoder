...
mul r1.xyzw, cb0[10].xyzw, cb0[11].xyzw
mad r0.yz, v3.xxyx, cb0[8].xxyx, cb0[8].zzwz
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r0.yzyy, t4.xyzw, s3
mad r1.xyzw, r3.xyzw, cb0[9].xyzw, r1.xyzw
mul r3.xyzw, r3.xyzw, cb0[12].xyzw
mad r1.xyzw, r3.xyzw, cb0[13].xxxx, r1.xyzw
mul r0.x, r0.x, r1.w
mul r0.yzw, r1.xxyz, cb0[14].xxxx
